...
struct lookback_iterator
  ...
  friend bool operator==(lookback_iterator const &x,
  ...
  typedef boost::iterator_range<std::reverse_iterator<Iterator>> lookback_range;

  lookback_range lookback() const { return lookback_range(base_, original_); }
