...
typedef cl::scanner<parse_iterator,
                    cl::scanner_policies<cl::iteration_policy, cl::match_policy,
                                         cl::action_policy>>
    scanner;
...
struct grammar : public cl::grammar<grammar> {
  ...
  template <typename Scanner>
  struct definition : Scanner_must_be_the_quickbook_scanner_typedef<Scanner> {
