...
struct element_info {
  ...
  enum context {
    ...
    in_top_level = phrase | maybe_block | nested_block | conditional_or_block |
                   section_block,
    ...
    is_contextual_block =
        maybe_block | nested_block | conditional_or_block | section_block,
  ...
  element_info(type_enum t, cl::rule<scanner> *r,
               value::tag_type tag_ = value::default_tag, unsigned int v = 0)
