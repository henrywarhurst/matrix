...
namespace quickbook {
template_symbol::template_symbol(std::string const &identifier_,
                                 std::vector<std::string> const &params_,
                                 value const &content_,
                                 template_scope const *lexical_parent_)
    : identifier(identifier_), params(params_), content(content_),
...
template_symbol *
template_stack::find_top_scope(std::string const &symbol) const {
