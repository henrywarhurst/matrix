...
void docheck(SymbolsT const &sym, CharT const *candidate, bool hit,
             CharT const *result, int length) {
...
static void default_constructible() { // this actually a compile time test
...
static void narrow_value_tests() { // also tests the add member functions
  nsymbols sym;
...
static void wide_value_tests() { // also tests the add member functions
  wsymbols sym;
