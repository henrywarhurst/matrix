...
//  ---------------------------------------------// Protect against ourself:
//  boostinspect:ndprecated_macros
...
const char *boost153macros[] = {
    "BOOST_HAS_STATIC_ASSERT", "BOOST_HAS_RVALUE_REFS",
    "BOOST_HAS_VARIADIC_TMPL", "BOOST_HAS_CHAR16_T",
    "BOOST_HAS_CHAR32_T",      NULL};
} // unnamed namespace
