...
struct use_terminal<
    qi::domain, terminal_ex<repository::qi::tag::advance, fusion::vector1<A0>>>
...
struct advance_parser
  ...
  advance_parser(Int dist) : dist(dist) {}

  // This function is called during the actual parsing process
  template <typename Iterator, typename Context, typename Skipper,
            typename Attribute>
  bool parse(Iterator &first, Iterator const &last, Context &, Skipper &,
             Attribute &) const {
  ...
  template <typename Context> boost::spirit::info what(Context &) const {
...
struct make_primitive<
    terminal_ex<repository::qi::tag::advance, fusion::vector1<A0>>, Modifiers> {
