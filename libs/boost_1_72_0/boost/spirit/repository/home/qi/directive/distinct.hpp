...
struct use_directive<
    qi::domain, terminal_ex<repository::tag::distinct, fusion::vector1<Tail>>>
    : mpl::true_ {};
...
struct make_directive<
    terminal_ex<repository::tag::distinct, fusion::vector1<Tail>>, Subject,
    Modifiers> {
  typedef
      typename result_of::compile<qi::domain, Tail, Modifiers>::type tail_type;

  typedef repository::qi::distinct_parser<Subject, tail_type, Modifiers>
      result_type;
