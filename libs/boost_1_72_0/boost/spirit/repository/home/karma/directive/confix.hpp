...
struct confix_generator : spirit::karma::primitive_generator<
                              confix_generator<Subject, Prefix, Suffix>> {
  ...
  template <typename Context> info what(Context const &ctx) const {
...
struct make_directive<
    terminal_ex<repository::tag::confix, fusion::vector2<Prefix, Suffix>>,
    Subject, Modifiers> {
  typedef typename result_of::compile<karma::domain, Prefix, Modifiers>::type
      prefix_type;
  typedef typename result_of::compile<karma::domain, Suffix, Modifiers>::type
      suffix_type;

  typedef repository::karma::confix_generator<Subject, prefix_type, suffix_type>
      result_type;
...
struct has_semantic_action<
    ...
    : mpl::or_<has_semantic_action<Subject>, has_semantic_action<Prefix>,
