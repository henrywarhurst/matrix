...
struct use_lazy_terminal<karma::domain, tag::auto_, 1 /*arity*/
                         > : mpl::true_ {};
...
struct auto_generator : generator<auto_generator<Modifiers>> {
  ...
  auto_generator(Modifiers const &modifiers) : modifiers_(modifiers) {}
...
struct lit_auto_generator : generator<lit_auto_generator<T, Modifiers>> {
  ...
  lit_auto_generator(typename add_reference<T>::type t,
  ...
  typedef
      typename spirit::result_of::compile<karma::domain, generator_type,
                                          Modifiers>::type generator_impl_type;
...
// auto_
template <typename Modifiers> struct make_primitive<tag::auto_, Modifiers> {
