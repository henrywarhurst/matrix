...
template <typename T> struct real_policies {
  ...
  static int floatfield(T n) {
    ...
    return (abs_n >= 1e5 || abs_n < 1e-3) ? fmtflags::scientific
                                          : fmtflags::fixed;
  }
  ...
  static bool integer_part(OutputIterator &sink, T n, bool sign,
                           bool force_sign) {
    return sign_inserter::call(sink, traits::test_zero(n), sign, force_sign,
                               force_sign) &&
  ...
  ///////////////////////////////////////////////////////////////////////
  template <typename OutputIterator>
  static bool fraction_part(OutputIterator &sink, T n, unsigned precision_,
                            unsigned precision) {
  ...
  static bool nan(OutputIterator &sink, T n, bool force_sign) {
    return sign_inserter::call(sink, false, traits::test_negative(n),
                               force_sign) &&
