...
namespace spirit {
namespace tag {
template <typename T, unsigned Radix> struct uint_generator {
  BOOST_SPIRIT_IS_TAG()
};
} // namespace tag
...
struct make_primitive<
    ...
    : detail::make_uint_direct<typename remove_const<T>::type, Modifiers,
                               Radix> {};

///////////////////////////////////////////////////////////////////////////
namespace detail {
template <typename T, typename Modifiers> struct basic_uint_literal {
  static bool const lower =
      has_modifier<Modifiers, tag::char_code_base<tag::lower>>::value;
  static bool const upper =
      has_modifier<Modifiers, tag::char_code_base<tag::upper>>::value;
