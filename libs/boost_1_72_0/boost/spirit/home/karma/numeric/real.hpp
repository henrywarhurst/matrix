...
struct real_generator
  ...
  real_generator() {}
  real_generator(Policies const &p) : spirit::terminal<tag_type>(p) {}
};
} // namespace karma
...
struct use_lazy_terminal<
    karma::domain, tag::stateful_tag<Policies, tag::double_, T>, 1 // arity
    > : mpl::true_ {};
...
struct any_real_generator
  ...
  bool generate(OutputIterator &sink, Context &context, Delimiter const &d,
    ...
    return inserter_type::call(sink, traits::extract_from<T>(attr, context),
                               p_) &&
...
struct literal_real_generator
    : primitive_generator<literal_real_generator<T, Policies, CharEncoding, Tag,
                                                 no_attribute>> {
  typedef typename Policies::properties properties;
...
struct make_primitive<terminal_ex<tag::stateful_tag<Policies, tag::double_, T>,
                                  fusion::vector1<A0>>,
                      Modifiers>
    : detail::make_real_direct<typename remove_const<T>::type, Modifiers,
                               Policies> {};

///////////////////////////////////////////////////////////////////////////
namespace detail {
template <typename T, typename Modifiers> struct basic_real_literal {
  static bool const lower =
      has_modifier<Modifiers, tag::char_code_base<tag::lower>>::value;
  static bool const upper =
      has_modifier<Modifiers, tag::char_code_base<tag::upper>>::value;
  ...
  typedef literal_real_generator<
      ...
      typename spirit::detail::get_encoding_with_case<Modifiers, unused_type,
                                                      lower || upper>::type,
      typename detail::get_casetag<Modifiers, lower || upper>::type, true>
      result_type;
