...
template <typename T> struct bool_policies;
...
struct bool_generator
  ...
  bool_generator() {}
  bool_generator(Policies const &data) : spirit::terminal<tag_type>(data) {}
};
} // namespace karma
...
public:
  any_bool_generator(Policies const &p = Policies()) : p_(p) {}
...
struct literal_bool_generator
    : primitive_generator<literal_bool_generator<T, CharEncoding, Tag, Policies,
                                                 no_attribute>> {
public:
  typedef typename Policies::properties properties;
  ...
  bool generate(OutputIterator &sink, Context &context, Delimiter const &d,
    ...
    return bool_inserter<T, Policies, CharEncoding, Tag>::call(sink, n_, p_) &&
           delimit_out(sink, d);
  }
  ...
  bool generate(OutputIterator &sink, Context &, Delimiter const &d,
                unused_type) const {
    return bool_inserter<T, Policies, CharEncoding, Tag>::call(sink, n_) &&
           delimit_out(sink, d);
  }
...
struct make_bool {
  ...
  typedef any_bool_generator<
      ...
      typename spirit::detail::get_encoding_with_case<Modifiers, unused_type,
                                                      lower || upper>::type,
      typename detail::get_casetag<Modifiers, lower || upper>::type, Policies>
      result_type;
...
template <typename Modifiers, bool b> struct make_bool_literal {
  static bool const lower =
      has_modifier<Modifiers, tag::char_code_base<tag::lower>>::value;
  static bool const upper =
      has_modifier<Modifiers, tag::char_code_base<tag::upper>>::value;
...
struct make_primitive<terminal_ex<tag::stateful_tag<Policies, tag::bool_, T>,
                                  fusion::vector1<A0>>,
                      Modifiers>
    : detail::make_bool_direct<Modifiers, typename remove_const<T>::type,
                               Policies> {};

///////////////////////////////////////////////////////////////////////////
namespace detail {
template <typename Modifiers> struct basic_bool_literal {
  static bool const lower =
      has_modifier<Modifiers, tag::char_code_base<tag::lower>>::value;
  static bool const upper =
      has_modifier<Modifiers, tag::char_code_base<tag::upper>>::value;
  ...
  template <typename T_> result_type operator()(T_ i, unused_type) const {
