...
struct use_lazy_terminal<karma::domain,
                         tag::int_generator<T, Radix, force_sign>, 1 // arity
                         > : mpl::true_ {};
...
struct any_int_generator
    : primitive_generator<
          any_int_generator<T, CharEncoding, Tag, Radix, force_sign>> {
private:
  ...
  static bool insert_int(OutputIterator &sink, Attribute const &attr) {
    return sign_inserter::call(sink, traits::test_zero(attr),
           ...
           int_inserter<Radix, CharEncoding, Tag>::call(
               sink, traits::get_absolute_value(attr));
  }
...
public:
  ...
  literal_int_generator(typename add_const<T>::type n) : n_(n) {}
...
struct make_primitive<tag::int_generator<T, Radix, force_sign>, Modifiers>
    : detail::make_int<typename remove_const<T>::type, Modifiers, Radix,
                       force_sign> {};
...
struct make_primitive<
    terminal_ex<tag::int_generator<T, Radix, force_sign>, fusion::vector1<A0>>,
    Modifiers> : detail::make_int_direct<typename remove_const<T>::type,
                                         Modifiers, Radix, force_sign> {};

///////////////////////////////////////////////////////////////////////////
namespace detail {
template <typename T, typename Modifiers> struct basic_int_literal {
  static bool const lower =
      has_modifier<Modifiers, tag::char_code_base<tag::lower>>::value;
  static bool const upper =
      has_modifier<Modifiers, tag::char_code_base<tag::upper>>::value;
  ...
  typedef literal_int_generator<
      ...
      typename spirit::detail::get_encoding_with_case<Modifiers, unused_type,
                                                      lower || upper>::type,
      typename detail::get_casetag<Modifiers, lower || upper>::type, 10, false,
      true>
      result_type;
