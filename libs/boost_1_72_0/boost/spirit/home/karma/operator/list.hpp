...
public:
  ...
  typedef mpl::int_<
      ...
      generator_properties::buffering | generator_properties::counting>
      properties;
  ...
  base_list(Left const &left, Right const &right) : left(left), right(right) {}
...
struct list : base_list<Left, Right, mpl::false_, list<Left, Right>> {
  ...
  list(Left const &left, Right const &right) : base_list_(left, right) {}
};
...
struct strict_list
  ...
  strict_list(Left const &left, Right const &right) : base_list_(left, right) {}
};
...
///////////////////////////////////////////////////////////////////////////
template <typename Left, typename Right, typename Attribute, typename Context,
          typename Iterator>
...
template <typename Left, typename Right, typename Attribute, typename Context,
          typename Iterator>
struct handles_container<karma::strict_list<Left, Right>, Attribute, Context,
                         Iterator> : mpl::true_ {};
} // namespace traits
} // namespace spirit
} // namespace boost
