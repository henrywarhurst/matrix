...
template <typename Elements> struct alternative_properties {
...
struct base_alternative : nary_generator<Derived> {
  ...
  struct attribute {
    ...
    typedef typename traits::build_attribute_sequence<
        Elements, Context, traits::alternative_attribute_transform, Iterator,
  ...
  base_alternative(Elements const &elements) : elements(elements) {}

  template <typename OutputIterator, typename Context, typename Delimiter,
            typename Attribute>
  bool generate(OutputIterator &sink, Context &ctx, Delimiter const &d,
                Attribute const &attr) const {
    typedef detail::alternative_generate_function<OutputIterator, Context,
                                                  Delimiter, Attribute, Strict>
        functor;
...
struct alternative
  ...
  alternative(Elements const &elements) : base_alternative_(elements) {}
};
...
struct strict_alternative
  ...
  strict_alternative(Elements const &elements) : base_alternative_(elements) {}
};
