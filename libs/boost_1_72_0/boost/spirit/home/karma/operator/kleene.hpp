...
public:
  ...
  base_kleene(Subject const &subject) : subject(subject) {}
...
struct kleene : base_kleene<Subject, mpl::false_, kleene<Subject>> {
  ...
  kleene(Subject const &subject) : base_kleene_(subject) {}
};
...
struct strict_kleene
  ...
  strict_kleene(Subject const &subject) : base_kleene_(subject) {}
};
...
template <typename Subject, typename Attribute, typename Context,
          typename Iterator>
struct handles_container<karma::strict_kleene<Subject>, Attribute, Context,
                         Iterator> : mpl::true_ {};
} // namespace traits
} // namespace spirit
} // namespace boost
