...
private:
  ...
  bool generate_subject(F f, Attribute const &, bool &result,
                        mpl::false_) const {
    bool r = !f(subject);
    if (r)
      result = true;
  ...
  //         template <typename F>
  //         bool generate_subject(F f, unused_type, bool& result, mpl::true_)
  //         const
  //         {
  //             bool r = f(subject);
  //             if (!r)
...
public:
  ...
  struct attribute : traits::build_std_vector<typename traits::attribute_of<
                         subject_type, Context, Iterator>::type> {};

  base_plus(Subject const &subject) : subject(subject) {}
...
struct plus : base_plus<Subject, mpl::false_, plus<Subject>> {
  ...
  plus(Subject const &subject) : base_plus_(subject) {}
};
...
struct strict_plus : base_plus<Subject, mpl::true_, strict_plus<Subject>> {
  ...
  strict_plus(Subject const &subject) : base_plus_(subject) {}
};
...
template <typename Subject, typename Attribute, typename Context,
          typename Iterator>
struct handles_container<karma::strict_plus<Subject>, Attribute, Context,
                         Iterator> : mpl::true_ {};
} // namespace traits
} // namespace spirit
} // namespace boost
