...
struct use_terminal<karma::domain,
                    terminal_ex<tag::lit, fusion::vector1<A0>> // enables
                                                               // lit('x')
                    ,
...
struct use_lazy_terminal<karma::domain,
                         tag::char_code<tag::char_, CharEncoding>, 1 // arity
                         > : mpl::true_ {};
...
struct literal_char
  ...
  template <typename Context> info what(Context const & /*context*/) const {
...
template <typename CharEncoding, typename Tag, bool no_attribute>
struct char_set : char_generator<char_set<CharEncoding, Tag, no_attribute>,
                                 CharEncoding, Tag> {
  typedef typename CharEncoding::char_type char_type;
  typedef CharEncoding char_encoding;
  ...
  template <typename String> char_set(String const &str) {
...
///////////////////////////////////////////////////////////////////////////
namespace detail {
template <typename Modifiers, typename Encoding> struct basic_literal {
  ...
  template <typename Char> result_type operator()(Char ch, unused_type) const {
...
struct make_primitive<tag::char_code<tag::char_, CharEncoding>, Modifiers> {
  ...
  typedef any_char<
      typename spirit::detail::get_encoding_with_case<Modifiers, CharEncoding,
                                                      lower || upper>::type,
...
struct make_char_direct {
  ...
  typedef typename mpl::if_<
      traits::is_string<A0>, char_set<encoding, tag, no_attribute>,
...
struct make_primitive<terminal_ex<tag::char_code<tag::char_, CharEncoding>,
  ...
  typedef literal_char<
      typename spirit::detail::get_encoding_with_case<Modifiers, CharEncoding,
                                                      lower || upper>::type,
      typename detail::get_casetag<Modifiers, lower || upper>::type, false>
      result_type;
