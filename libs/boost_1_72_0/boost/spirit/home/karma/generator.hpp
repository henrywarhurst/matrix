...
template <typename Derived> struct primitive_generator : generator<Derived> {
  struct primitive_generator_id;
};

template <typename Derived> struct nary_generator : generator<Derived> {
...
template <typename Derived> struct unary_generator : generator<Derived> {
...
template <typename Derived> struct binary_generator : generator<Derived> {
...
template <typename T> struct is_generator : detail::has_generator_id<T> {};
...
template <typename T> struct properties_of : T::properties {};
