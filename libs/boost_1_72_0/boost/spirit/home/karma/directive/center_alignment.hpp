...
// enables center[]
template <> struct use_directive<karma::domain, tag::center> : mpl::true_ {};
...
inline static bool center_generate(OutputIterator &sink, Context &ctx,
                                   Delimiter const &d, Attribute const &attr,
                                   Embedded const &e, unsigned int const width,
                                   Padding const &p) {
...
struct simple_center_alignment
  ...
  bool generate(OutputIterator &sink, Context &ctx, Delimiter const &d,
    ...
    return detail::center_generate(sink, ctx, d, attr, subject, width,
...
struct make_directive<
    terminal_ex<tag::center, fusion::vector1<Width>>, Subject, Modifiers,
...
struct make_directive<
    terminal_ex<tag::center, fusion::vector1<Padding>>, Subject, Modifiers,
...
template <typename Width, typename Padding, typename Subject,
          typename Modifiers>
struct make_directive<terminal_ex<tag::center, fusion::vector2<Width, Padding>>,
                      Subject, Modifiers> {
  typedef typename result_of::compile<karma::domain, Padding, Modifiers>::type
      padding_type;
...
struct handles_container<karma::simple_center_alignment<Subject, Width>,
