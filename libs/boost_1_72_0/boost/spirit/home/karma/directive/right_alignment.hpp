...
inline static bool
right_align_generate(OutputIterator &sink, Context &ctx, Delimiter const &d,
                     Attribute const &attr, Embedded const &e,
...
struct simple_right_alignment
  ...
  typedef mpl::int_<generator_properties::countingbuffer |
  ...
  bool generate(OutputIterator &sink, Context &ctx, Delimiter const &d,
    ...
    return detail::right_align_generate(sink, ctx, d, attr, subject, width,
...
struct make_directive<
    terminal_ex<tag::right_align, fusion::vector1<Width>>, Subject, Modifiers,
...
struct make_directive<
    terminal_ex<tag::right_align, fusion::vector1<Padding>>, Subject, Modifiers,
    typename enable_if<mpl::and_<
        spirit::traits::matches<karma::domain, Padding>,
        mpl::not_<mpl::bool_<integer_traits<Padding>::is_integral>>>>::type> {
  typedef typename result_of::compile<karma::domain, Padding, Modifiers>::type
      padding_type;
  ...
  result_type operator()(Terminal const &term, Subject const &subject,
    ...
    return result_type(
        subject, compile<karma::domain>(fusion::at_c<0>(term.args), modifiers));
  }
};
...
template <typename Width, typename Padding, typename Subject,
          typename Modifiers>
struct make_directive<
    terminal_ex<tag::right_align, fusion::vector2<Width, Padding>>, Subject,
    Modifiers> {
  typedef typename result_of::compile<karma::domain, Padding, Modifiers>::type
      padding_type;
  ...
  result_type operator()(Terminal const &term, Subject const &subject,
                         Modifiers const &modifiers) const {
    return result_type(
        subject, compile<karma::domain>(fusion::at_c<1>(term.args), modifiers),
...
struct handles_container<karma::simple_right_alignment<Subject, Width>,
...
struct handles_container<
    karma::padding_right_alignment<Subject, Padding, Width>, Attribute, Context,
