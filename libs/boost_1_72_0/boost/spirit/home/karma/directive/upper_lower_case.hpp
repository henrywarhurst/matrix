...
struct use_directive<karma::domain,
                     tag::char_code<tag::upper, CharEncoding>> // enables upper
    : mpl::true_ {};

template <typename CharEncoding>
struct use_directive<karma::domain,
                     tag::char_code<tag::lower, CharEncoding>> // enables lower
    : mpl::true_ {};
...
struct compound_modifier<
    ...
    typename enable_if<
        has_modifier<Current, tag::char_code<tag::lower, CharEncoding>>>::type>
    : Current {
...
struct compound_modifier<
    ...
    typename enable_if<
        has_modifier<Current, tag::char_code<tag::upper, CharEncoding>>>::type>
    : Current {
  compound_modifier() : Current() {}
