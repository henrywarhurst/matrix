...
template <> struct attribute_count<unused_type, false> : mpl::int_<0> {};

template <typename T> struct attribute_count<T, false> : mpl::int_<1> {};
...
struct duplicate_sequence_attribute {
  typedef typename fusion::result_of::make_cons<
      ...
      typename duplicate_sequence_attribute<Attribute, T, N - 1>::type>::type
      type;
...
struct duplicate_sequence_attribute<Attribute, T, 1> {
  typedef
      typename fusion::result_of::make_cons<reference_wrapper<T const>>::type
          type;
...
struct duplicate_attribute {
  ...
  typedef
      typename duplicate_sequence_attribute<Attribute, T, N>::type cons_type;
...
struct duplicate_directive : unary_generator<duplicate_directive<Subject>> {
  ...
  duplicate_directive(Subject const &subject) : subject(subject) {}
  ...
  bool generate(OutputIterator &sink, Context &ctx, Delimiter const &d,
    ...
    typedef
        typename traits::attribute_of<Subject, Context>::type subject_attr_type;
