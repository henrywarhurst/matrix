...
// enables maxwidth[]
template <> struct use_directive<karma::domain, tag::maxwidth> : mpl::true_ {};
...
bool buffer_copy_rest(detail::enable_buffering<OutputIterator> &, std::size_t,
                      unused_type) {
  return true;
}
...
inline static bool
maxwidth_generate(OutputIterator &sink, Context &ctx, Delimiter const &d,
...
struct make_directive<terminal_ex<tag::maxwidth, fusion::vector1<T>>, Subject,
                      Modifiers> {
...
struct make_directive<terminal_ex<tag::maxwidth, fusion::vector2<T, RestIter>>,
                      Subject, Modifiers> {
...
template <typename Subject, typename Attribute, typename Context,
          typename Iterator>
struct handles_container<karma::maxwidth_width<Subject>, Attribute, Context,
                         Iterator>
