...
namespace spirit {
namespace karma {
template <typename T> struct as : stateful_tag_type<T, tag::as> {
  BOOST_SPIRIT_ASSERT_MSG((traits::is_container<T>::type::value),
                          error_type_must_be_a_container, (T));
};
} // namespace karma
} // namespace spirit
} // namespace boost
...
///////////////////////////////////////////////////////////////////////////
// enables as_string[...]
template <> struct use_directive<karma::domain, tag::as_string> : mpl::true_ {};
...
struct as_directive : unary_generator<as_directive<Subject, T>> {
  ...
  as_directive(Subject const &subject) : subject(subject) {}
...
template <typename Subject, typename T, typename Attribute, typename Context,
          typename Iterator>
struct handles_container<karma::as_directive<Subject, T>, Attribute, Context,
                         Iterator> : mpl::false_ {
