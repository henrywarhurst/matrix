...
struct omit_directive : unary_generator<omit_directive<Subject, Execute>> {
  ...
  typedef mpl::int_<generator_properties::disabling |
                    subject_type::properties::value>
      properties;

  omit_directive(Subject const &subject) : subject(subject) {}
...
///////////////////////////////////////////////////////////////////////////
template <typename Subject, bool Execute, typename Attribute, typename Context,
          typename Iterator>
