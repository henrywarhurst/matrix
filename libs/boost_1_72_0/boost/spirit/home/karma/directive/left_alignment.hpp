...
inline static bool
left_align_generate(OutputIterator &sink, Context &ctx, Delimiter const &d,
...
struct simple_left_alignment
  ...
  typedef mpl::int_<generator_properties::counting |
  ...
  bool generate(OutputIterator &sink, Context &ctx, Delimiter const &d,
    ...
    return detail::left_align_generate(sink, ctx, d, attr, subject, width,
...
struct make_directive<
    terminal_ex<tag::left_align, fusion::vector1<Width>>, Subject, Modifiers,
...
struct make_directive<
    terminal_ex<tag::left_align, fusion::vector1<Padding>>, Subject, Modifiers,
...
template <typename Width, typename Padding, typename Subject,
          typename Modifiers>
struct make_directive<
    terminal_ex<tag::left_align, fusion::vector2<Width, Padding>>, Subject,
    Modifiers> {
  typedef typename result_of::compile<karma::domain, Padding, Modifiers>::type
      padding_type;
...
struct handles_container<karma::simple_left_alignment<Subject, Width>,
                         Attribute, Context, Iterator>
    : unary_handles_container<Subject, Attribute, Context, Iterator> {};

template <typename Subject, typename Padding, typename Width,
          typename Attribute, typename Context, typename Iterator>
struct handles_container<karma::padding_left_alignment<Subject, Padding, Width>,
                         Attribute, Context, Iterator>
    : unary_handles_container<Subject, Attribute, Context, Iterator> {};
} // namespace traits
} // namespace spirit
