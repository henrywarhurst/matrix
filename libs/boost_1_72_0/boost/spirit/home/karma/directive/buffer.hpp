...
struct buffer_directive : unary_generator<buffer_directive<Subject>> {
  ...
  buffer_directive(Subject const &subject) : subject(subject) {}
...
struct make_directive<tag::buffer, buffer_directive<Subject>, Modifiers> {
  typedef buffer_directive<Subject> result_type;
  result_type operator()(unused_type, buffer_directive<Subject> const &subject,
                         unused_type) const {
    return subject;
  }
};
...
template <typename Subject, typename Attribute, typename Context,
          typename Iterator>
struct handles_container<karma::buffer_directive<Subject>, Attribute, Context,
                         Iterator>
