...
struct use_terminal<karma::domain, tag::stateful_tag<Expr, tag::attr_cast,
                                                     Exposed, Transformed>>
    : mpl::true_ {};
} // namespace spirit
} // namespace boost
...
struct attr_cast_generator
  ...
  typedef
      typename result_of::compile<karma::domain, Subject>::type subject_type;
  ...
  attr_cast_generator(Subject const &subject) : subject(subject) {
