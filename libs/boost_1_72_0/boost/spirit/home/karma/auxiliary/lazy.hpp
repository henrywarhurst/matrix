...
struct use_terminal<karma::domain,
                    phoenix::actor<Eval>> // enables phoenix actors
    : mpl::true_ {};
...
struct lazy_generator : generator<lazy_generator<Function, Modifiers>> {
  ...
  template <typename Context, typename Iterator> struct attribute {
    typedef
        typename boost::result_of<karma_modify(tag::lazy_eval, Modifiers)>::type
            modifier;
    ...
    typedef
        typename result_of::compile<karma::domain, expr_type, modifier>::type
            generator_type;

    typedef
        typename traits::attribute_of<generator_type, Context, Iterator>::type
            type;
  };
  ...
  template <typename Context> info what(Context &context) const {
    return info("lazy", compile<karma::domain>(
                            func(unused, context),
                            karma_modify()(tag::lazy_eval(), modifiers))
                            .what(context));
  }
...
struct lazy_directive
  ...
  bool generate(OutputIterator &sink, Context &ctx, Delimiter const &d,
                Attribute const &attr) const {
    return detail::lazy_generate_impl_main(
        compile<karma::domain>(proto::make_expr<proto::tag::subscript>(
