...
// enables eps
template <> struct use_terminal<karma::domain, tag::eps> : mpl::true_ {};
...
struct semantic_predicate : primitive_generator<semantic_predicate> {
  ...
  semantic_predicate(bool predicate) : predicate_(predicate) {}
...
///////////////////////////////////////////////////////////////////////////
template <typename Modifiers> struct make_primitive<tag::eps, Modifiers> {
