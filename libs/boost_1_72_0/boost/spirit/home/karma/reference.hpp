...
///////////////////////////////////////////////////////////////////////////
template <typename Subject> struct reference : generator<reference<Subject>> {
  typedef mpl::int_<generator_properties::all_properties> properties;

  typedef Subject subject_type;

  reference(Subject &subject) : ref(subject) {}
  ...
  template <typename OutputIterator, typename Context, typename Delimiter,
            typename Attribute>
  bool generate(OutputIterator &sink, Context &context, Delimiter const &delim,
  ...
  bool generate(OutputIterator &sink, unused_type, Delimiter const &delim,
                unused_type) const {
...
template <typename Subject, typename Attribute, typename Context,
          typename Iterator>
struct handles_container<karma::reference<Subject>, Attribute, Context,
                         Iterator>
