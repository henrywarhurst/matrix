...
template <typename T> inline unused_type as(unused_type) { return unused; }
...
template <typename T> inline bool valid_as(unused_type) { return true; }
} // namespace traits
} // namespace spirit
} // namespace boost
...
template <typename T> struct attribute_as<T, unused_type> {
  typedef unused_type type;
};

template <typename T> struct attribute_as<T, unused_type const> {
  typedef unused_type type;
};
} // namespace result_of
} // namespace spirit
