...
public:
  ...
  template <typename T> void output(T const &value) {
    ++count;
    if (value == '\n') {
      ++line;
      column = 1;
...
//  output.
///////////////////////////////////////////////////////////////////////////
template <typename OutputIterator> class counting_sink : boost::noncopyable {
public:
...
///////////////////////////////////////////////////////////////////////////
template <typename OutputIterator> struct counting_policy {
public:
  ...
  template <typename T> void output(T const &) {
...
public:
  ...
  template <typename T> bool output(T const &value) {
...
struct no_buffering_policy {
  ...
  template <typename T> bool output(T const & /*value*/) { return true; }
...
struct make_output_iterator {
  ...
  typedef
      typename mpl::if_c<(properties & generator_properties::counting) ? true
                                                                       : false,
  ...
  typedef typename mpl::if_c<
      ...
      output_iterator_base<buffering_type, counting_type, tracking_type>>::type
      type;
};
...
class output_iterator<karma::ostream_iterator<T, Elem, Traits>, Properties>
    : public output_iterator<
          ...
          output_iterator<karma::ostream_iterator<T, Elem, Traits>,
                          Properties>> {
private:
...
template <typename OutputIterator> struct disable_counting {
...
///////////////////////////////////////////////////////////////////////////
template <typename OutputIterator> struct disable_output {
...
///////////////////////////////////////////////////////////////////////////
template <typename Sink> bool sink_is_good(Sink const &) {
