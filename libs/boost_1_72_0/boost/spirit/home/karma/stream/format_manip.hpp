...
inline detail::format_manip<Expr, mpl::false_, mpl::false_, unused_type,
                            Attribute>
...
format_delimited(Expr const &expr, Delimiter const &d,
...
inline detail::format_manip<Expr, mpl::false_, mpl::false_, Delimiter,
                            Attribute>
