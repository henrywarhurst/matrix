...
namespace spirit {
namespace tag {
template <typename Char = char> struct stream_tag { BOOST_SPIRIT_IS_TAG() };
} // namespace tag
...
struct use_lazy_terminal<karma::domain, tag::stream, 1 /*arity*/
                         > : mpl::true_ {};

template <>                                             // enables wstream(f)
struct use_lazy_terminal<karma::domain, tag::wstream, 1 /*arity*/
                         > : mpl::true_ {};
...
template <typename Char>
struct use_lazy_terminal<karma::domain, tag::stream_tag<Char>, 1 /*arity*/
                         > : mpl::true_ {};
...
struct any_stream_generator
  ...
  template <typename Context, typename Unused = unused_type> struct attribute {
  ...
  static bool generate(OutputIterator &sink, Context &context,
    ...
    typedef karma::detail::iterator_sink<OutputIterator, Char, CharEncoding,
                                         Tag>
        sink_device;
  ...
  template <typename T, typename Traits, typename Properties, typename Context,
            typename Delimiter, typename Attribute>
  static bool generate(
      karma::detail::output_iterator<karma::ostream_iterator<T, Char, Traits>,
                                     Properties> &sink,
      Context &context, Delimiter const &d, Attribute const &attr) {
    typedef karma::detail::output_iterator<
        karma::ostream_iterator<T, Char, Traits>, Properties>
        output_iterator;
    typedef karma::detail::iterator_sink<output_iterator, Char, CharEncoding,
                                         Tag>
        sink_device;
  ...
  static bool generate(OutputIterator &, Context &, Delimiter const &,
    ...
    BOOST_SPIRIT_ASSERT_FAIL(OutputIterator,
                             stream_not_usable_without_attribute, ());
    return false;
  }
...
struct lit_stream_generator
  ...
  lit_stream_generator(typename add_reference<T>::type t) : t_(t) {}
  ...
  // this is a special overload to detect if the output iterator has been
  // generated by a format_manip object.
  template <typename T1, typename Traits, typename Properties, typename Context,
            typename Delimiter, typename Attribute>
  bool generate(
      karma::detail::output_iterator<karma::ostream_iterator<T1, Char, Traits>,
                                     Properties> &sink,
      Context &, Delimiter const &d, Attribute const &) const {
    typedef karma::detail::output_iterator<
...
///////////////////////////////////////////////////////////////////////////
template <typename Char, typename Modifiers> struct make_stream {
...
struct make_primitive<terminal_ex<tag::stream_tag<Char>, fusion::vector1<A0>>,
                      Modifiers> : make_any_stream<Char, A0, Modifiers> {};
