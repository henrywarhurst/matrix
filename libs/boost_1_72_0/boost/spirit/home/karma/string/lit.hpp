...
struct use_lazy_terminal<karma::domain,
                         tag::char_code<tag::string, CharEncoding>, 1 /*arity*/
                         > : mpl::true_ {};
...
struct any_string : primitive_generator<any_string<CharEncoding, Tag>> {
  ...
  static bool generate(OutputIterator &, Context &, Delimiter const &,
    ...
    BOOST_SPIRIT_ASSERT_FAIL(OutputIterator,
                             string_not_usable_without_attribute, ());
    return false;
  }
...
struct literal_string
    : primitive_generator<
          literal_string<String, CharEncoding, Tag, no_attribute>> {
  typedef CharEncoding char_encoding;
  typedef
  ...
  literal_string(typename add_reference<String>::type str) : str_(str) {}
...
struct handles_container<karma::any_string<CharEncoding, Tag>, Attribute,
                         Context, Iterator> : mpl::false_ {};

template <typename String, typename CharEncoding, typename Tag,
          bool no_attribute, typename Attribute, typename Context,
          typename Iterator>
struct handles_container<
    karma::literal_string<String, CharEncoding, Tag, no_attribute>, Attribute,
    Context, Iterator> : mpl::false_ {};
} // namespace traits
} // namespace spirit
} // namespace boost
