...
struct debug_handler {
  ...
  debug_handler(function_type subject, F f, std::string const &rule_name)
      : subject(subject), f(f), rule_name(rule_name) {}
...
void debug(rule<OutputIterator, T1, T2, T3, T4> &r, F f) {
  ...
  typedef debug_handler<OutputIterator, typename rule_type::context_type,
                        typename rule_type::delimiter_type,
                        typename rule_type::properties, F>
      debug_handler;
...
void debug(rule<OutputIterator, T1, T2, T3, T4> &r) {
  ...
  typedef debug_handler<OutputIterator, typename rule_type::context_type,
                        typename rule_type::delimiter_type,
                        typename rule_type::properties, simple_trace>
      debug_handler;
