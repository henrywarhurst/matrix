...
template <typename Derived> struct primitive_parser : parser<Derived> {
  struct primitive_parser_id;
};

template <typename Derived> struct nary_parser : parser<Derived> {
...
template <typename Derived> struct unary_parser : parser<Derived> {
...
template <typename Derived> struct binary_parser : parser<Derived> {
...
template <typename T> struct is_parser : detail::has_parser_id<T> {};

template <typename T>
struct is_primitive_parser : detail::has_primitive_parser_id<T> {};

template <typename T> struct is_nary_parser : detail::has_nary_parser_id<T> {};
