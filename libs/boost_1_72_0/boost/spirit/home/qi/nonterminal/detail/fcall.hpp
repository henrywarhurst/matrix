...
typename lazy_enable_if_c<
    (params_size == N), proto::terminal<spirit::qi::parameterized_nonterminal<
...
operator()(BOOST_PP_ENUM_BINARY_PARAMS(N, A, const &f)) const {
  ...
  typedef spirit::qi::parameterized_nonterminal<parameterized_subject_type,
                                                vector_type>
      parameterized_type;
  typedef typename proto::terminal<parameterized_type>::type result_type;

  return result_type::make(
      parameterized_type(this->get_parameterized_subject(),
