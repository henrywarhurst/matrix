...
namespace detail {
///////////////////////////////////////////////////////////////////////////
template <typename Iterator> struct base_iterator_source {
  ...
  std::streampos seek(boost::iostreams::stream_offset,
...
struct iterator_source<
    Iterator, typename boost::enable_if_c<boost::is_convertible<
