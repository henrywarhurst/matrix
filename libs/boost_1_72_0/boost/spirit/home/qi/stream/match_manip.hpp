...
inline detail::match_manip<Expr, mpl::false_, mpl::false_, unused_type,
                           Attribute>
...
phrase_match(Expr const &expr, Skipper const &s,
...
phrase_match(Expr const &xpr, Skipper const &s,
             BOOST_SCOPED_ENUM(skip_flag) post_skip, Attribute &p) {
  using qi::detail::match_manip;
...
phrase_match(Expr const &xpr, Skipper const &s, Attribute &p) {
  ...
  BOOST_SPIRIT_ASSERT_MATCH(qi::domain, Expr);
  BOOST_SPIRIT_ASSERT_MATCH(qi::domain, Skipper);
  return match_manip<Expr, mpl::false_, mpl::false_, Skipper, Attribute>(xpr, s,
                                                                         p);
}
