...
template <> struct make_component<qi::domain, proto::tag::terminal> {
...
template <typename Tag> struct make_component<qi::domain, Tag> {
  template <typename Sig> struct result;
...
template <> struct make_component<qi::domain, proto::tag::function> {
  template <typename Sig> struct result;
...
template <> struct make_component<qi::domain, tag::directive> {
  template <typename Sig> struct result;
