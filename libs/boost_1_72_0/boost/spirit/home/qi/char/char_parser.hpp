...
template <typename T> struct is_char_parser : detail::has_char_parser_id<T> {};
} // namespace traits
} // namespace spirit
} // namespace boost
...
struct negated_char_parser
  ...
  negated_char_parser(Positive const &positive_) : positive(positive_) {}
...
///////////////////////////////////////////////////////////////////////////
namespace detail {
template <typename Positive> struct make_negated_char_parser {
...
struct make_composite<proto::tag::complement, Elements, Modifiers> {
  ...
  BOOST_SPIRIT_ASSERT_MSG((traits::is_char_parser<subject>::value),
                          subject_is_not_negatable, (subject));

  typedef typename detail::make_negated_char_parser<subject>::result_type
      result_type;
