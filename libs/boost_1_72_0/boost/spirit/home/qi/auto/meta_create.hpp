...
template <typename Sequence> struct meta_create_sequence {
  ...
  typedef make_nary_proto_expr<sequence_type, proto::tag::shift_right,
                               qi::domain>
      make_proto_expr;
...
struct meta_create_impl<
    T, typename enable_if<mpl::and_<traits::is_container<T>,
                                    mpl::not_<traits::is_string<T>>>>::type>
...
template <typename T> struct meta_create<boost::optional<T>> {
  typedef make_unary_proto_expr<T, proto::tag::negate, qi::domain>
      make_proto_expr;
...
struct meta_create_exists<qi::domain, T>
    : mpl::not_<is_same<qi::no_auto_mapping_exists,
