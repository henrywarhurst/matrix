...
namespace detail {
template <typename T, typename BoolPolicies> struct bool_impl {
...
struct literal_bool_parser
  ...
  template <typename Value> literal_bool_parser(Value const &n) : n_(n) {}
...
struct make_bool {
  ...
  typedef
      typename mpl::if_<mpl::and_<no_case, is_same<bool_policies<T>, Policies>>,
