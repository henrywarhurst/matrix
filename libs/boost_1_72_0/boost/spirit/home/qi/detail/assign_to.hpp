...
///////////////////////////////////////////////////////////////////////////
namespace detail {
template <typename T> struct is_iter_range : mpl::false_ {};
...
template <typename Attribute, typename Iterator>
struct assign_to_attribute_from_iterators<boost::optional<Attribute>,
                                          Iterator> {
  static void call(Iterator const &first, Iterator const &last,
...
struct assign_to_attribute_from_value {
  ...
  static void call(T_ const &val, Attribute &attr, mpl::true_) {
    typedef
        typename fusion::result_of::value_at_c<Attribute, 0>::type element_type;
...
struct assign_to_attribute_from_value<
  ...
  static void
  call(T const &val,
       typename fusion::extension::adt_attribute_proxy<Attribute, N, Const>
           &attr) {
    attr = val;
  }
};
...
template <typename T> inline void assign_to(T const &, unused_type) {}
} // namespace traits
} // namespace spirit
} // namespace boost
