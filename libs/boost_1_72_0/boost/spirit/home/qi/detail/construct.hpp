...
struct assign_to_attribute_from_iterators<char, Iterator> {
  static void call(Iterator const &first, Iterator const &, char &attr) {
    attr = *first;
  }
};
...
struct assign_to_attribute_from_iterators<signed char, Iterator> {
  static void call(Iterator const &first, Iterator const &, signed char &attr) {
    attr = *first;
  }
};
...
struct assign_to_attribute_from_iterators<unsigned char, Iterator> {
  static void call(Iterator const &first, Iterator const &,
                   unsigned char &attr) {
    attr = *first;
  }
};
...
struct assign_to_attribute_from_iterators<wchar_t, Iterator> {
  static void call(Iterator const &first, Iterator const &, wchar_t &attr) {
    attr = *first;
  }
};
