...
struct negate_weak_substitute_if_not
    : mpl::if_<Sequence,
               ...
               typename mpl::not_<
                   traits::is_weak_substitute<Attribute, ValueType>>::type> {};
...
struct not_compatible_element
    : mpl::and_<negate_weak_substitute_if_not<Sequence, Attribute, Container>,
                negate_weak_substitute_if_not<Sequence, Attribute, ValueType>> {
};
...
struct pass_through_container_fusion_sequence {
  typedef typename mpl::find_if<
      Attribute, not_compatible_element<Container, ValueType, mpl::_1>>::type
      iter;
...
template <typename Container, typename ValueType, typename Attribute,
          typename Sequence>
struct pass_through_container_fusion_sequence<Container, ValueType, Attribute,
                                              Sequence, true> {
  typedef typename mpl::find_if<
      Attribute,
      not_compatible_element<Container, ValueType, mpl::_1, Sequence>>::type
      iter;
  typedef typename mpl::end<Attribute>::type end;
...
template <typename Container, typename ValueType, typename Attribute,
          ...
          bool IsSequence =
              fusion::traits::is_sequence<AttributeValueType>::value>
struct pass_through_container_container
    : mpl::or_<traits::is_weak_substitute<Attribute, Container>,
...
template <typename Container, typename ValueType, typename Attribute,
          typename Sequence, typename AttributeValueType>
struct pass_through_container_container<Container, ValueType, Attribute,
                                        Sequence, AttributeValueType, true>
    : pass_through_container_fusion_sequence<Container, ValueType,
                                             AttributeValueType, Sequence> {};
...
template <typename Container, typename ValueType, typename Attribute,
          typename Sequence>
struct pass_through_container_optional<Container, ValueType, Attribute,
                                       Sequence, true>
    : pass_through_container_fusion_sequence<Container, ValueType, Attribute,
                                             Sequence> {};
...
template <typename Container, typename ValueType, typename Attribute,
          typename Sequence>
struct pass_through_container<Container, boost::optional<ValueType>,
                              boost::optional<Attribute>, Sequence>
...
struct pass_through_container<Container, ValueType, boost::variant<T0, TN...>,
                              Sequence>
    : mpl::bool_<
          pass_through_container<Container, ValueType, T0,
                                 Sequence>::type::value ||
          pass_through_container<Container, ValueType, boost::variant<TN...>,
                                 Sequence>::type::value> {};
#else
#define BOOST_SPIRIT_PASS_THROUGH_CONTAINER(z, N, _)                           \
  pass_through_container<Container, ValueType, BOOST_PP_CAT(T, N),             \
                         Sequence>::type::value || /***/
...
struct pass_through_container<Container, ValueType,
    ...
    : mpl::bool_<BOOST_PP_REPEAT(BOOST_VARIANT_LIMIT_TYPES,
                                 BOOST_SPIRIT_PASS_THROUGH_CONTAINER,
                                 _) false> {};
...
template <typename Container, typename ValueType, typename Attribute,
          typename Sequence>
struct pass_through_container<Container, ValueType, Attribute, Sequence,
                              qi::domain>
    : qi::detail::pass_through_container<Container, ValueType, Attribute,
                                         Sequence> {};
} // namespace traits
} // namespace spirit
} // namespace boost
...
template <typename F, typename Attr, typename Sequence> struct pass_container {
  typedef typename F::context_type context_type;
  typedef typename F::iterator_type iterator_type;

  pass_container(F const &f_, Attr &attr_) : f(f_), attr(attr_) {}
  ...
  bool dispatch_attribute(Component const &component, mpl::true_) const {
    ...
    typedef typename traits::attribute_of<Component, context_type,
                                          iterator_type>::type rhs_attribute;
    ...
    typedef mpl::and_<
        ...
        traits::pass_through_container<Attr, value_type, rhs_attribute,
                                       Sequence, qi::domain>>
        predicate;
  ...
  bool operator()(Component const &component) const {
    ...
    typedef typename traits::not_is_unused<typename traits::attribute_of<
        Component, context_type, iterator_type>::type>::type predicate;
...
inline pass_container<F, Attr, mpl::false_> make_pass_container(F const &f,
                                                                Attr &attr) {
