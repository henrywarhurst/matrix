...
struct permutation : nary_parser<permutation<Elements>> {
  template <typename Context, typename Iterator> struct attribute {
    ...
    typedef typename traits::build_attribute_sequence<
        Elements, Context, traits::permutation_attribute_transform, Iterator,
  ...
  permutation(Elements const &elements_) : elements(elements_) {}
  ...
  bool parse(Iterator &first, Iterator const &last, Context &context,
    ...
    detail::permute_function<Iterator, Context, Skipper> f(first, last, context,
                                                           skipper);
