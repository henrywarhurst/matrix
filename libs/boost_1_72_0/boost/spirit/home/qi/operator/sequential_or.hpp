...
struct sequential_or : nary_parser<sequential_or<Elements>> {
  template <typename Context, typename Iterator> struct attribute {
    ...
    typedef typename traits::build_attribute_sequence<
        Elements, Context, traits::sequential_or_attribute_transform, Iterator,
  ...
  sequential_or(Elements const &elements_) : elements(elements_) {}
  ...
  bool parse(Iterator &first, Iterator const &last, Context &context,
    ...
    detail::pass_function<Iterator, Context, Skipper> f(first, last, context,
                                                        skipper);
