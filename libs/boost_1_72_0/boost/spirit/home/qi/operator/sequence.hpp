...
private:
  ...
  fail_function(Iterator &first, Iterator const &last, Context &context,
    ...
    return detail::fail_function<Iterator, Context, Skipper>(first, last,
                                                             context, skipper);
  }
...
//     template <typename Attribute, typename Elements, typename Context,
//     typename Iterator> struct is_attribute_compatible<Attribute,
//     sequence<Elements>, Context, Iterator>
//       : mpl::or_<
//             is_convertible<Attribute
//               , typename traits::attribute_of<sequence<Elements>, Context,
//               Iterator>::type>
