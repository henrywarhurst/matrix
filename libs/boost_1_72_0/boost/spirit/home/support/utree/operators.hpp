...
struct utree_is_equal {
  ...
  bool operator()(basic_string<Base, type_> const &a,
...
struct utree_is_less_than {
  ...
  bool operator()(utree::invalid_type, utree::invalid_type) const {
    BOOST_THROW_EXCEPTION(
        bad_type_exception("no less-than comparison for this utree type",
  ...
  bool operator()(utree::nil_type, utree::nil_type) const {
    BOOST_THROW_EXCEPTION(bad_type_exception(
        "no less-than comparison for this utree type", utree_type::nil_type));
    return false; // no less than comparison for nil
  }

  bool operator()(any_ptr const &, any_ptr const &) const {
    BOOST_THROW_EXCEPTION(bad_type_exception(
        "no less-than comparison for this utree type", utree_type::any_type));
...
struct utree_print {
  ...
  template <typename T> void operator()(T val) const { out << val << ' '; }
...
template <typename Base> struct logical_function {
  ...
  // unary
  template <typename A> utree operator()(A const &a) const {
    return dispatch(a, boost::is_arithmetic<A>());
  }

  // unary
  template <typename A> utree dispatch(A const &a, mpl::true_) const {
    return Base::eval(a);
  }

  // unary
  template <typename A> utree dispatch(A const &, mpl::false_) const {
    return Base::eval(true);
  }
};

template <typename Base> struct arithmetic_function {
  typedef utree result_type;
  ...
  template <typename A> utree dispatch(A const &, boost::mpl::false_) const {
    return utree(); // cannot apply to non-arithmetic types
  }

  template <typename A> utree dispatch(A const &a, boost::mpl::true_) const {
...
template <typename Base> struct integral_function {
  typedef utree result_type;
  ...
  utree operator()(A const &a, B const &b) const {
    return dispatch(
        a, b, boost::mpl::and_<boost::is_integral<A>, boost::is_integral<B>>());
  }
...
#define BOOST_SPIRIT_UTREE_CREATE_FUNCTION(name, expr, base)                   \
  struct BOOST_PP_CAT(function_impl_, name) {                                  \
    ...
    template <typename A> static utree eval(A const &a) {                      \
      static int b;                                                            \
      (void)b;                                                                 \
      return utree(expr);                                                      \
    }                                                                          \
  };                                                                           \
  base<BOOST_PP_CAT(function_impl_, name)> const BOOST_PP_CAT(                 \
      base, BOOST_PP_CAT(_, name)) = {};                                       \
  /***/
...
inline bool operator!=(utree const &a, utree const &b) { return !(a == b); }

inline bool operator>(utree const &a, utree const &b) { return b < a; }
...
#pragma GCC diagnostic ignored                                                 \
    "-Wbool-operation" // '~' on an expression of type bool
#endif
...
inline utree operator+(utree const &a, utree const &b) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(
        bad_type_exception("addition performed on non-arithmetic utree types",
                           a.which(), b.which()));
  }
  return r;
}
...
inline utree operator-(utree const &a, utree const &b) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(bad_type_exception(
        "subtraction performed on non-arithmetic utree types", a.which(),
        b.which()));
  }
  return r;
}
...
inline utree operator*(utree const &a, utree const &b) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(bad_type_exception(
        "multiplication performed on non-arithmetic utree types", a.which(),
        b.which()));
  }
  return r;
}
...
inline utree operator/(utree const &a, utree const &b) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(
        bad_type_exception("division performed on non-arithmetic utree types",
                           a.which(), b.which()));
  }
  return r;
}
...
inline utree operator%(utree const &a, utree const &b) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(bad_type_exception(
        "modulos performed on non-integral utree types", a.which(), b.which()));
  }
  return r;
}
...
inline utree operator-(utree const &a) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(bad_type_exception(
        "negation performed on non-arithmetic utree type", a.which()));
  }
  return r;
}
...
inline utree operator&(utree const &a, utree const &b) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(
        bad_type_exception("bitwise and performed on non-integral utree types",
                           a.which(), b.which()));
  }
  return r;
}
...
inline utree operator|(utree const &a, utree const &b) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(
        bad_type_exception("bitwise or performed on non-integral utree types",
                           a.which(), b.which()));
  }
  return r;
}
...
inline utree operator^(utree const &a, utree const &b) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(
        bad_type_exception("bitwise xor performed on non-integral utree types",
                           a.which(), b.which()));
  }
  return r;
}
...
inline utree operator<<(utree const &a, utree const &b) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(
        bad_type_exception("left shift performed on non-integral utree types",
                           a.which(), b.which()));
  }
  return r;
}
...
inline utree operator>>(utree const &a, utree const &b) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(
        bad_type_exception("right shift performed on non-integral utree types",
                           a.which(), b.which()));
  }
  return r;
}
...
inline utree operator~(utree const &a) {
  ...
  if (r.which() == utree_type::invalid_type) {
    BOOST_THROW_EXCEPTION(bad_type_exception(
        "inversion performed on non-integral utree type", a.which()));
  }
  return r;
}
} // namespace spirit
