...
template <BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
    BOOST_SPIRIT_EXTENDED_VARIANT_LIMIT_TYPES, typename T,
...
struct extended_variant {
...
#if defined(BOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES)
  typedef boost::variant<BOOST_SPIRIT_EXTENDED_VARIANT_ENUM_PARAMS(T)>
      variant_type;
  typedef typename variant_type::types types;

  typedef extended_variant<BOOST_SPIRIT_EXTENDED_VARIANT_ENUM_PARAMS(T)>
      base_type;
#else
  ...
  template <typename T> extended_variant(T const &var) : var(var) {}

  template <typename T> extended_variant(T &var) : var(var) {}
...
inline T const &get(boost::spirit::extended_variant<
                    BOOST_SPIRIT_EXTENDED_VARIANT_ENUM_PARAMS(T)> const &x) {
  return boost::get<T>(x.get());
}

template <typename T, BOOST_SPIRIT_EXTENDED_VARIANT_ENUM_PARAMS(typename T)>
inline T &get(boost::spirit::extended_variant<
