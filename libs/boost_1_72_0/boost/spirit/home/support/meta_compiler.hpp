...
template <typename Domain> struct meta_compiler {
  struct meta_grammar;

  BOOST_SPIRIT_ASSERT_MSG((!use_operator<Domain, proto::tag::subscript>::value),
  ...
  struct cases {
    ...
    struct case_<proto::tag::subscript, Enable>
        : proto::or_<
              ...
              ///////////////////////////////////////////////////////////////////
              proto::when<
                  proto::binary_expr<proto::tag::subscript,
...
namespace detail {
template <typename Domain> struct compiler {
  // Default case
