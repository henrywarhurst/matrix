...
class fsq_iterator
    : public boost::iterator_facade<fsq_iterator<Queue, T, Pointer>, T,
                                    std::random_access_iterator_tag> {
public:
  typedef typename Queue::position_type position_type;
  typedef boost::iterator_facade<fsq_iterator<Queue, T, Pointer>, T,
                                 std::random_access_iterator_tag>
      base_type;
...
private:
  ...
  distance_to(fsq_iterator<Q, T_, P> const &x) const {
...
public:
  ...
  typedef fsq_iterator<fixed_size_queue<T, N>, T const, T const *>
      const_iterator;
