...
struct multi_pass_unique<T, Ownership, Checking, Input, Storage, false, false,
  ...
  template <typename MultiPass> inline static void clear_queue(MultiPass &mp) {
...
struct multi_pass_unique<T, Ownership, Checking, Input, Storage, true, false,
  ...
  template <typename MultiPass> inline static void clone(MultiPass &mp) {
    Ownership::clone(mp);
  }

  template <typename MultiPass> inline static bool release(MultiPass &mp) {
