...
struct default_input_policy {
  ...
  template <typename Functor> default_input_policy(Functor const &) {}

  template <typename MultiPass> static void destroy(MultiPass &) {}
  ...
  template <typename MultiPass> static bool input_at_eof(MultiPass const &mp);
...
struct default_ownership_policy {
  ...
  template <typename MultiPass> static void clone(MultiPass &) {}

  template <typename MultiPass> static bool release(MultiPass &mp);

  template <typename MultiPass> static bool is_unique(MultiPass const &mp);
};
...
struct default_storage_policy {
  ...
  template <typename MultiPass> static void increment(MultiPass &) {}

  template <typename MultiPass> static void clear_queue(MultiPass &) {}

  template <typename MultiPass> static bool is_eof(MultiPass const &mp);
...
struct default_checking_policy {
  ...
  template <typename MultiPass> static void docheck(MultiPass const &) {}
