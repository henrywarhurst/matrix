...
template <typename Token> inline bool token_is_valid(Token const &) {
  return true;
}
} // namespace split_functor_input_is_valid_test_
...
struct split_functor_input {
  ...
  public:
    ...
    template <typename MultiPass> static void advance_input(MultiPass &mp) {
    ...
    template <typename MultiPass> static void destroy(MultiPass &mp) {
  ...
  protected:
    ...
    void swap(unique &x) { boost::swap(ftor, x.ftor); }
  ...
  ///////////////////////////////////////////////////////////////////////
  template <typename Functor> struct shared {
  protected:
    typedef typename Functor::first_type functor_type;
    typedef typename functor_type::result_type result_type;
