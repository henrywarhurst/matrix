...
template <class Iterator> void line_pos_iterator<Iterator>::increment() {
...
get_current_line(Iterator lower_bound, Iterator current, Iterator upper_bound);
...
template <class Iterator> inline std::size_t get_line(Iterator) { return -1; }
