...
struct not_is_variant<fusion::extension::adt_attribute_proxy<T, N, Const>,
                      Domain>
    : not_is_variant<
...
template <typename T, int N, bool Const, typename Domain>
struct not_is_optional<fusion::extension::adt_attribute_proxy<T, N, Const>,
                       Domain>
    : not_is_optional<
          typename fusion::extension::adt_attribute_proxy<T, N, Const>::type,
          Domain> {};
...
struct container_value<fusion::extension::adt_attribute_proxy<T, N, Const>>
    : container_value<typename remove_reference<
          typename fusion::extension::adt_attribute_proxy<T, N,
                                                          Const>::type>::type> {
};
...
struct push_back_container<
    ...
    typename enable_if<is_reference<
        ...
        type> {
  static bool call(fusion::extension::adt_attribute_proxy<T, N, false> &p,
                   Val const &val) {
    typedef
        typename fusion::extension::adt_attribute_proxy<T, N, false>::type type;
...
struct container_iterator<fusion::extension::adt_attribute_proxy<T, N, Const>>
    : container_iterator<typename remove_reference<
          typename fusion::extension::adt_attribute_proxy<T, N,
                                                          Const>::type>::type> {
};
...
struct begin_container<fusion::extension::adt_attribute_proxy<T, N, Const>> {
  typedef typename remove_reference<
      typename fusion::extension::adt_attribute_proxy<T, N, Const>::type>::type
      container_type;
...
struct begin_container<
  ...
  typedef typename add_const<
      typename remove_reference<typename fusion::extension::adt_attribute_proxy<
          T, N, Const>::type>::type>::type container_type;
...
struct assign_to_attribute_from_value<
    fusion::extension::adt_attribute_proxy<T, N, false>, Val> {
  static void call(Val const &val,
...
struct extract_from_attribute<
  ...
  typedef typename fusion::extension::adt_attribute_proxy<T, N, Const>::type
      get_return_type;
  typedef typename remove_const<
      typename remove_reference<get_return_type>::type>::type embedded_type;
  typedef typename spirit::result_of::extract_from<Exposed, embedded_type>::type
      extracted_type;
  ...
  typedef
      typename mpl::if_c<is_reference<get_return_type>::value, extracted_type,
                         typename remove_reference<extracted_type>::type>::type
          type;
...
struct transform_attribute<
    fusion::extension::adt_attribute_proxy<T, N, false>, Attribute, Domain,
  ...
  static void post(fusion::extension::adt_attribute_proxy<T, N, false> &val,
...
struct transform_attribute<
    fusion::extension::adt_attribute_proxy<T, N, Const>, Attribute, Domain,
    typename enable_if<is_reference<
        typename fusion::extension::adt_attribute_proxy<T, N, Const>::type>>::
        type> {
  typedef Attribute &type;
  ...
  static void post(fusion::extension::adt_attribute_proxy<T, N, Const> &,
                   Attribute const &) {}
...
struct attribute_size<fusion::extension::adt_attribute_proxy<T, N, Const>> {
  typedef typename remove_const<
      typename remove_reference<typename fusion::extension::adt_attribute_proxy<
          T, N, Const>::type>::type>::type embedded_type;
