...
///////////////////////////////////////////////////////////////////////
template <typename OpTag, typename Domain> struct nary_proto_expr_function {
...
struct make_unary_proto_expr {
  ...
  typedef typename proto::result_of::make_expr<
      OpTag, typename subject_type::type>::type type;
...
struct make_nary_proto_expr {
  ...
  typedef typename fusion::result_of::fold<Sequence, unused_type,
                                           make_proto_expr>::type type;
