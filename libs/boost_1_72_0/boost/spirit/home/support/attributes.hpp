...
struct value_type_is_substitute
    : is_substitute<typename container_value<T>::type,
...
struct is_substitute_impl<
    ...
    typename enable_if<mpl::and_<
        fusion::traits::is_sequence<T>, fusion::traits::is_sequence<Expected>,
        mpl::equal<T, Expected, is_substitute<mpl::_1, mpl::_2>>>>::type>
    : mpl::true_ {};
...
struct is_substitute_impl<
    T, Expected,
    typename enable_if<
        mpl::and_<is_container<T>, is_container<Expected>,
                  detail::value_type_is_substitute<T, Expected>>>::type>
    : mpl::true_ {};
} // namespace detail
...
//        // attribute having the corresponding character type as its
//        value_type. template <typename T, typename Expected> struct
//        is_weak_substitute_for_value_type
...
struct value_type_is_weak_substitute
    : is_weak_substitute<typename container_value<T>::type,
                         typename container_value<Expected>::type> {};
...
struct is_weak_substitute_impl<
    ...
    typename enable_if<
        mpl::and_<is_container<T>, is_container<Expected>,
                  value_type_is_weak_substitute<T, Expected>>>::type>
    : mpl::true_ {};
...
struct is_weak_substitute_impl<
    ...
    typename enable_if<mpl::and_<
        fusion::traits::is_sequence<T>, fusion::traits::is_sequence<Expected>,
        mpl::equal<T, Expected, is_weak_substitute<mpl::_1, mpl::_2>>>>::type>
    : mpl::true_ {};
...
struct is_weak_substitute_impl<
    T, Expected,
    typename enable_if<mpl::and_<mpl::not_<fusion::traits::is_sequence<T>>,
                                 fusion::traits::is_sequence<Expected>>>::type>
    : mpl::false_ {};
} // namespace detail
...
struct is_weak_substitute<boost::variant<T0, T1, TN...>, Expected>
    : mpl::bool_<is_weak_substitute<T0, Expected>::type::value &&
                 is_weak_substitute<boost::variant<T1, TN...>,
                                    Expected>::type::value> {};
#else
...
struct is_weak_substitute<
    T, T,
    typename enable_if<mpl::and_<not_is_optional<T>, not_is_variant<T>>>::type>
    : mpl::true_ {};
...
template <typename T>
struct is_proxy<T,
                typename enable_if<mpl::and_<fusion::traits::is_sequence<T>,
                                             fusion::traits::is_view<T>>>::type>
    : mpl::true_ {};
...
template <typename T> struct variant_type : mpl::identity<T> {};
...
struct compute_compatible_component_variant
    : mpl::or_<traits::detail::attribute_is_compatible<Expected, Attribute>,
               traits::is_hold_any<Expected>,
               mpl::eval_if<is_container<Expected>,
...
struct compute_compatible_component_variant<
    Variant, Expected, mpl::false_,
    typename enable_if<
        detail::has_types<typename variant_type<Variant>::type>>::type> {
  ...
  typedef typename mpl::distance<typename mpl::begin<types>::type, iter>::type
      distance;
  ...
  typedef
      typename mpl::eval_if<type, mpl::deref<iter>,
                            mpl::identity<unused_type>>::type compatible_type;
...
struct compute_compatible_component
    : compute_compatible_component_variant<
          Attribute, Expected,
          typename not_is_variant_or_variant_in_optional<Attribute,
                                                         Domain>::type> {};
...
template <typename T> int which(T const &v) {
...
struct attribute_not_unused {
  ...
  struct apply
      : not_is_unused<
            typename attribute_of<Component, Context, Iterator>::type> {};
};
...
///////////////////////////////////////////////////////////////////////////
template <typename T> struct sequence_size : fusion::result_of::size<T> {};

template <> struct sequence_size<unused_type> : mpl::int_<0> {};
...
struct attribute_size_impl<
    Attribute, typename enable_if<mpl::and_<
                   fusion::traits::is_sequence<Attribute>,
                   mpl::not_<traits::is_container<Attribute>>>>::type> {
...
struct attribute_size_impl<
    Attribute, typename enable_if<mpl::and_<
                   ...
                   mpl::not_<traits::is_iterator_range<Attribute>>>>::type> {
...
template <typename Attribute> struct attribute_size<optional<Attribute>> {
...
struct attribute_size_visitor : static_visitor<std::size_t> {
  template <typename T> std::size_t operator()(T const &val) const {
...
template <typename Iterator> struct attribute_size<iterator_range<Iterator>> {
...
template <> struct attribute_size<unused_type> {
  typedef std::size_t type;
...
struct wrap_if_not_tuple : mpl::if_<fusion::traits::is_sequence<Attribute>,
                                    Attribute &, fusion::vector1<Attribute &>> {
};

template <typename Attribute> struct wrap_if_not_tuple<Attribute, mpl::true_> {
  typedef fusion::vector1<Attribute &> type;
};

template <> struct wrap_if_not_tuple<unused_type, mpl::false_> {
  typedef unused_type type;
};

template <> struct wrap_if_not_tuple<unused_type const, mpl::false_> {
  typedef unused_type type;
};
...
///////////////////////////////////////////////////////////////////////////
template <typename T> struct build_optional {
  typedef boost::optional<T> type;
};

template <typename T> struct build_optional<boost::optional<T>> {
  typedef boost::optional<T> type;
};

template <> struct build_optional<unused_type> { typedef unused_type type; };
...
///////////////////////////////////////////////////////////////////////////
template <typename T> struct build_std_vector { typedef std::vector<T> type; };

template <> struct build_std_vector<unused_type> { typedef unused_type type; };
...
///////////////////////////////////////////////////////////////////////////
template <typename Sequence> struct build_fusion_vector {
  ...
  typedef typename mpl::eval_if<
      fusion::result_of::empty<filtered_attributes>, mpl::identity<unused_type>,
      fusion::result_of::as_vector<filtered_attributes>>::type type;
};

template <> struct build_fusion_vector<unused_type> {
  typedef unused_type type;
};
...
struct build_attribute_sequence {
  struct element_attribute {
    ...
    template <typename F, typename Element> struct result<F(Element)> {
      typedef typename Transform<
          typename attribute_of<Element, Context, Iterator>::type, Domain>::type
          type;
    };
  ...
  typedef
      typename fusion::result_of::transform<Sequence, element_attribute>::type
          type;
};
...
struct build_collapsed_variant<Sequence, false, 2> {
  typedef boost::optional<typename mpl::deref<
      typename mpl::next<typename mpl::begin<Sequence>::type>::type>::type>
      type;
};
} // namespace detail
...
///////////////////////////////////////////////////////////////////////////
template <typename Sequence> struct build_variant {
  // Remove all unused attributes.
  typedef typename filter_unused_attributes<Sequence>::type filtered_attributes;
  ...
  typedef typename mpl::eval_if<
      no_unused, mpl::identity<Sequence>,
      fusion::result_of::push_front<filtered_attributes, unused_type>>::type
      attribute_sequence;

  // Make sure each of the types occur only once in the type list
  typedef typename mpl::fold<attribute_sequence, mpl::vector<>,
                             mpl::if_<mpl::contains<mpl::_1, mpl::_2>, mpl::_1,
                                      mpl::push_back<mpl::_1, mpl::_2>>>::type
      no_duplicates;
  ...
  typedef typename traits::detail::build_collapsed_variant<
      no_duplicates, no_unused::value>::type type;
};
...
template <typename Attribute> struct synthesize_attribute {
...
///////////////////////////////////////////////////////////////////////////
template <typename A, typename B> void swap_impl(A &a, B &b) {
  A temp = a;
  a = b;
  b = temp;
}

template <typename T> void swap_impl(T &a, T &b) { boost::swap(a, b); }

template <typename A> void swap_impl(A &, unused_type) {}

template <typename A> void swap_impl(unused_type, A &) {}
...
//  form: vector<T> --> T
///////////////////////////////////////////////////////////////////////////
template <typename T> struct strip_single_element_vector { typedef T type; };

#if !defined(BOOST_FUSION_HAS_VARIADIC_VECTOR)
template <typename T> struct strip_single_element_vector<fusion::vector1<T>> {
  typedef T type;
};
#endif
template <typename T> struct strip_single_element_vector<fusion::vector<T>> {
  typedef T type;
};
...
// sequence
///////////////////////////////////////////////////////////////////////////
template <typename T, bool IsFusionSeq = fusion::traits::is_sequence<T>::value,
...
///////////////////////////////////////////////////////////////////////////
template <typename T> void clear(T &val);
...
// default
template <typename T> void clear_impl2(T &val, mpl::false_) { val = T(); }

// for fusion sequences
template <typename T> void clear_impl2(T &val, mpl::true_) {
  fusion::for_each(val, clear_visitor());
}

// dispatch default or fusion sequence
template <typename T> void clear_impl(T &val, mpl::false_) {
  clear_impl2(val, fusion::traits::is_sequence<T>());
}

// STL containers
template <typename T> void clear_impl(T &val, mpl::true_) { val.clear(); }
} // namespace detail

template <typename T, typename Enable /* = void*/> struct clear_value {
...
// optionals
template <typename T> struct clear_value<boost::optional<T>> {
...
// iterator range
template <typename T> struct clear_value<iterator_range<T>> {
...
// main dispatch
template <typename T> void clear(T &val) { clear_value<T>::call(val); }
...
///////////////////////////////////////////////////////////////////////////
namespace detail {
template <typename Out> struct print_fusion_sequence {
  print_fusion_sequence(Out &out_) : out(out_), is_first(true) {}
...
template <typename Out> struct print_visitor : static_visitor<> {
...
template <typename Out> inline void print_attribute(Out &, unused_type) {}

///////////////////////////////////////////////////////////////////////////
// generate debug output for lookahead token (character) stream
namespace detail {
struct token_printer_debug_for_chars {
  template <typename Out, typename Char> static void print(Out &o, Char c) {
...
struct token_printer_debug {
  template <typename Out, typename T> static void print(Out &o, T const &val) {
    o << val;
  }
};
} // namespace detail
...
struct token_printer_debug
    : mpl::if_<mpl::and_<is_convertible<T, char>, is_convertible<char, T>>,
