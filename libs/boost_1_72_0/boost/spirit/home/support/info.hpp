...
template <typename Callback> struct basic_info_walker {
...
template <typename Out> struct simple_printer {
...
template <typename Out> Out &operator<<(Out &out, info const &what) {
