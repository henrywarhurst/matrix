...
// enables raw_token
template <> struct use_terminal<qi::domain, tag::raw_token> : mpl::true_ {};
...
struct plain_raw_token : primitive_parser<plain_raw_token<TokenId>> {
  ...
  plain_raw_token(TokenId const &id) : id(id) {}
...
///////////////////////////////////////////////////////////////////////////
template <typename Modifiers> struct make_primitive<tag::raw_token, Modifiers> {
