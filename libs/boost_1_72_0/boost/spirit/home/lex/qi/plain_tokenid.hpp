...
// enables tokenid
template <> struct use_terminal<qi::domain, tag::tokenid> : mpl::true_ {};
...
struct plain_tokenid : primitive_parser<plain_tokenid<TokenId>> {
  ...
  plain_tokenid(TokenId const &id) : id(id) {}
...
///////////////////////////////////////////////////////////////////////////
template <typename Modifiers> struct make_primitive<tag::tokenid, Modifiers> {
...
struct make_primitive<
    terminal_ex<tag::tokenid, fusion::vector2<TokenId, TokenId>>, Modifiers> {
...
template <typename Idtype, typename Attr, typename Context, typename Iterator>
struct handles_container<qi::plain_tokenid_range<Idtype>, Attr, Context,
                         Iterator> : mpl::true_ {};
} // namespace traits
} // namespace spirit
} // namespace boost
