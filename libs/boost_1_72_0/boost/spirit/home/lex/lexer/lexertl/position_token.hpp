...
template <typename Iterator = char const *,
          ...
          typename HasState = mpl::true_, typename Idtype = std::size_t>
...
struct position_token<Iterator, lex::omit, mpl::false_, Idtype> {
  ...
  position_token() : id_(id_type(boost::lexer::npos)) {}

  //  construct an invalid token
  explicit position_token(int) : id_(id_type(0)) {}

  position_token(id_type id, std::size_t) : id_(id) {}

  position_token(id_type id, std::size_t, token_value_type) : id_(id) {}
...
public:
  ...
  //  construct an invalid token
  explicit position_token(int) : base_type(0), state_(boost::lexer::npos) {}
  ...
  position_token(id_type id, std::size_t state, token_value_type)
      : base_type(id, boost::lexer::npos, unused), state_(state) {}

  position_token(id_type id, std::size_t state, Iterator const &first,
                 Iterator const &last)
      : base_type(id, boost::lexer::npos, first, last), state_(state) {}
...
public:
  ...
  //  construct an invalid token
  explicit position_token(int) : base_type(0) {}

  position_token(id_type id, std::size_t state) : base_type(id, state) {}
...
struct position_token_value_typesequence {
  typedef typename mpl::insert<AttributeTypes,
                               typename mpl::begin<AttributeTypes>::type,
                               IteratorPair>::type sequence_type;
...
struct position_token_value
    : mpl::eval_if<
          mpl::or_<is_same<AttributeTypes, mpl::vector0<>>,
...
public:
  typedef typename base_type::id_type id_type;
  typedef
      typename detail::position_token_value<iterpair_type, AttributeTypes>::type
          token_value_type;
  ...
  position_token(id_type id, std::size_t state, Iterator const &first,
                 Iterator const &last)
      : base_type(id, state, first, last), value_(iterpair_type(first, last)) {}
...
struct assign_to_attribute_from_value<
  ...
  static void call(lex::lexertl::position_token<Iterator, AttributeTypes,
                                                HasState, Idtype> const &t,
                   Attribute &attr) {
    ...
    if (0 == t.value().which()) {
      ...
      typedef lex::lexertl::position_token<Iterator, AttributeTypes, HasState,
                                           Idtype>
          token_type;
...
struct assign_to_container_from_value<
    ...
    : assign_to_attribute_from_value<
          Attribute, lex::lexertl::position_token<Iterator, AttributeTypes,
                                                  HasState, Idtype>> {};
...
struct assign_to_attribute_from_value<
  ...
  static void call(lex::lexertl::position_token<Iterator, mpl::vector0<>,
                                                HasState, Idtype> const &t,
                   Attribute &attr) {
...
//           , lex::lexertl::position_token<Iterator, mpl::vector0<>, HasState,
//           Idtype> >
...
struct assign_to_attribute_from_value<
  ...
  static void call(lex::lexertl::position_token<Iterator, mpl::vector<>,
                                                HasState, Idtype> const &t,
                   Attribute &attr) {
    //  The default type returned by the token_def parser component (if
    //  it has no token value type assigned) is the pair of iterators
...
//       , typename Idtype>
//     struct assign_to_container_from_value<Attribute
//           , lex::lexertl::position_token<Iterator, mpl::vector<>, HasState,
//           Idtype> >
//       : assign_to_attribute_from_value<Attribute
//           , lex::lexertl::position_token<Iterator, mpl::vector<>, HasState,
//           Idtype> >
...
template <typename Attribute, typename Iterator, typename Attr,
          typename HasState, typename Idtype>
struct assign_to_attribute_from_value<
    Attribute, lex::lexertl::position_token<Iterator, mpl::vector1<Attr>,
                                            HasState, Idtype>> {
  static void call(lex::lexertl::position_token<Iterator, mpl::vector1<Attr>,
                                                HasState, Idtype> const &t,
                   Attribute &attr) {
    //  The goal of this function is to avoid the conversion of the pair of
    //  iterators (to the matched character sequence) into the token value
    ...
    if (!t.has_value()) {
      ...
      typedef lex::lexertl::position_token<Iterator, mpl::vector1<Attr>,
                                           HasState, Idtype>
          token_type;
...
//       , typename HasState, typename Idtype>
//     struct assign_to_container_from_value<Attribute
//           , lex::lexertl::position_token<Iterator, mpl::vector1<Attr>,
//           HasState, Idtype> >
//       : assign_to_attribute_from_value<Attribute
//           , lex::lexertl::position_token<Iterator, mpl::vector1<Attr>,
//           HasState, Idtype> >
...
template <typename Attribute, typename Iterator, typename Attr,
          typename HasState, typename Idtype>
struct assign_to_attribute_from_value<
    Attribute, lex::lexertl::position_token<Iterator, mpl::vector<Attr>,
                                            HasState, Idtype>> {
  static void call(lex::lexertl::position_token<Iterator, mpl::vector<Attr>,
                                                HasState, Idtype> const &t,
                   Attribute &attr) {
    //  The goal of this function is to avoid the conversion of the pair of
    //  iterators (to the matched character sequence) into the token value
    ...
    if (!t.has_value()) {
      ...
      // Re-assign the attribute to the stored value
      typedef lex::lexertl::position_token<Iterator, mpl::vector<Attr>,
                                           HasState, Idtype>
          token_type;
      spirit::traits::assign_to(attr, const_cast<token_type &>(t).value());
    } else {
...
//       , typename HasState, typename Idtype>
//     struct assign_to_container_from_value<Attribute
//           , lex::lexertl::position_token<Iterator, mpl::vector<Attr>,
//           HasState, Idtype> >
//       : assign_to_attribute_from_value<Attribute
//           , lex::lexertl::position_token<Iterator, mpl::vector<Attr>,
//           HasState, Idtype> >
...
struct assign_to_attribute_from_value<
  ...
  static void call(lex::lexertl::position_token<Iterator, lex::omit, HasState,
                                                Idtype> const &t,
                   Attribute &attr) {
    // do nothing
  }
...
struct assign_to_container_from_value<
    ...
    : assign_to_attribute_from_value<
          fusion::vector2<Idtype_, iterator_range<Iterator>>,
          lex::lexertl::position_token<Iterator, AttributeTypes, HasState,
                                       Idtype>> {};
...
struct token_printer_debug<
  ...
  typedef lex::lexertl::position_token<Iterator, Attribute, HasState, Idtype>
      token_type;

  template <typename Out> static void print(Out &out, token_type const &val) {
    out << '[';
