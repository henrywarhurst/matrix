...
struct token<Iterator, lex::omit, mpl::false_, Idtype> {
  ...
  token(id_type id, std::size_t, token_value_type) : id_(id) {}
...
protected:
  typename boost::integral_promotion<id_type>::type
      id_; // token id, 0 if nothing has been matched
};
...
struct token_value_type
    : mpl::eval_if<mpl::or_<is_same<AttributeTypes, mpl::vector0<>>,
...
public:
  typedef typename base_type::id_type id_type;
  typedef typename detail::token_value_type<iterpair_type, AttributeTypes>::type
      token_value_type;
...
struct assign_to_attribute_from_value<
  ...
  call(lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype> const &t,
    ...
    if (0 == t.value().which()) {
      ...
      typedef lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype>
          token_type;
...
struct assign_to_container_from_value<
    Attribute, lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype>>
...
template <typename Iterator, typename AttributeTypes, typename HasState,
          typename Idtype>
struct assign_to_container_from_value<
    utree, lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype>>
    : assign_to_attribute_from_value<
          utree,
          lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype>> {};

template <typename Iterator>
struct assign_to_container_from_value<iterator_range<Iterator>,
                                      iterator_range<Iterator>> {
  static void call(iterator_range<Iterator> const &val,
