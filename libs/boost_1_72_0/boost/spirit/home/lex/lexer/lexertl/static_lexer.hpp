...
//
///////////////////////////////////////////////////////////////////////////
template <typename Token = token<>, typename LexerTables = static_::lexer,
...
private:
  ...
  struct iterator_data_type {
    ...
    iterator_data_type(next_token_functor next,
                       ...
                       std::size_t num_states, bool bol)
  ...
  BOOST_SPIRIT_ASSERT_MSG(tables_type::static_version ==
...
public:
  ...
  iterator_type begin(Iterator_ &first, Iterator_ const &last,
    ...
    iterator_data_type iterator_data(&tables_type::template next<Iterator_>,
                                     actions_, &tables_type::state_name,
...
public:
  ...
  std::size_t add_token(char_type const *, string_type const &, std::size_t,
                        char_type const *) {
    return unique_id_++;
  }
