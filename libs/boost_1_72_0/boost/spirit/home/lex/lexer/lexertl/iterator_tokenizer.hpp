...
public:
  ...
  static std::size_t
  next(boost::lexer::basic_state_machine<char_type> const &state_machine_,
  ...
  again:
    ...
    while (curr_ != end_) {
      ...
      if (BOL_state_ && bol) {
        ...
        typedef typename boost::lexer::char_traits<value_type>::index_type
            index_type;
        ...
        std::size_t const state_ =
            ptr_[lookup_[static_cast<std::size_t>(index)]];
