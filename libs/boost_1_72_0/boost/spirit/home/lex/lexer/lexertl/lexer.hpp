...
///////////////////////////////////////////////////////////////////////
template <typename Char> inline bool must_escape(Char c) {
  // FIXME: more needed?
  switch (c) {
  case '+':
  case '/':
...
///////////////////////////////////////////////////////////////////////
template <typename Char> inline std::basic_string<Char> escape(Char ch) {
...
private:
  ...
  struct iterator_data_type {
    ...
    iterator_data_type(boost::lexer::basic_state_machine<char_type> const &sm,
...
protected:
  ...
  lexer(unsigned int flags)
      : flags_(detail::map_flags(flags)), rules_(flags_),
...
public:
  ...
  void add_action(std::size_t unique_id, std::size_t state, F act) {
    ...
    if (state == all_states_id) {
      ...
      typedef
          typename basic_rules_type::string_size_t_map::value_type state_type;
