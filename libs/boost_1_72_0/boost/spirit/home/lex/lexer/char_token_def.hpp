...
// enables 'x'
template <> struct use_terminal<lex::domain, char> : mpl::true_ {};

// enables "x"
template <> struct use_terminal<lex::domain, char[2]> : mpl::true_ {};

// enables wchar_t
template <> struct use_terminal<lex::domain, wchar_t> : mpl::true_ {};

// enables L"x"
template <> struct use_terminal<lex::domain, wchar_t[2]> : mpl::true_ {};
...
///////////////////////////////////////////////////////////////////////////
namespace detail {
template <typename CharEncoding> struct basic_literal {
...
struct make_primitive<terminal_ex<tag::char_code<tag::char_, CharEncoding>,
                                  fusion::vector1<Char (&)[2]> // single char
                                                               // strings
                                  >,
                      Modifiers> {
  typedef char_token_def<CharEncoding> result_type;
