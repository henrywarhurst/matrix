...
struct subrules_scanner : public ScannerT {
  ...
  template <typename PoliciesT> struct rebind_policies {
  ...
  subrules_scanner<typename rebind_scanner_policies<ScannerT, PoliciesT>::type,
                   ListT>
  ...
  template <typename IteratorT> struct rebind_iterator {
  ...
  subrules_scanner<typename rebind_scanner_iterator<ScannerT, IteratorT>::type,
                   ListT>
...
//
///////////////////////////////////////////////////////////////////////////
template <typename ScannerT, typename ListT> struct subrules_scanner_finder {
