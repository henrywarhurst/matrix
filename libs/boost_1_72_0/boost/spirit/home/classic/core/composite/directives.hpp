...
//
///////////////////////////////////////////////////////////////////////////
template <typename ScannerT> struct lexeme_scanner {
...
//
///////////////////////////////////////////////////////////////////////////
template <typename BaseT> struct inhibit_case_iteration_policy : public BaseT {
  ...
  template <typename CharT> CharT filter(CharT ch) const {
...
template <int N> struct inhibit_case_parser_gen_base {
...
//
///////////////////////////////////////////////////////////////////////////
template <typename ScannerT> struct as_lower_scanner {
  typedef scanner_policies<
...
struct longest_parser_gen {
  template <typename A, typename B> struct result {

    typedef
        typename impl::to_longest_alternative<alternative<A, B>>::result_t type;
  };
...
struct shortest_parser_gen {
  template <typename A, typename B> struct result {
    ...
    typedef typename impl::to_shortest_alternative<alternative<A, B>>::result_t
        type;
  };
...
//
///////////////////////////////////////////////////////////////////////////
template <typename BoundsT> struct min_bounded_gen;
...
//
///////////////////////////////////////////////////////////////////////////
template <typename BoundsT> struct max_bounded_gen;
...
//
///////////////////////////////////////////////////////////////////////////
template <typename BoundsT> struct bounded_gen;
