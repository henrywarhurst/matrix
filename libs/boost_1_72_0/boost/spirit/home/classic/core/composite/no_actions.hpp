...
namespace detail {
template <typename ActionPolicy> struct compute_no_actions_action_policy {
  typedef no_actions_action_policy<ActionPolicy> type;
};

template <typename ActionPolicy>
struct compute_no_actions_action_policy<
    no_actions_action_policy<ActionPolicy>> {
  typedef no_actions_action_policy<ActionPolicy> type;
};
} // namespace detail

template <typename ScannerT = scanner<>> struct no_actions_scanner {
...
template <typename ScannerT = scanner<>> struct no_actions_scanner_list {
