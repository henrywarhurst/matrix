...
#define BOOST_SPIRIT_DEBUG_FLAGS_ESCAPE_CHAR                                   \
  0x0002                                      // escape_char_parse diagnostics
...
#define BOOST_SPIRIT_DEBUG_RULE(r)                                             \
  ::BOOST_SPIRIT_CLASSIC_NS::impl::get_node_registry().register_node(          \
      &r, #r, BOOST_SPIRIT_DEBUG_TRACENODE)
...
#define BOOST_SPIRIT_DEBUG_TRACE_RULE(r, t)                                    \
  ::BOOST_SPIRIT_CLASSIC_NS::impl::get_node_registry().register_node(&r, #r,   \
                                                                     (t))
...
#define BOOST_SPIRIT_DEBUG_TRACE_RULE_NAME(r, n, t)                            \
  ::BOOST_SPIRIT_CLASSIC_NS::impl::get_node_registry().register_node(&r, (n),  \
                                                                     (t))
