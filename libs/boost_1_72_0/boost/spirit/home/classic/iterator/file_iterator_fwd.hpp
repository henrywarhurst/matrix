...
template <typename CharT = char> class std_file_iterator;

// may never be defined -- so what...
template <typename CharT = char> class mmap_file_iterator;
} // namespace fileiter_impl

// no defaults here -- too much dependencies
template <typename CharT, typename BaseIterator> class file_iterator;
