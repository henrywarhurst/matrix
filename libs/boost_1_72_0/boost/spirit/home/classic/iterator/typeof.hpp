...
template <typename QueueT, typename T, typename PointerT> class fsq_iterator;
...
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::multi_pass_policies::ref_counted)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::multi_pass_policies::first_owner)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::multi_pass_policies::buf_id_check)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::multi_pass_policies::no_check)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::multi_pass_policies::std_deque)
BOOST_TYPEOF_REGISTER_TEMPLATE(
    BOOST_SPIRIT_CLASSIC_NS::multi_pass_policies::fixed_size_queue,
    (BOOST_TYPEOF_INTEGRAL(std::size_t)))
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::multi_pass_policies::input_iterator)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::multi_pass_policies::lex_input)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::multi_pass_policies::functor_input)
...
BOOST_TYPEOF_REGISTER_TEMPLATE(
    BOOST_SPIRIT_CLASSIC_NS::fileiter_impl::std_file_iterator, 1)
BOOST_TYPEOF_REGISTER_TEMPLATE(
    BOOST_SPIRIT_CLASSIC_NS::fileiter_impl::mmap_file_iterator, 1)

BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::fileiter_impl::std_file_iterator<char>)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::fileiter_impl::std_file_iterator<wchar_t>)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::fileiter_impl::mmap_file_iterator<char>)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::fileiter_impl::mmap_file_iterator<wchar_t>)

// fixed_size_queue.hpp

BOOST_TYPEOF_REGISTER_TEMPLATE(BOOST_SPIRIT_CLASSIC_NS::fixed_size_queue,
...
BOOST_TYPEOF_REGISTER_TEMPLATE(
    BOOST_SPIRIT_CLASSIC_NS::file_position_without_column_base, 1)

BOOST_TYPEOF_REGISTER_TYPE(BOOST_SPIRIT_CLASSIC_NS::file_position)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::file_position_base<std::basic_string<wchar_t>>)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::file_position_without_column)
BOOST_TYPEOF_REGISTER_TYPE(
    BOOST_SPIRIT_CLASSIC_NS::file_position_without_column_base<
