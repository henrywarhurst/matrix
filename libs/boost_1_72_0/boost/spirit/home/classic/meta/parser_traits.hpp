...
//
///////////////////////////////////////////////////////////////////////////////
template <typename UnaryT> struct is_unary_composite {

  BOOST_STATIC_CONSTANT(
      bool, value = (::boost::is_convertible<typename UnaryT::parser_category_t,
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename ActionT> struct is_action_parser {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename BinaryT> struct is_binary_composite {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename CompositeT> struct is_composite_parser {
...
///////////////////////////////////////////////////////////////////////////////
template <typename ParserT> struct is_alternative {
...
template <typename ParserT> struct is_sequence {
...
template <typename ParserT> struct is_sequential_or {
...
template <typename ParserT> struct is_intersection {
...
template <typename ParserT> struct is_difference {
...
template <typename ParserT> struct is_exclusive_or {
...
template <typename ParserT> struct is_optional {
...
template <typename ParserT> struct is_kleene_star {
...
template <typename ParserT> struct is_positive {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename UnaryT> struct unary_subject {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename BinaryT> struct binary_left_subject {
...
template <typename BinaryT> struct binary_right_subject {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename ActionT> struct action_subject {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename ActionT> struct semantic_action {
