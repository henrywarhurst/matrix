...
struct rxstrlit : public parser<rxstrlit<CharT>> {
  ...
  rxstrlit(CharT const *first, CharT const *last) : rx(first, last) {}
  rxstrlit(CharT const *first) : rx(first) {}
  ...
  parse(ScannerT const &scan) const {
    ...
    typedef typename std::iterator_traits<iterator_t>::iterator_category
        iterator_category;
...
///////////////////////////////////////////////////////////////////////////////
// Generator functions
template <typename CharT> inline rxstrlit<CharT> regex_p(CharT const *first) {
