...
class stored_rule
    : public impl::rule_base<
          ...
          typename mpl::if_c<EmbedByValue, stored_rule<T0, T1, T2, true>,
...
public:
  ...
  stored_rule(stored_rule const &r) : ptr(r.ptr) {}

  template <typename ParserT>
  stored_rule(ParserT const &p)
      : ptr(new impl::concrete_parser<ParserT, scanner_t, attr_t>(p)) {}

  template <typename ParserT> stored_rule &operator=(ParserT const &p) {
...
private:
  ...
  stored_rule(shared_ptr<abstract_parser_t> const &ptr) : ptr(ptr) {}
