...
template <typename ResultT> struct make_tuple { typedef tuple<ResultT> type; };

///////////////////////////////////////////////////////////////////////////////
//  nil_t is converted to an empty tuple type
template <> struct make_tuple<nil_t> { typedef tuple<> type; };
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename TupleT, typename AppendT> struct concat_tuple;
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename AppendT> struct concat_tuple<tuple<>, AppendT> {

  typedef tuple<AppendT> type;
};

template <> struct concat_tuple<tuple<>, nil_t> { typedef tuple<> type; };
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename A, typename AppendT> struct concat_tuple<tuple<A>, AppendT> {

  typedef tuple<A, AppendT> type;
};

template <typename A> struct concat_tuple<tuple<A>, nil_t> {
...
template <typename A, typename B> struct concat_tuple<tuple<A, B>, nil_t> {
...
///////////////////////////////////////////////////////////////////////////////
template <typename A, typename B, typename C, typename D, typename E,
          typename F, typename G, typename AppendT>
...
///////////////////////////////////////////////////////////////////////////////
template <typename A, typename B, typename C, typename D, typename E,
          typename F, typename G, typename H, typename AppendT>
...
///////////////////////////////////////////////////////////////////////////////
template <typename A, typename B, typename C, typename D, typename E,
          typename F, typename G, typename H, typename I, typename AppendT>
...
template <typename A, typename B, typename C, typename D, typename E,
          typename F, typename G, typename H, typename I, typename J,
          typename K, typename L, typename AppendT>
...
template <typename A, typename B, typename C, typename D, typename E,
          typename F, typename G, typename H, typename I, typename J,
          typename K, typename L, typename M, typename AppendT>
...
template <typename A, typename B, typename C, typename D, typename E,
          typename F, typename G, typename H, typename I, typename J,
          typename K, typename L, typename M, typename N, typename AppendT>
...
template <typename TupleT1, typename TupleT2> struct concat_tuples {

  typedef typename concat_tuple_element<
      TupleT1, TupleT2, 0, typename tuple_element<0, TupleT2>::type>::type type;
};
...
namespace impl {
template <unsigned N> struct convert_actors_ {};
} // namespace impl
...
TupleResultT convert_actors(ActorTupleT const &actor_tuple) {
  ...
  return impl::convert_actors_<length>::template apply<
      TupleResultT, ActorTupleT>::do_(actor_tuple);
}
...
struct convert_actor {
  ...
  template <bool C> struct is_default_t {};
  ...
  static type do_(ActorTupleT const &actor_tuple) {
    return actor_element(actor_tuple,
                         is_default_t<(N >= ActorTupleT::length)>());
  }
};

///////////////////////////////////////
template <> struct convert_actors_<1> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
...
///////////////////////////////////////
template <> struct convert_actors_<2> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
...
///////////////////////////////////////
template <> struct convert_actors_<3> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
...
/////////////////////////////////////
template <> struct convert_actors_<4> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
      ...
      return TupleResultT(
          ...
          converter2::do_(actor_tuple), converter3::do_(actor_tuple));
    }
  };
};

/////////////////////////////////////
template <> struct convert_actors_<5> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
...
/////////////////////////////////////
template <> struct convert_actors_<6> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
      ...
      return TupleResultT(
          converter0::do_(actor_tuple), converter1::do_(actor_tuple),
          converter2::do_(actor_tuple), converter3::do_(actor_tuple),
          converter4::do_(actor_tuple), converter5::do_(actor_tuple));
    }
  };
};
...
/////////////////////////////////////
template <> struct convert_actors_<7> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
...
/////////////////////////////////////
template <> struct convert_actors_<8> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
      ...
      return TupleResultT(
          ...
          converter2::do_(actor_tuple), converter3::do_(actor_tuple),
          converter4::do_(actor_tuple), converter5::do_(actor_tuple),
          converter6::do_(actor_tuple), converter7::do_(actor_tuple));
    }
  };
};

/////////////////////////////////////
template <> struct convert_actors_<9> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
...
/////////////////////////////////////
template <> struct convert_actors_<10> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
      ...
      return TupleResultT(
          ...
          converter4::do_(actor_tuple), converter5::do_(actor_tuple),
          converter6::do_(actor_tuple), converter7::do_(actor_tuple),
          converter8::do_(actor_tuple), converter9::do_(actor_tuple));
    }
  };
};

/////////////////////////////////////
template <> struct convert_actors_<11> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
...
/////////////////////////////////////
template <> struct convert_actors_<12> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
      ...
      return TupleResultT(
          ...
          converter6::do_(actor_tuple), converter7::do_(actor_tuple),
          converter8::do_(actor_tuple), converter9::do_(actor_tuple),
          converter10::do_(actor_tuple), converter11::do_(actor_tuple));
    }
  };
};
...
/////////////////////////////////////
template <> struct convert_actors_<13> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
...
///////////////////////////////////////
template <> struct convert_actors_<14> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
      ...
      return TupleResultT(
          ...
          converter8::do_(actor_tuple), converter9::do_(actor_tuple),
          converter10::do_(actor_tuple), converter11::do_(actor_tuple),
          converter12::do_(actor_tuple), converter13::do_(actor_tuple));
    }
  };
};

///////////////////////////////////////
template <> struct convert_actors_<15> {
  template <typename TupleResultT, typename ActorTupleT> struct apply {
    static TupleResultT do_(ActorTupleT const &actor_tuple) {
      typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;
      typedef impl::convert_actor<1, TupleResultT, ActorTupleT> converter1;
