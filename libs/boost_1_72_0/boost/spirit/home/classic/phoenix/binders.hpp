...
//
///////////////////////////////////////////////////////////////////////////////
template <typename FuncT> struct functor_action : public FuncT {
  ...
  functor_action(FuncT fptr_ = FuncT()) : FuncT(fptr_) {}
};
...
//////////////////////////////////
template <typename FuncT, typename TupleT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G>
...
//////////////////////////////////
template <typename FuncT, typename TupleT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H>
struct composite8_result<functor_action<FuncT>, TupleT, A, B, C, D, E, F, G,
                         H> {
...
template <typename FuncT, typename TupleT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H,
          typename I>
struct composite9_result<functor_action<FuncT>, TupleT, A, B, C, D, E, F, G, H,
                         I> {
...
struct composite10_result<functor_action<FuncT>, TupleT, A, B, C, D, E, F, G, H,
                          I, J> {
...
struct composite11_result<functor_action<FuncT>, TupleT, A, B, C, D, E, F, G, H,
                          I, J, K> {
...
struct composite12_result<functor_action<FuncT>, TupleT, A, B, C, D, E, F, G, H,
                          I, J, K, L> {
...
template <typename FuncT, typename TupleT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H,
          typename I, typename J, typename K, typename L, typename M>
struct composite13_result<functor_action<FuncT>, TupleT, A, B, C, D, E, F, G, H,
                          I, J, K, L, M> {
...
template <typename FuncT, typename TupleT, typename A, typename B, typename C,
          ...
          typename I, typename J, typename K, typename L, typename M,
          typename N>
struct composite14_result<functor_action<FuncT>, TupleT, A, B, C, D, E, F, G, H,
                          I, J, K, L, M, N> {
...
struct composite15_result<functor_action<FuncT>, TupleT, A, B, C, D, E, F, G, H,
                          I, J, K, L, M, N, O> {
...
//////////////////////////////////
template <typename FuncT> inline functor<FuncT> bind(FuncT func) {
...
//////////////////////////////////
template <typename T> struct as_ptr {
...
//////////////////////////////////
template <typename T> struct as_ptr<T *> {
...
//////////////////////////////////
template <typename T, typename ClassT> struct member_var_ptr_action {

  typedef member_var_ptr_action<T, ClassT> self_t;

  template <typename CT> struct result {
    typedef typename boost::mpl::if_<boost::is_const<CT>, T const &, T &>::type
        type;
  };

  typedef T ClassT::*mem_var_ptr_t;

  member_var_ptr_action(mem_var_ptr_t ptr_) : ptr(ptr_) {}
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename RT, typename A = nil_t, typename B = nil_t,
          typename C = nil_t
...
#endif
          >
struct function_ptr : public function<function_ptr_action<RT, A, B, C
#if PHOENIX_LIMIT > 3
                                                          ,
                                                          D, E, F
#if PHOENIX_LIMIT > 6
  ...
  typedef function_ptr_action<RT, A, B, C
#if PHOENIX_LIMIT > 3
                              ,
                              D, E, F
#if PHOENIX_LIMIT > 6
  ...
  function_ptr(FPT fp) : function<action_t>(action_t(fp)) {}
};
...
struct function_ptr_action<RT, nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 3
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
  ...
  function_ptr_action(func_ptr_t fptr_) : fptr(fptr_) {}
...
//////////////////////////////////
template <typename RT> inline function_ptr<RT> bind(RT (*fptr)()) {
...
struct function_ptr_action<RT, A, nil_t, nil_t,
#if PHOENIX_LIMIT > 3
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
  ...
  template <typename A_> struct result { typedef result_type type; };
...
struct function_ptr_action<RT, A, B, nil_t,
#if PHOENIX_LIMIT > 3
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
  ...
  template <typename A_, typename B_> struct result {
...
struct function_ptr_action<RT, A, B, C,
#if PHOENIX_LIMIT > 3
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
  ...
  template <typename A_, typename B_, typename C_> struct result {
    typedef result_type type;
  };
...
struct function_ptr_action<RT, A, B, C, D, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
  ...
  template <typename A_, typename B_, typename C_, typename D_> struct result {
    typedef result_type type;
  };
...
template <typename RT, typename A, typename B, typename C, typename D,
          typename E>
struct function_ptr_action<RT, A, B, C, D, E, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
  ...
  result_type operator()(A a, B b, C c, D d, E e) const {
...
struct function_ptr_action<RT, A, B, C, D, E, F,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
  ...
  result_type operator()(A a, B b, C c, D d, E e, F f) const {
...
struct function_ptr_action<RT, A, B, C, D, E, F, G, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
  ...
  result_type operator()(A a, B b, C c, D d, E e, F f, G g) const {
...
template <typename RT, typename A, typename B, typename C, typename D,
          typename E, typename F, typename G>
inline function_ptr<RT, A, B, C, D, E, F, G> bind(RT (*fptr)(A, B, C, D, E, F,
                                                             G)) {
...
struct function_ptr_action<RT, A, B, C, D, E, F, G, H, nil_t,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
...
template <typename RT, typename A, typename B, typename C, typename D,
          typename E, typename F, typename G, typename H>
inline function_ptr<RT, A, B, C, D, E, F, G, H> bind(RT (*fptr)(A, B, C, D, E,
                                                                F, G, H)) {
...
struct function_ptr_action<RT, A, B, C, D, E, F, G, H, I,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
...
template <typename RT, typename A, typename B, typename C, typename D,
          typename E, typename F, typename G, typename H, typename I,
          typename J>
struct function_ptr_action<RT, A, B, C, D, E, F, G, H, I, J, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
#endif
                           nil_t //  Unused
  ...
  result_type operator()(A a, B b, C c, D d, E e, F f, G g, H h, I i,
                         J j) const {
...
struct function_ptr_action<RT, A, B, C, D, E, F, G, H, I, J, K, nil_t,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
#endif
                           nil_t //  Unused
  ...
  result_type operator()(A a, B b, C c, D d, E e, F f, G g, H h, I i, J j,
                         K k) const {
...
struct function_ptr_action<RT, A, B, C, D, E, F, G, H, I, J, K, L,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
#endif
                           nil_t //  Unused
  ...
  result_type operator()(A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k,
                         L l) const {
...
struct function_ptr_action<RT, A, B, C, D, E, F, G, H, I, J, K, L, M, nil_t,
                           nil_t, nil_t> {
...
struct function_ptr_action<RT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, nil_t,
                           nil_t> {
...
template <typename RT, typename A, typename B, typename C, typename D,
          ...
          typename J, typename K, typename L, typename M, typename N,
          typename O>
struct function_ptr_action<RT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O,
                           nil_t> {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename RT, typename ClassT, typename A = nil_t, typename B = nil_t,
          typename C = nil_t
...
struct member_function_ptr
    : public function<member_function_ptr_action<RT, ClassT, A, B, C
#if PHOENIX_LIMIT > 3
                                                 ,
                                                 D, E, F
#if PHOENIX_LIMIT > 6
  ...
  typedef member_function_ptr_action<RT, ClassT, A, B, C
#if PHOENIX_LIMIT > 3
                                     ,
                                     D, E, F
#if PHOENIX_LIMIT > 6
  ...
  template <typename FPT>
  member_function_ptr(FPT fp) : function<action_t>(action_t(fp)) {}
};
...
struct member_function_ptr_action<RT, ClassT, nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 3
                                  nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                                  nil_t, nil_t, nil_t,
  ...
  template <typename CT> struct result { typedef result_type type; };

  member_function_ptr_action(mem_func_ptr_t fptr_) : fptr(fptr_) {}

  template <typename CT> result_type operator()(CT &obj) const {
...
struct member_function_ptr_action<RT, ClassT, A, nil_t, nil_t,
#if PHOENIX_LIMIT > 3
                                  nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                                  nil_t, nil_t, nil_t,
  ...
  template <typename CT, typename A_> struct result {
    typedef result_type type;
  };

  member_function_ptr_action(mem_func_ptr_t fptr_) : fptr(fptr_) {}

  template <typename CT> result_type operator()(CT &obj, A a) const {
...
//////////////////////////////////
template <typename RT, typename ClassT, typename A>
inline member_function_ptr<RT, ClassT const, A> bind(RT (ClassT::*fptr)(A)
                                                         const) {
...
struct member_function_ptr_action<RT, ClassT, A, B, nil_t,
#if PHOENIX_LIMIT > 3
                                  nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                                  nil_t, nil_t, nil_t,
  ...
  template <typename CT, typename A_, typename B_> struct result {
    typedef result_type type;
  };

  member_function_ptr_action(mem_func_ptr_t fptr_) : fptr(fptr_) {}

  template <typename CT> result_type operator()(CT &obj, A a, B b) const {
...
//////////////////////////////////
template <typename RT, typename ClassT, typename A, typename B>
inline member_function_ptr<RT, ClassT const, A, B> bind(RT (ClassT::*fptr)(A, B)
                                                            const) {
...
struct member_function_ptr_action<RT, ClassT, A, B, C, nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                                  nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                                  nil_t, nil_t, nil_t,
  ...
  template <typename CT, typename A_, typename B_, typename C_> struct result {
    typedef result_type type;
  };

  member_function_ptr_action(mem_func_ptr_t fptr_) : fptr(fptr_) {}

  template <typename CT> result_type operator()(CT &obj, A a, B b, C c) const {
...
//////////////////////////////////
template <typename RT, typename ClassT, typename A, typename B, typename C>
inline member_function_ptr<RT, ClassT, A, B, C> bind(RT (ClassT::*fptr)(A, B,
                                                                        C)) {
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D>
struct member_function_ptr_action<RT, ClassT, A, B, C, D, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                                  nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                                  nil_t, nil_t, nil_t,
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E>
struct member_function_ptr_action<RT, ClassT, A, B, C, D, E, nil_t,
#if PHOENIX_LIMIT > 6
                                  nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                                  nil_t, nil_t, nil_t,
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F>
struct member_function_ptr_action<RT, ClassT, A, B, C, D, E, F, nil_t, nil_t,
                                  nil_t,
#if PHOENIX_LIMIT > 9
                                  nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G>
struct member_function_ptr_action<RT, ClassT, A, B, C, D, E, F, G, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                                  nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                                  nil_t, nil_t, nil_t,
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H>
struct member_function_ptr_action<RT, ClassT, A, B, C, D, E, F, G, H, nil_t,
#if PHOENIX_LIMIT > 9
                                  nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                                  nil_t, nil_t, nil_t,
  ...
  template <typename CT>
  result_type operator()(CT &obj, A a, B b, C c, D d, E e, F f, G g,
                         H h) const {
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H,
          typename I>
struct member_function_ptr_action<RT, ClassT, A, B, C, D, E, F, G, H, I, nil_t,
                                  nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                                  nil_t, nil_t, nil_t,
#endif
  ...
  template <typename CT>
  result_type operator()(CT &obj, A a, B b, C c, D d, E e, F f, G g, H h,
                         I i) const {
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H,
          typename I, typename J>
struct member_function_ptr_action<RT, ClassT, A, B, C, D, E, F, G, H, I, J,
                                  nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                                  nil_t, nil_t, nil_t,
#endif
  ...
  template <typename CT>
  result_type operator()(CT &obj, A a, B b, C c, D d, E e, F f, G g, H h, I i,
                         J j) const {
...
bind(RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J) const) {
  return member_function_ptr<RT, ClassT const, A, B, C, D, E, F, G, H, I, J>(
      fptr);
}
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H,
          typename I, typename J, typename K>
struct member_function_ptr_action<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K,
                                  nil_t,
#if PHOENIX_LIMIT > 12
                                  nil_t, nil_t, nil_t,
#endif
...
bind(RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K) const) {
  return member_function_ptr<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K>(
      fptr);
}
...
bind(RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K, L)) {
  return member_function_ptr<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L>(
      fptr);
}
...
bind(RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K, L, M)) {
  return member_function_ptr<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L, M>(
      fptr);
}
...
#endif
          >
struct bound_member : public function<bound_member_action<RT, ClassT, A, B, C
#if PHOENIX_LIMIT > 3
                                                          ,
                                                          D, E, F
#if PHOENIX_LIMIT > 6
  ...
  typedef bound_member_action<RT, ClassT, A, B, C
#if PHOENIX_LIMIT > 3
                              ,
                              D, E, F
#if PHOENIX_LIMIT > 6
  ...
  bound_member(CT &c, FPT fp) : function<action_t>(action_t(c, fp)) {}
...
template <typename RT, typename ClassT>
struct bound_member_action<RT, ClassT, nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 3
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
...
template <typename RT, typename ClassT>
inline bound_member<RT, ClassT const> bind(ClassT const &obj,
                                           RT (ClassT::*fptr)()) {
...
///////////////////////////////////////////////////////////////////////////////
template <typename RT, typename ClassT, typename A>
struct bound_member_action<RT, ClassT, A, nil_t, nil_t,
#if PHOENIX_LIMIT > 3
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
...
//////////////////////////////////
template <typename RT, typename ClassT, typename A>
inline bound_member<RT, ClassT const, A> bind(ClassT const &obj,
                                              RT (ClassT::*fptr)(A) const) {
...
///////////////////////////////////////////////////////////////////////////////
template <typename RT, typename ClassT, typename A, typename B>
struct bound_member_action<RT, ClassT, A, B, nil_t,
#if PHOENIX_LIMIT > 3
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
...
//////////////////////////////////
template <typename RT, typename ClassT, typename A, typename B>
inline bound_member<RT, ClassT, A, B> bind(ClassT &obj,
                                           RT (ClassT::*fptr)(A, B)) {
...
///////////////////////////////////////////////////////////////////////////////
template <typename RT, typename ClassT, typename A, typename B, typename C>
struct bound_member_action<RT, ClassT, A, B, C, nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
...
//////////////////////////////////
template <typename RT, typename ClassT, typename A, typename B, typename C>
inline bound_member<RT, ClassT, A, B, C> bind(ClassT &obj,
                                              RT (ClassT::*fptr)(A, B, C)) {
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D>
struct bound_member_action<RT, ClassT, A, B, C, D, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E>
struct bound_member_action<RT, ClassT, A, B, C, D, E, nil_t,
#if PHOENIX_LIMIT > 6
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F>
struct bound_member_action<RT, ClassT, A, B, C, D, E, F, nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G>
struct bound_member_action<RT, ClassT, A, B, C, D, E, F, G, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H>
struct bound_member_action<RT, ClassT, A, B, C, D, E, F, G, H, nil_t,
#if PHOENIX_LIMIT > 9
                           nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H,
          typename I>
struct bound_member_action<RT, ClassT, A, B, C, D, E, F, G, H, I, nil_t, nil_t,
                           nil_t,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
#endif
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H,
          typename I, typename J>
struct bound_member_action<RT, ClassT, A, B, C, D, E, F, G, H, I, J, nil_t,
                           nil_t,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
#endif
...
bind(ClassT const &obj,
     RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J) const) {
  return bound_member<RT, ClassT const, A, B, C, D, E, F, G, H, I, J>(obj,
                                                                      fptr);
}
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H,
          typename I, typename J, typename K>
struct bound_member_action<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, nil_t,
#if PHOENIX_LIMIT > 12
                           nil_t, nil_t, nil_t,
#endif
                           nil_t //  Unused
...
bind(ClassT const &obj,
     RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K) const) {
  return bound_member<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K>(obj,
                                                                         fptr);
}
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H,
          typename I, typename J, typename K, typename L>
struct bound_member_action<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L,
                           nil_t, nil_t, nil_t, nil_t> {
...
bind(ClassT &obj, RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K, L)) {
  return bound_member<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L>(obj,
                                                                      fptr);
}
...
bind(ClassT const &obj,
     RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K, L) const) {
  return bound_member<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K, L>(
      obj, fptr);
}
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          typename D, typename E, typename F, typename G, typename H,
          typename I, typename J, typename K, typename L, typename M>
struct bound_member_action<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L, M,
                           nil_t, nil_t, nil_t> {
...
bind(ClassT &obj, RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K, L, M)) {
  return bound_member<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L, M>(obj,
                                                                         fptr);
}
...
bind(ClassT const &obj,
     RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K, L, M) const) {
  return bound_member<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K, L, M>(
      obj, fptr);
}
...
template <typename RT, typename ClassT, typename A, typename B, typename C,
          ...
          typename I, typename J, typename K, typename L, typename M,
          typename N>
struct bound_member_action<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L, M, N,
                           nil_t, nil_t> {
...
bind(ClassT &obj,
     RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K, L, M, N)) {
  return bound_member<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L, M, N>(
      obj, fptr);
}
...
bind(ClassT const &obj,
     RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K, L, M, N) const) {
  return bound_member<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K, L, M,
                      N>(obj, fptr);
}
...
bind(ClassT &obj,
     RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O)) {
  return bound_member<RT, ClassT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>(
      obj, fptr);
}
...
inline bound_member<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K, L, M, N,
                    O>
bind(ClassT const &obj,
     RT (ClassT::*fptr)(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O) const) {
  return bound_member<RT, ClassT const, A, B, C, D, E, F, G, H, I, J, K, L, M,
                      N, O>(obj, fptr);
}
