...
//
///////////////////////////////////////////////////////////////////////////////
template <typename OperationT, typename TupleT> struct composite0_result {
...
struct composite<OperationT, A, B, C, D, nil_t, nil_t,
  ...
  template <typename TupleT> struct result {
    ...
    typedef
        typename composite4_result<OperationT, TupleT, A, B, C, D>::type type;
  };
...
struct composite<OperationT, A, B, C, D, E, nil_t,
  ...
  template <typename TupleT> struct result {
    ...
    typedef typename composite5_result<OperationT, TupleT, A, B, C, D, E>::type
        type;
  };
...
struct composite<OperationT, A, B, C, D, E, F,
  ...
  template <typename TupleT> struct result {
    ...
    typedef
        typename composite6_result<OperationT, TupleT, A, B, C, D, E, F>::type
            type;
  };

  composite(OperationT const &op_, A const &a_, B const &b_, C const &c_,
            D const &d_, E const &e_, F const &f_)
      : op(op_), a(a_), b(b_), c(c_), d(d_), e(e_), f(f_) {}
...
struct composite<OperationT, A, B, C, D, E, F, G, nil_t, nil_t,
  ...
  composite(OperationT const &op_, A const &a_, B const &b_, C const &c_,
      ...
      : op(op_), a(a_), b(b_), c(c_), d(d_), e(e_), f(f_), g(g_) {}
...
struct composite<OperationT, A, B, C, D, E, F, G, H, nil_t,
  ...
  template <typename TupleT> struct result {
    ...
    typedef typename composite8_result<OperationT, TupleT, A, B, C, D, E, F, G,
                                       H>::type type;
  };

  composite(OperationT const &op_, A const &a_, B const &b_, C const &c_,
            D const &d_, E const &e_, F const &f_, G const &g_, H const &h_)
      : op(op_), a(a_), b(b_), c(c_), d(d_), e(e_), f(f_), g(g_), h(h_) {}
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I,
  ...
  template <typename TupleT> struct result {
    ...
    typedef typename composite9_result<OperationT, TupleT, A, B, C, D, E, F, G,
                                       H, I>::type type;
  };
  ...
  composite(OperationT const &op_, A const &a_, B const &b_, C const &c_,
            D const &d_, E const &e_, F const &f_, G const &g_, H const &h_,
            I const &i_)
      : op(op_), a(a_), b(b_), c(c_), d(d_), e(e_), f(f_), g(g_), h(h_), i(i_) {
  }
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, nil_t, nil_t,
  ...
  template <typename TupleT> struct result {
    ...
    typedef typename composite10_result<OperationT, TupleT, A, B, C, D, E, F, G,
                                        H, I, J>::type type;
  };
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, nil_t,
  ...
  template <typename TupleT> struct result {
    ...
    typedef typename composite11_result<OperationT, TupleT, A, B, C, D, E, F, G,
                                        H, I, J, K>::type type;
  };
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L,
  ...
  template <typename TupleT> struct result {
    ...
    typedef typename composite12_result<OperationT, TupleT, A, B, C, D, E, F, G,
                                        H, I, J, K, L>::type type;
  };
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, nil_t,
  ...
  template <typename TupleT> struct result {
    ...
    typedef typename composite13_result<OperationT, TupleT, A, B, C, D, E, F, G,
                                        H, I, J, K, L, M>::type type;
  };
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, nil_t,
  ...
  template <typename TupleT> struct result {
    ...
    typedef typename composite14_result<OperationT, TupleT, A, B, C, D, E, F, G,
...
template <typename OperationT, typename A, typename B, typename C, typename D,
          ...
          typename J, typename K, typename L, typename M, typename N,
          typename O>
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O,
                 nil_t> {
  ...
  template <typename TupleT> struct result {
    ...
    typedef typename composite15_result<OperationT, TupleT, A, B, C, D, E, F, G,
...
//////////////////////////////////  input is an actor
template <typename OperationT, typename BaseT> struct make_unary {

  typedef typename make_composite<OperationT, actor<BaseT>>::type type;

  static type construct(actor<BaseT> const &_0) {
    typedef
        typename make_composite<OperationT, actor<BaseT>>::composite_type ret_t;
...
template <typename OperationT, typename BaseT, typename B> struct make_binary1 {
  ...
  static type construct(actor<BaseT> const &_0_, B const &_1_) {
    typedef typename make_composite<OperationT, actor<BaseT>, B>::composite_type
        ret_t;
...
template <typename OperationT, typename A, typename BaseT> struct make_binary2 {
  ...
  static type construct(A const &_0_, actor<BaseT> const &_1_) {
    typedef typename make_composite<OperationT, A, actor<BaseT>>::composite_type
        ret_t;
...
struct make_binary3 {
  ...
  typedef typename make_composite<OperationT, actor<BaseA>, actor<BaseB>>::type
      type;
