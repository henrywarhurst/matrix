...
//
///////////////////////////////////////////////////////////////////////////////
template <typename OperationT> struct function {
  ...
  typename impl::make_composite<OperationT, A, B, C, D, E, F, G, H, I, J>::type
  operator()(A const &a, B const &b, C const &c, D const &d, E const &e,
  ...
  typename impl::make_composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L,
                                M>::type
  operator()(A const &a, B const &b, C const &c, D const &d, E const &e,
             F const &f, G const &g, H const &h, I const &i, J const &j,
...
function<OperationT>::operator()(A const &a, B const &b, C const &c) const {
  typedef
      typename impl::make_composite<OperationT, A, B, C>::composite_type ret_t;
...
function<OperationT>::operator()(A const &a, B const &b, C const &c,
                                 D const &d) const {
  typedef typename impl::make_composite<OperationT, A, B, C, D>::composite_type
      ret_t;
...
function<OperationT>::operator()(A const &a, B const &b, C const &c, D const &d,
                                 E const &e) const {
  typedef
...
function<OperationT>::operator()(A const &a, B const &b, C const &c, D const &d,
  ...
  return ret_t(
      op, as_actor<A>::convert(a), as_actor<B>::convert(b),
...
function<OperationT>::operator()(A const &a, B const &b, C const &c, D const &d,
  ...
  typedef typename impl::make_composite<OperationT, A, B, C, D, E, F, G, H, I,
                                        J, K, L, M, N, O>::composite_type ret_t;
