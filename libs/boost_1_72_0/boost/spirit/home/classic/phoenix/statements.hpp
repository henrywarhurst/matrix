...
//
///////////////////////////////////////////////////////////////////////////////
template <typename A0, typename A1> struct sequential_composite {

  typedef sequential_composite<A0, A1> self_t;

  template <typename TupleT> struct result { typedef void type; };

  sequential_composite(A0 const &_0, A1 const &_1) : a0(_0), a1(_1) {}

  template <typename TupleT> void eval(TupleT const &args) const {
    a0.eval(args);
    a1.eval(args);
  }
...
//////////////////////////////////
template <typename CondT, typename ThenT> struct else_gen {
  ...
  operator[](ElseT const &else_) {
    typedef if_then_else_composite<CondT, ThenT, typename as_actor<ElseT>::type>
        result;
...
//////////////////////////////////
template <typename CondT, typename ThenT> struct if_then_composite {
...
//////////////////////////////////
template <typename CondT> struct if_gen {
...
//////////////////////////////////
template <typename CondT> inline if_gen<CondT> if_(CondT const &cond) {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename CondT, typename DoT> struct while_composite {
...
//////////////////////////////////
template <typename CondT> struct while_gen {
...
//////////////////////////////////
template <typename CondT> inline while_gen<CondT> while_(CondT const &cond) {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename DoT, typename CondT> struct do_composite {
...
////////////////////////////////////
template <typename DoT> struct do_gen2 {
...
struct do_gen {
  ...
  template <typename DoT> do_gen2<DoT> operator[](DoT const &do_) const {
...
//////////////////////////////////
template <typename InitT, typename CondT, typename StepT> struct for_gen {
  ...
  operator[](DoT const &do_) const {
    ...
    return result(as_actor<InitT>::convert(init),
