...
//////////////////////////////////
template <typename T> struct unary_operator<negative_op, T> {
...
//////////////////////////////////
template <typename T> struct unary_operator<positive_op, T> {
...
//////////////////////////////////
template <typename T> struct unary_operator<logical_not_op, T> {
...
//////////////////////////////////
template <typename T> struct unary_operator<invert_op, T> {
...
//////////////////////////////////
template <typename T> struct unary_operator<reference_op, T> {
...
//////////////////////////////////
template <typename T> struct unary_operator<dereference_op, T *> {
...
//////////////////////////////////
template <typename T> struct unary_operator<dereference_op, T *const> {
...
//////////////////////////////////
template <> struct unary_operator<dereference_op, nil_t> {
...
//////////////////////////////////
#ifndef __BORLANDC__
template <> struct unary_operator<dereference_op, nil_t const> {
...
//////////////////////////////////
template <typename T> struct unary_operator<pre_incr_op, T> {
...
//////////////////////////////////
template <typename T> struct unary_operator<pre_decr_op, T> {
...
//////////////////////////////////
template <typename T> struct unary_operator<post_incr_op, T> {
...
//////////////////////////////////
template <typename T> struct unary_operator<post_decr_op, T> {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename T> struct rank { static int const value = INT_MAX; };
...
template <> struct rank<::boost::long_long_type> {
  static int const value = 110;
};
template <> struct rank<::boost::ulong_long_type> {
...
template <typename T> struct rank<T *> { static int const value = 160; };

template <typename T> struct rank<T *const> { static int const value = 160; };
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename T0, typename T1> struct higher_rank {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename TagT, typename T0, typename T1> struct binary_operator;

//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<assign_op, T0, T1> {
...
//////////////////////////////////
template <typename T1> struct binary_operator<index_op, nil_t, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<index_op, T0 *, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<plus_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<minus_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<times_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<divide_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<mod_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<and_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<or_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<xor_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<shift_l_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<shift_r_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<eq_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<not_eq_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<lt_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<lt_eq_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<gt_op, T0, T1> {
...
//////////////////////////////////
template <typename T0, typename T1> struct binary_operator<gt_eq_op, T0, T1> {
...
struct negative_op {
  ...
  template <typename T0> struct result {
...
struct divide_assign_op {
  ...
  template <typename T0, typename T1> struct result {
    ...
    typedef
        typename binary_operator<divide_assign_op, T0, T1>::result_type type;
  };
...
struct shift_l_assign_op {
  ...
  template <typename T0, typename T1> struct result {
    ...
    typedef
        typename binary_operator<shift_l_assign_op, T0, T1>::result_type type;
  };
...
struct shift_r_assign_op {
  ...
  template <typename T0, typename T1> struct result {
    ...
    typedef
        typename binary_operator<shift_r_assign_op, T0, T1>::result_type type;
  };
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename A0, typename A1> struct logical_and_composite {

  typedef logical_and_composite<A0, A1> self_t;

  template <typename TupleT> struct result {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename A0, typename A1> struct logical_or_composite {
