...
//
///////////////////////////////////////////////////////////////////////////////
template <typename TupleT> struct unpack_tuple : public TupleT {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename ActorT, typename TupleT> struct actor_result {
...
template <typename BaseT> struct actor : public BaseT {
  ...
  typename actor_result<
      BaseT, tuple<A &, B &, C &, D &, E &, F &, G &, H &, I &>>::type
  ...
  typename actor_result<
      BaseT, tuple<A &, B &, C &, D &, E &, F &, G &, H &, I &, J &>>::type
  ...
  typename actor_result<BaseT, tuple<A &, B &, C &, D &, E &, F &, G &, H &,
                                     I &, J &, K &, L &>>::type
  operator()(A &a, B &b, C &c, D &d, E &e, F &f, G &g, H &h, I &i, J &j, K &k,
             L &l) const;
...
//////////////////////////////////
template <typename BaseT> struct as_actor<actor<BaseT>> {
...
//////////////////////////////////
template <> struct as_actor<nil_t> {
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename BaseT> actor<BaseT>::actor() : BaseT() {}
...
inline
    ...
    actor<BaseT>::operator()(A &a_, B &b_, C &c_, D &d_, E &e_, F &f_, G &g_,
                             H &h_) const {
  return BaseT::eval(tuple<A &, B &, C &, D &, E &, F &, G &, H &>(
...
inline typename actor_result<
    BaseT, tuple<A &, B &, C &, D &, E &, F &, G &, H &, I &>>::type
actor<BaseT>::operator()(A &a_, B &b_, C &c_, D &d_, E &e_, F &f_, G &g_, H &h_,
                         I &i_) const {
...
template <typename A, typename B, typename C, typename D, typename E,
          typename F, typename G, typename H, typename I, typename J,
          typename K, typename L>
inline typename actor_result<BaseT, tuple<A &, B &, C &, D &, E &, F &, G &,
                                          H &, I &, J &, K &, L &>>::type
actor<BaseT>::operator()(A &a_, B &b_, C &c_, D &d_, E &e_, F &f_, G &g_, H &h_,
                         I &i_, J &j_, K &k_, L &l_) const {
  return BaseT::eval(
...
inline typename actor_result<BaseT, tuple<A &, B &, C &, D &, E &, F &, G &,
                                          H &, I &, J &, K &, L &, M &>>::type
actor<BaseT>::operator()(A &a_, B &b_, C &c_, D &d_, E &e_, F &f_, G &g_, H &h_,
                         I &i_, J &j_, K &k_, L &l_, M &m_) const {
  return BaseT::eval(
...
inline
  ...
  return BaseT::eval(
      tuple<A &, B &, C &, D &, E &, F &, G &, H &, I &, J &, K &, L &, M &,
            N &>(a_, b_, c_, d_, e_, f_, g_, h_, i_, j_, k_, l_, m_, n_));
}
