...
template <typename T> struct access<T &> {
...
//
///////////////////////////////////////////////////////////////////////////////
template <int N, typename TupleT> struct tuple_element {
  typedef nil_t type;
  typedef nil_t &rtype;
...
//////////////////////////////////
template <typename TupleT> struct tuple_element<0, TupleT> {
...
//////////////////////////////////
template <typename TupleT> struct tuple_element<1, TupleT> {
...
//////////////////////////////////
template <typename TupleT> struct tuple_element<2, TupleT> {
...
#if PHOENIX_LIMIT > 3
//////////////////////////////////
template <typename TupleT> struct tuple_element<3, TupleT> {
...
//////////////////////////////////
template <typename TupleT> struct tuple_element<4, TupleT> {
...
//////////////////////////////////
template <typename TupleT> struct tuple_element<5, TupleT> {
...
#if PHOENIX_LIMIT > 6
//////////////////////////////////
template <typename TupleT> struct tuple_element<6, TupleT> {
...
//////////////////////////////////
template <typename TupleT> struct tuple_element<7, TupleT> {
...
//////////////////////////////////
template <typename TupleT> struct tuple_element<8, TupleT> {
...
#if PHOENIX_LIMIT > 9
//////////////////////////////////
template <typename TupleT> struct tuple_element<9, TupleT> {
...
//////////////////////////////////
template <typename TupleT> struct tuple_element<10, TupleT> {
...
//////////////////////////////////
template <typename TupleT> struct tuple_element<11, TupleT> {
...
#if PHOENIX_LIMIT > 12
//////////////////////////////////
template <typename TupleT> struct tuple_element<12, TupleT> {
...
//////////////////////////////////
template <typename TupleT> struct tuple_element<13, TupleT> {
...
//////////////////////////////////
template <typename TupleT> struct tuple_element<14, TupleT> {
...
//
///////////////////////////////////////////////////////////////////////////////
template <int N> struct tuple_index {};
...
//
///////////////////////////////////////////////////////////////////////////////
template <typename DerivedT> struct tuple_base {
...
//
///////////////////////////////////////////////////////////////////////////////
template <> struct tuple<> : public tuple_base<tuple<>> {
