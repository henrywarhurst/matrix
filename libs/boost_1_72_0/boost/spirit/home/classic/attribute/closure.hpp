...
public:
  typedef typename ::phoenix::tuple_element<0, typename ClosureT::tuple_t>::type
      attr_t;
...
struct closure : public ::phoenix::closure<T0, T1, T2
  ...
  template <typename DerivedT2> struct aux {
    ...
    init_closure_parser<DerivedT2,
                        ::phoenix::tuple<typename ::phoenix::as_actor<A>::type>>
    operator()(A const &a) const {
      ...
      return init_closure_parser<DerivedT2, actor_tuple_t>(
          aux_derived(), actor_tuple_t(::phoenix::as_actor<A>::convert(a)));
    }
    ...
    operator()(A const &a, B const &b, C const &c, D const &d, E const &e,
      ...
      typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t>
          actor_tuple_t;
    ...
    operator()(A const &a, B const &b, C const &c, D const &d, E const &e,
      ...
      typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t>
          actor_tuple_t;
...
//
///////////////////////////////////////////////////////////////////////////
template <typename ActorT> struct container_begin {
  typedef container_begin<ActorT> self_t;

  template <typename TupleT> struct result {
    typedef
        typename ::phoenix::actor_result<ActorT, TupleT>::plain_type::iterator
            type;
  };
...
template <typename ActorT> struct container_end {
  typedef container_begin<ActorT> self_t;
