...
struct reskip_directive : unary_parser<Subject, reskip_directive<Subject>> {
  ...
  reskip_directive(Subject const &subject) : base_type(subject) {}
...
struct skip_directive
    : unary_parser<Subject, skip_directive<Subject, Skipper>> {
  ...
  skip_directive(Subject const &subject, Skipper const &skipper)
      : base_type(subject), skipper(skipper) {}
...
struct reskip_gen {
  template <typename Skipper> struct skip_gen {
    skip_gen(Skipper const &skipper) : skipper_(skipper) {}
