...
inline bool parse_main(Iterator &first, Iterator last, Parser const &p,
                       Attribute &attr) {
...
template <typename Iterator, typename Parser, typename Skipper,
          typename Attribute>
inline bool phrase_parse_main(Iterator &first, Iterator last, Parser const &p,
                              Skipper const &s, Attribute &attr,
...
template <typename Iterator, typename Parser, typename Skipper,
          typename Attribute>
inline bool phrase_parse(Iterator &first, Iterator last, Parser const &p,
                         Skipper const &s, Attribute &attr,
                         skip_flag post_skip = skip_flag::post_skip) {
...
template <typename Iterator, typename Parser, typename Skipper,
          typename Attribute>
inline bool phrase_parse(Iterator const &first_, Iterator last, Parser const &p,
                         Skipper const &s, Attribute &attr,
                         skip_flag post_skip = skip_flag::post_skip) {
  Iterator first = first_;
  return phrase_parse_main(first, last, p, s, attr, post_skip);
...
///////////////////////////////////////////////////////////////////////////
template <typename Skipper> struct phrase_parse_context {
  typedef decltype(
      make_context<skipper_tag>(as_parser(std::declval<Skipper>()))) type;
};
} // namespace x3
} // namespace spirit
} // namespace boost
