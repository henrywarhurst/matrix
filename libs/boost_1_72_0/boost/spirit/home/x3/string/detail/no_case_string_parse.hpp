...
namespace x3 {
namespace detail {
template <typename Char, typename Encoding> struct no_case_string {
  typedef std::basic_string<Char> string_type;
  typedef typename string_type::const_iterator const_iterator;

  no_case_string(char_type const *str) : lower(str), upper(str) {
...
inline bool no_case_string_parse(String const &str, Iterator &first,
