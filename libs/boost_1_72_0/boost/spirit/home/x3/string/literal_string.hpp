...
struct literal_string : parser<literal_string<String, Encoding, Attribute>> {
  ...
  literal_string(
      typename add_reference<typename add_const<String>::type>::type str)
      : str(str) {}
...
namespace extension {
template <int N> struct as_parser<char[N]> {
  typedef literal_string<char const *, char_encoding::standard, unused_type>
      type;
...
template <int N> struct as_parser<char const[N]> : as_parser<char[N]> {};

#ifndef BOOST_SPIRIT_NO_STANDARD_WIDE
template <int N> struct as_parser<wchar_t[N]> {
  typedef literal_string<wchar_t const *, char_encoding::standard_wide,
                         unused_type>
      type;
...
template <int N> struct as_parser<wchar_t const[N]> : as_parser<wchar_t[N]> {};
#endif

template <> struct as_parser<char const *> {
  typedef literal_string<char const *, char_encoding::standard, unused_type>
      type;
...
template <typename Char> struct as_parser<std::basic_string<Char>> {
  typedef literal_string<Char const *, char_encoding::standard, unused_type>
      type;
...
struct get_info<literal_string<String, Encoding, Attribute>> {
  ...
  std::string
  operator()(literal_string<String, Encoding, Attribute> const &p) const {
