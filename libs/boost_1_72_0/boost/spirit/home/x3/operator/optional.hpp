...
struct optional : proxy<Subject, optional<Subject>> {
  ...
  optional(Subject const &subject) : base_type(subject) {}
  ...
  bool parse_subject(Iterator &first, Iterator const &last,
                     ...
                     Attribute &attr, traits::container_attribute) const {
    detail::parse_into_container(this->subject, first, last, context, rcontext,
                                 attr);
    return true;
  }
  ...
  bool parse_subject(Iterator &first, Iterator const &last,
                     Context const &context, RContext &rcontext,
                     Attribute &attr, traits::optional_attribute) const {
