...
inline literal_char<char_encoding::standard, unused_type> lit(char ch) {
  return {ch};
}

inline literal_char<char_encoding::standard, unused_type> lit(wchar_t ch) {
  return {ch};
}
...
inline literal_char<char_encoding::standard_wide, unused_type> lit(wchar_t ch) {
  return {ch};
}
} // namespace standard_wide
#endif
...
inline literal_char<char_encoding::ascii, unused_type> lit(char ch) {
  return {ch};
}

inline literal_char<char_encoding::ascii, unused_type> lit(wchar_t ch) {
  return {ch};
}
} // namespace ascii
...
inline literal_char<char_encoding::iso8859_1, unused_type> lit(char ch) {
  return {ch};
}

inline literal_char<char_encoding::iso8859_1, unused_type> lit(wchar_t ch) {
  return {ch};
}
} // namespace iso8859_1
