...
template <typename T> inline bool scale(int exp, T &n) {
...
template <typename T> inline bool scale(int exp, int frac, T &n) {
...
inline float negate(bool neg, float n) { return neg ? x3::changesign(n) : n; }

inline double negate(bool neg, double n) { return neg ? x3::changesign(n) : n; }

inline long double negate(bool neg, long double n) {
  return neg ? x3::changesign(n) : n;
}

template <typename T> inline T negate(bool neg, T const &n) {
  return neg ? -n : n;
}
...
namespace spirit {
namespace x3 {
template <typename T, typename RealPolicies> struct extract_real {
