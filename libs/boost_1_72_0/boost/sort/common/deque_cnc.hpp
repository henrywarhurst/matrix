...
/// @remarks
//---------------------------------------------------------------------------
template <typename T, typename Allocator = std::allocator<T>> class deque_cnc {
public:
  //-----------------------------------------------------------------------
...
public:
  ...
  ///         false - Empty tree
  //------------------------------------------------------------------------
  bool pop_copy_back(value_type &P) { //-------------------------- begin
                                      //-----------------------------
    std::lock_guard<spinlock> S(spl);
    if (dq.size() == 0)
      return false;
  ...
  ///         false - Empty tree
  //------------------------------------------------------------------------
  bool pop_move_back(value_type &P) { //-------------------------- begin
                                      //-----------------------------
    std::lock_guard<spinlock> S(spl);
    if (dq.size() == 0)
      return false;
  ...
  ///         false - Empty tree
  //-----------------------------------------------------------------------
  bool pop_copy_front(value_type &P) { //-------------------------- begin
                                       //-----------------------------
    std::lock_guard<spinlock> S(spl);
    if (dq.size() == 0)
      return false;
  ...
  ///         false - Empty tree
  //------------------------------------------------------------------------
  bool pop_move_front(value_type &P) { //-------------------------- begin
                                       //-----------------------------
    std::lock_guard<spinlock> S(spl);
    if (dq.size() == 0)
      return false;
