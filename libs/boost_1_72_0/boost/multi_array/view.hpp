...
class const_multi_array_view
  ...
  typedef boost::detail::multi_array::multi_array_impl_base<T, NumDims>
      super_type;
...
public:
  ...
  const_multi_array_view(const const_multi_array_view<T, NumDims, OPtr> &other)
  ...
  template <typename OPtr>
  bool operator==(const const_multi_array_view<T, NumDims, OPtr> &rhs) const {
...
public: // should be protected
  ...
  explicit const_multi_array_view(TPtr base, const ExtentList &extents,
    ...
    boost::detail::multi_array::copy_n(extents.begin(), NumDims,
                                       extent_list_.begin());
    boost::detail::multi_array::copy_n(strides.begin(), NumDims,
                                       stride_list_.begin());
...
public:
  ...
  // see generate_array_view in base.hpp
  template <int NDims>
  typename array_view<NDims>::type operator[](
      const boost::detail::multi_array::index_gen<NumDims, NDims> &indices) {
...
public: // should be private
  ...
  template <typename ExtentList, typename Index>
  explicit multi_array_view(T *base, const ExtentList &extents,
                            const boost::array<Index, NumDims> &strides)
