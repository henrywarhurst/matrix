...
public:
  ...
  const_reference operator[](index idx) const {
    return super_type::access(boost::type<const_reference>(), idx, base_,
  ...
  size_type num_elements() const {
    return std::accumulate(shape(), shape() + num_dimensions(), size_type(1),
...
public: // Should be protected
  ...
  const_sub_array(TPtr base, const size_type *extents, const index *strides,
...
public:
  ...
  reference operator[](index idx) {
    return super_type::access(boost::type<reference>(), idx, this->base_,
...
public: // should be private
  ...
  sub_array(T *base, const size_type *extents, const index *strides,
            const index *index_base)
