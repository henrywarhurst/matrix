...
class token_iterator
  ...
  template <class Other> bool equal(const Other &a) const {
...
public:
  ...
  token_iterator(
      ...
      : f_(t.tokenizer_function()), begin_(t.base()), end_(t.end()),
        valid_(!t.at_end()), tok_(t.current_token()) {}
...
make_token_iterator(Iterator begin, Iterator end, const TokenizerFunc &fun) {
  typedef typename token_iterator_generator<TokenizerFunc, Iterator, Type>::type
      ret_type;
