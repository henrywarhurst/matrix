...
template <typename T> struct is_rvalue_reference_member;
...
template <typename T> struct is_rvalue_reference_member_v {
...
`is_rvalue_reference_member_v<T>` is equivalent to
