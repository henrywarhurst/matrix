...
template <typename T>
struct add_transaction_safe_impl<
    T, typename std::is_same<add_transaction_safe_t<T>, detail::dummy>::type> {
...
template <typename T>
struct add_transaction_safe : detail::add_transaction_safe_impl<T> {};
