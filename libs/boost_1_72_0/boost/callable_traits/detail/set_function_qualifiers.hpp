...
#define BOOST_CLBL_TRTS_SET_FUNCTION_QUALIFIERS(QUAL)                          \
  ...
  struct set_function_qualifiers_t<flag_map<int QUAL>::value, false, false,    \
                                   Return, Args...> {                          \
    using type = Return(Args...) QUAL;                                         \
  };                                                                           \
                                                                               \
  template <typename Return, typename... Args>                                 \
  struct set_function_qualifiers_t<flag_map<int QUAL>::value, true, false,     \
                                   Return, Args...> {                          \
    using type =                                                               \
        Return(Args...) QUAL BOOST_CLBL_TRTS_TRANSACTION_SAFE_SPECIFIER;       \
  };                                                                           \
                                                                               \
  template <typename Return, typename... Args>                                 \
  struct set_function_qualifiers_t<flag_map<int QUAL>::value, false, true,     \
                                   Return, Args...> {                          \
    using type = Return(Args...) QUAL BOOST_CLBL_TRTS_NOEXCEPT_SPECIFIER;      \
  };                                                                           \
                                                                               \
  template <typename Return, typename... Args>                                 \
  struct set_function_qualifiers_t<flag_map<int QUAL>::value, true, true,      \
                                   Return, Args...> {                          \
    using type =                                                               \
        Return(Args...) QUAL BOOST_CLBL_TRTS_TRANSACTION_SAFE_SPECIFIER        \
        BOOST_CLBL_TRTS_NOEXCEPT_SPECIFIER;                                    \
                                                                               ...
                                                                               \
  template <typename Return, typename... Args>                                 \
  struct set_varargs_function_qualifiers_t<flag_map<int QUAL>::value, false,   \
                                           false, Return, Args...> {           \
    using type = Return(Args..., ...) QUAL;                                    \
  };                                                                           \
                                                                               \
  template <typename Return, typename... Args>                                 \
  struct set_varargs_function_qualifiers_t<flag_map<int QUAL>::value, true,    \
                                           false, Return, Args...> {           \
    using type = Return(Args...,                                               \
                        ...) QUAL BOOST_CLBL_TRTS_TRANSACTION_SAFE_SPECIFIER;  \
  };                                                                           \
                                                                               \
  template <typename Return, typename... Args>                                 \
  struct set_varargs_function_qualifiers_t<flag_map<int QUAL>::value, false,   \
