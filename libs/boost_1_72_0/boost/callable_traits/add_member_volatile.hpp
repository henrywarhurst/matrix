...
//<-
    ...
    detail::sfinae_try<
        ...
        detail::fail_if_invalid<typename detail::traits<T>::add_member_volatile,
...
template <typename T>
struct add_member_volatile_impl<
    T, typename std::is_same<add_member_volatile_t<T>, detail::dummy>::type> {
...
[table
    ...
    [[`int(foo::*)() transaction_safe`] [`int(foo::*)() volatile
transaction_safe`]]
