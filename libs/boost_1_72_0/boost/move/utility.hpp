...
//! \file
//! This header includes core utilities from
//! <tt><boost/move/utility_core.hpp></tt> and defines some more advanced
//! utilities such as:
...
BOOST_MOVE_FORCEINLINE typename ::boost::move_detail::enable_if_c<
    ...
    typename ::boost::move_detail::add_const<T>::type &>::type
...
BOOST_MOVE_FORCEINLINE typename ::boost::move_detail::enable_if_c<
    enable_move_utility_emulation<T>::value &&
        has_move_emulation_enabled<T>::value && ::boost::move_detail::
            is_nothrow_move_constructible_or_uncopyable<T>::value,
    rv<T> &>::type
move_if_noexcept(T &x) BOOST_NOEXCEPT {
