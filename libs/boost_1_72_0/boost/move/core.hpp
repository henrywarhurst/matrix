...
template <class T> struct is_not_rv {
...
template <class T> struct has_move_emulation_disabled {
...
template <class T> struct forward_type<boost::rv<T>> { typedef T type; };
...
template <class T> struct has_move_emulation_enabled {
