...
// BOOST_MOVE_HAS_TRIVIAL_CONSTRUCTOR(T) should evaluate to true if "T x;" has
// no effect BOOST_MOVE_HAS_TRIVIAL_COPY(T) should evaluate to true if T(t) <==>
// memcpy (Note: this trait does not guarantee T is copy constructible, the copy
// constructor could be deleted but still be trivial)
// BOOST_MOVE_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T) should evaluate to true if
// T(boost::move(t)) <==> memcpy BOOST_MOVE_HAS_TRIVIAL_ASSIGN(T) should
// evaluate to true if t = u <==> memcpy (Note: this trait does not guarantee T
// is assignable , the copy assignmen could be deleted but still be trivial)
// BOOST_MOVE_HAS_TRIVIAL_MOVE_ASSIGN(T) should evaluate to true if t =
// boost::move(u) <==> memcpy BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR(T) should
// evaluate to true if ~T() has no effect BOOST_MOVE_HAS_NOTHROW_CONSTRUCTOR(T)
...
// throw BOOST_MOVE_IS_ENUM(T) should evaluate to true it t is a union type.
//
// The following can also be defined: when detected our implementation is
// greatly simplified.
//
// BOOST_ALIGNMENT_OF(T) should evaluate to the alignment requirements of type
// T.
...
#define BOOST_MOVE_HAS_TRIVIAL_CONSTRUCTOR(T)                                  \
  BOOST_STD_EXTENSION_NAMESPACE::has_trivial_default_ctor<T>::value
#define BOOST_MOVE_HAS_TRIVIAL_COPY(T)                                         \
  BOOST_STD_EXTENSION_NAMESPACE::has_trivial_copy_ctor<T>::value
#define BOOST_MOVE_HAS_TRIVIAL_ASSIGN(T)                                       \
  BOOST_STD_EXTENSION_NAMESPACE::has_trivial_assignment<T>::value
#define BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR(T)                                   \
  BOOST_STD_EXTENSION_NAMESPACE::has_trivial_dtor<T>::value
#endif
...
#define BOOST_MOVE_HAS_TRIVIAL_ASSIGN(T)                                       \
  (__has_trivial_assign(T) || ::boost::move_detail::is_pod<T>::value)
#define BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR(T)                                   \
  (__has_trivial_destructor(T) || ::boost::move_detail::is_pod<T>::value)
#define BOOST_MOVE_HAS_NOTHROW_CONSTRUCTOR(T)                                  \
  (__has_nothrow_constructor(T) ||                                             \
   ::boost::move_detail::is_trivially_default_constructible<T>::value)
#define BOOST_MOVE_HAS_NOTHROW_COPY(T)                                         \
  (__has_nothrow_copy(T) ||                                                    \
   ::boost::move_detail::is_trivially_copy_constructible<T>::value)
#define BOOST_MOVE_HAS_NOTHROW_ASSIGN(T)                                       \
...
#define BOOST_MOVE_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T)                             \
  (__has_trivial_move_constructor(T) || ::boost::move_detail::is_pod<T>::value)
#define BOOST_MOVE_HAS_TRIVIAL_MOVE_ASSIGN(T)                                  \
  (__has_trivial_move_assign(T) || ::boost::move_detail::is_pod<T>::value)
#endif
#endif
...
#define BOOST_MOVE_IS_UNION(T) __is_union(T)
     ...
     (__GLIBCXX__ >= 20080306 && __GLIBCXX__ != 20080519)) &&                  \
    __has_feature(is_pod)
...
#define BOOST_MOVE_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T)                             \
  __has_trivial_move_constructor(T)
#endif
...
#define BOOST_MOVE_HAS_TRIVIAL_COPY(T)                                         \
  ((__has_trivial_copy(T) BOOST_MOVE_INTEL_TT_OPTS))
#define BOOST_MOVE_HAS_TRIVIAL_ASSIGN(T)                                       \
  ((__has_trivial_assign(T) BOOST_MOVE_INTEL_TT_OPTS))
#define BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR(T)                                   \
  (__has_trivial_destructor(T) BOOST_MOVE_INTEL_TT_OPTS)
#define BOOST_MOVE_HAS_NOTHROW_CONSTRUCTOR(T)                                  \
  (__has_nothrow_constructor(T) BOOST_MOVE_INTEL_TT_OPTS)
#define BOOST_MOVE_HAS_NOTHROW_COPY(T)                                         \
  ((__has_nothrow_copy(T) BOOST_MOVE_INTEL_TT_OPTS))
#define BOOST_MOVE_HAS_NOTHROW_ASSIGN(T)                                       \
  ((__has_nothrow_assign(T) BOOST_MOVE_INTEL_TT_OPTS))
...
#define BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR(T) (__has_trivial_destructor(T))
#define BOOST_MOVE_HAS_NOTHROW_CONSTRUCTOR(T)                                  \
  (__has_nothrow_default_constructor(T))
...
// in some compilers the intrinsic is limited to class types so add scalar and
// void
#define BOOST_MOVE_IS_POD_IMPL(T)                                              \
  (::boost::move_detail::is_scalar<T>::value ||                                \
   ::boost::move_detail::is_void<T>::value || BOOST_MOVE_IS_POD(T))
#else
#define BOOST_MOVE_IS_POD_IMPL(T)                                              \
  (::boost::move_detail::is_scalar<T>::value ||                                \
...
#define BOOST_MOVE_IS_EMPTY_IMPL(T)                                            \
  ::boost::move_detail::is_empty_nonintrinsic<T>::value
#endif
...
#define BOOST_MOVE_IS_TRIVIALLY_MOVE_CONSTRUCTIBLE(T)                          \
  BOOST_MOVE_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T)
#else
#define BOOST_MOVE_IS_TRIVIALLY_MOVE_CONSTRUCTIBLE(T)                          \
  ::boost::move_detail::is_pod<T>::value
#endif
...
#define BOOST_MOVE_IS_TRIVIALLY_MOVE_ASSIGNABLE(T)                             \
  BOOST_MOVE_HAS_TRIVIAL_MOVE_ASSIGN(T)
#else
#define BOOST_MOVE_IS_TRIVIALLY_MOVE_ASSIGNABLE(T)                             \
  ::boost::move_detail::is_pod<T>::value
#endif
...
#define BOOST_MOVE_IS_NOTHROW_COPY_ASSIGNABLE(T)                               \
  BOOST_MOVE_HAS_NOTHROW_ASSIGN(T)
#else
#define BOOST_MOVE_IS_NOTHROW_COPY_ASSIGNABLE(T)                               \
  ::boost::move_detail::is_pod<T>::value
#endif
...
#define BOOST_MOVE_IS_NOTHROW_MOVE_ASSIGNABLE(T)                               \
  BOOST_MOVE_HAS_NOTHROW_MOVE_ASSIGN(T)
#else
#define BOOST_MOVE_IS_NOTHROW_MOVE_ASSIGNABLE(T)                               \
  ::boost::move_detail::is_pod<T>::value
#endif
...
#define BOOST_MOVE_IS_ENUM_IMPL(T)                                             \
  ::boost::move_detail::is_enum_nonintrinsic<T>::value
#endif
...
template <> struct unvoid_ref<const volatile void> {
...
//    add_const_reference
//////////////////////////
template <class T> struct add_const_reference { typedef const T &type; };

template <class T> struct add_const_reference<T &> { typedef T &type; };

//////////////////////////
//    add_const_if_c
//////////////////////////
template <class T, bool Add>
struct add_const_if_c : if_c<Add, typename add_const<T>::type, T> {};
...
//    make_unsigned
//////////////////////////
template <class T> struct make_unsigned_impl { typedef T type; };
template <> struct make_unsigned_impl<signed char> {
  typedef unsigned char type;
};
template <> struct make_unsigned_impl<signed short> {
  typedef unsigned short type;
};
template <> struct make_unsigned_impl<signed int> {
  typedef unsigned int type;
};
template <> struct make_unsigned_impl<signed long> {
  typedef unsigned long type;
};
#ifdef BOOST_HAS_LONG_LONG
template <> struct make_unsigned_impl<::boost::long_long_type> {
  typedef ::boost::ulong_long_type type;
};
#endif

template <class T>
struct make_unsigned : make_unsigned_impl<typename remove_cv<T>::type> {};

//////////////////////////
//    is_floating_point
//////////////////////////
template <class T> struct is_floating_point_cv {
  static const bool value = false;
};
template <> struct is_floating_point_cv<float> {
  static const bool value = true;
};
template <> struct is_floating_point_cv<double> {
  static const bool value = true;
};
template <> struct is_floating_point_cv<long double> {
  static const bool value = true;
};

template <class T>
struct is_floating_point : is_floating_point_cv<typename remove_cv<T>::type> {};
...
template <> struct is_integral_cv<unsigned char> {
  static const bool value = true;
};
template <> struct is_integral_cv<signed char> {
  static const bool value = true;
};
...
template <> struct is_integral_cv<unsigned short> {
  static const bool value = true;
};
template <> struct is_integral_cv<int> { static const bool value = true; };
template <> struct is_integral_cv<unsigned int> {
  static const bool value = true;
};
template <> struct is_integral_cv<long> { static const bool value = true; };
template <> struct is_integral_cv<unsigned long> {
  static const bool value = true;
};
#ifdef BOOST_HAS_LONG_LONG
template <> struct is_integral_cv<::boost::long_long_type> {
  static const bool value = true;
};
template <> struct is_integral_cv<::boost::ulong_long_type> {
  static const bool value = true;
};
#endif

template <class T>
struct is_integral : public is_integral_cv<typename remove_cv<T>::type> {};
...
//       is_void
//////////////////////////
template <class T> struct is_void_cv { static const bool value = false; };

template <> struct is_void_cv<void> { static const bool value = true; };

template <class T> struct is_void : is_void_cv<typename remove_cv<T>::type> {};
...
//           is_member_pointer
//////////////////////////////////////
template <class T> struct is_member_pointer_cv {
  static const bool value = false;
};
template <class T, class U> struct is_member_pointer_cv<T U::*> {
  static const bool value = true;
};

template <class T>
struct is_member_pointer : is_member_pointer_cv<typename remove_cv<T>::type> {};

//////////////////////////////////////
//          is_nullptr_t
//////////////////////////////////////
template <class T> struct is_nullptr_t_cv { static const bool value = false; };
...
template <class T>
struct is_nullptr_t : is_nullptr_t_cv<typename remove_cv<T>::type> {};
...
// converted to a prvalue pointer to that function. This does not apply to
// non-static member functions because lvalues that refer to non-static member
// functions do not exist.
template <class T> struct is_reference_convertible_to_pointer {
  struct twochar {
    char dummy[2];
  };
...
template <class T> struct is_function_impl<T, true> {
  static const bool value = false;
};

template <class T> struct is_function : is_function_impl<T> {};

//////////////////////////////////////
//       is_union
//////////////////////////////////////
template <class T> struct is_union_noextents_cv {
  static const bool value = BOOST_MOVE_IS_UNION_IMPL(T);
};

template <class T>
struct is_union
    : is_union_noextents_cv<
...
template <class T> struct is_arithmetic {
  static const bool value =
      is_floating_point<T>::value || is_integral<T>::value;
};

//////////////////////////////////////
//    is_member_function_pointer
//////////////////////////////////////
template <class T> struct is_member_function_pointer_cv {
  static const bool value = false;
};

template <class T, class C>
struct is_member_function_pointer_cv<T C::*> : is_function<T> {};
...
template <typename T> struct is_empty_nonintrinsic<T, true> {
  static const bool value =
...
template <class T> struct has_boost_move_no_copy_constructor_or_assign_type {
  template <class U>
...
//////////////////////////////////////
    ...
    !defined(BOOST_NO_CXX11_DECLTYPE) && !defined(BOOST_INTEL_CXX_VERSION) &&  \
    !(defined(BOOST_MSVC) && _MSC_VER == 1800)
#define BOOST_MOVE_TT_CXX11_IS_COPY_CONSTRUCTIBLE
#endif

template <class T> struct is_copy_constructible {
// Intel compiler has problems with SFINAE for copy constructors and deleted
// functions:
//
// error: function *function_name* cannot be referenced -- it is a deleted
// function static yes_type test(U&, decltype(U(boost::declval<U&>()))* = 0);
//                                                        ^
// MSVC 12.0 (Visual 2013) has problems when the copy constructor has been
// deleted. See:
...
#else
  template <class U> static yes_type test(U &, decltype(U(source<U>())) * = 0);
#endif
...
//
// error: function *function_name* cannot be referenced -- it is a deleted
// function static boost::type_traits::yes_type test(T1&,
...
template <class T> struct is_trivially_copy_constructible {
  // In several compilers BOOST_MOVE_IS_TRIVIALLY_COPY_CONSTRUCTIBLE return true
  // even with deleted copy constructors so make sure the type is copy
  // constructible.
...
//////////////////////////////////////
template <class T> struct is_nothrow_default_constructible : is_pod<T> {
...
struct alignment_of_impl
    ...
    : alignment_logic<sizeof(alignment_of_hack<T>) - 2 * sizeof(T),
                      __alignof(T)> {
};
...
template <std::size_t Len, std::size_t Align> struct aligned_struct;
...
// Workaround for bogus [-Wignored-attributes] warning on GCC 6.x/7.x: don't use
// a type that "directly" carries the alignment attribute. See
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=82270
template <std::size_t Len, std::size_t Align> union aligned_struct_wrapper {
  aligned_struct<Len, Align> aligner;
  unsigned char data[sizeof(aligned_struct<Len, Align>)];
};

template <std::size_t Len, std::size_t Align> struct aligned_storage_impl {
...
#define BOOST_MOVE_ALIGNED_NEXT_STEP(TYPE, NEXT_TYPE)                          \
  ...
  struct aligned_next<Len, Align, TYPE, false>                                 \
      : aligned_next<Len, Align, NEXT_TYPE,                                    \
                     Align == alignment_of<NEXT_TYPE>::value> {};              \
//
