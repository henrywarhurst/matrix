...
#define BOOST_MOVE_CATCH_CONST(U)                                              \
  typename ::boost::move_detail::if_<::boost::move_detail::is_class<U>,        \
                                     BOOST_CATCH_CONST_RLVALUE(U),             \
                                     const U &>::type
...
#define BOOST_MOVE_CONVERSION_AWARE_CATCH_COMMON(PUB_FUNCTION, TYPE,           \
                                                 RETURN_VALUE, FWD_FUNCTION)   \
  BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(                            \
      BOOST_MOVE_CATCH_CONST(TYPE) x) {                                        \
    return FWD_FUNCTION(static_cast<const TYPE &>(x));                         \
  }                                                                            \
                                                                               \
  BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(                            \
      BOOST_MOVE_CATCH_RVALUE(TYPE) x) {                                       \
...
#define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE,    \
                                          FWD_FUNCTION)                        \
  BOOST_MOVE_CONVERSION_AWARE_CATCH_COMMON(PUB_FUNCTION, TYPE, RETURN_VALUE,   \
                                           FWD_FUNCTION)                       \
                                                                               \
  template <class BOOST_MOVE_TEMPL_PARAM>                                      \
  BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(                            \
      const BOOST_MOVE_TEMPL_PARAM &u,                                         \
      typename boost_move_conversion_aware_catch_1<                            \
          ::boost::move_detail::nat, BOOST_MOVE_TEMPL_PARAM, TYPE>::type * =   \
          0) {                                                                 \
  ...
  BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(                            \
      const BOOST_MOVE_TEMPL_PARAM &u,                                         \
      typename boost_move_conversion_aware_catch_2<                            \
          ::boost::move_detail::nat, BOOST_MOVE_TEMPL_PARAM, TYPE>::type * =   \
          0) {                                                                 \
    TYPE t((u));                                                               \
...
#define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE,    \
  ...
  BOOST_MOVE_FORCEINLINE typename boost_move_conversion_aware_catch_1<         \
      RETURN_VALUE, BOOST_MOVE_TEMPL_PARAM, TYPE>::type                        \
  PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u) {                              \
    return FWD_FUNCTION(u);                                                    \
  }                                                                            \
                                                                               \
  template <class BOOST_MOVE_TEMPL_PARAM>                                      \
  BOOST_MOVE_FORCEINLINE typename boost_move_conversion_aware_catch_2<         \
      RETURN_VALUE, BOOST_MOVE_TEMPL_PARAM, TYPE>::type                        \
  PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u) {                              \
    TYPE t((u));                                                               \
    return FWD_FUNCTION(::boost::move(t));                                     \
...
template <class RETURN_VALUE, class BOOST_MOVE_TEMPL_PARAM,
          class UNLESS_CONVERTIBLE_TO, class TYPE>
struct boost_move_conversion_aware_catch_1arg_1
    : public ::boost::move_detail::enable_if_and<
          RETURN_VALUE,
          ::boost::move_detail::not_<
              ::boost::move_detail::is_same_or_convertible<
                  BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO>>,
          ::boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>,
          ::boost::has_move_emulation_disabled<BOOST_MOVE_TEMPL_PARAM>> {};
...
struct boost_move_conversion_aware_catch_1arg_2
    : public ::boost::move_detail::disable_if_or<
          RETURN_VALUE,
          ::boost::move_detail::is_same_or_convertible<BOOST_MOVE_TEMPL_PARAM,
                                                       UNLESS_CONVERTIBLE_TO>,
          ::boost::move_detail::is_rv_impl<BOOST_MOVE_TEMPL_PARAM>,
          ::boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>> {};

#define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG_COMMON(                         \
    PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1,                      \
    UNLESS_CONVERTIBLE_TO)                                                     \
  BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(                            \
      ARG1 arg1, BOOST_MOVE_CATCH_CONST(TYPE) x) {                             \
    return FWD_FUNCTION(arg1, static_cast<const TYPE &>(x));                   \
  }                                                                            \
                                                                               \
  BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(                            \
      ARG1 arg1, BOOST_MOVE_CATCH_RVALUE(TYPE) x) {                            \
...
//
#if defined(BOOST_MOVE_HELPERS_RETURN_SFINAE_BROKEN)
#define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE,             \
                                               RETURN_VALUE, FWD_FUNCTION,     \
                                               ARG1, UNLESS_CONVERTIBLE_TO)    \
  BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG_COMMON(PUB_FUNCTION, TYPE,            \
                                                RETURN_VALUE, FWD_FUNCTION,    \
                                                ARG1, UNLESS_CONVERTIBLE_TO)   \
                                                                               \
  template <class BOOST_MOVE_TEMPL_PARAM>                                      \
  BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(                            \
      ARG1 arg1, const BOOST_MOVE_TEMPL_PARAM &u,                              \
      typename boost_move_conversion_aware_catch_1arg_1<                       \
          void, BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO, TYPE>::type * = \
          0) {                                                                 \
  ...
  BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(                            \
      ARG1 arg1, const BOOST_MOVE_TEMPL_PARAM &u,                              \
      typename boost_move_conversion_aware_catch_1arg_2<                       \
          void, BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO, TYPE>::type * = \
          0) {                                                                 \
    TYPE t((u));                                                               \
...
#define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE,             \
  ...
  BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG_COMMON(PUB_FUNCTION, TYPE,            \
                                                ...
                                                ARG1, UNLESS_CONVERTIBLE_TO)   \
                                                                               \
  template <class BOOST_MOVE_TEMPL_PARAM>                                      \
  BOOST_MOVE_FORCEINLINE typename boost_move_conversion_aware_catch_1arg_1<    \
      RETURN_VALUE, BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO, TYPE>::type \
  PUB_FUNCTION(ARG1 arg1, const BOOST_MOVE_TEMPL_PARAM &u) {                   \
    return FWD_FUNCTION(arg1, u);                                              \
  }                                                                            \
                                                                               \
  template <class BOOST_MOVE_TEMPL_PARAM>                                      \
  BOOST_MOVE_FORCEINLINE typename boost_move_conversion_aware_catch_1arg_2<    \
      RETURN_VALUE, BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO, TYPE>::type \
  PUB_FUNCTION(ARG1 arg1, const BOOST_MOVE_TEMPL_PARAM &u) {                   \
    TYPE t((u));                                                               \
    return FWD_FUNCTION(arg1, ::boost::move(t));                               \
...
#define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE,             \
  ...
  BOOST_MOVE_FORCEINLINE typename ::boost::move_detail::disable_if_or<         \
      ...
      ::boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>,             \
      ::boost::move_detail::is_same_or_convertible<                            \
          BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO>>::type                \
  PUB_FUNCTION(ARG1 arg1, const BOOST_MOVE_TEMPL_PARAM &u) {                   \
    TYPE t((u));                                                               \
    return FWD_FUNCTION(arg1, ::boost::move(t));                               \
  }                                                                            \
