...
template <class T> struct mref<T &> {
...
#define BOOST_MOVE_DECLVAL2                                                    \
  BOOST_MOVE_DECLVAL1, ::boost::move_detail::declval<P1>()
#define BOOST_MOVE_DECLVAL3                                                    \
  BOOST_MOVE_DECLVAL2, ::boost::move_detail::declval<P2>()
#define BOOST_MOVE_DECLVAL4                                                    \
  BOOST_MOVE_DECLVAL3, ::boost::move_detail::declval<P3>()
#define BOOST_MOVE_DECLVAL5                                                    \
  BOOST_MOVE_DECLVAL4, ::boost::move_detail::declval<P4>()
#define BOOST_MOVE_DECLVAL6                                                    \
  BOOST_MOVE_DECLVAL5, ::boost::move_detail::declval<P5>()
#define BOOST_MOVE_DECLVAL7                                                    \
  BOOST_MOVE_DECLVAL6, ::boost::move_detail::declval<P6>()
#define BOOST_MOVE_DECLVAL8                                                    \
  BOOST_MOVE_DECLVAL7, ::boost::move_detail::declval<P7>()
#define BOOST_MOVE_DECLVAL9                                                    \
  BOOST_MOVE_DECLVAL8, ::boost::move_detail::declval<P8>()

// BOOST_MOVE_DECLVALQN
#define BOOST_MOVE_DECLVALQ0
#define BOOST_MOVE_DECLVALQ1 ::boost::move_detail::declval<Q0>()
#define BOOST_MOVE_DECLVALQ2                                                   \
  BOOST_MOVE_DECLVALQ1, ::boost::move_detail::declval<Q1>()
#define BOOST_MOVE_DECLVALQ3                                                   \
  BOOST_MOVE_DECLVALQ2, ::boost::move_detail::declval<Q2>()
#define BOOST_MOVE_DECLVALQ4                                                   \
  BOOST_MOVE_DECLVALQ3, ::boost::move_detail::declval<Q3>()
#define BOOST_MOVE_DECLVALQ5                                                   \
  BOOST_MOVE_DECLVALQ4, ::boost::move_detail::declval<Q4>()
#define BOOST_MOVE_DECLVALQ6                                                   \
  BOOST_MOVE_DECLVALQ5, ::boost::move_detail::declval<Q5>()
#define BOOST_MOVE_DECLVALQ7                                                   \
  BOOST_MOVE_DECLVALQ6, ::boost::move_detail::declval<Q6>()
#define BOOST_MOVE_DECLVALQ8                                                   \
  BOOST_MOVE_DECLVALQ7, ::boost::move_detail::declval<Q7>()
#define BOOST_MOVE_DECLVALQ9                                                   \
  BOOST_MOVE_DECLVALQ8, ::boost::move_detail::declval<Q8>()
...
#define BOOST_MOVE_FWD_INIT2                                                   \
  BOOST_MOVE_FWD_INIT1, m_p1(::boost::forward<P1>(p1))
#define BOOST_MOVE_FWD_INIT3                                                   \
  BOOST_MOVE_FWD_INIT2, m_p2(::boost::forward<P2>(p2))
#define BOOST_MOVE_FWD_INIT4                                                   \
  BOOST_MOVE_FWD_INIT3, m_p3(::boost::forward<P3>(p3))
#define BOOST_MOVE_FWD_INIT5                                                   \
  BOOST_MOVE_FWD_INIT4, m_p4(::boost::forward<P4>(p4))
#define BOOST_MOVE_FWD_INIT6                                                   \
  BOOST_MOVE_FWD_INIT5, m_p5(::boost::forward<P5>(p5))
#define BOOST_MOVE_FWD_INIT7                                                   \
  BOOST_MOVE_FWD_INIT6, m_p6(::boost::forward<P6>(p6))
#define BOOST_MOVE_FWD_INIT8                                                   \
  BOOST_MOVE_FWD_INIT7, m_p7(::boost::forward<P7>(p7))
#define BOOST_MOVE_FWD_INIT9                                                   \
  BOOST_MOVE_FWD_INIT8, m_p8(::boost::forward<P8>(p8))

// BOOST_MOVE_FWD_INITQN
#define BOOST_MOVE_FWD_INITQ0
#define BOOST_MOVE_FWD_INITQ1 m_q0(::boost::forward<Q0>(q0))
#define BOOST_MOVE_FWD_INITQ2                                                  \
  BOOST_MOVE_FWD_INITQ1, m_q1(::boost::forward<Q1>(q1))
#define BOOST_MOVE_FWD_INITQ3                                                  \
  BOOST_MOVE_FWD_INITQ2, m_q2(::boost::forward<Q2>(q2))
#define BOOST_MOVE_FWD_INITQ4                                                  \
  BOOST_MOVE_FWD_INITQ3, m_q3(::boost::forward<Q3>(q3))
#define BOOST_MOVE_FWD_INITQ5                                                  \
  BOOST_MOVE_FWD_INITQ4, m_q4(::boost::forward<Q4>(q4))
#define BOOST_MOVE_FWD_INITQ6                                                  \
  BOOST_MOVE_FWD_INITQ5, m_q5(::boost::forward<Q5>(q5))
#define BOOST_MOVE_FWD_INITQ7                                                  \
  BOOST_MOVE_FWD_INITQ6, m_q6(::boost::forward<Q6>(q6))
#define BOOST_MOVE_FWD_INITQ8                                                  \
  BOOST_MOVE_FWD_INITQ7, m_q7(::boost::forward<Q7>(q7))
#define BOOST_MOVE_FWD_INITQ9                                                  \
  BOOST_MOVE_FWD_INITQ8, m_q8(::boost::forward<Q8>(q8))
...
#define BOOST_MOVE_UNVOIDCREF(T)                                               \
  const typename boost::move_detail::unvoid<T>::type &
// BOOST_MOVE_CREFN
...
#define BOOST_MOVE_FWD_T2                                                      \
  BOOST_MOVE_FWD_T1, typename ::boost::move_detail::forward_type<P1>::type
#define BOOST_MOVE_FWD_T3                                                      \
  BOOST_MOVE_FWD_T2, typename ::boost::move_detail::forward_type<P2>::type
#define BOOST_MOVE_FWD_T4                                                      \
  BOOST_MOVE_FWD_T3, typename ::boost::move_detail::forward_type<P3>::type
#define BOOST_MOVE_FWD_T5                                                      \
  BOOST_MOVE_FWD_T4, typename ::boost::move_detail::forward_type<P4>::type
#define BOOST_MOVE_FWD_T6                                                      \
  BOOST_MOVE_FWD_T5, typename ::boost::move_detail::forward_type<P5>::type
#define BOOST_MOVE_FWD_T7                                                      \
  BOOST_MOVE_FWD_T6, typename ::boost::move_detail::forward_type<P6>::type
#define BOOST_MOVE_FWD_T8                                                      \
  BOOST_MOVE_FWD_T7, typename ::boost::move_detail::forward_type<P7>::type
#define BOOST_MOVE_FWD_T9                                                      \
  BOOST_MOVE_FWD_T8, typename ::boost::move_detail::forward_type<P8>::type

// BOOST_MOVE_FWD_TQN
#define BOOST_MOVE_FWD_TQ0
#define BOOST_MOVE_FWD_TQ1 typename ::boost::move_detail::forward_type<Q0>::type
#define BOOST_MOVE_FWD_TQ2                                                     \
  BOOST_MOVE_FWD_TQ1, typename ::boost::move_detail::forward_type<Q1>::type
#define BOOST_MOVE_FWD_TQ3                                                     \
  BOOST_MOVE_FWD_TQ2, typename ::boost::move_detail::forward_type<Q2>::type
#define BOOST_MOVE_FWD_TQ4                                                     \
  BOOST_MOVE_FWD_TQ3, typename ::boost::move_detail::forward_type<Q3>::type
#define BOOST_MOVE_FWD_TQ5                                                     \
  BOOST_MOVE_FWD_TQ4, typename ::boost::move_detail::forward_type<Q4>::type
#define BOOST_MOVE_FWD_TQ6                                                     \
  BOOST_MOVE_FWD_TQ5, typename ::boost::move_detail::forward_type<Q5>::type
#define BOOST_MOVE_FWD_TQ7                                                     \
  BOOST_MOVE_FWD_TQ6, typename ::boost::move_detail::forward_type<Q6>::type
#define BOOST_MOVE_FWD_TQ8                                                     \
  BOOST_MOVE_FWD_TQ7, typename ::boost::move_detail::forward_type<Q7>::type
#define BOOST_MOVE_FWD_TQ9                                                     \
  BOOST_MOVE_FWD_TQ8, typename ::boost::move_detail::forward_type<Q8>::type
...
#define BOOST_MOVE_IIF_I(bit, t, f) BOOST_MOVE_IIF_II(BOOST_MOVE_IIF_ ## bit(t,
f)) #define BOOST_MOVE_IIF_II(id) id #define BOOST_MOVE_IIF_0(t, f) f #define
BOOST_MOVE_IIF_1(t, f) t
*/
...
#define BOOST_MOVE_OR_I(x, y)                                                  \
  BOOST_MOVE_BITOR(BOOST_MOVE_BOOL(x), BOOST_MOVE_BOOL(y))
...
#define BOOST_MOVE_AND_I(x, y)                                                 \
  BOOST_MOVE_BITAND(BOOST_MOVE_BOOL(x), BOOST_MOVE_BOOL(y))
...
#define BOOST_MOVE_ITERATE_2TO3(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_2TO2(MACROFUNC) MACROFUNC(3)
#define BOOST_MOVE_ITERATE_2TO4(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_2TO3(MACROFUNC) MACROFUNC(4)
#define BOOST_MOVE_ITERATE_2TO5(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_2TO4(MACROFUNC) MACROFUNC(5)
#define BOOST_MOVE_ITERATE_2TO6(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_2TO5(MACROFUNC) MACROFUNC(6)
#define BOOST_MOVE_ITERATE_2TO7(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_2TO6(MACROFUNC) MACROFUNC(7)
#define BOOST_MOVE_ITERATE_2TO8(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_2TO7(MACROFUNC) MACROFUNC(8)
#define BOOST_MOVE_ITERATE_2TO9(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_2TO8(MACROFUNC) MACROFUNC(9)

// BOOST_MOVE_ITERATE_1TON
#define BOOST_MOVE_ITERATE_1TO1(MACROFUNC) MACROFUNC(1)
#define BOOST_MOVE_ITERATE_1TO2(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_1TO1(MACROFUNC) MACROFUNC(2)
#define BOOST_MOVE_ITERATE_1TO3(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_1TO2(MACROFUNC) MACROFUNC(3)
#define BOOST_MOVE_ITERATE_1TO4(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_1TO3(MACROFUNC) MACROFUNC(4)
#define BOOST_MOVE_ITERATE_1TO5(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_1TO4(MACROFUNC) MACROFUNC(5)
#define BOOST_MOVE_ITERATE_1TO6(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_1TO5(MACROFUNC) MACROFUNC(6)
#define BOOST_MOVE_ITERATE_1TO7(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_1TO6(MACROFUNC) MACROFUNC(7)
#define BOOST_MOVE_ITERATE_1TO8(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_1TO7(MACROFUNC) MACROFUNC(8)
#define BOOST_MOVE_ITERATE_1TO9(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_1TO8(MACROFUNC) MACROFUNC(9)

// BOOST_MOVE_ITERATE_0TON
#define BOOST_MOVE_ITERATE_0TO0(MACROFUNC) MACROFUNC(0)
#define BOOST_MOVE_ITERATE_0TO1(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_0TO0(MACROFUNC) MACROFUNC(1)
#define BOOST_MOVE_ITERATE_0TO2(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_0TO1(MACROFUNC) MACROFUNC(2)
#define BOOST_MOVE_ITERATE_0TO3(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_0TO2(MACROFUNC) MACROFUNC(3)
#define BOOST_MOVE_ITERATE_0TO4(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_0TO3(MACROFUNC) MACROFUNC(4)
#define BOOST_MOVE_ITERATE_0TO5(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_0TO4(MACROFUNC) MACROFUNC(5)
#define BOOST_MOVE_ITERATE_0TO6(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_0TO5(MACROFUNC) MACROFUNC(6)
#define BOOST_MOVE_ITERATE_0TO7(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_0TO6(MACROFUNC) MACROFUNC(7)
#define BOOST_MOVE_ITERATE_0TO8(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_0TO7(MACROFUNC) MACROFUNC(8)
#define BOOST_MOVE_ITERATE_0TO9(MACROFUNC)                                     \
  BOOST_MOVE_ITERATE_0TO8(MACROFUNC) MACROFUNC(9)
...
#define BOOST_MOVE_ITER2DLOW_0TOMAX1(MACROFUNC2D, M)                           \
  BOOST_MOVE_ITER2DLOW_0TOMAX0(MACROFUNC2D, M) MACROFUNC2D(M, 1)
#define BOOST_MOVE_ITER2DLOW_0TOMAX2(MACROFUNC2D, M)                           \
  BOOST_MOVE_ITER2DLOW_0TOMAX1(MACROFUNC2D, M) MACROFUNC2D(M, 2)
#define BOOST_MOVE_ITER2DLOW_0TOMAX3(MACROFUNC2D, M)                           \
  BOOST_MOVE_ITER2DLOW_0TOMAX2(MACROFUNC2D, M) MACROFUNC2D(M, 3)
#define BOOST_MOVE_ITER2DLOW_0TOMAX4(MACROFUNC2D, M)                           \
  BOOST_MOVE_ITER2DLOW_0TOMAX3(MACROFUNC2D, M) MACROFUNC2D(M, 4)
#define BOOST_MOVE_ITER2DLOW_0TOMAX5(MACROFUNC2D, M)                           \
  BOOST_MOVE_ITER2DLOW_0TOMAX4(MACROFUNC2D, M) MACROFUNC2D(M, 5)
#define BOOST_MOVE_ITER2DLOW_0TOMAX6(MACROFUNC2D, M)                           \
  BOOST_MOVE_ITER2DLOW_0TOMAX5(MACROFUNC2D, M) MACROFUNC2D(M, 6)
#define BOOST_MOVE_ITER2DLOW_0TOMAX7(MACROFUNC2D, M)                           \
  BOOST_MOVE_ITER2DLOW_0TOMAX6(MACROFUNC2D, M) MACROFUNC2D(M, 7)
#define BOOST_MOVE_ITER2DLOW_0TOMAX8(MACROFUNC2D, M)                           \
  BOOST_MOVE_ITER2DLOW_0TOMAX7(MACROFUNC2D, M) MACROFUNC2D(M, 8)
#define BOOST_MOVE_ITER2DLOW_0TOMAX9(MACROFUNC2D, M)                           \
  BOOST_MOVE_ITER2DLOW_0TOMAX8(MACROFUNC2D, M) MACROFUNC2D(M, 9)

#define BOOST_MOVE_ITER2D_0TOMAX0(MAX, MACROFUNC2D)                            \
  BOOST_MOVE_ITER2DLOW_0TOMAX##MAX(MACROFUNC2D, 0)
#define BOOST_MOVE_ITER2D_0TOMAX1(MAX, MACROFUNC2D)                            \
  BOOST_MOVE_ITER2D_0TOMAX0(MAX, MACROFUNC2D)                                  \
  BOOST_MOVE_ITER2DLOW_0TOMAX##MAX(MACROFUNC2D, 1)
#define BOOST_MOVE_ITER2D_0TOMAX2(MAX, MACROFUNC2D)                            \
  BOOST_MOVE_ITER2D_0TOMAX1(MAX, MACROFUNC2D)                                  \
  BOOST_MOVE_ITER2DLOW_0TOMAX##MAX(MACROFUNC2D, 2)
#define BOOST_MOVE_ITER2D_0TOMAX3(MAX, MACROFUNC2D)                            \
  BOOST_MOVE_ITER2D_0TOMAX2(MAX, MACROFUNC2D)                                  \
  BOOST_MOVE_ITER2DLOW_0TOMAX##MAX(MACROFUNC2D, 3)
#define BOOST_MOVE_ITER2D_0TOMAX4(MAX, MACROFUNC2D)                            \
  BOOST_MOVE_ITER2D_0TOMAX3(MAX, MACROFUNC2D)                                  \
  BOOST_MOVE_ITER2DLOW_0TOMAX##MAX(MACROFUNC2D, 4)
#define BOOST_MOVE_ITER2D_0TOMAX5(MAX, MACROFUNC2D)                            \
  BOOST_MOVE_ITER2D_0TOMAX4(MAX, MACROFUNC2D)                                  \
  BOOST_MOVE_ITER2DLOW_0TOMAX##MAX(MACROFUNC2D, 5)
#define BOOST_MOVE_ITER2D_0TOMAX6(MAX, MACROFUNC2D)                            \
  BOOST_MOVE_ITER2D_0TOMAX5(MAX, MACROFUNC2D)                                  \
  BOOST_MOVE_ITER2DLOW_0TOMAX##MAX(MACROFUNC2D, 6)
#define BOOST_MOVE_ITER2D_0TOMAX7(MAX, MACROFUNC2D)                            \
  BOOST_MOVE_ITER2D_0TOMAX6(MAX, MACROFUNC2D)                                  \
  BOOST_MOVE_ITER2DLOW_0TOMAX##MAX(MACROFUNC2D, 7)
#define BOOST_MOVE_ITER2D_0TOMAX8(MAX, MACROFUNC2D)                            \
  BOOST_MOVE_ITER2D_0TOMAX7(MAX, MACROFUNC2D)                                  \
  BOOST_MOVE_ITER2DLOW_0TOMAX##MAX(MACROFUNC2D, 8)
#define BOOST_MOVE_ITER2D_0TOMAX9(MAX, MACROFUNC2D)                            \
  BOOST_MOVE_ITER2D_0TOMAX8(MAX, MACROFUNC2D)                                  \
  BOOST_MOVE_ITER2DLOW_0TOMAX##MAX(MACROFUNC2D, 9)

#define BOOST_MOVE_ITER2D_0TOMAX(MAX, MACROFUNC2D)                             \
  BOOST_MOVE_ITER2D_0TOMAX_I(MAX, MACROFUNC2D)
#define BOOST_MOVE_ITER2D_0TOMAX_I(MAX, MACROFUNC2D)                           \
  BOOST_MOVE_ITER2D_0TOMAX##MAX(MAX, MACROFUNC2D)
