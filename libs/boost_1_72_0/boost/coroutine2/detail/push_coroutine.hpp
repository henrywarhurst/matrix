...
private:
  template <typename X> friend class pull_coroutine;
...
public:
  ...
  public:
    ...
    explicit iterator(push_coroutine<T> *c) noexcept : c_{c} {}
...
template <typename T> class push_coroutine<T &> {
private:
  template <typename X> friend class pull_coroutine;
...
template <typename T>
typename push_coroutine<T>::iterator begin(push_coroutine<T> &c) {
  return typename push_coroutine<T>::iterator(&c);
}

template <typename T>
typename push_coroutine<T>::iterator end(push_coroutine<T> &) {
