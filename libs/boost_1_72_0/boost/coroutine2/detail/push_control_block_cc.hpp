...
template <typename T> struct push_coroutine<T>::control_block {
  ...
  control_block(typename pull_coroutine<T>::control_block *,
                boost::context::fiber &) noexcept;
...
struct push_coroutine<void>::control_block {
  ...
  control_block(pull_coroutine<void>::control_block *,
                boost::context::fiber &) noexcept;
