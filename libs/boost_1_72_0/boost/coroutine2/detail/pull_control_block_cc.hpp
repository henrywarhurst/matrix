...
template <typename T> struct pull_coroutine<T>::control_block {
  ...
  control_block(typename push_coroutine<T>::control_block *,
...
struct pull_coroutine<void>::control_block {
  ...
  control_block(push_coroutine<void>::control_block *,
                boost::context::fiber &) noexcept;
