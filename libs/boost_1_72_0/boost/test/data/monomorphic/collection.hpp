...
//!
//! This dataset is applicable to any container implementing a forward iterator.
//! Note that container with one element will be considered as singletons. This
//! dataset is constructible with the @ref boost::unit_test::data::make
//! function.
...
template <typename C> struct is_dataset<collection<C>> : mpl::true_ {};
