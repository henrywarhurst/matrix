...
template <typename T>
inline auto as_tuple_impl_xvalues(T const &arg,
                                  std::false_type /* is_rvalue_ref */)
...
template <typename T>
inline T &&as_tuple_impl(T &&arg, std::true_type /* is_tuple */) {
...
inline auto sample_merge(T1 &&a1, T2 &&a2)
