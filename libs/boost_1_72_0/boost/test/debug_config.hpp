...
//!
//! This file is intended to be edited by end user to specify varios macros,
//! which configure debugger interface Alterntively you can set these parameters
//! in your own sources/makefiles
// ***************************************************************************
