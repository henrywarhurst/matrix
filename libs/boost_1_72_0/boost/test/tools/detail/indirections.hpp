...
//
//  Description : inidiration interfaces to support manipulators and message
//  output
// ***************************************************************************
...
template <typename E> struct assertion_evaluate_t {
...
template <typename E>
inline assertion_evaluate_t<E> assertion_evaluate(E const &e) {
...
inline assertion_evaluate_t<E> operator<<(assertion_evaluate_t<E> const &ae,
                                          T const &) {
  return ae;
}
...
template <typename T>
inline assertion_type operator<<(assertion_type const &at, T const &) {
  return at;
}
