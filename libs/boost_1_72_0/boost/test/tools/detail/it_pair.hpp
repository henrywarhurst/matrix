...
//
//  Description : support for backward compatible collection comparison
//  interface
// ***************************************************************************
...
template <typename It> struct it_pair {
...
template <typename It> it_pair<It> make_it_pair(It const &b, It const &e) {
  return it_pair<It>(b, e);
}

//____________________________________________________________________________//

template <typename T> it_pair<T const *> make_it_pair(T const *b, T const *e) {
  return it_pair<T const *>(b, e);
}
