...
public:
  ...
  readwrite_property<run_status>
      p_default_status; ///< run status obtained by this unit during setup phase
  readwrite_property<run_status>
      p_run_status; ///< run status assigned to this unit before execution phase
  ...
  readwrite_property<decor_list_t>
      p_decorators; ///< automatically assigned decorators; execution is delayed
                    ///< till framework::finalize_setup_phase function
...
public:
  ...
  friend BOOST_TEST_DECL master_test_suite_t &
...
inline test_case *
make_test_case(void (UserTestCase::*test_method)(), const_string tc_name,
