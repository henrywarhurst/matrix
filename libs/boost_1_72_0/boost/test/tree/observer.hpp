...
public:
  ...
  //! incoherent/instable state, the test execution is aborted and all remaining
  //! tests are discarded.
  //!
  ...
  //!
  //! This function is called to signal that a test unit (case or suite) timed
  //! out. A valid test unit is available through
