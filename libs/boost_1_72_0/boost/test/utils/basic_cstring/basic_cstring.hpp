...
public:
  ...
  template <typename LenType> basic_cstring &assign(pointer s, LenType len) {
...
// change the API of cstring using BOOST_TEST_STRING_VIEW as the code should
// remain compatible between boost.test and test module using different compiler
// options.
//! @internal
template <class CharT, class string_view_t = std::basic_string_view<CharT>>
class BOOST_SYMBOL_VISIBLE stringview_cstring_helper
    : public basic_cstring<CharT> {
public:
...
template <typename CharT> CharT basic_cstring<CharT>::null = 0;
...
template <typename CharT> inline bool basic_cstring<CharT>::is_empty() const {
  return m_end == m_begin;
}

//____________________________________________________________________________//

template <typename CharT> inline bool basic_cstring<CharT>::empty() const {
  return is_empty();
}

//____________________________________________________________________________//

template <typename CharT> inline void basic_cstring<CharT>::clear() {
  m_begin = m_end;
}
...
template <typename CharT>
inline basic_cstring<CharT> &basic_cstring<CharT>::assign(pointer f,
                                                          pointer l) {
