...
public:
  ...
  explicit setcolor(bool is_color_output = false,
    ...
    m_command_size =
        std::sprintf(m_control_command, "%c[%c;3%c;4%cm", 0x1B,
                     static_cast<char>(attr + '0'), static_cast<char>(fg + '0'),
...
public:
  ...
  explicit setcolor(bool is_color_output = false,
                    ...
                    term_color::_ fg = term_color::ORIGINAL,
                    term_color::_ bg = term_color::ORIGINAL)
      : m_is_color_output(is_color_output), m_attr(attr), m_fg(fg), m_bg(bg) {}
...
struct scope_setcolor {
  ...
  explicit scope_setcolor(bool is_color_output, std::ostream &os,
                          ...
                          term_color::_ fg = term_color::ORIGINAL,
                          term_color::_ bg = term_color::ORIGINAL)
      : m_os(&os), m_is_color_output(is_color_output) {
...
struct scope_setcolor : setcolor {
  ...
  explicit scope_setcolor(bool is_color_output, std::ostream &os,
                          ...
                          term_color::_ fg = term_color::ORIGINAL,
                          term_color::_ bg = term_color::ORIGINAL)
      : setcolor(is_color_output, attr, fg, bg), m_os(&os) {
    os << *this;
  }
