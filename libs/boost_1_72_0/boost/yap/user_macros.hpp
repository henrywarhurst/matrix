...
/** Defines operator overloads for unary operator \a op_name that each take an
    ...
    ExpressionTemplate.
*/
#define BOOST_YAP_USER_UNARY_OPERATOR(op_name, expr_template,                  \
  ...
  auto operator BOOST_YAP_INDIRECT_CALL(op_name)(                              \
    ...
    using lhs_type = ::boost::yap::detail::operand_type_t<                     \
        result_expr_template, expr_template<Kind, Tuple> const &>;             \
  ...
  auto operator BOOST_YAP_INDIRECT_CALL(op_name)(                              \
    ...
    using lhs_type =                                                           \
        ::boost::yap::detail::operand_type_t<result_expr_template,             \
...
/** Defines operator overloads for binary operator \a op_name that each
    ...
    ExpressionTemplate.
*/
#define BOOST_YAP_USER_BINARY_OPERATOR(op_name, expr_template,                 \
                                       result_expr_template)                   \
  ...
  constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(                    \
      expr_template<Kind, Tuple> &&lhs, Expr &&rhs) {                          \
    using lhs_type =                                                           \
        ::boost::yap::detail::remove_cv_ref_t<expr_template<Kind, Tuple> &&>;  \
    using rhs_type =                                                           \
        ::boost::yap::detail::operand_type_t<result_expr_template, Expr>;      \
    using tuple_type = ::boost::hana::tuple<lhs_type, rhs_type>;               \
    return result_expr_template<::boost::yap::expr_kind::op_name, tuple_type>{ \
  ...
  constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(                    \
      ...
      ->::boost::yap::detail::free_binary_op_result_t<                         \
          result_expr_template, ::boost::yap::expr_kind::op_name, T,           \
          expr_template<Kind, Tuple> &&> {                                     \
...
#define BOOST_YAP_USER_ASSIGN_OPERATOR(this_type, expr_template)               \
  template <typename Expr,                                                     \
            typename = std::enable_if_t<!::boost::yap::detail::copy_or_move<   \
                this_type, Expr &&>::value>>                                   \
  constexpr auto operator=(Expr &&rhs) const & {                               \
    using lhs_type = ::boost::yap::detail::operand_type_t<expr_template,       \
                                                          this_type const &>;  \
    using rhs_type =                                                           \
  ...
  constexpr auto operator=(Expr &&rhs) & {                                     \
    using lhs_type =                                                           \
        ::boost::yap::detail::operand_type_t<expr_template, decltype(*this)>;  \
    using rhs_type =                                                           \
        ::boost::yap::detail::operand_type_t<expr_template, Expr>;             \
    using tuple_type = ::boost::hana::tuple<lhs_type, rhs_type>;               \
    return expr_template<::boost::yap::expr_kind::assign, tuple_type>{         \
...
#define BOOST_YAP_USER_SUBSCRIPT_OPERATOR(expr_template)                       \
  template <typename Expr> constexpr auto operator[](Expr &&rhs) const & {     \
    using lhs_type =                                                           \
        ::boost::yap::detail::operand_type_t<expr_template, decltype(*this)>;  \
    using rhs_type =                                                           \
        ::boost::yap::detail::operand_type_t<expr_template, Expr>;             \
  ...
  template <typename Expr> constexpr auto operator[](Expr &&rhs) & {           \
    using lhs_type =                                                           \
        ::boost::yap::detail::operand_type_t<expr_template, decltype(*this)>;  \
    using rhs_type =                                                           \
        ::boost::yap::detail::operand_type_t<expr_template, Expr>;             \
...
#define BOOST_YAP_USER_CALL_OPERATOR(expr_template)                            \
  template <typename... U> constexpr auto operator()(U &&... u) const & {      \
    ...
    using tuple_type = ::boost::hana::tuple<                                   \
        lhs_type, ::boost::yap::detail::operand_type_t<expr_template, U>...>;  \
  ...
  template <typename... U> constexpr auto operator()(U &&... u) & {            \
    using lhs_type =                                                           \
        ::boost::yap::detail::operand_type_t<expr_template, decltype(*this)>;  \
    using tuple_type = ::boost::hana::tuple<                                   \
        lhs_type, ::boost::yap::detail::operand_type_t<expr_template, U>...>;  \
  ...
  template <typename... U> constexpr auto operator()(U &&... u) && {           \
    ...
    using tuple_type = ::boost::hana::tuple<                                   \
        this_type, ::boost::yap::detail::operand_type_t<expr_template, U>...>; \
    return expr_template<::boost::yap::expr_kind::call, tuple_type>{           \
        tuple_type{                                                            \
            std::move(*this),                                                  \
            ::boost::yap::detail::make_operand<                                \
...
#define BOOST_YAP_USER_CALL_OPERATOR_MAKE_OPERAND(z, n, expr_template)         \
  ::boost::yap::detail::make_operand<::boost::yap::detail::operand_type_t<     \
      expr_template, BOOST_PP_CAT(U, n)>>{}(                                   \
...
#define BOOST_YAP_USER_CALL_OPERATOR_N(expr_template, n)                       \
  ...
  constexpr auto operator()(BOOST_PP_ENUM_BINARY_PARAMS(n, U, &&u)) const & {  \
    using lhs_type =                                                           \
        ::boost::yap::detail::operand_type_t<expr_template, decltype(*this)>;  \
    using tuple_type = ::boost::hana::tuple<                                   \
        lhs_type, BOOST_PP_ENUM(n, BOOST_YAP_USER_CALL_OPERATOR_OPERAND_T,     \
                                expr_template)>;                               \
    return expr_template<::boost::yap::expr_kind::call, tuple_type>{           \
        tuple_type{::boost::yap::detail::make_operand<lhs_type>{}(*this),      \
                   BOOST_PP_ENUM(n, BOOST_YAP_USER_CALL_OPERATOR_MAKE_OPERAND, \
                                 expr_template)}};                             \
  }                                                                            \
  template <BOOST_PP_ENUM_PARAMS(n, typename U)>                               \
  ...
  constexpr auto operator()(BOOST_PP_ENUM_BINARY_PARAMS(n, U, &&u)) && {       \
    using this_type = ::boost::yap::detail::remove_cv_ref_t<decltype(*this)>;  \
    using tuple_type = ::boost::hana::tuple<                                   \
        this_type, BOOST_PP_ENUM(n, BOOST_YAP_USER_CALL_OPERATOR_OPERAND_T,    \
                                 expr_template)>;                              \
    return expr_template<::boost::yap::expr_kind::call, tuple_type>{           \
        tuple_type{std::move(*this),                                           \
                   BOOST_PP_ENUM(n, BOOST_YAP_USER_CALL_OPERATOR_MAKE_OPERAND, \
...
#define BOOST_YAP_USER_EXPR_IF_ELSE(expr_template)                             \
  ...
  constexpr auto if_else(Expr1 &&expr1, Expr2 &&expr2, Expr3 &&expr3)          \
      ->::boost::yap::detail::ternary_op_result_t<expr_template, Expr1, Expr2, \
                                                  Expr3> {                     \
    using result_types =                                                       \
        ::boost::yap::detail::ternary_op_result<expr_template, Expr1, Expr2,   \
                                                Expr3>;                        \
...
#define BOOST_YAP_USER_UDT_ANY_IF_ELSE(expr_template, udt_trait)               \
  ...
  constexpr auto if_else(Expr1 &&expr1, Expr2 &&expr2, Expr3 &&expr3)          \
      ->::boost::yap::detail::udt_any_ternary_op_result_t<                     \
          expr_template, Expr1, Expr2, Expr3, udt_trait> {                     \
...
#define BOOST_YAP_USER_UDT_UNARY_OPERATOR(op_name, expr_template, udt_trait)   \
  ...
  constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(T &&x)              \
      ->::boost::yap::detail::udt_unary_op_result_t<                           \
          expr_template, ::boost::yap::expr_kind::op_name, T, udt_trait> {     \
...
*/
#define BOOST_YAP_USER_UDT_UDT_BINARY_OPERATOR(op_name, expr_template,         \
                                               t_udt_trait, u_udt_trait)       \
  template <typename T, typename U>                                            \
  constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(T &&lhs, U &&rhs)   \
      ->::boost::yap::detail::udt_udt_binary_op_result_t<                      \
          expr_template, ::boost::yap::expr_kind::op_name, T, U, t_udt_trait,  \
          u_udt_trait> {                                                       \
...
/** Defines a free/non-member operator overload for binary operator \a op_name
   ...
   expression.
    ...
    accepted as template parameters to the defined operator overload.
*/
#define BOOST_YAP_USER_UDT_ANY_BINARY_OPERATOR(op_name, expr_template,         \
                                               udt_trait)                      \
  template <typename T, typename U>                                            \
  constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(T &&lhs, U &&rhs)   \
      ->::boost::yap::detail::udt_any_binary_op_result_t<                      \
          expr_template, ::boost::yap::expr_kind::op_name, T, U, udt_trait> {  \
...
#define BOOST_YAP_USER_LITERAL_PLACEHOLDER_OPERATOR(expr_template)             \
  template <char... c> constexpr auto operator"" _p() {                        \
    using i =                                                                  \
        ::boost::hana::llong<::boost::hana::ic_detail::parse<sizeof...(c)>(    \
            {c...})>;                                                          \
