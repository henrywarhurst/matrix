...
template <typename Ptree> class standard_callbacks {
public:
  ...
  template <typename Range> void on_number(Range code_units) {
  ...
  template <typename Range> void on_code_units(Range code_units) {
