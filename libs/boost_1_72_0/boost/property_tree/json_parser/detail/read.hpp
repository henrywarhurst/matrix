...
template <typename Iterator, typename Sentinel> class minirange {
public:
...
void read_json_internal(
  ...
  read_json_internal(iterator(stream), iterator(), encoding, callbacks,
                     filename);
