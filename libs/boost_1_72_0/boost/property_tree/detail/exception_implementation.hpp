...
template <class P>
inline std::string prepare_bad_path_what(const std::string &what,
                                         const P &path) {
...
template <class D> inline D ptree_bad_data::data() const {
...
template <class P> inline P ptree_bad_path::path() const {
