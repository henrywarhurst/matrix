...
template <class T> struct is_abstract : boost::is_abstract<T> {};
} // namespace serialization
} // namespace boost
...
namespace boost {
namespace serialization {
template <class T> struct is_abstract : boost::false_type {};
} // namespace serialization
} // namespace boost
...
#define BOOST_SERIALIZATION_ASSUME_ABSTRACT(T)                                 \
  namespace boost {                                                            \
  namespace serialization {                                                    \
  template <> struct is_abstract<T> : boost::true_type {};                     \
  template <> struct is_abstract<const T> : boost::true_type {};               \
  }                                                                            \
  }                                                                            \
  /**/
