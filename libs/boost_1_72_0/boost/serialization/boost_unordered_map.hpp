...
save(Archive &ar,
  ...
  boost::serialization::stl::save_unordered_collection<
      Archive, boost::unordered_map<Key, HashFcn, EqualKey, Allocator>>(ar, t);
}
...
inline void load(Archive &ar,
  ...
  boost::serialization::stl::load_unordered_collection<
      Archive, boost::unordered_map<Key, HashFcn, EqualKey, Allocator>,
      boost::serialization::stl::archive_input_unordered_map<
          Archive, boost::unordered_map<Key, HashFcn, EqualKey, Allocator>>>(ar,
                                                                             t);
}
...
save(Archive &ar,
  ...
  boost::serialization::stl::save_unordered_collection<
      Archive, boost::unordered_multimap<Key, HashFcn, EqualKey, Allocator>>(ar,
                                                                             t);
}
...
load(Archive &ar,
  ...
  boost::serialization::stl::load_unordered_collection<
      Archive, boost::unordered_multimap<Key, HashFcn, EqualKey, Allocator>,
      boost::serialization::stl::archive_input_unordered_multimap<
          Archive,
          boost::unordered_multimap<Key, HashFcn, EqualKey, Allocator>>>(ar, t);
}
