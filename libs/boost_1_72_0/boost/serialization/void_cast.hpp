...
void_upcast(extended_type_info const &derived, extended_type_info const &base,
            void const *const t);
...
BOOST_SERIALIZATION_DECL void const *
void_downcast(extended_type_info const &derived, extended_type_info const &base,
              void const *const t);
...
public:
  ...
  // Constructor
  void_caster(extended_type_info const *derived, extended_type_info const *base,
              std::ptrdiff_t difference = 0,
              void_caster const *const parent = 0)
      : m_derived(derived), m_base(base), m_difference(difference),
        m_parent(parent) {}
  virtual ~void_caster() {}
};
...
class BOOST_SYMBOL_VISIBLE void_caster_primitive : public void_caster {
  ...
  virtual bool has_virtual_base() const { return false; }
...
void_caster_primitive<Derived, Base>::void_caster_primitive()
    : void_caster(
           ...
           * displace 0: at least one compiler treated 0 by not shifting it at
           * all displace by small value (8): caused ICE on certain mingw gcc
           * versions */
...
class BOOST_SYMBOL_VISIBLE void_caster_virtual_base : public void_caster {
  virtual bool has_virtual_base() const { return true; }
