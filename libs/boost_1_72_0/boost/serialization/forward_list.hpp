...
inline void save(Archive &ar, const std::forward_list<U, Allocator> &t,
...
typename boost::disable_if<
    ...
    void>::type
collection_load_impl(Archive &ar, std::forward_list<T, Allocator> &t,
...
template <class Archive, class U, class Allocator>
inline void load(Archive &ar, std::forward_list<U, Allocator> &t,
                 const unsigned int /*file_version*/
) {
...
template <class Archive, class U, class Allocator>
inline void serialize(Archive &ar, std::forward_list<U, Allocator> &t,
                      const unsigned int file_version) {
