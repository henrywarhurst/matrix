...
template <class Super, class Bindings> struct is_subconcept_f {
  template <class T>
  using apply = ::boost::mp11::mp_set_contains<
      Super, ::boost::type_erasure::detail::rebind_placeholders_t<T, Bindings>>;
};

template <class Super> struct is_subconcept_f<Super, void> {
  template <class T> using apply = ::boost::mp11::mp_set_contains<Super, T>;
};
...
struct is_subconcept_impl {
  ...
  typedef
      typename ::boost::type_erasure::detail::get_placeholder_normalization_map<
          Super>::type placeholder_subs_super;

  typedef typename ::boost::type_erasure::detail::normalize_concept<Sub>::type
      normalized_sub;
  typedef
      typename ::boost::type_erasure::detail::get_placeholder_normalization_map<
          Sub>::type placeholder_subs_sub;

  typedef typename ::boost::mpl::eval_if<
      ::boost::is_same<PlaceholderMap, void>, boost::mpl::identity<void>,
      ::boost::type_erasure::detail::convert_deductions<
          PlaceholderMap, placeholder_subs_sub, placeholder_subs_super>>::type
      bindings;

  typedef typename ::boost::mpl::if_<
      ::boost::is_same<PlaceholderMap, void>, ::boost::mpl::_1,
      ::boost::type_erasure::detail::rebind_placeholders<
          ::boost::mpl::_1, bindings>>::type transform;

  typedef typename ::boost::is_same<
      typename ::boost::mpl::find_if<normalized_sub,
                                     ::boost::mpl::not_<::boost::mpl::has_key<
                                         super_set, transform>>>::type,
  ...
  typedef ::boost::type_erasure::detail::normalize_concept_t<Sub>
      normalized_sub;
  typedef ::boost::type_erasure::detail::get_placeholder_normalization_map_t<
      Sub>
      placeholder_subs_sub;
  typedef ::boost::mp11::mp_eval_if_c<
      ::boost::is_same<PlaceholderMap, void>::value, void,
      ::boost::type_erasure::detail::convert_deductions_t, PlaceholderMap,
      placeholder_subs_sub, placeholder_subs_super>
      bindings;

  typedef typename ::boost::mp11::mp_all_of<
      normalized_sub, ::boost::type_erasure::detail::is_subconcept_f<
                          super_set, bindings>::template apply>
      type;
#endif
};
...
struct is_subconcept
    : ::boost::mpl::and_<
          ...
          ::boost::type_erasure::detail::is_subconcept_impl<
              Sub, Super, PlaceholderMap>>::type {};

#ifndef BOOST_TYPE_ERASURE_DOXYGEN
template <class Sub, class Super>
struct is_subconcept<Sub, Super, void>
    : ::boost::type_erasure::detail::is_subconcept_impl<Sub, Super,
                                                        void>::type {};
template <class Sub, class Super, class PlaceholderMap>
