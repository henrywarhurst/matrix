...
template <class R, class Tag> struct make_result_placeholder_map {
  typedef ::boost::mpl::map<::boost::mpl::pair<
      ...
      typename ::boost::remove_const<
          typename ::boost::remove_reference<Tag>::type>::type>>
      type;
};
...
#endif
{
  typedef typename ::boost::remove_const<
      typename ::boost::remove_reference<Any>::type>::type src_type;
  typedef typename ::boost::type_erasure::detail::normalize_concept<
      typename ::boost::type_erasure::concept_of<src_type>::type>::type
      normalized;
...
#ifndef BOOST_TYPE_ERASURE_USE_MP11
  typedef ::boost::type_erasure::detail::substitution_map<::boost::mpl::map0<>>
      identity_map;
#else
 ...
 * \endcode
 */
template <class R, class Any> R dynamic_any_cast(Any &&arg);
...
R dynamic_any_cast(const any<Concept, Tag> &arg) {
  return ::boost::type_erasure::detail::dynamic_any_cast_impl<R>(
      ...
      ::boost::type_erasure::make_binding<
          typename ::boost::type_erasure::detail::make_result_placeholder_map<
              R, Tag>::type>());
}
