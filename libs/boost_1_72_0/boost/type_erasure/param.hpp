...
template <class T> struct placeholder_conversion<T, T> : boost::mpl::true_ {};
template <class T> struct placeholder_conversion<T, T &> : boost::mpl::true_ {};
template <class T>
 ...
 * A conversion sequence from @ref any "any<C, P>" to @ref param "param<C, P1>"
 * is a better conversion sequence than @ref any "any<C, P>" to @ref param
 * "param<C, P2>" iff the corresponding placeholder standard conversion sequence
 * from P to P1 is a better conversion sequence than P to P2.
 *
...
public:
  ...
  param(any<Concept, U> &a
        ...
        typename boost::enable_if<
            ::boost::type_erasure::detail::placeholder_conversion<U, T>>::type
            * = 0
#endif
        )
      : _impl(a) {
  ...
  param(const any<Concept, U> &a
        ...
        typename boost::enable_if<
            ::boost::type_erasure::detail::placeholder_conversion<
                typename ::boost::add_const<U>::type, T>>::type * = 0
#endif
        )
      : _impl(a) {
  }
...
template <class Concept, class T> class param<Concept, const T &> {
public:
  friend struct boost::type_erasure::detail::access;
  ...
  param(const ::boost::type_erasure::detail::storage &data,
      ...
      : _impl(data, table) {}
  template <class U>
  param(U &u, typename boost::enable_if<
                  ::boost::is_same<U, const any<Concept, T>>>::type * = 0)
      : _impl(u) {}
 ...
 */
template <class Any, class T> struct as_param {
  ...
  typedef typename ::boost::mpl::if_<
      ...
      param<typename ::boost::type_erasure::concept_of<Any>::type, T>, T>::type
      type;
#endif
};
