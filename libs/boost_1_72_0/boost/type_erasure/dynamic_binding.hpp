 ...
 */
template <class PlaceholderList> class dynamic_binding {
public:
  template <class Map> dynamic_binding(const static_binding<Map> &) {
...
private:
  template <class Concept> friend class binding;
  typename ::boost::type_erasure::detail::make_dynamic_vtable<
      PlaceholderList>::type impl;
};
