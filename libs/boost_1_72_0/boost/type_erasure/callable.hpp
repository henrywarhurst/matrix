...
template <class Sig, class F = _self> struct callable;

namespace detail {

template <class Sig> struct result_of_callable;
...
template <class R, class... T, class F> struct callable<R(T...), F> {
  static R apply(F &f, T... arg) { return f(std::forward<T>(arg)...); }
};

template <class... T, class F> struct callable<void(T...), F> {
...
struct concept_interface<callable<R(T...), F>, Base, F, Enable> : Base {
  ...
  _boost_type_erasure_callable_size _boost_type_erasure_deduce_callable(
  ...
  operator()(typename ::boost::type_erasure::as_param<Base, T>::type... arg) {
    return ::boost::type_erasure::call(
        callable<R(T...), F>(), *this,
        ::std::forward<typename ::boost::type_erasure::as_param<Base, T>::type>(
            arg)...);
  }
};
...
struct concept_interface<callable<R(T...), F>, Base, F,
                         typename Base::_boost_type_erasure_is_callable>
    : Base {
  typedef typename ::boost::mpl::push_back<
      typename Base::_boost_type_erasure_callable_results, R>::type
...
template <class R, class F, class Base, class... T>
struct concept_interface<callable<R(T...), const F>, Base, F,
                         typename Base::_boost_type_erasure_is_callable>
    : Base {
  typedef typename ::boost::mpl::push_back<
      typename Base::_boost_type_erasure_callable_results, R>::type
...
template <class This, class... T> struct result_of_callable<This(T...)> {
...
#define BOOST_PP_ITERATION_LIMITS                                              \
  (0, BOOST_PP_DEC(BOOST_TYPE_ERASURE_MAX_ARITY))
...
#define BOOST_TYPE_ERASURE_DECLVAL(z, n, data)                                 \
  ::boost::declval<BOOST_PP_CAT(T, n)>()
...
#define BOOST_TYPE_ERASURE_FORWARD_REBIND(z, n, data)                          \
  ::std::forward<typename ::boost::type_erasure::as_param<                     \
      Base, BOOST_PP_CAT(T, n)>::type>(BOOST_PP_CAT(arg, n))
#endif
...
template <class R BOOST_PP_ENUM_TRAILING_PARAMS(N, class T), class F,
          class Base, class Enable>
struct concept_interface<callable<R(BOOST_PP_ENUM_PARAMS(N, T)), F>, Base, F,
                         Enable> : Base {
  template <class Sig>
  struct result : ::boost::type_erasure::detail::result_of_callable<Sig> {};
  typedef void _boost_type_erasure_is_callable;
...
template <class R BOOST_PP_ENUM_TRAILING_PARAMS(N, class T), class F,
          class Base, class Enable>
struct concept_interface<callable<R(BOOST_PP_ENUM_PARAMS(N, T)), const F>, Base,
                         F, Enable> : Base {
  template <class Sig>
  struct result : ::boost::type_erasure::detail::result_of_callable<Sig> {};
  typedef void _boost_type_erasure_is_callable;
...
template <class R BOOST_PP_ENUM_TRAILING_PARAMS(N, class T), class F,
          class Base>
struct concept_interface<callable<R(BOOST_PP_ENUM_PARAMS(N, T)), const F>, Base,
                         F, typename Base::_boost_type_erasure_is_callable>
    : Base {
  typedef typename ::boost::mpl::push_back<
      typename Base::_boost_type_erasure_callable_results, R>::type
      _boost_type_erasure_callable_results;
