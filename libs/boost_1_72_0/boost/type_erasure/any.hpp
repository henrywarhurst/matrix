...
template <class Sig> struct constructible;

template <class T> struct destructible;

template <class T, class U> struct assignable;
...
template <class Concept, class Base, class ID> struct choose_concept_interface {
...
template <class Concept, class Base, class ID> struct choose_concept_interface {
  typedef decltype(
      boost_type_erasure_find_interface(::boost::declval<Concept>())) finder;
...
template <class Derived, class Concept, class T> struct compute_bases {
  typedef typename ::boost::mpl::reverse_fold<
      ...
      ::boost::type_erasure::detail::choose_concept_interface<
          ::boost::mpl::_2, ::boost::mpl::_1, T>>::type type;
};

#else

template <class ID> struct compute_bases_f {
  template <class Concept, class Base>
  using apply =
      typename ::boost::type_erasure::detail::choose_concept_interface<
          Concept, Base, ID>::type;
};
...
template <class Derived, class Concept, class T>
using compute_bases = ::boost::mpl::identity<
    ::boost::type_erasure::detail::compute_bases_t<Derived, Concept, T>>;

#endif

template <class T> T make(T *) { return T(); }
...
template <class Op> yes check_overload(const Op *);
...
template <class T> fallback make_fallback(T &&, boost::mpl::false_) {
  return fallback();
}

template <class T> T &&make_fallback(T &&arg, boost::mpl::true_) {
  return std::forward<T>(arg);
}

#else

template <class T> fallback make_fallback(const T &, boost::mpl::false_) {
  return fallback();
}

template <class T> const T &make_fallback(const T &arg, boost::mpl::true_) {
  return arg;
}

#endif

template <class T> struct is_any : ::boost::mpl::false_ {};
...
template <class T> struct is_binding_arg : ::boost::mpl::false_ {};
template <class T> struct is_binding_arg<binding<T>> : ::boost::mpl::true_ {};
template <class T>
...
template <class T> struct is_static_binding_arg : ::boost::mpl::false_ {};
template <class T>
...
template <class T> struct is_any_arg : ::boost::mpl::false_ {};
template <class Concept, class T>
...
template <class T> struct safe_concept_of;
template <class Concept, class T> struct safe_concept_of<any<Concept, T>> {
...
template <class T> struct safe_placeholder_of;
template <class Concept, class T> struct safe_placeholder_of<any<Concept, T>> {
  typedef T type;
};
template <class Concept, class T>
...
template <class T>
using safe_placeholder_t = ::boost::remove_cv_t<
    ::boost::remove_reference_t<typename safe_placeholder_of<T>::type>>;
}
...
struct any_constructor_control<
    ...
    typename boost::enable_if_c<
        ...
        ::boost::type_erasure::detail::has_mutable_copy_constructor<
            Base>::value>::type> : Base {
  using Base::Base;
...
struct any_constructor_impl
    : ::boost::type_erasure::detail::compute_bases<
          ::boost::type_erasure::any<Concept, T>, Concept, T>::type {
  typedef typename ::boost::type_erasure::detail::compute_bases<
      ::boost::type_erasure::any<Concept, T>, Concept, T>::type
      _boost_type_erasure_base;
  // Internal constructors
  typedef ::boost::type_erasure::binding<Concept>
      _boost_type_erasure_table_type;
  any_constructor_impl(const ::boost::type_erasure::detail::storage &data_arg,
                       const _boost_type_erasure_table_type &table_arg)
      : _boost_type_erasure_table(table_arg),
        _boost_type_erasure_data(data_arg) {}
  any_constructor_impl(::boost::type_erasure::detail::storage &&data_arg,
                       const _boost_type_erasure_table_type &table_arg)
      : _boost_type_erasure_table(table_arg),
        _boost_type_erasure_data(data_arg) {}
  // default constructor
  ...
  template <
      ...
      typename ::boost::enable_if_c<
          ...
          !::boost::type_erasure::detail::is_static_binding_arg<U>::value>::type
          * = nullptr>
  any_constructor_impl(U &&data_arg)
      : _boost_type_erasure_table(
            (BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, T, ::boost::decay_t<U>),
             ::boost::type_erasure::make_binding<::boost::mpl::map1<
                 ::boost::mpl::pair<T, ::boost::decay_t<U>>>>())),
  ...
  any_constructor_impl(U &&data_arg, const static_binding<Map> &b)
      : _boost_type_erasure_table(
            (BOOST_TYPE_ERASURE_INSTANTIATE(Concept, Map), b)),
        _boost_type_erasure_data(std::forward<U>(data_arg)) {
    BOOST_MPL_ASSERT((::boost::is_same<typename ::boost::mpl::at<Map, T>::type,
                                       ::boost::decay_t<U>>));
  }
  ...
  template <
      ...
      typename ::boost::enable_if_c<::boost::type_erasure::is_subconcept<
          ...
          typename ::boost::mpl::if_c<
              ::boost::is_same<T, ::boost::type_erasure::detail::
                                      safe_placeholder_t<U>>::value,
              void,
              ::boost::mpl::map1<::boost::mpl::pair<
                  T, ::boost::type_erasure::detail::safe_placeholder_t<U>>>>::
      ...
      : _boost_type_erasure_table(
            ...
            typename ::boost::mpl::if_c<
                ::boost::is_same<T, ::boost::type_erasure::detail::
                                        safe_placeholder_t<U>>::value,
#ifndef BOOST_TYPE_ERASURE_USE_MP11
                ::boost::type_erasure::detail::substitution_map<
                    ::boost::mpl::map0<>>,
#else
                ::boost::type_erasure::detail::make_identity_placeholder_map<
                    Concept>,
#endif
                ::boost::mpl::map1<::boost::mpl::pair<
                    T, ::boost::type_erasure::detail::safe_placeholder_t<U>>>>::
  ...
  template <class U,
            typename ::boost::enable_if_c<
                ::boost::type_erasure::detail::is_any_arg<U>::value>::type * =
                nullptr>
  ...
  any_constructor_impl(U &&other, const static_binding<Map> &binding_arg)
      : _boost_type_erasure_table(
            ::boost::type_erasure::detail::access::table(other), binding_arg),
        _boost_type_erasure_data(::boost::type_erasure::call(
            ::boost::type_erasure::detail::make(
                false ? other._boost_type_erasure_deduce_constructor(
                            std::forward<U>(other))
      ...
      : _boost_type_erasure_table(
        ...
        _boost_type_erasure_data(::boost::type_erasure::call(
            ::boost::type_erasure::detail::make(
                false ? other._boost_type_erasure_deduce_constructor(
                            static_cast<
                                typename _boost_type_erasure_base::
                                    _boost_type_erasure_derived_type const &>(
                                other))
                      : 0),
            other)) {}
  any_constructor_impl(any_constructor_impl &other)
      : _boost_type_erasure_table(
        ...
        _boost_type_erasure_data(::boost::type_erasure::call(
            ::boost::type_erasure::detail::make(
                false ? other._boost_type_erasure_deduce_constructor(
                            static_cast<typename _boost_type_erasure_base::
                                            _boost_type_erasure_derived_type &>(
                                other))
                      : 0),
            other)) {}
  any_constructor_impl(any_constructor_impl &&other)
  ...
  const _boost_type_erasure_table_type &_boost_type_erasure_extract_table(
      ::boost::type_erasure::constructible<R(A...)> *, U &&... u) {
    return *::boost::type_erasure::detail::extract_table(
        static_cast<void (*)(A...)>(0), u...);
  }
  // forwarding constructor
  template <class... U,
            typename ::boost::enable_if_c<
                ::boost::type_erasure::detail::has_constructor<
                    any_constructor_impl, U...>::value>::type * = nullptr>
  ...
  any_constructor_impl &operator=(const any_constructor_impl &other) {
    static_cast<
        ...
        ->_boost_type_erasure_resolve_assign(
            static_cast<const typename _boost_type_erasure_base::
                            _boost_type_erasure_derived_type &>(other));
    return *this;
  }
...
struct is_rvalue_for_any<any<C, P>>
    : ::boost::mpl::not_<::boost::is_lvalue_reference<P>> {};
 ...
 *
 * \see concept_of, placeholder_of, \any_cast, \is_empty, \binding_of,
 * \typeid_of
 */
...
public:
  ...
  using _boost_type_erasure_base =
      ::boost::type_erasure::any_constructor_control<
          ::boost::type_erasure::any_constructor_impl<Concept, T>>;
  ...
  any(const ::boost::type_erasure::detail::storage &data_arg,
      ...
      : table(table_arg), data(data_arg) {}
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
  /** INTERNAL ONLY */
  any(::boost::type_erasure::detail::storage &&data_arg,
      const table_type &table_arg)
      : table(table_arg), data(data_arg) {}
#endif
  /**
  ...
  any(const U &data_arg)
      : table((BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, T, U),
  ...
  any(const U &data_arg, const static_binding<Map> &binding_arg)
      : table((BOOST_TYPE_ERASURE_INSTANTIATE(Concept, Map), binding_arg)),
        data(data_arg) {
    BOOST_MPL_ASSERT(
        (::boost::is_same<typename ::boost::mpl::at<Map, T>::type, U>));
  }
  ...
  template <class U>
  any(U &&data_arg)
      : table((BOOST_TYPE_ERASURE_INSTANTIATE1(
                   Concept, T,
                   typename ::boost::remove_cv<
                       typename ::boost::remove_reference<U>::type>::type),
               ::boost::type_erasure::make_binding<::boost::mpl::map1<
                   ::boost::mpl::pair<T, typename ::boost::remove_cv<
   ...
   *
   * \pre @c Concept must contain @ref constructible "constructible<T(const
   * T&)>". (This is included in @ref copy_constructible
   ...
   */
  any(const any &other)
      : table(other.table), data(::boost::type_erasure::call(
                                constructible<T(const T &)>(), other)) {}
  /**
   ...
   *
   * \pre @c Concept must contain @ref constructible "constructible<T(const
   * T&)>". \pre @c Concept must not refer to any non-deduced placeholder
   * besides @c T. \pre After substituting @c T for @c Tag2, the requirements of
      ...
      : table(
            ...
            ::boost::mpl::map1<::boost::mpl::pair<
                ...
                typename ::boost::remove_const<
                    typename ::boost::remove_reference<Tag2>::type>::type>>()),
        data(::boost::type_erasure::call(
            constructible<typename ::boost::remove_const<
                typename boost::remove_reference<Tag2>::type>::
                              type(const typename boost::remove_reference<
                                   Tag2>::type &)>(),
            other)) {}
  /**
   ...
   *
   * \pre @c Concept must contain @ref constructible "constructible<T(const
   * T&)>". \pre @c Map must be an MPL map with keys for all the non-deduced
   ...
   *
   * \pre @c Concept must contain @ref constructible "constructible<T(const
   * T&)>". \pre The type stored in @c other must match the type expected by
   *      @c binding.
   *
  ...
  explicit any(const binding<Concept> &binding_arg, U &&... arg)
      : table(binding_arg),
        data(::boost::type_erasure::detail::make(
            false ? this->_boost_type_erasure_deduce_constructor(arg...)
                  : 0)(arg...)) {}
  ...
  any(any &other)
      : table(::boost::type_erasure::detail::access::table(other)),
        data(::boost::type_erasure::call(
            ::boost::type_erasure::detail::make(
                false ? this->_boost_type_erasure_deduce_constructor(other)
                      : 0),
            other)) {}
  template <class Concept2, class Tag2>
  any(any<Concept2, Tag2> &other)
      : table(
        ...
        data(::boost::type_erasure::call(
            ::boost::type_erasure::detail::make(
                false ? other._boost_type_erasure_deduce_constructor(other)
                      : 0),
            other)) {}
  template <class Concept2, class Tag2>
  any(any<Concept2, Tag2> &&other)
  ...
  explicit any(const binding<Concept> &binding_arg)
      : table(binding_arg),
        data(::boost::type_erasure::call(
            binding_arg, ::boost::type_erasure::constructible<T()>())) {}
  ...
  any(U0 &&u0, U1 &&u1, U &&... u)
      : table(_boost_type_erasure_extract_table(
            false ? this->_boost_type_erasure_deduce_constructor(
                        std::forward<U0>(u0), std::forward<U1>(u1),
                        std::forward<U>(u)...)
                  : 0,
...
#ifdef BOOST_NO_CXX11_RVALUE_REFERENCES
  template <class U> any &operator=(U &other) {
    _boost_type_erasure_resolve_assign(other);
    return *this;
  }
  template <class U> any &operator=(const U &other) {
    _boost_type_erasure_resolve_assign(other);
    return *this;
  }
#else
...
private:
  ...
  void _boost_type_erasure_swap(any &other) {
    ...
    ::std::swap(this->_boost_type_erasure_table,
                other._boost_type_erasure_table);
  }
#endif
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
  /** INTERNAL ONLY */
  ...
  void _boost_type_erasure_resolve_assign(Other &&other) {
    _boost_type_erasure_assign_impl(
        ...
        false
            ? this->_boost_type_erasure_deduce_assign(
                  ::boost::type_erasure::detail::make_fallback(
                      std::forward<Other>(other),
                      ::boost::mpl::bool_<
                          sizeof(::boost::type_erasure::detail::check_overload(
                              ::boost::declval<any &>()
                                  ._boost_type_erasure_deduce_assign(
                                      std::forward<Other>(other)))) ==
                          sizeof(::boost::type_erasure::detail::yes)>()))
            : 0,
  ...
  void _boost_type_erasure_assign_impl(Other &&other, const assignable<T, U> *,
                                       ::boost::mpl::false_) {
    ::boost::type_erasure::call(assignable<T, U>(), *this,
                                std::forward<Other>(other));
  }
  /** INTERNAL ONLY */
  template <class Other, class U>
  ...
  /** INTERNAL ONLY */
  template <class Other>
  void _boost_type_erasure_assign_impl(Other &&other, const void *,
                                       ::boost::mpl::true_) {
...
#else
  /** INTERNAL ONLY */
  template <class Other> void _boost_type_erasure_resolve_assign(Other &other) {
    _boost_type_erasure_assign_impl(
        other,
        false
            ? this->_boost_type_erasure_deduce_assign(
  ...
  void _boost_type_erasure_resolve_assign_any(Other &&other) {
    _boost_type_erasure_assign_impl(
        ...
        false
            ...
            : 0,
        false
            ? this->_boost_type_erasure_deduce_constructor(
                  ::boost::type_erasure::detail::make_fallback(
                      std::forward<Other>(other),
                      ::boost::mpl::bool_<
                          sizeof(::boost::type_erasure::detail::check_overload(
  ...
  void _boost_type_erasure_assign_impl(Other &&other, const assignable<T, U> *,
    ...
    {
      ::boost::type_erasure::unchecked_call(assignable<T, U>(), *this,
                                            std::forward<Other>(other));
    } else {
      any temp(std::forward<Other>(other));
      _boost_type_erasure_swap(temp);
...
public:
  ...
  any(U &arg
      ...
      typename ::boost::disable_if<::boost::mpl::or_<
          ::boost::is_const<U>, ::boost::type_erasure::detail::is_any<U>>>::type
          * = 0
#endif
      )
      : table((BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, T, U),
   ...
   * \throws Nothing.
   */
  any(const any &other) : data(other.data), table(other.table) {}
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
  any(any &other) : data(other.data), table(other.table) {}
#endif
  /**
   * Constructs an @ref any from another @ref any.
   *
  ...
  any(const any<Concept2, Tag2 &> &other
      ...
      ,
      typename ::boost::disable_if<::boost::mpl::or_<
          ::boost::is_same<Concept, Concept2>, ::boost::is_const<Tag2>>>::type
          * = 0
#endif
      )
      : data(::boost::type_erasure::detail::access::data(other)),
  ...
  any(any<Concept2, Tag2> &other
      ...
      : data(::boost::type_erasure::detail::access::data(other)),
        table(::boost::type_erasure::detail::access::table(other),
              ::boost::mpl::map1<::boost::mpl::pair<
                  T, typename ::boost::remove_reference<Tag2>::type>>()) {
  }
  /**
   * Constructs an @ref any from another reference.
   *
...
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
      ,
      typename ::boost::disable_if<::boost::is_const<
          typename ::boost::remove_reference<Tag2>::type>>::type * = 0
#endif
      )
      : data(::boost::type_erasure::detail::access::data(other)),
        table(::boost::type_erasure::detail::access::table(other),
  ...
  operator param<Concept, T &>() const {
    return param<Concept, T &>(data, table);
  }
#endif
private:
  /** INTERNAL ONLY */
            ...
            ? this->_boost_type_erasure_deduce_assign(
                  ::boost::type_erasure::detail::make_fallback(
                      ...
                      ::boost::mpl::bool_<
                          ...
                          sizeof(::boost::type_erasure::detail::yes)>()))
            : 0,
        ::boost::mpl::and_<::boost::type_erasure::is_relaxed<Concept>,
                           ::boost::is_convertible<Other &, any>>());
  }
  /** INTERNAL ONLY */
  template <class Other, class U>
...
class any<Concept, const T &>
    : public ::boost::type_erasure::detail::compute_bases<
          ::boost::type_erasure::any<Concept, const T &>, Concept, T>::type {
  typedef ::boost::type_erasure::binding<Concept> table_type;
...
public:
  ...
  any(const U &arg)
      : table((BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, T, U),
               ::boost::type_erasure::make_binding<
                   ::boost::mpl::map1<::boost::mpl::pair<T, U>>>())) {
    data.data =
        const_cast<void *>(static_cast<const void *>(::boost::addressof(arg)));
  }
  /**
   * Constructs an @ref any from a reference.
   *
...
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
      ,
      typename ::boost::disable_if<::boost::is_same<Concept, Concept2>>::type
          * = 0
#endif
      )
      : data(::boost::type_erasure::detail::access::data(other)),
  ...
  operator param<Concept, const T &>() const {
    return param<Concept, const T &>(data, table);
  }
#endif
private:
  /** INTERNAL ONLY */
...
public:
  ...
  any(U &&arg
      ...
      typename ::boost::disable_if<
          ::boost::mpl::or_<::boost::is_reference<U>, ::boost::is_const<U>,
                            ::boost::type_erasure::detail::is_any<U>>>::type * =
          0
#endif
      )
      : table((BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, T, U),
   ...
   */
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
  any(any &&other) : data(other.data), table(std::move(other.table)) {}
  any(const any &other) : data(other.data), table(other.table) {}
#endif
  /**
   * Constructs an @ref any from another @ref any.
  ...
  any(any<Concept2, Tag2 &&> &&other
      ...
      ,
      typename ::boost::disable_if<::boost::mpl::or_<
          ::boost::is_reference<Tag2>, ::boost::is_same<Concept, Concept2>,
...
template <class Concept, class T> using any_ref = any<Concept, T &>;
template <class Concept, class T> using any_cref = any<Concept, const T &>;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
template <class Concept, class T> using any_rvref = any<Concept, T &&>;
#endif
#endif
