...
void require_match(const binding<Concept> &binding_arg, const Op &f,
                   U &&... args);

/**
 * \overload
 */
template <class Op, class... U> void require_match(const Op &f, U &&... args);
...
template <class Concept, class Op, class... U>
void require_match_impl(::boost::mpl::true_,
...
template <class Concept, class Op, class... U>
void require_match_impl(::boost::mpl::false_,
...
template <class Concept, class Op, class... U>
void require_match(const ::boost::type_erasure::binding<Concept> &table,
                   const Op &op, U &&... arg) {
  ::boost::type_erasure::is_relaxed<Concept> cond;
  ::boost::type_erasure::detail::require_match_impl(cond, table, op,
                                                    ::std::forward<U>(arg)...);
}

#ifndef BOOST_TYPE_ERASURE_USE_MP11

template <class Op, class... U> void require_match(const Op &op, U &&... arg) {
  ::boost::type_erasure::is_relaxed<
      typename ::boost::type_erasure::detail::extract_concept<
          ...
          U...>::type>
      cond;
  ::boost::type_erasure::detail::require_match_impl(cond, op,
                                                    ::std::forward<U>(arg)...);
}
...
void require_match_impl(
    ::boost::mpl::true_, const ::boost::type_erasure::binding<Concept> &table,
...
void require_match_impl(::boost::mpl::false_,
                        const ::boost::type_erasure::binding<Concept> &,
                        const Op &BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(
                            N, U, RREF BOOST_PP_INTERCEPT)) {}
