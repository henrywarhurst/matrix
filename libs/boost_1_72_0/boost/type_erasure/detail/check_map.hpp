...
template <class T> struct is_deduced : boost::mpl::false_ {};
template <class T>
...
template <class Concept, class Map> struct check_map {
  ...
  typedef typename ::boost::mpl::fold<
      placeholder_subs, ::boost::mpl::set0<>,
  ...
  typedef typename ::boost::is_same<
      typename ::boost::mpl::find_if<
          ...
          ::boost::mpl::not_<::boost::mpl::or_<
              ...
              ::boost::mpl::has_key<indirect_deduced_placeholders,
                                    ::boost::mpl::_1>>>>::type,
  ...
  typedef ::boost::mp11::mp_unique<::boost::mp11::mp_append<
      ...
      okay_placeholders;
  template <class P>
  using check_placeholder =
      ::boost::mpl::or_<::boost::type_erasure::detail::is_deduced<P>,
