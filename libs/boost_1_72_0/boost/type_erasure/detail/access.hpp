...
#include <boost/type_erasure/detail/storage.hpp>
    ...
    !(defined(__clang_major__) && __clang_major__ == 3 &&                      \
      __clang__minor__ <= 2) /* Inherited constructors */
...
template <class Concept, class T> class any;
...
struct access {
  ...
  template <class Concept, class T,
            class = typename ::boost::enable_if_c<
                !::boost::is_reference<T>::value>::type>
  static const typename any<Concept, T>::table_type &
  table(const ::boost::type_erasure::any_base<
        ::boost::type_erasure::any<Concept, T>> &arg) {
    return static_cast<const ::boost::type_erasure::any<Concept, T> &>(arg)
        ._boost_type_erasure_table;
  }
  template <class Concept, class T>
  static ::boost::type_erasure::detail::storage &
  data(::boost::type_erasure::any_base<::boost::type_erasure::any<Concept, T>>
           &arg) {
    return static_cast<::boost::type_erasure::any<Concept, T> &>(arg)
        ._boost_type_erasure_data;
  }
  template <class Concept, class T>
  static const ::boost::type_erasure::detail::storage &
  data(const ::boost::type_erasure::any_base<
       ::boost::type_erasure::any<Concept, T>> &arg) {
    return static_cast<const ::boost::type_erasure::any<Concept, T> &>(arg)
        ._boost_type_erasure_data;
  }
  ...
  data(::boost::type_erasure::any_base<::boost::type_erasure::any<Concept, T>>
           &&arg) {
    return std::move(static_cast<::boost::type_erasure::any<Concept, T> &&>(arg)
                         ._boost_type_erasure_data);
  }
#endif
  template <class Derived>
  ...
  template <class Concept, class T>
  static const ::boost::type_erasure::detail::storage &
  data(::boost::type_erasure::any_base<
       ::boost::type_erasure::any<Concept, const T &>> &arg) {
    return static_cast<::boost::type_erasure::any<Concept, const T &> &>(arg)
        .data;
  }
  template <class Derived>
  static const ::boost::type_erasure::detail::storage &
  ...
  data(const ::boost::type_erasure::any_base<
       ::boost::type_erasure::any<Concept, T &>> &arg) {
    return const_cast<::boost::type_erasure::detail::storage &>(
        static_cast<const ::boost::type_erasure::any<Concept, T &> &>(arg)
            .data);
  }
  template <class Concept, class T>
  static const ::boost::type_erasure::detail::storage &
  data(const ::boost::type_erasure::any_base<
       ::boost::type_erasure::any<Concept, const T &>> &arg) {
    return static_cast<const ::boost::type_erasure::any<Concept, const T &> &>(
               arg)
        .data;
  }
  template <class Concept, class T>
  ...
  template <class Concept, class T>
  static ::boost::type_erasure::detail::storage &&data(
      ::boost::type_erasure::any_base<::boost::type_erasure::any<Concept, T &&>>
          &arg) {
    return std::move(
        static_cast<::boost::type_erasure::any<Concept, T &&> &>(arg).data);
  }
  ...
  data(const ::boost::type_erasure::any_base<
       ::boost::type_erasure::any<Concept, T &&>> &arg) {
    return std::move(const_cast<::boost::type_erasure::detail::storage &>(
        static_cast<const ::boost::type_erasure::any<Concept, T &&> &>(arg)
            .data));
  }
  template <class Concept, class T>
  ...
  data(const ::boost::type_erasure::param<Concept, T &&> &arg) {
    return std::move(
        const_cast<::boost::type_erasure::detail::storage &>(arg._impl.data));
  }
