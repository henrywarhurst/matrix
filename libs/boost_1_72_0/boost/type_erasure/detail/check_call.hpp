...
template <class Sig, class Args> struct check_call : ::boost::mpl::false_ {};

template <class T, class Enable = void> struct qualified_placeholder {
  typedef void type;
};
...
struct qualified_placeholder<T &, typename T::_boost_type_erasure_is_any> {
  ...
  typedef
      typename ::boost::mpl::if_<::boost::is_const<T>, const unref, unref>::type
          add_const;
  typedef typename ::boost::mpl::if_<::boost::is_reference<placeholder>,
                                     placeholder, add_const &>::type type;
};
...
struct check_placeholder_arg
    : check_placeholder_arg_impl<
          P, typename ::boost::type_erasure::detail::qualified_placeholder<
                 Arg>::type>::type {};
...
using check_nonplaceholder_arg_t =
    typename ::boost::is_convertible<Arg, T>::type;
...
using check_arg_t = ::boost::type_erasure::detail::eval_if<
    ...
    ::boost::type_erasure::detail::check_nonplaceholder_arg_t, FormalArg,
    ActualArg>;

// MSVC 14.1 ICE's if we use check_arg_t directly.
template <class FormalArg, class ActualArg> struct check_arg {
...
template <class FormalArg, class ActualArg> struct check_arg {
  typedef typename ::boost::mpl::eval_if<
      is_placeholder<typename ::boost::remove_cv<
          typename ::boost::remove_reference<FormalArg>::type>::type>,
      ::boost::type_erasure::detail::check_placeholder_arg<FormalArg,
                                                           ActualArg>,
...
struct and_<T1, T...> : boost::mpl::eval_if_c<T1::type::value, and_<T...>,
                                              boost::mpl::false_>::type {};

template <class T1> struct and_<T1> : T1::type {};

template <> struct and_<> : boost::mpl::true_ {};
...
#define BOOST_TYPE_ERASURE_CHECK_ARG(z, n, data)                               \
  typedef typename ::boost::type_erasure::detail::check_arg<                   \
      BOOST_PP_CAT(T, n), BOOST_PP_CAT(U, n)>::type BOOST_PP_CAT(check, n);    \
  typedef typename ::boost::mpl::and_<BOOST_PP_CAT(type, n),                   \
                                      BOOST_PP_CAT(check, n)>::type            \
...
struct check_call<R(BOOST_PP_ENUM_PARAMS(N, T)),
