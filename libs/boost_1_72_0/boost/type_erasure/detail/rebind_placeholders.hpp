...
template <class T, class Bindings> struct rebind_placeholders {
  typedef void type;
};

template <class T> struct identity { typedef T type; };

template <class PrimitiveConcept, class Sig> struct vtable_adapter;
...
template <class T, class Bindings>
using rebind_one_placeholder =
    ::boost::mp11::mp_second<::boost::mp11::mp_map_find<Bindings, T>>;

template <class T> struct rebind_placeholders_in_argument_impl {
  ...
  using apply = ::boost::type_erasure::detail::eval_if<
      ...
      ::boost::type_erasure::detail::first, T, Bindings>;
};

template <class T, class Bindings>
using rebind_placeholders_in_argument_t = typename ::boost::type_erasure::
    detail::rebind_placeholders_in_argument_impl<T>::template apply<Bindings>;

template <class T, class Bindings>
using rebind_placeholders_in_argument =
    ::boost::mpl::identity<::boost::type_erasure::detail::
                               rebind_placeholders_in_argument_t<T, Bindings>>;

template <class T> struct rebind_placeholders_in_argument_impl<T &> {
  template <class Bindings>
...
template <class T> struct rebind_placeholders_in_argument_impl<const T> {
  template <class Bindings>
...
template <class F, class Bindings>
using rebind_deduced_placeholder = ::boost::mp11::mp_second<
...
struct rebind_placeholders_in_argument_impl<::boost::type_erasure::deduced<F>> {
  template <class Bindings>
  using apply = ::boost::type_erasure::detail::eval_if<
      ::boost::mp11::mp_map_contains<Bindings,
                                     ::boost::type_erasure::deduced<F>>::value,
      ::boost::type_erasure::detail::rebind_deduced_placeholder,
      ::boost::type_erasure::detail::rebind_placeholders_in_deduced, F,
      Bindings>;
};
...
struct rebind_placeholders_in_argument_impl<R(T...)> {
  template <class Bindings>
  using apply = rebind_placeholders_in_argument_t<R, Bindings>(
      rebind_placeholders_in_argument_t<T, Bindings>...);
};
...
struct rebind_placeholders<vtable_adapter<PrimitiveConcept, Sig>, Bindings> {
  typedef ::boost::type_erasure::detail::make_mp_list<Bindings> xBindings;
  typedef vtable_adapter<rebind_placeholders_t<PrimitiveConcept, xBindings>,
...
template <class T, class Bindings> struct rebind_placeholders_in_argument {
  BOOST_MPL_ASSERT(
      (boost::mpl::or_<
          ::boost::mpl::not_<::boost::type_erasure::is_placeholder<T>>,
          ::boost::mpl::has_key<Bindings, T>>));
  typedef typename ::boost::mpl::eval_if<
      ::boost::type_erasure::is_placeholder<T>, ::boost::mpl::at<Bindings, T>,
...
struct rebind_placeholders_in_argument<const T, Bindings> {
  typedef const typename ::boost::type_erasure::detail::
      rebind_placeholders_in_argument<T, Bindings>::type type;
};

template <class F, class Bindings> struct rebind_placeholders_in_deduced {
  typedef typename ::boost::type_erasure::deduced<
      typename ::boost::type_erasure::detail::rebind_placeholders<
          F, Bindings>::type>::type type;
};

template <class F, class Bindings>
struct rebind_placeholders_in_argument<::boost::type_erasure::deduced<F>,
                                       Bindings> {
  typedef typename ::boost::mpl::eval_if<
...
template <template <class...> class T, class... U, class Bindings>
struct rebind_placeholders<T<U...>, Bindings> {
  typedef T<typename rebind_placeholders_in_argument<U, Bindings>::type...>
      type;
};
...
struct rebind_placeholders_in_argument<R (C::*)(T...), Bindings> {
  typedef typename ::boost::type_erasure::detail::
      rebind_placeholders_in_argument<R, Bindings>::type (
...
#define BOOST_TYPE_ERASURE_REBIND(z, n, data)                                  \
  typename rebind_placeholders_in_argument<BOOST_PP_CAT(data, n),              \
                                           Bindings>::type
...
struct rebind_placeholders_in_argument<R(BOOST_PP_ENUM_PARAMS(N, T)),
                                       Bindings> {
  typedef
      typename ::boost::type_erasure::detail::rebind_placeholders_in_argument<
          R, Bindings>::type type(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_REBIND,
                                                T));
};
