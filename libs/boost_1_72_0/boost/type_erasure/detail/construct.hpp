...
const table_type &_boost_type_erasure_extract_table(
  ...
  return *::boost::type_erasure::detail::BOOST_PP_CAT(extract_table, N)(
      (R(*)(BOOST_PP_ENUM_PARAMS(N, A)))0, BOOST_PP_ENUM_PARAMS(N, u));
}
    ...
    : table(binding_arg),
      data(::boost::type_erasure::call(
          ...
          ::boost::type_erasure::detail::make(
              false ? this->_boost_type_erasure_deduce_constructor(
                          BOOST_TYPE_ERASURE_FORWARD(N))
                    : 0) BOOST_PP_COMMA_IF(N) BOOST_TYPE_ERASURE_FORWARD(N))) {}

// disambiguate
template <BOOST_PP_ENUM_PARAMS(N, class U)>
any(binding<Concept> &binding_arg BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U,
                                                                       &&u))
    : table(binding_arg),
      data(::boost::type_erasure::call(
          binding_arg,
...
template <BOOST_PP_ENUM_PARAMS(N, class U)>
any(const binding<Concept> &binding_arg
        BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, const U, &u))
    : table(binding_arg),
      data(::boost::type_erasure::call(
          binding_arg, ::boost::type_erasure::detail::make(
                           false ? this->_boost_type_erasure_deduce_constructor(
                                       BOOST_PP_ENUM_PARAMS(N, u))
                                 : 0) BOOST_PP_ENUM_TRAILING_PARAMS(N, u))) {}
