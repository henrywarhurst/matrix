...
template <class T, class Out> struct get_placeholders;
...
template <class T> struct replace_param_for_vtable {
  typedef
      typename ::boost::mpl::if_<::boost::type_erasure::is_placeholder<
                                     typename ::boost::remove_cv<T>::type>,
                                 const ::boost::type_erasure::detail::storage &,
                                 T>::type type;
};

template <class T> struct replace_param_for_vtable<T &> {
  typedef typename ::boost::mpl::if_<::boost::type_erasure::is_placeholder<
                                         typename ::boost::remove_cv<T>::type>,
                                     ::boost::type_erasure::detail::storage &,
                                     T &>::type type;
};

template <class T> struct replace_param_for_vtable<const T &> {
  typedef
      typename ::boost::mpl::if_<::boost::type_erasure::is_placeholder<
                                     typename ::boost::remove_cv<T>::type>,
                                 const ::boost::type_erasure::detail::storage &,
...
template <class T> struct replace_result_for_vtable {
  typedef typename ::boost::mpl::if_<::boost::type_erasure::is_placeholder<
                                         typename ::boost::remove_cv<T>::type>,
                                     ::boost::type_erasure::detail::storage,
                                     T>::type type;
...
template <class T> struct replace_result_for_vtable<T &> {
  typedef typename ::boost::mpl::if_<::boost::type_erasure::is_placeholder<
                                         typename ::boost::remove_cv<T>::type>,
                                     ::boost::type_erasure::detail::storage &,
                                     T &>::type type;
...
template <class T> struct replace_result_for_vtable<const T &> {
  typedef typename ::boost::mpl::if_<::boost::type_erasure::is_placeholder<
                                         typename ::boost::remove_cv<T>::type>,
                                     ::boost::type_erasure::detail::storage &,
                                     const T &>::type type;
...
template <class Sig> struct get_vtable_signature;
...
template <class PrimitiveConcept> struct adapt_to_vtable {
  typedef ::boost::type_erasure::detail::vtable_adapter<
      ...
      typename ::boost::type_erasure::detail::get_vtable_signature<
          typename ::boost::type_erasure::detail::get_signature<
              PrimitiveConcept>::type>::type>
      type;
};

template <class Concept> struct maybe_adapt_to_vtable {
...
struct vtable_adapter_impl<
    PrimitiveConcept, ::boost::type_erasure::detail::storage(T...), R2(U...)> {
  typedef ::boost::type_erasure::detail::storage (*type)(T...);
  static ::boost::type_erasure::detail::storage value(T... arg) {
    return ::boost::type_erasure::detail::storage(PrimitiveConcept::apply(
        ::boost::type_erasure::detail::extract<U>(std::forward<T>(arg))...));
  }
};

template <class PrimitiveConcept, class... T, class R2, class... U>
struct vtable_adapter_impl<PrimitiveConcept,
                           ::boost::type_erasure::detail::storage &(T...),
                           R2(U...)> {
  typedef ::boost::type_erasure::detail::storage (*type)(T...);
  static ::boost::type_erasure::detail::storage value(T... arg) {
    ::boost::type_erasure::detail::storage result;
    typename ::boost::remove_reference<R2>::type *p = ::boost::addressof(
        PrimitiveConcept::apply(::boost::type_erasure::detail::extract<U>(
            std::forward<T>(arg))...));
...
struct vtable_adapter
    : vtable_adapter_impl<PrimitiveConcept, Sig,
                          typename ::boost::type_erasure::detail::get_signature<
                              PrimitiveConcept>::type> {};

template <class R, class... T> struct get_vtable_signature<R(T...)> {
  typedef
      typename ::boost::type_erasure::detail::replace_result_for_vtable<R>::type
...
#define BOOST_TYPE_ERASURE_EXTRACT(z, n, data)                                 \
  ::boost::type_erasure::detail::extract<typename traits::BOOST_PP_CAT(        \
      BOOST_PP_CAT(arg, BOOST_PP_INC(n)), _type)>(                             \
...
#define BOOST_TYPE_ERASURE_EXTRACT(z, n, data)                                 \
  ::boost::type_erasure::detail::extract<typename traits::BOOST_PP_CAT(        \
      BOOST_PP_CAT(arg, BOOST_PP_INC(n)), _type)>(BOOST_PP_CAT(arg, n))
...
template <class PrimitiveConcept,
          class R BOOST_PP_ENUM_TRAILING_PARAMS(N, class T)>
...
struct vtable_adapter<PrimitiveConcept, ::boost::type_erasure::detail::storage(
                                            BOOST_PP_ENUM_PARAMS(N, T))> {
  typedef ::boost::type_erasure::detail::storage (*type)(
      BOOST_PP_ENUM_PARAMS(N, T));
  static ::boost::type_erasure::detail::storage
  value(BOOST_PP_ENUM_BINARY_PARAMS(N, T, arg)) {
#if N > 0
    typedef typename ::boost::function_traits<
        typename ::boost::type_erasure::detail::get_signature<
            PrimitiveConcept>::type>
...
struct vtable_adapter<PrimitiveConcept, ::boost::type_erasure::detail::storage
  ...
  value(BOOST_PP_ENUM_BINARY_PARAMS(N, T, arg)) {
    ...
    typename ::boost::remove_reference<typename traits::result_type>::type *p =
        ::boost::addressof(PrimitiveConcept::apply(
            BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_EXTRACT, ~)));
    result.data = const_cast<void *>(static_cast<const void *>(p));
    return result;
  }
...
template <class PrimitiveConcept BOOST_PP_ENUM_TRAILING_PARAMS(N, class T)>
struct vtable_adapter<PrimitiveConcept,
                      ::boost::type_erasure::detail::storage &&
                          (BOOST_PP_ENUM_PARAMS(N, T))> {
  typedef ::boost::type_erasure::detail::storage (*type)(
      BOOST_PP_ENUM_PARAMS(N, T));
  ...
  value(BOOST_PP_ENUM_BINARY_PARAMS(N, T, arg)) {
    typedef typename ::boost::function_traits<
        ...
        traits;
    ::boost::type_erasure::detail::storage result;
    typename traits::result_type tmp = PrimitiveConcept::apply(
        BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_EXTRACT, ~));
    typename ::boost::remove_reference<typename traits::result_type>::type *p =
        ::boost::addressof(tmp);
    result.data = const_cast<void *>(static_cast<const void *>(p));
