 ...
 */
template <class T> struct placeholder_of {
#ifdef BOOST_TYPE_ERASURE_DOXYGEN
  typedef detail::unspecified type;
#else
  typedef typename ::boost::type_erasure::placeholder_of<
      typename T::_boost_type_erasure_derived_type>::type type;
#endif
};
...
template <class T>
using placeholder_of_t =
    typename ::boost::type_erasure::placeholder_of<T>::type;
