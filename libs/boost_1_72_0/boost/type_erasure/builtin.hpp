 ...
 */
template <class T = _self> struct destructible {
  /** INTERNAL ONLY */
 ...
 */
template <class T = _self, class U = const T &> struct assignable {
...
/** INTERNAL ONLY */
template <class T, class U> struct assignable<T, U &&> {
...
struct concept_interface<
    assignable<T, U>, Base, T,
    typename ::boost::enable_if_c<::boost::is_reference<U>::value>::type>
    : Base {
 ...
 * use \typeid_of.
 */
template <class T = _self> struct typeid_ {
  /** INTERNAL ONLY */
