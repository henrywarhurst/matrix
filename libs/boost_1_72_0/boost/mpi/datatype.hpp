 ...
 */
template <typename T>
struct is_mpi_integer_datatype : public boost::mpl::false_ {};
 ...
 */
template <typename T>
struct is_mpi_floating_point_datatype : public boost::mpl::false_ {};
 ...
 */
template <typename T>
struct is_mpi_logical_datatype : public boost::mpl::false_ {};
 ...
 */
template <typename T>
struct is_mpi_byte_datatype : public boost::mpl::false_ {};
...
struct is_mpi_builtin_datatype
    : boost::mpl::or_<is_mpi_integer_datatype<T>,
                      ...
                      is_mpi_logical_datatype<T>, is_mpi_complex_datatype<T>,
 ...
 */
template <typename T>
struct is_mpi_datatype : public is_mpi_builtin_datatype<T> {};
...
#define BOOST_MPI_DATATYPE(CppType, MPIType, Kind)                             \
  template <> inline MPI_Datatype get_mpi_datatype<CppType>(const CppType &) { \
    return MPIType;                                                            \
  }                                                                            \
                                                                               \
  template <>                                                                  \
...
#if defined(BOOST_HAS_LONG_LONG) &&                                            \
    (defined(MPI_UNSIGNED_LONG_LONG) || (BOOST_MPI_VERSION >= 2))
...
/// INTERNAL ONLY
template <> inline MPI_Datatype get_mpi_datatype<bool>(const bool &) {
  static MPI_Datatype type = detail::build_mpi_datatype_for_bool();
  return type;
}

/// INTERNAL ONLY
template <> struct is_mpi_datatype<bool> : boost::mpl::bool_<true> {};

#ifndef BOOST_MPI_DOXYGEN
// direct support for special primitive data types of the serialization library
BOOST_MPI_DATATYPE(boost::archive::library_version_type,
                   get_mpi_datatype(uint_least16_t()), integer);
BOOST_MPI_DATATYPE(boost::archive::version_type,
                   get_mpi_datatype(uint_least8_t()), integer);
BOOST_MPI_DATATYPE(boost::archive::class_id_type,
                   get_mpi_datatype(int_least16_t()), integer);
BOOST_MPI_DATATYPE(boost::archive::class_id_reference_type,
                   get_mpi_datatype(int_least16_t()), integer);
BOOST_MPI_DATATYPE(boost::archive::class_id_optional_type,
                   get_mpi_datatype(int_least16_t()), integer);
BOOST_MPI_DATATYPE(boost::archive::object_id_type,
                   get_mpi_datatype(uint_least32_t()), integer);
BOOST_MPI_DATATYPE(boost::archive::object_reference_type,
                   get_mpi_datatype(uint_least32_t()), integer);
BOOST_MPI_DATATYPE(boost::archive::tracking_type, get_mpi_datatype(bool()),
                   builtin);
BOOST_MPI_DATATYPE(boost::serialization::collection_size_type,
                   get_mpi_datatype(std::size_t()), integer);
BOOST_MPI_DATATYPE(boost::serialization::item_version_type,
                   get_mpi_datatype(uint_least8_t()), integer);
#endif // Doxygen
...
#define BOOST_IS_MPI_DATATYPE(T)                                               \
  namespace boost {                                                            \
  namespace mpi {                                                              \
  template <> struct is_mpi_datatype<T> : mpl::true_ {};                       \
  }                                                                            \
  }                                                                            \
  /**/
