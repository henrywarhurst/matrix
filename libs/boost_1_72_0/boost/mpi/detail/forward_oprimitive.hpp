...
template <class ImplementationArchive> class forward_oprimitive {
public:
  /// the type of the archive to which the saving of primitive types will be
  /// forwarded
  typedef ImplementationArchive implementation_archive_type;

  /// the constructor takes a reference to the implementation archive used for
  /// saving primitve types
...
public:
  ...
  template <class T> void save(const T &t) { implementation_archive << t; }
