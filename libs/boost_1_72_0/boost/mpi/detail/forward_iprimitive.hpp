...
template <class ImplementationArchive> class forward_iprimitive {
public:
  ...
  template <class T>
  void load_array(serialization::array_wrapper<T> &x,
...
public:
  ...
  template <class T> void load(T &t) { implementation_archive >> t; }
