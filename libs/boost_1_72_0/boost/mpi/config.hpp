...
/** @brief Comment this macro is you are running in an heterogeneous
 * environment.
 *
 ...
 *
 * It you do so, check that your MPI implementation supports thats kind of
 * environment.
 */
#define BOOST_MPI_HOMOGENEOUS

#if defined MPI_VERSION
/** @brief Major version of the underlying MPI implementation supproted
 * standard.
 *
 * If, for some reason, MPI_VERSION is not supported, you should probably set
 * that according to your MPI documentation
 */
...
/** @brief Major version of the underlying MPI implementation supported
 * standard.
 *
 * If, for some reason, MPI_SUBVERSION is not supported, you should probably set
 * that according to your MPI documentation
 */
...
#if !defined(BOOST_MPI_NO_LIB) && !defined(BOOST_MPI_SOURCE) &&                \
