...
#error                                                                         \
    "<boost/endian/endian.hpp> is deprecated. Define BOOST_ENDIAN_DEPRECATED_NAMES to use."
#endif
...
typedef endian_arithmetic<order::big, uint16_t, 16, align::yes>
    aligned_ubig16_t;
...
typedef endian_arithmetic<order::big, uint32_t, 32, align::yes>
    aligned_ubig32_t;
...
typedef endian_arithmetic<order::big, uint64_t, 64, align::yes>
    aligned_ubig64_t;
