...
//  Allow user to force BOOST_ENDIAN_NO_INTRINSICS in case they aren't available
//  for a particular platform/compiler combination. Please report such
//  platform/compiler combinations to the Boost mailing list.
