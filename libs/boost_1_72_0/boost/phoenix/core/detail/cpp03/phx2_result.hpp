...
template <typename F,
          ...
          typename Dummy = void>
struct has_phx2_result : mpl::false_ {};
...
#pragma wave option(preserve : 2, line : 0, output                             \
                    : "preprocessed/phx2_result_" BOOST_PHOENIX_LIMIT_STR      \
                      ".hpp")
#endif
/*=============================================================================
    Copyright (c) 2011 Thomas Heller
...
struct has_phx2_result<F, BOOST_PHOENIX_A>
    : mpl::eval_if<has_result_type<F>, mpl::false_,
                   has_phx2_result_impl<
                       typename F::template result<F(BOOST_PHOENIX_A)>>>::type {
};
