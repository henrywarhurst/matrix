...
struct number_backend_float_architype {
  ...
  number_backend_float_architype &
  operator=(const number_backend_float_architype &o) {
    m_value = o.m_value;
  ...
  number_backend_float_architype &operator=(const char *s) {
    ...
    try {
      ...
      BOOST_THROW_EXCEPTION(std::runtime_error(
          std::string("Unable to parse input string: \"") + s +
  ...
  void swap(number_backend_float_architype &o) {
    std::cout << "Swapping (" << m_value << " with " << o.m_value << ")"
              << std::endl;
...
typedef boost::multiprecision::number<number_backend_float_architype>
