...
is_valid_bitwise_op(const cpp_int_backend<MinBits1, MaxBits1, signed_magnitude,
...
BOOST_MP_CXX14_CONSTEXPR void bitwise_op(CppInt1 &result, const CppInt2 &o,
                                         Op op, const mpl::true_ &)
...
struct bit_and {
  BOOST_MP_CXX14_CONSTEXPR limb_type
  operator()(limb_type a, limb_type b) const BOOST_NOEXCEPT {
    return a & b;
  }
};
struct bit_or {
...
template <unsigned MinBits1, unsigned MaxBits1, cpp_int_check_type Checked1,
          class Allocator1>
BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    !is_trivial_cpp_int<cpp_int_backend<MinBits1, MaxBits1, unsigned_magnitude,
...
template <class Int>
inline BOOST_MP_CXX14_CONSTEXPR void left_shift_byte(Int &result,
                                                     double_limb_type s) {
...
template <class Int>
inline BOOST_MP_CXX14_CONSTEXPR void left_shift_limb(Int &result,
                                                     double_limb_type s) {
  limb_type offset = static_cast<limb_type>(s / Int::limb_bits);
  limb_type shift = static_cast<limb_type>(s % Int::limb_bits);
...
template <class Int>
inline BOOST_MP_CXX14_CONSTEXPR void left_shift_generic(Int &result,
                                                        double_limb_type s) {
  limb_type offset = static_cast<limb_type>(s / Int::limb_bits);
  limb_type shift = static_cast<limb_type>(s % Int::limb_bits);
...
template <class Int>
inline BOOST_MP_CXX14_CONSTEXPR void right_shift_byte(Int &result,
                                                      double_limb_type s) {
  limb_type offset = static_cast<limb_type>(s / Int::limb_bits);
...
template <class Int>
inline BOOST_MP_CXX14_CONSTEXPR void right_shift_limb(Int &result,
                                                      double_limb_type s) {
  limb_type offset = static_cast<limb_type>(s / Int::limb_bits);
...
template <class Int>
inline BOOST_MP_CXX14_CONSTEXPR void right_shift_generic(Int &result,
                                                         double_limb_type s) {
  limb_type offset = static_cast<limb_type>(s / Int::limb_bits);
  limb_type shift = static_cast<limb_type>(s % Int::limb_bits);
  unsigned ors = result.size();
...
template <unsigned MinBits1, unsigned MaxBits1, cpp_int_check_type Checked1,
          class Allocator1>
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    !is_trivial_cpp_int<cpp_int_backend<MinBits1, MaxBits1, signed_magnitude,
                                        Checked1, Allocator1>>::value>::type
...
BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
    typename enable_if<is_trivial_cpp_int<cpp_int_backend<
        MinBits1, MaxBits1, SignType1, Checked1, Allocator1>>>::type
    eval_left_shift(cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1,
                                    Allocator1> &result,
                    T s)
        BOOST_MP_NOEXCEPT_IF((
...
eval_bitwise_and(cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1,
  ...
  if (result.sign() || o.sign()) {
    ...
    constexpr
#endif
        const unsigned m = static_unsigned_max<
