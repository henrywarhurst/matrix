...
inline BOOST_MP_CXX14_CONSTEXPR bool eval_eq(const T &a, const U &b) {
  typedef mpl::bool_<
      boost::multiprecision::detail::is_first_backend<T, U>::value>
      tag_type;
...
inline
    ...
    BOOST_CONSTEXPR
#endif
    typename boost::enable_if_c<number_category<Backend>::value ==
...
BOOST_PREVENT_MACRO_SUBSTITUTION(
    const Arithmetic &a, const number<Backend, ExpressionTemplates> &b) {
  return a > b;
}
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    ...
    bool>::type isgreater
BOOST_PREVENT_MACRO_SUBSTITUTION(
    const Arithmetic &a, const detail::expression<Tag, A1, A2, A3, A4> &b) {
  return a > b;
}
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    ...
    bool>::type isgreater
BOOST_PREVENT_MACRO_SUBSTITUTION(
    const detail::expression<Tag, A1, A2, A3, A4> &a, const Arithmetic &b) {
  return a > b;
}
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    ...
    bool>::type islessgreater
BOOST_PREVENT_MACRO_SUBSTITUTION(
    const Arithmetic &a, const detail::expression<Tag, A1, A2, A3, A4> &bb) {
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    ...
    bool>::type islessgreater
BOOST_PREVENT_MACRO_SUBSTITUTION(
    const detail::expression<Tag, A1, A2, A3, A4> &aa, const Arithmetic &b) {
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if<
    ...
    bool>::type islessgreater
BOOST_PREVENT_MACRO_SUBSTITUTION(
    const detail::expression<Tag, A1, A2, A3, A4> &aa,
