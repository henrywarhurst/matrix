...
#else
#define INSTRUMENT_BACKEND(x)                                                  \
  std::cout << BOOST_STRINGIZE(x) << " = "                                     \
            << x.str(0, std::ios_base::scientific) << std::endl;
#endif
#endif
...
void generic_interconvert(
    To &to, const From &from,
    const mpl::int_<number_kind_floating_point> & /*to_type*/,
    const mpl::int_<number_kind_integer> & /*from_type*/);
template <class To, class From>
void generic_interconvert(To &to, const From &from,
                          const mpl::int_<number_kind_integer> & /*to_type*/,
                          const mpl::int_<number_kind_integer> & /*from_type*/);
template <class To, class From>
void generic_interconvert(
    To &to, const From &from,
    const mpl::int_<number_kind_floating_point> & /*to_type*/,
    const mpl::int_<number_kind_floating_point> & /*from_type*/);
template <class To, class From>
void generic_interconvert(
    To &to, const From &from,
    const mpl::int_<number_kind_rational> & /*to_type*/,
    const mpl::int_<number_kind_rational> & /*from_type*/);
template <class To, class From>
void generic_interconvert(To &to, const From &from,
                          const mpl::int_<number_kind_rational> & /*to_type*/,
                          const mpl::int_<number_kind_integer> & /*from_type*/);
...
// of each depending on whether the backend can be directly constructed from
// type V.
//
// Note that we have to provide *all* the template parameters to class number
// when used in enable_if as MSVC-10 won't compile the code if we rely on a
// computed-default parameter. Since the result of the test doesn't depend on
// whether expression templates are on or off we just use et_on everywhere.  We
// could use a BOOST_WORKAROUND but that just obfuscates the code even more....
//
template <class T, class V>
inline BOOST_MP_CXX14_CONSTEXPR
    typename disable_if_c<is_convertible<V, T>::value>::type
...
template <class T, class V>
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<is_convertible<V, T>::value>::type
    eval_add(T &result, V const &v) {
  T t(v);
  eval_add(result, t);
}
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<!is_same<T, U>::value && is_same<T, V>::value>::type
    eval_multiply_add(T &t, const U &u, const V &v) {
...
template <class T, class V>
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<is_convertible<V, number<T, et_on>>::value &&
                         !is_convertible<V, T>::value>::type
...
//
// Default versions of 3-arg arithmetic functions, these mostly just forward to
// the 2 arg versions:
//
template <class T, class U, class V>
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_add_default(T &t, const T &u,
                                                      const T &v) {
  if (&t == &v) {
    eval_add(t, u);
  } else if (&t == &u) {
...
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<is_convertible<U, number<T, et_on>>::value &&
...
template <class T, class U>
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<is_convertible<U, number<T, et_on>>::value>::type
    eval_add_default(T &t, const U &u, const T &v) {
  eval_add(t, v, u);
}
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_add_default(T &t, const U &u,
                                                      const V &v) {
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_subtract_default(T &t, const T &u,
                                                           const T &v) {
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_subtract_default(T &t, const U &u,
                                                           const V &v) {
  if (is_same<T, V>::value && ((void *)&t == (void *)&v)) {
    eval_subtract(t, u);
    t.negate();
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_subtract(T &t, const U &u,
                                                   const V &v) {
  eval_subtract_default(t, u, v);
}

template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_multiply_default(T &t, const T &u,
                                                           const T &v) {
  if (&t == &v) {
    eval_multiply(t, u);
  } else if (&t == &u) {
...
#endif
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_multiply_default(T &t, const U &u,
                                                           const V &v) {
  if (is_same<T, V>::value && ((void *)&t == (void *)&v)) {
    eval_multiply(t, u);
  } else {
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_multiply(T &t, const U &u,
                                                   const V &v) {
  eval_multiply_default(t, u, v);
}

template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_multiply_add(T &t, const T &u,
                                                       const T &v, const T &x) {
  if ((void *)&x == (void *)&t) {
    T z;
...
template <class T, class U>
inline BOOST_MP_CXX14_CONSTEXPR
    typename boost::disable_if_c<boost::is_same<T, U>::value, T>::type
    make_T(const U &u) {
  T t;
  t = number<T>::canonical_value(u);
  return t;
}
template <class T> inline BOOST_MP_CXX14_CONSTEXPR const T &make_T(const T &t) {
  return t;
}
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_divide_default(T &t, const T &u,
                                                         const T &v) {
  if (&t == &u)
    eval_divide(t, v);
  else if (&t == &v) {
...
#endif
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_divide_default(T &t, const U &u,
                                                         const V &v) {
  if (is_same<T, V>::value && ((void *)&t == (void *)&v)) {
    T temp;
    temp = u;
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_modulus_default(T &t, const T &u,
                                                          const T &v) {
  if (&t == &u)
    eval_modulus(t, v);
  else if (&t == &v) {
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_modulus_default(T &t, const U &u,
                                                          const V &v) {
  if (is_same<T, V>::value && ((void *)&t == (void *)&v)) {
    T temp(u);
    eval_modulus(temp, v);
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_modulus(T &t, const U &u,
                                                  const V &v) {
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_bitwise_and_default(T &t, const T &u,
                                                              const T &v) {
  if (&t == &v) {
...
template <class T, class U>
inline BOOST_MP_CXX14_CONSTEXPR
    typename disable_if_c<is_convertible<U, T>::value>::type
...
template <class T, class U>
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<is_convertible<U, T>::value>::type
    eval_bitwise_and_default(T &t, const T &u, const U &v) {
  T vv(v);
  eval_bitwise_and(t, u, vv);
}
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_bitwise_and(T &t, const U &u,
                                                      const V &v) {
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_bitwise_or_default(T &t, const T &u,
                                                             const T &v) {
  if (&t == &v) {
    eval_bitwise_or(t, u);
  } else if (&t == &u) {
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_bitwise_or_default(T &t, const U &u,
                                                             const V &v) {
  if (is_same<T, V>::value && ((void *)&t == (void *)&v)) {
    eval_bitwise_or(t, u);
  } else {
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_bitwise_or(T &t, const U &u,
                                                     const V &v) {
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_bitwise_xor_default(T &t, const T &u,
                                                              const T &v) {
  if (&t == &v) {
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_bitwise_xor_default(T &t, const U &u,
                                                              const V &v) {
  if (is_same<T, V>::value && ((void *)&t == (void *)&v)) {
    eval_bitwise_xor(t, u);
  } else {
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_bitwise_xor(T &t, const U &u,
                                                      const V &v) {
  eval_bitwise_xor_default(t, u, v);
}

template <class T> inline BOOST_MP_CXX14_CONSTEXPR void eval_increment(T &val) {
  typedef typename mpl::front<typename T::unsigned_types>::type ui_type;
  eval_add(val, static_cast<ui_type>(1u));
}
template <class T> inline BOOST_MP_CXX14_CONSTEXPR void eval_decrement(T &val) {
  typedef typename mpl::front<typename T::unsigned_types>::type ui_type;
  eval_subtract(val, static_cast<ui_type>(1u));
}

template <class T, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_left_shift(T &result, const T &arg,
                                                     const V val) {
  result = arg;
...
template <class T, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_right_shift(T &result, const T &arg,
                                                      const V val) {
  result = arg;
...
template <class T, class V, class U>
inline BOOST_MP_CXX14_CONSTEXPR void assign_components(T &result, const V &v1,
                                                       const U &v2) {
...
#endif
template <class R, int b> struct has_enough_bits {
  template <class T>
  struct type
      : public mpl::and_<mpl::not_<is_same<R, T>>,
                         mpl::bool_<std::numeric_limits<T>::digits >= b>> {};
};

template <class R> struct terminal {
...
template <class R, class B> struct calculate_next_larger_type {
  // Find which list we're looking through:
  typedef typename mpl::if_<
      is_signed<R>, typename B::signed_types,
      typename mpl::if_<is_unsigned<R>, typename B::unsigned_types,
                        typename B::float_types>::type>::type list_type;
  // A predicate to find a type with enough bits:
  typedef typename has_enough_bits<
      R, std::numeric_limits<R>::digits>::template type<mpl::_>
      pred_type;
  // See if the last type is in the list, if so we have to start after this:
  typedef typename mpl::find_if<list_type, is_same<R, mpl::_>>::type start_last;
  // Where we're starting from, either the start of the sequence or the last
  // type found:
  typedef
      typename mpl::if_<is_same<start_last, typename mpl::end<list_type>::type>,
                        typename mpl::begin<list_type>::type, start_last>::type
          start_seq;
  // The range we're searching:
  typedef mpl::iterator_range<start_seq, typename mpl::end<list_type>::type>
      range;
  // Find the next type:
  typedef typename mpl::find_if<range, pred_type>::type iter_type;
  // Either the next type, or a "terminal" to indicate we've run out of types to
  // search:
  typedef typename mpl::eval_if<
      is_same<typename mpl::end<list_type>::type, iter_type>,
      mpl::identity<terminal<R>>, mpl::deref<iter_type>>::type type;
};

template <class R, class T>
inline BOOST_MP_CXX14_CONSTEXPR
    typename boost::enable_if_c<boost::is_integral<R>::value, bool>::type
    check_in_range(const T &t) {
  // Can t fit in an R?
  if ((t > 0) && std::numeric_limits<R>::is_specialized &&
      std::numeric_limits<R>::is_bounded &&
...
inline BOOST_MP_CXX14_CONSTEXPR
    typename boost::enable_if_c<boost::is_integral<R>::value>::type
  ...
  } else if (std::numeric_limits<R>::is_specialized &&
             std::numeric_limits<R>::is_bounded &&
...
template <class R, class B>
inline BOOST_MP_CXX14_CONSTEXPR
    typename boost::disable_if_c<boost::is_integral<R>::value>::type
    eval_convert_to(R *result, const B &backend) {
  typedef typename calculate_next_larger_type<R, B>::type next_type;
  next_type n = next_type();
  eval_convert_to(&n, backend);
  if (std::numeric_limits<R>::is_specialized &&
      ...
      ((n > (next_type)(std::numeric_limits<R>::max)() ||
        (n < (next_type) - (std::numeric_limits<R>::max)())))) {
    *result = n > 0 ? (std::numeric_limits<R>::max)()
...
inline void last_chance_eval_convert_to(terminal<R> *result, const B &backend,
  ...
  if (std::numeric_limits<R>::is_integer &&
      !std::numeric_limits<R>::is_signed && (eval_get_sign(backend) < 0))
    BOOST_THROW_EXCEPTION(
        std::range_error("Attempt to convert negative value to an unsigned "
                         "integer results in undefined behaviour"));
  try {
    result->value =
        boost::lexical_cast<R>(backend.str(0, std::ios_base::fmtflags(0)));
  } catch (const bad_lexical_cast &) {
    if (eval_get_sign(backend) < 0) {
      *result = std::numeric_limits<R>::is_integer &&
...
inline void last_chance_eval_convert_to(terminal<R> *result, const B &backend,
  ...
  try {
    ...
    result->value =
        boost::lexical_cast<R>(t.str(0, std::ios_base::fmtflags(0)));
  } catch (const bad_lexical_cast &) {
    if (eval_get_sign(backend) < 0) {
      *result = std::numeric_limits<R>::is_integer &&
                        std::numeric_limits<R>::is_signed
...
template <class R, class B>
inline BOOST_MP_CXX14_CONSTEXPR void eval_convert_to(terminal<R> *result,
                                                     const B &backend) {
...
inline BOOST_MP_CXX14_CONSTEXPR void
eval_convert_to(terminal<number<B1, et>> *result, const B2 &backend) {
  //
  // We ran out of types to try for the conversion, try
...
template <class B>
inline BOOST_MP_CXX14_CONSTEXPR void eval_convert_to(std::string *result,
                                                     const B &backend) {
...
template <class B>
inline BOOST_MP_CXX14_CONSTEXPR void
eval_convert_to(std::complex<float> *result, const B &backend) {
  typedef typename scalar_result_from_possible_complex<
      multiprecision::number<B>>::type scalar_type;
  scalar_type re, im;
  eval_real(re.backend(), backend);
  eval_imag(im.backend(), backend);

  *result = std::complex<float>(re.template convert_to<float>(),
                                im.template convert_to<float>());
}

template <class B>
inline BOOST_MP_CXX14_CONSTEXPR void
eval_convert_to(std::complex<double> *result, const B &backend) {
  typedef typename scalar_result_from_possible_complex<
      multiprecision::number<B>>::type scalar_type;
  scalar_type re, im;
  eval_real(re.backend(), backend);
  ...
  *result = std::complex<double>(re.template convert_to<double>(),
                                 im.template convert_to<double>());
}

template <class B>
inline BOOST_MP_CXX14_CONSTEXPR void
eval_convert_to(std::complex<long double> *result, const B &backend) {
  typedef typename scalar_result_from_possible_complex<
      multiprecision::number<B>>::type scalar_type;
  scalar_type re, im;
  eval_real(re.backend(), backend);
...
inline BOOST_MP_CXX14_CONSTEXPR int eval_fpclassify(const Backend &arg) {
  BOOST_STATIC_ASSERT_MSG(
      number_category<Backend>::value == number_kind_floating_point,
      "The fpclassify function is only valid for floating point types.");
  return eval_is_zero(arg) ? FP_ZERO : FP_NORMAL;
}

template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_fmod(T &result, const T &a,
                                               const T &b) {
  BOOST_STATIC_ASSERT_MSG(
      number_category<T>::value == number_kind_floating_point,
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if<is_arithmetic<A>, void>::type
eval_fmod(T &result, const T &x, const A &a) {
  typedef typename boost::multiprecision::detail::canonical<A, T>::type
      canonical_type;
  typedef typename mpl::if_<is_same<A, canonical_type>, T, canonical_type>::type
      cast_type;
  cast_type c;
  c = a;
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_remquo(T &result, const T &a,
                                                 const T &b, int *pi) {
  BOOST_STATIC_ASSERT_MSG(
      number_category<T>::value == number_kind_floating_point,
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_remainder(T &result, const U &a,
                                                    const V &b) {
  int i(0);
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_fdim(T &result, const T &a,
                                               const T &b) {
  typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type
      ui_type;
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR
    typename boost::enable_if_c<boost::is_arithmetic<A>::value>::type
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void eval_modf(T &result, T const &arg,
                                               T *pipart) {
  typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type
      ui_type;
...
inline BOOST_MP_CXX14_CONSTEXPR void eval_round(T &result, const T &a) {
  ...
  typedef
      typename boost::multiprecision::detail::canonical<float, T>::type fp_type;
...
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if<is_integral<Arithmetic>>::type
...
template <class T> inline BOOST_MP_CXX14_CONSTEXPR int eval_msb(const T &val) {
  int c = eval_get_sign(val);
  if (c == 0) {
    BOOST_THROW_EXCEPTION(std::range_error("No bits were set in the operand."));
  }
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR bool eval_bit_test(const T &val,
                                                   unsigned index) {
  typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type
      ui_type;
  T mask, t;
...
void BOOST_MP_CXX14_CONSTEXPR eval_integer_sqrt(B &s, B &r, const B &x) {
  ...
  //
  typedef
      typename boost::multiprecision::detail::canonical<unsigned char, B>::type
          ui_type;
...
//
template <class B>
inline BOOST_MP_CXX14_CONSTEXPR typename B::exponent_type
eval_ilogb(const B &val) {
  BOOST_STATIC_ASSERT_MSG(
...
template <class T> BOOST_MP_CXX14_CONSTEXPR int eval_signbit(const T &val);
...
inline BOOST_MP_CXX14_CONSTEXPR void eval_logb(B &result, const B &val) {
  ...
  typedef
      typename boost::mpl::if_c<boost::is_same<boost::intmax_t, long>::value,
                                boost::long_long_type, boost::intmax_t>::type
          max_t;
...
template <class B, class A>
inline BOOST_MP_CXX14_CONSTEXPR void eval_scalbln(B &result, const B &val,
                                                  A e) {
...
is_arg_nan(const T &val, mpl::true_ const &, const mpl::false_ &) {
  return eval_fpclassify(val) == FP_NAN;
}
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR bool
is_arg_nan(const T &val, mpl::false_ const &, const mpl::true_ &) {
  return (boost::math::isnan)(val);
}
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR bool is_arg_nan(const T &, mpl::false_ const &,
                                                const mpl::false_ &) {
  return false;
}
...
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_fmax(T &result, const U &a,
                                               const V &b) {
  if (is_arg_nan(a))
    result = number<T>::canonical_value(b);
  else if (is_arg_nan(b))
    result = number<T>::canonical_value(a);
  else if (eval_lt(number<T>::canonical_value(a),
                   number<T>::canonical_value(b)))
    result = number<T>::canonical_value(b);
  else
    result = number<T>::canonical_value(a);
}
template <class T, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR void eval_fmin(T &result, const U &a,
                                               const V &b) {
  if (is_arg_nan(a))
    result = number<T>::canonical_value(b);
  else if (is_arg_nan(b))
...
inline BOOST_MP_CXX14_CONSTEXPR void eval_hypot(R &result, const T &a,
                                                const U &b) {
  //
...
template <class To, class From>
inline BOOST_MP_CXX14_CONSTEXPR void eval_set_real_imp(To &to,
                                                       const From &from) {
...
template <class To, class From>
inline BOOST_MP_CXX14_CONSTEXPR void eval_set_imag_imp(To &to,
                                                       const From &from) {
  typedef typename component_type<number<To>>::type to_component_type;
  typename to_component_type::backend_type to_component;
  to_component = from;
...
template <class To, class From>
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<number_category<To>::value ==
...
template <class To, class From>
inline BOOST_MP_CXX14_CONSTEXPR
    typename disable_if_c<number_category<To>::value ==
                          number_kind_complex>::type
    eval_set_real(To &to, const From &from) {
  to = from;
}
...
template <class T> void BOOST_MP_CXX14_CONSTEXPR eval_set_imag(T &, const T &) {
  BOOST_STATIC_ASSERT_MSG(
      sizeof(T) == INT_MAX,
...
inline BOOST_MP_CXX14_CONSTEXPR int fpclassify BOOST_PREVENT_MACRO_SUBSTITUTION(
    const multiprecision::detail::expression<tag, A1, A2, A3, A4> &arg) {
  typedef
      typename multiprecision::detail::expression<tag, A1, A2, A3,
                                                  A4>::result_type value_type;
...
// Default versions of sign manipulation functions, if individual backends can
// do better than this (for example with signed zero), then they should overload
...
inline BOOST_MP_CXX14_CONSTEXPR
    multiprecision::number<Backend, ExpressionTemplates>
        copysign BOOST_PREVENT_MACRO_SUBSTITUTION(
            const multiprecision::number<Backend, ExpressionTemplates> &a,
  ...
  return (boost::multiprecision::signbit)(a) !=
             ...
             ? (boost::multiprecision::changesign)(a)
             : a;
}
template <class Backend,
          multiprecision::expression_template_option ExpressionTemplates,
...
inline BOOST_MP_CXX14_CONSTEXPR
  ...
  typedef
      typename multiprecision::detail::expression<tag, A1, A2, A3,
                                                  A4>::result_type value_type;
  return copysign BOOST_PREVENT_MACRO_SUBSTITUTION(value_type(a),
                                                   value_type(b));
}
//
// real and imag:
...
real(const multiprecision::number<Backend, ExpressionTemplates> &a) {
  ...
  typedef typename scalar_result_from_possible_complex<
      multiprecision::number<Backend, ExpressionTemplates>>::type result_type;
  boost::multiprecision::detail::scoped_default_precision<result_type>
      precision_guard(a);
  result_type result;
...
//
// Complex number functions, these are overloaded at the Backend level, we just
// provide the expression template versions here, plus overloads for non-complex
// types:
//
...
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<number_category<T>::value == number_kind_complex,
...
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<number_category<T>::value ==
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    number_category<typename detail::expression<
        tag, A1, A2, A3, A4>::result_type>::value == number_kind_complex ||
        number_category<typename detail::expression<tag, A1, A2, A3, A4>::
...
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR
    typename boost::enable_if_c<number_category<T>::value !=
                                    number_kind_complex,
                                typename scalar_result_from_possible_complex<
                                    number<T, ExpressionTemplates>>::type>::type
    norm(const number<T, ExpressionTemplates> &v) {
...
BOOST_MP_CXX14_CONSTEXPR typename complex_result_from_scalar<
...
polar(number<Backend, ExpressionTemplates> const &r,
  ...
  return typename complex_result_from_scalar<
      ...
      type(number<Backend, ExpressionTemplates>(r * cos(theta)),
           number<Backend, ExpressionTemplates>(r * sin(theta)));
}

template <class tag, class A1, class A2, class A3, class A4, class Backend,
          expression_template_option ExpressionTemplates>
BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    boost::is_same<
    ...
    typename complex_result_from_scalar<
        number<Backend, ExpressionTemplates>>::type>::type
...
BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    boost::is_same<
        typename detail::expression<tag, A1, A2, A3, A4>::result_type,
        typename detail::expression<tagb, A1b, A2b, A3b,
                                    A4b>::result_type>::value,
    typename complex_result_from_scalar<typename detail::expression<
        tag, A1, A2, A3, A4>::result_type>::type>::type
polar(detail::expression<tag, A1, A2, A3, A4> const &r,
      detail::expression<tagb, A1b, A2b, A3b, A4b> const &theta) {
  typedef
      typename detail::expression<tag, A1, A2, A3, A4>::result_type scalar_type;
  return typename complex_result_from_scalar<scalar_type>::type(
      scalar_type(r * cos(theta)), scalar_type(r * sin(theta)));
}
//
// We also allow the first argument to polar to be an arithmetic type (probably
// a literal):
//
...
BOOST_MP_CXX14_CONSTEXPR
    typename boost::enable_if_c<boost::is_arithmetic<Scalar>::value,
                                typename complex_result_from_scalar<number<
                                    Backend, ExpressionTemplates>>::type>::type
...
BOOST_PREVENT_MACRO_SUBSTITUTION(
    const multiprecision::number<Backend, ExpressionTemplates> &arg) {
  detail::scoped_default_precision<
      multiprecision::number<Backend, ExpressionTemplates>>
      precision_guard(arg);
...
inline BOOST_MP_CXX14_CONSTEXPR
  ...
  if ((boost::multiprecision::isnan)(result) &&
      !(boost::multiprecision::isnan)(arg)) {
    result = std::numeric_limits<
        multiprecision::number<Backend, ExpressionTemplates>>::infinity();
    errno = ERANGE;
  }
  return result;
}
...
inline BOOST_MP_CXX14_CONSTEXPR
  ...
  if ((arg == 0) &&
      std::numeric_limits<
          multiprecision::number<Backend, ExpressionTemplates>>::has_infinity) {
    errno = ERANGE;
    return 1 / arg;
  }
...
inline BOOST_MP_CXX14_CONSTEXPR
  ...
  return nextafter BOOST_PREVENT_MACRO_SUBSTITUTION(value_type(a),
                                                    value_type(b));
}
template <class Backend,
          multiprecision::expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR
  ...
  typedef
      typename multiprecision::detail::expression<tag, A1, A2, A3,
                                                  A4>::result_type value_type;
  detail::scoped_default_precision<value_type> precision_guard(a, b);
  return nexttoward BOOST_PREVENT_MACRO_SUBSTITUTION(value_type(a),
                                                     value_type(b));
}

template <class B1, class B2, class B3, expression_template_option ET1,
          expression_template_option ET2, expression_template_option ET3>
inline BOOST_MP_CXX14_CONSTEXPR number<B1, ET1> &add(number<B1, ET1> &result,
                                                     const number<B2, ET2> &a,
                                                     const number<B3, ET3> &b) {
  BOOST_STATIC_ASSERT_MSG(
      (is_convertible<B2, B1>::value),
      "No conversion to the target of a mixed precision addition exists");
  BOOST_STATIC_ASSERT_MSG(
      (is_convertible<B3, B1>::value),
      "No conversion to the target of a mixed precision addition exists");
...
template <class B1, class B2, class B3, expression_template_option ET1,
          expression_template_option ET2, expression_template_option ET3>
inline BOOST_MP_CXX14_CONSTEXPR number<B1, ET1> &
subtract(number<B1, ET1> &result, const number<B2, ET2> &a,
         const number<B3, ET3> &b) {
  BOOST_STATIC_ASSERT_MSG(
      (is_convertible<B2, B1>::value),
      "No conversion to the target of a mixed precision addition exists");
...
template <class B1, class B2, class B3, expression_template_option ET1,
          expression_template_option ET2, expression_template_option ET3>
inline BOOST_MP_CXX14_CONSTEXPR number<B1, ET1> &
multiply(number<B1, ET1> &result, const number<B2, ET2> &a,
         const number<B3, ET3> &b) {
  BOOST_STATIC_ASSERT_MSG(
      (is_convertible<B2, B1>::value),
      "No conversion to the target of a mixed precision addition exists");
...
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<is_integral<I>::value, number<B, ET> &>::type
    add(number<B, ET> &result, const I &a, const I &b) {
  using default_ops::eval_add;
  typedef typename detail::canonical<I, B>::type canonical_type;
  eval_add(result.backend(), static_cast<canonical_type>(a),
           static_cast<canonical_type>(b));
  return result;
}
...
inline BOOST_MP_CXX14_CONSTEXPR
  ...
  using default_ops::eval_subtract;
  typedef typename detail::canonical<I, B>::type canonical_type;
  eval_subtract(result.backend(), static_cast<canonical_type>(a),
                static_cast<canonical_type>(b));
  return result;
}
...
inline BOOST_MP_CXX14_CONSTEXPR
  ...
  using default_ops::eval_multiply;
  typedef typename detail::canonical<I, B>::type canonical_type;
  eval_multiply(result.backend(), static_cast<canonical_type>(a),
                static_cast<canonical_type>(b));
  return result;
}
...
template <class tag, class A1, class A2, class A3, class A4, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR int
itrunc(const detail::expression<tag, A1, A2, A3, A4> &v, const Policy &pol) {
  typedef
      typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
  number_type r(trunc(v, pol));
  if ((r > (std::numeric_limits<int>::max)()) ||
      r < (std::numeric_limits<int>::min)() || !(boost::math::isfinite)(v))
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::itrunc<%1%>(%1%)", 0, number_type(v), 0, pol);
  return r.template convert_to<int>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR int
itrunc(const detail::expression<tag, A1, A2, A3, A4> &v) {
  return itrunc(v, boost::math::policies::policy<>());
}
template <class Backend, expression_template_option ExpressionTemplates,
          class Policy>
inline BOOST_MP_CXX14_CONSTEXPR int
itrunc(const number<Backend, ExpressionTemplates> &v, const Policy &pol) {
  number<Backend, ExpressionTemplates> r(trunc(v, pol));
  if ((r > (std::numeric_limits<int>::max)()) ||
      r < (std::numeric_limits<int>::min)() || !(boost::math::isfinite)(v))
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::itrunc<%1%>(%1%)", 0, v, 0, pol);
  return r.template convert_to<int>();
}
template <class Backend, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR int
itrunc(const number<Backend, ExpressionTemplates> &v) {
  return itrunc(v, boost::math::policies::policy<>());
}
template <class tag, class A1, class A2, class A3, class A4, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR long
ltrunc(const detail::expression<tag, A1, A2, A3, A4> &v, const Policy &pol) {
  typedef
      typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
  number_type r(trunc(v, pol));
  if ((r > (std::numeric_limits<long>::max)()) ||
      r < (std::numeric_limits<long>::min)() || !(boost::math::isfinite)(v))
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::ltrunc<%1%>(%1%)", 0, number_type(v), 0L, pol);
  return r.template convert_to<long>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR long
ltrunc(const detail::expression<tag, A1, A2, A3, A4> &v) {
  return ltrunc(v, boost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR long
ltrunc(const number<T, ExpressionTemplates> &v, const Policy &pol) {
  number<T, ExpressionTemplates> r(trunc(v, pol));
  if ((r > (std::numeric_limits<long>::max)()) ||
      r < (std::numeric_limits<long>::min)() || !(boost::math::isfinite)(v))
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::ltrunc<%1%>(%1%)", 0, v, 0L, pol);
  return r.template convert_to<long>();
}
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR long
ltrunc(const number<T, ExpressionTemplates> &v) {
  return ltrunc(v, boost::math::policies::policy<>());
}
#ifndef BOOST_NO_LONG_LONG
template <class tag, class A1, class A2, class A3, class A4, class Policy>
...
lltrunc(const detail::expression<tag, A1, A2, A3, A4> &v, const Policy &pol) {
  ...
  if ((r > (std::numeric_limits<boost::long_long_type>::max)()) ||
    ...
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::lltrunc<%1%>(%1%)", 0, number_type(v), 0LL,
        pol);
...
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR boost::long_long_type
lltrunc(const number<T, ExpressionTemplates> &v, const Policy &pol) {
  number<T, ExpressionTemplates> r(trunc(v, pol));
  if ((r > (std::numeric_limits<boost::long_long_type>::max)()) ||
      r < (std::numeric_limits<boost::long_long_type>::min)() ||
      !(boost::math::isfinite)(v))
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::lltrunc<%1%>(%1%)", 0, v, 0LL, pol);
  return r.template convert_to<boost::long_long_type>();
}
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR boost::long_long_type
lltrunc(const number<T, ExpressionTemplates> &v) {
  return lltrunc(v, boost::math::policies::policy<>());
}
#endif
template <class tag, class A1, class A2, class A3, class A4, class Policy>
...
round(const number<T, ExpressionTemplates> &v, const Policy &) {
  ...
  detail::scoped_default_precision<
      multiprecision::number<T, ExpressionTemplates>>
      precision_guard(v);
...
template <class tag, class A1, class A2, class A3, class A4, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR int
iround(const detail::expression<tag, A1, A2, A3, A4> &v, const Policy &pol) {
  typedef
      typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
  ...
  if ((r > (std::numeric_limits<int>::max)()) ||
      r < (std::numeric_limits<int>::min)() || !(boost::math::isfinite)(v))
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::iround<%1%>(%1%)", 0, number_type(v), 0, pol);
  return r.template convert_to<int>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR int
iround(const detail::expression<tag, A1, A2, A3, A4> &v) {
  return iround(v, boost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR int
iround(const number<T, ExpressionTemplates> &v, const Policy &pol) {
  number<T, ExpressionTemplates> r(round(v, pol));
  if ((r > (std::numeric_limits<int>::max)()) ||
      r < (std::numeric_limits<int>::min)() || !(boost::math::isfinite)(v))
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::iround<%1%>(%1%)", 0, v, 0, pol);
  return r.template convert_to<int>();
}
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR int
iround(const number<T, ExpressionTemplates> &v) {
  return iround(v, boost::math::policies::policy<>());
}
template <class tag, class A1, class A2, class A3, class A4, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR long
lround(const detail::expression<tag, A1, A2, A3, A4> &v, const Policy &pol) {
  typedef
      typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
  number_type r(round(v, pol));
  if ((r > (std::numeric_limits<long>::max)()) ||
      r < (std::numeric_limits<long>::min)() || !(boost::math::isfinite)(v))
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::lround<%1%>(%1%)", 0, number_type(v), 0L, pol);
  return r.template convert_to<long>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR long
lround(const detail::expression<tag, A1, A2, A3, A4> &v) {
  return lround(v, boost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR long
lround(const number<T, ExpressionTemplates> &v, const Policy &pol) {
  number<T, ExpressionTemplates> r(round(v, pol));
  if ((r > (std::numeric_limits<long>::max)()) ||
      r < (std::numeric_limits<long>::min)() || !(boost::math::isfinite)(v))
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::lround<%1%>(%1%)", 0, v, 0L, pol);
  return r.template convert_to<long>();
}
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR long
lround(const number<T, ExpressionTemplates> &v) {
  return lround(v, boost::math::policies::policy<>());
}
#ifndef BOOST_NO_LONG_LONG
template <class tag, class A1, class A2, class A3, class A4, class Policy>
...
llround(const detail::expression<tag, A1, A2, A3, A4> &v, const Policy &pol) {
  ...
  if ((r > (std::numeric_limits<boost::long_long_type>::max)()) ||
      ...
      !(boost::math::isfinite)(v))
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::iround<%1%>(%1%)", 0, number_type(v), 0LL, pol);
  return r.template convert_to<boost::long_long_type>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR boost::long_long_type
...
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR boost::long_long_type
llround(const number<T, ExpressionTemplates> &v, const Policy &pol) {
  number<T, ExpressionTemplates> r(round(v, pol));
  if ((r > (std::numeric_limits<boost::long_long_type>::max)()) ||
      r < (std::numeric_limits<boost::long_long_type>::min)() ||
      !(boost::math::isfinite)(v))
    return boost::math::policies::raise_rounding_error(
        "boost::multiprecision::iround<%1%>(%1%)", 0, v, 0LL, pol);
  return r.template convert_to<boost::long_long_type>();
}
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR boost::long_long_type
llround(const number<T, ExpressionTemplates> &v) {
  return llround(v, boost::math::policies::policy<>());
}
#endif
//
...
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<number_category<T>::value ==
                             number_kind_floating_point,
                         number<T, ExpressionTemplates>>::type
    frexp(const number<T, ExpressionTemplates> &v,
...
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<number_category<T>::value ==
                             number_kind_floating_point,
                         number<T, ExpressionTemplates>>::type
    modf(const number<T, ExpressionTemplates> &v,
         number<T, ExpressionTemplates> *pipart) {
...
template <class T, expression_template_option ExpressionTemplates, class tag,
          class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<number_category<T>::value ==
                             number_kind_floating_point,
                         number<T, ExpressionTemplates>>::type
    modf(const detail::expression<tag, A1, A2, A3, A4> &v,
         number<T, ExpressionTemplates> *pipart) {
  using default_ops::eval_modf;
  detail::scoped_default_precision<
      multiprecision::number<T, ExpressionTemplates>>
...
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<number_category<B>::value == number_kind_integer,
...
struct fma_func {
  ...
  BOOST_MP_CXX14_CONSTEXPR void operator()(B &result, const T &a, const U &b,
                                           const V &c) const {
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if<
    mpl::and_<
        mpl::bool_<number_category<number<Backend, et_on>>::value ==
                   number_kind_floating_point>,
        mpl::or_<is_number<U>, is_number_expression<U>, is_arithmetic<U>>,
        mpl::or_<is_number<V>, is_number_expression<V>, is_arithmetic<V>>>,
    detail::expression<detail::function, default_ops::fma_func,
                       number<Backend, et_on>, U, V>>::type
fma(const number<Backend, et_on> &a, const U &b, const V &c) {
  return detail::expression<detail::function, default_ops::fma_func,
                            number<Backend, et_on>, U, V>(
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if<
    mpl::and_<
        mpl::bool_<number_category<typename detail::expression<
                       tag, Arg1, Arg2, Arg3, Arg4>::result_type>::value ==
                   number_kind_floating_point>,
        mpl::or_<is_number<U>, is_number_expression<U>, is_arithmetic<U>>,
        mpl::or_<is_number<V>, is_number_expression<V>, is_arithmetic<V>>>,
    detail::expression<detail::function, default_ops::fma_func,
                       detail::expression<tag, Arg1, Arg2, Arg3, Arg4>, U,
                       V>>::type
fma(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4> &a, const U &b,
    const V &c) {
  return detail::expression<detail::function, default_ops::fma_func,
                            detail::expression<tag, Arg1, Arg2, Arg3, Arg4>, U,
                            V>(default_ops::fma_func(), a, b, c);
}

template <class Backend, class U, class V>
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if<
    mpl::and_<
        mpl::bool_<number_category<number<Backend, et_off>>::value ==
                   number_kind_floating_point>,
        mpl::or_<is_number<U>, is_number_expression<U>, is_arithmetic<U>>,
        mpl::or_<is_number<V>, is_number_expression<V>, is_arithmetic<V>>>,
...
fma(const number<Backend, et_off> &a, const U &b, const V &c) {
  ...
  detail::scoped_default_precision<multiprecision::number<Backend, et_off>>
      precision_guard(a, b, c);
  number<Backend, et_off> result;
  eval_multiply_add(result.backend(),
                    number<Backend, et_off>::canonical_value(a),
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if<
    ...
    detail::expression<detail::function, default_ops::fma_func, U,
                       ...
                       V>>::type
fma(const U &a, const detail::expression<tag, Arg1, Arg2, Arg3, Arg4> &b,
    const V &c) {
  return detail::expression<detail::function, default_ops::fma_func, U,
                            detail::expression<tag, Arg1, Arg2, Arg3, Arg4>, V>(
      default_ops::fma_func(), a, b, c);
}
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if<
    mpl::and_<mpl::bool_<number_category<number<Backend, et_on>>::value ==
                         number_kind_floating_point>,
              is_arithmetic<U>, is_arithmetic<V>>,
...
fma(const U &a, const V &b, const number<Backend, et_on> &c) {
  return detail::expression<detail::function, default_ops::fma_func, U, V,
                            number<Backend, et_on>>(default_ops::fma_func(), a,
                                                    b, c);
}

template <class U, class V, class tag, class Arg1, class Arg2, class Arg3,
          class Arg4>
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if<
    mpl::and_<mpl::bool_<number_category<typename detail::expression<
                             tag, Arg1, Arg2, Arg3, Arg4>::result_type>::
                             value == number_kind_floating_point>,
              is_arithmetic<U>, is_arithmetic<V>>,
    detail::expression<detail::function, default_ops::fma_func, U, V,
                       detail::expression<tag, Arg1, Arg2, Arg3, Arg4>>>::type
fma(const U &a, const V &b,
    const detail::expression<tag, Arg1, Arg2, Arg3, Arg4> &c) {
  return detail::expression<detail::function, default_ops::fma_func, U, V,
                            detail::expression<tag, Arg1, Arg2, Arg3, Arg4>>(
      default_ops::fma_func(), a, b, c);
}
...
template <class U, class V, class Backend>
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if<
    mpl::and_<mpl::bool_<number_category<number<Backend, et_off>>::value ==
                         number_kind_floating_point>,
              is_arithmetic<U>, is_arithmetic<V>>,
    number<Backend, et_off>>::type
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    number_category<number<Backend, et_on>>::value ==
        number_kind_floating_point,
    detail::expression<detail::function, default_ops::remquo_func,
                       number<Backend, et_on>, U, int *>>::type
remquo(const number<Backend, et_on> &a, const U &b, int *pi) {
  return detail::expression<detail::function, default_ops::remquo_func,
                            number<Backend, et_on>, U, int *>(
      default_ops::remquo_func(), a, b, pi);
}

template <class tag, class Arg1, class Arg2, class Arg3, class Arg4, class U>
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    number_category<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::
                        result_type>::value == number_kind_floating_point,
    detail::expression<detail::function, default_ops::remquo_func,
                       detail::expression<tag, Arg1, Arg2, Arg3, Arg4>, U,
                       int *>>::type
remquo(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4> &a, const U &b,
       int *pi) {
  return detail::expression<detail::function, default_ops::remquo_func,
                            detail::expression<tag, Arg1, Arg2, Arg3, Arg4>, U,
                            int *>(default_ops::remquo_func(), a, b, pi);
}
...
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<
    ...
    detail::expression<detail::function, default_ops::remquo_func, U,
                       detail::expression<tag, Arg1, Arg2, Arg3, Arg4>,
                       int *>>::type
remquo(const U &a, const detail::expression<tag, Arg1, Arg2, Arg3, Arg4> &b,
       int *pi) {
  return detail::expression<detail::function, default_ops::remquo_func, U,
                            detail::expression<tag, Arg1, Arg2, Arg3, Arg4>,
                            int *>(default_ops::remquo_func(), a, b, pi);
...
template <class Backend, class U>
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<number_category<number<Backend, et_on>>::value ==
                             number_kind_floating_point,
                         number<Backend, et_off>>::type
  ...
  detail::scoped_default_precision<multiprecision::number<Backend, et_off>>
      precision_guard(a, b);
  number<Backend, et_off> result;
  eval_remquo(result.backend(), a.backend(),
              number<Backend, et_off>::canonical_value(b), pi);
  return result;
}
template <class U, class Backend>
inline BOOST_MP_CXX14_CONSTEXPR
  ...
  detail::scoped_default_precision<multiprecision::number<Backend, et_off>>
      precision_guard(a, b);
  number<Backend, et_off> result;
  eval_remquo(result.backend(), number<Backend, et_off>::canonical_value(a),
              b.backend(), pi);
  return result;
}
...
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<number_category<B>::value == number_kind_integer,
                         number<B, ExpressionTemplates>>::type
    sqrt(const number<B, ExpressionTemplates> &x,
         number<B, ExpressionTemplates> &r) {
  using default_ops::eval_integer_sqrt;
  detail::scoped_default_precision<
      multiprecision::number<B, ExpressionTemplates>>
      precision_guard(x, r);
...
namespace detail {
template <class Backend> struct abs_funct {
  BOOST_MP_CXX14_CONSTEXPR void operator()(Backend &result,
                                           const Backend &arg) const {
    using default_ops::eval_abs;
    eval_abs(result, arg);
  }
};
template <class Backend> struct conj_funct {
  BOOST_MP_CXX14_CONSTEXPR void operator()(Backend &result,
                                           const Backend &arg) const {
...
template <class Backend> struct proj_funct {
  BOOST_MP_CXX14_CONSTEXPR void operator()(Backend &result,
                                           const Backend &arg) const {
...
inline BOOST_MP_CXX14_CONSTEXPR typename boost::disable_if_c<
    ...
    detail::expression<detail::function,
                       detail::abs_funct<typename detail::backend_type<
                           detail::expression<tag, A1, A2, A3, A4>>::type>,
                       detail::expression<tag, A1, A2, A3, A4>>>::type
abs(const detail::expression<tag, A1, A2, A3, A4> &arg) {
  return detail::expression<detail::function,
                            detail::abs_funct<typename detail::backend_type<
                                detail::expression<tag, A1, A2, A3, A4>>::type>,
...
inline BOOST_MP_CXX14_CONSTEXPR typename disable_if_c<
    number_category<Backend>::value == number_kind_complex,
    detail::expression<detail::function, detail::abs_funct<Backend>,
                       number<Backend, et_on>>>::type
abs(const number<Backend, et_on> &arg) {
  return detail::expression<detail::function, detail::abs_funct<Backend>,
                            number<Backend, et_on>>(
      detail::abs_funct<Backend>(), arg);
}
template <class Backend>
inline BOOST_MP_CXX14_CONSTEXPR
    typename disable_if_c<number_category<Backend>::value ==
                              number_kind_complex,
                          number<Backend, et_off>>::type
...
inline BOOST_MP_CXX14_CONSTEXPR
    detail::expression<detail::function,
                       detail::conj_funct<typename detail::backend_type<
                           detail::expression<tag, A1, A2, A3, A4>>::type>,
                       detail::expression<tag, A1, A2, A3, A4>>
...
template <class Backend>
inline BOOST_MP_CXX14_CONSTEXPR
    detail::expression<detail::function, detail::conj_funct<Backend>,
                       number<Backend, et_on>>
    conj(const number<Backend, et_on> &arg) {
  return detail::expression<detail::function, detail::conj_funct<Backend>,
                            number<Backend, et_on>>(
...
inline BOOST_MP_CXX14_CONSTEXPR
    detail::expression<detail::function,
                       detail::proj_funct<typename detail::backend_type<
                           detail::expression<tag, A1, A2, A3, A4>>::type>,
                       detail::expression<tag, A1, A2, A3, A4>>
...
template <class Backend>
inline BOOST_MP_CXX14_CONSTEXPR
    detail::expression<detail::function, detail::proj_funct<Backend>,
                       number<Backend, et_on>>
    proj(const number<Backend, et_on> &arg) {
  return detail::expression<detail::function, detail::proj_funct<Backend>,
                            number<Backend, et_on>>(
...
HETERO_BINARY_OP_FUNCTOR_B(ldexp, boost::long_long_type,
                           number_kind_floating_point)
// HETERO_BINARY_OP_FUNCTOR_B(frexp, boost::long_long_type*,
// number_kind_floating_point)
...
HETERO_BINARY_OP_FUNCTOR_B(scalbn, boost::long_long_type,
                           number_kind_floating_point)
HETERO_BINARY_OP_FUNCTOR_B(scalbln, boost::long_long_type,
                           number_kind_floating_point)
...
template <class Backend,
          multiprecision::expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR
    typename enable_if_c<number_category<Backend>::value ==
                             number_kind_floating_point,
...
namespace math {
//
// Overload of Boost.Math functions that find the wrong overload when used with
// number:
//
namespace detail {
...
sinc_pi(const multiprecision::number<Backend, ExpressionTemplates> &x) {
...
template <class Backend,
          multiprecision::expression_template_option ExpressionTemplates>
inline multiprecision::number<Backend, ExpressionTemplates>
sinhc_pi(const multiprecision::number<Backend, ExpressionTemplates> &x) {
  boost::multiprecision::detail::scoped_default_precision<
      multiprecision::number<Backend, ExpressionTemplates>>
      precision_guard(x);
