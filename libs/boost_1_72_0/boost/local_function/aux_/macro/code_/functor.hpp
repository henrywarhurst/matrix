...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_ARG_TYPE_(typename01, i)   \
  ...
  ::boost::function_traits<BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_F_TYPE_>::    \
      BOOST_PP_CAT(BOOST_PP_CAT(arg, i), _type)

#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_ARG_TYPEDEF_(r, typename01, i,   \
                                                           param_traits)       \
  typedef BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_ARG_TYPE_(               \
      typename01, BOOST_PP_INC(i)) /* name must follow Boost.FunctionTraits    \
                                      arg1_type, arg2_type, ... */             \
      BOOST_PP_CAT(BOOST_PP_CAT(arg, BOOST_PP_INC(i)), _type);

#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_ARG_DECL_(r, typename01,   \
                                                              i, param_traits) \
  BOOST_PP_EXPR_IIF(typename01, typename)                                      \
  ::boost::call_traits<BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_ARG_TYPE_(  \
      typename01, BOOST_PP_INC(i))>::param_type                                \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_ARG_NAME_(BOOST_PP_INC(i))
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_DECL_ENUM_(                \
  ...
  BOOST_PP_IIF(                                                                \
      BOOST_PP_COMPL(default01), BOOST_PP_TUPLE_EAT(1) /* without default */   \
      ,                                                                        \
      BOOST_PP_IIF(                                                            \
          BOOST_PP_IS_EMPTY(                                                   \
              BOOST_LOCAL_FUNCTION_AUX_PP_PARAM_TRAITS_DEFAULT(param_traits)), \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_TYPE_(                      \
  ...
  BOOST_PP_EXPR_IIF(typename01, typename)                                      \
  BOOST_SCOPE_EXIT_DETAIL_PARAMS_T(id)::BOOST_SCOPE_EXIT_DETAIL_PARAM_T(       \
      id, BOOST_PP_ADD(i, offset), bind_var_without_type)
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_DECL_TYPE_(      \
  ...
  BOOST_PP_IIF(                                                                \
      BOOST_PP_COMPL(BOOST_PP_TUPLE_ELEM(4, 3, id_typename_offset_const)),     \
      BOOST_PP_EMPTY,                                                          \
      BOOST_PP_IIF(                                                            \
          BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_IS_THISUNDERSCORE_BACK(       \
              bind_var_without_type), /* pointed obj const */                  \
          BOOST_PP_EXPR_IIF(                                                   \
              BOOST_PP_TUPLE_ELEM(4, 1, id_typename_offset_const), typename)   \
              BOOST_PP_IDENTITY(                                               \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_DECL_(           \
  ...
  BOOST_PP_IIF(BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_IS_THISUNDERSCORE_BACK(  \
                   BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITHOUT_TYPE(   \
                       bind_var_without_type)),                                \
               this_ BOOST_PP_TUPLE_EAT(1), BOOST_PP_TUPLE_REM(1))             \
  (bind_var_without_type)
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_MAYBECONST_BIND_TYPE_(     \
  ...
  , BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_DECL_TYPE_(          \
        ...
        BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITHOUT_TYPE(bind_traits))

#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_PARAM_(offset,   \
                                                                     i)        \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_MAYBECONST_BIND_PARAM_DECL_( \
    r, id_typename_offset_const, i, bind_traits)                                 \
  , BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_DECL_TYPE_(            \
        r, id_typename_offset_const, i,                                          \
        BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITHOUT_TYPE(                \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_THIS_PARAM_ bind_this
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_NOBIND_PARAM_DECL_(z, n,   \
                                                                       unused) \
  , ::boost::local_function::aux::nobind_t                                     \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_MEMBER_DECL_(    \
  ...
  ::boost::local_function::aux::member_type<                                   \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_DECL_TYPE_(        \
          r, id_typename_offset_const, i, bind_var_without_type)>::reference   \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_MEMBER_VAR_(       \
          BOOST_PP_ADD(                                                        \
              i, BOOST_PP_TUPLE_ELEM(                                          \
                     4, 2, id_typename_offset_const))); /* end member variable \
                                                           declaration */

#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_MAYBECONST_STATIC_BIND_MEMBER_( \
    r, id_typename_offset_const, i, bind_traits)                                    \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_MEMBER_INIT_ENUM_( \
    r, id_offset, i, bind_traits)                                                \
  BOOST_PP_COMMA_IF(i)                                                           \
  BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_MEMBER_VAR_(             \
      BOOST_PP_ADD(i, BOOST_PP_TUPLE_ELEM(2, 1, id_offset)))                     \
  (/* member variable initialization */                                          \
   static_cast<BOOST_SCOPE_EXIT_DETAIL_PARAMS_T(BOOST_PP_TUPLE_ELEM(             \
       2, 0, id_offset)) *>(BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAMS_)       \
  ...
  typedef /* the type with the special typeof name */                          \
      BOOST_LOCAL_FUNCTION_AUX_TYPEOF_TYPE(                                    \
          BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_DECL_(         \
              r, id_typename_offset_const, i,                                  \
              BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITHOUT_TYPE(        \
                  bind_traits))); /* end typedef */

// Expand to the function type `R (A1, ...)`.
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_F_(id, typename01, decl_traits,  \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_BODY_(                      \
    id, typename01, const_bind_macro, bind_macro, const_bind_this_macro,       \
    bind_this_macro, param_macro, params, const_binds, has_const_bind_this,    \
    binds, has_bind_this)                                                      \
  BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BODY_FUNC_(                            \
      BOOST_PP_LIST_FOR_EACH_I(const_bind_macro, 0 /* no offset */,            \
                               const_binds) /* pass plain binds */             \
      BOOST_PP_COMMA_IF(BOOST_PP_BITAND(BOOST_PP_LIST_IS_CONS(const_binds),    \
                                        BOOST_PP_LIST_IS_CONS(binds)))         \
          BOOST_PP_LIST_FOR_EACH_I(                                            \
              bind_macro, /* offset index of # const-binds (could be 0) */     \
              BOOST_PP_LIST_SIZE(const_binds), binds) /* pass bind `this` */   \
      BOOST_PP_COMMA_IF(                                                       \
          BOOST_PP_BITAND(BOOST_PP_BITOR(BOOST_PP_LIST_IS_CONS(const_binds),   \
                                         BOOST_PP_LIST_IS_CONS(binds)),        \
          ...
          BOOST_PP_EXPR_IIF(has_const_bind_this, const_bind_this_macro)        \
              BOOST_PP_EXPR_IIF(has_bind_this,                                 \
                                bind_this_macro) /* pass params */             \
      BOOST_PP_COMMA_IF(BOOST_PP_BITAND(                                       \
          BOOST_PP_BITOR(BOOST_PP_BITOR(BOOST_PP_LIST_IS_CONS(const_binds),    \
                                        BOOST_PP_LIST_IS_CONS(binds)),         \
                         BOOST_PP_BITOR(has_const_bind_this, has_bind_this)),  \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_(                           \
    z, defaults_n, id, typename01, decl_traits, params, const_binds,           \
    has_const_bind_this, binds, has_bind_this)                                 \
  inline BOOST_LOCAL_FUNCTION_AUX_CODE_RESULT_TYPE(id, typename01) operator()( \
      BOOST_PP_LIST_FOR_EACH_I(                                                \
          BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_ARG_DECL_ENUM_,          \
          typename01, params)) /* cannot be const because of binds (same as    \
                                  for global fctor) */                         \
  {                                                                            \
    /* just forward call to member function with local func name */            \
    return BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_BODY_(                   \
        id, typename01,                                                        \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_MEMBER_BIND_ENUM_,    \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_MEMBER_BIND_ENUM_,    \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_MEMBER_THIS_,               \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_MEMBER_THIS_,               \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_ARG_NAME_ENUM_, params,    \
        const_binds, has_const_bind_this, binds, has_bind_this);               \
  }

#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_FUNC_(z, defaults_n, \
                                                                unused)        \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_COMMA_BIND_PARAM_DECLS_(                              \
  ...
  BOOST_PP_LIST_FOR_EACH_I(                                                                                     \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_MAYBECONST_BIND_PARAM_DECL_, /* offset of # of const-binds */ \
      (id, typename01, BOOST_PP_LIST_SIZE(const_binds), 0 /* const */), binds)                                  \
  BOOST_PP_IIF(                                                                                                 \
      BOOST_PP_BITOR(has_bind_this, has_const_bind_this),                                                       \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_BIND_THIS_PARAM_DECL_,                                        \
      BOOST_PP_TUPLE_EAT(2))                                                                                    \
  (id, typename01) /* fill with nobind_t (if no local-types as tparams) */                                      \
      BOOST_PP_REPEAT(                                                                                          \
          BOOST_PP_SUB(                                                                                         \
              BOOST_LOCAL_FUNCTION_CONFIG_BIND_MAX,                                                             \
              BOOST_PP_IIF(BOOST_PP_BITOR(has_bind_this, has_const_bind_this),                                  \
                           BOOST_PP_INC,                                                                        \
                           BOOST_PP_TUPLE_REM(1))(BOOST_PP_LIST_SIZE(                                           \
                  BOOST_PP_LIST_APPEND(const_binds, binds)))),                                                  \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_OPERATOR_(           \
    id, typename01, params, const_binds, has_const_bind_this, binds,           \
    has_bind_this)                                                             \
  operator()(BOOST_PP_LIST_FOR_EACH_I(                                         \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_ARG_NAME_ENUM_, ~, params))

#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_BODY_(               \
    id, typename01, params, const_binds, has_const_bind_this, binds,           \
    has_bind_this)                                                             \
  BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_BODY_(                            \
      id, typename01,                                                          \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_(                           \
    z, defaults_n, id, typename01, decl_traits, params, const_binds,                  \
    has_const_bind_this, binds, has_bind_this)                                        \
  inline static BOOST_LOCAL_FUNCTION_AUX_CODE_RESULT_TYPE(id, typename01)             \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_FUNC_(                        \
          z, defaults_n,                                                              \
          ~)(void *object BOOST_PP_IIF(                                               \
          ...
          id, typename01, const_binds, has_const_bind_this, binds,                    \
          has_bind_this)                                                              \
                 BOOST_PP_LIST_FOR_EACH_I(                                            \
    ...
    return static_cast<BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CLASS_TYPE_(             \
        id) *>(object)                                                                \
        ->BOOST_PP_IIF(                                                               \
            BOOST_LOCAL_FUNCTION_CONFIG_LOCALS_AS_TPARAMS,                            \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_FOR_DEFAULTS_(                                       \
    z, defaults_n,                                                                                      \
    op_id_typename_decl_params_constbinds_hasconstthis_binds_hasthis)                                   \
  BOOST_PP_EXPAND(BOOST_PP_TUPLE_ELEM(                                                                  \
      9, 0, op_id_typename_decl_params_constbinds_hasconstthis_binds_hasthis)(                          \
      z, defaults_n,                                                                                    \
      BOOST_PP_TUPLE_ELEM(                                                                              \
          9, 1, /* id */                                                                                \
          op_id_typename_decl_params_constbinds_hasconstthis_binds_hasthis),                            \
      ...
      BOOST_PP_LIST_FIRST_N(/* remove last n default params */                                          \
                            BOOST_PP_SUB(                                                               \
                                BOOST_PP_LIST_SIZE(BOOST_PP_TUPLE_ELEM(                                 \
                                    9, 4,                                                               \
                                    op_id_typename_decl_params_constbinds_hasconstthis_binds_hasthis)), \
                                defaults_n),                                                            \
                            BOOST_PP_TUPLE_ELEM(                                                        \
      ...
      BOOST_PP_TUPLE_ELEM(                                                                              \
          9, 8, /* has_bind_this */                                                                     \
          op_id_typename_decl_params_constbinds_hasconstthis_binds_hasthis)) /* end `op_macro(...)` */  \
                  ) /* end expand */
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_BIND_TYPES_(                        \
  ...
  BOOST_PP_LIST_FOR_EACH_I(                                                             \
      ...
      (id, typename01, 0 /* no offset */, 1 /* const */), const_binds)                  \
  BOOST_PP_LIST_FOR_EACH_I(                                                             \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_MAYBECONST_BIND_TYPE_, /* offset      \
                                                                            of          \
                                                                            #           \
                                                                            of          \
                                                                            const-binds \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_TYPEOF_TYPEDEFS_(            \
  ...
  BOOST_PP_LIST_FOR_EACH_I(                                                     \
      ...
      (id, typename01, 0 /* no offset */, 1 /* const-bind */), const_binds)     \
  /* bind typeof types */                                                       \
  BOOST_PP_LIST_FOR_EACH_I(                                                     \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_TYPEDEF_, /* offset      \
                                                                    index with  \
                                                                    # of        \
                                                                    preceding   \
                                                                    const-binds \
  ...
  BOOST_PP_EXPR_IIF(                                                            \
      ...
      typedef BOOST_LOCAL_FUNCTION_AUX_TYPEOF_TYPE(                             \
          BOOST_PP_EXPR_IIF(typename01,                                         \
                            typename)::boost::local_function::aux::             \
              add_pointed_const<BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPE(   \
                  id, typename01)>::type this_); /* close typedef */            \
  )                                                                             \
  /* ... or, non-const this */                                                  \
  BOOST_PP_EXPR_IIF(has_bind_this,                                              \
                    typedef BOOST_LOCAL_FUNCTION_AUX_TYPEOF_TYPE(               \
                        BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPE(           \
                            id, typename01) this_); /* close typedef */         \
  )
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_MEMBER_DECLS_(                                                                                  \
  ...
  BOOST_PP_LIST_FOR_EACH_I(/* bind member references */                                                                                            \
                           BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_MEMBER_DECL_, /* offset index of # of const-binds (could be 0) */ \
                           (id, typename01, BOOST_PP_LIST_SIZE(const_binds),                                                                       \
                            0 /* no const */),                                                                                                     \
                           binds)                                                                                                                  \
  ...
  BOOST_PP_EXPR_IIF(                                                                                                                               \
      BOOST_PP_BITOR(has_bind_this,                                                                                                                \
                     has_const_bind_this), /* this is * so no & */                                                                                 \
      BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPE(id, typename01)                                                                                 \
          BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_MEMBER_THIS_; /* end                                                                          \
                                                                      member                                                                       \
                                                                      variable                                                                     \
                                                                      declaration                                                                  \
                                                                    */                                                                             \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_STATIC_BINDS_(                                                 \
  ...
  BOOST_PP_LIST_FOR_EACH_I(                                                                                        \
      ...
      (id, typename01, 0 /* no offset */, 1 /* const */), const_binds)                                             \
  BOOST_PP_LIST_FOR_EACH_I(                                                                                        \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_MAYBECONST_STATIC_BIND_MEMBER_, /* offset of # of const-binds */ \
      (id, typename01, BOOST_PP_LIST_SIZE(const_binds), 0 /* const */), binds)                                     \
  BOOST_PP_IIF(                                                                                                    \
      BOOST_PP_BITOR(has_bind_this, has_const_bind_this),                                                          \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_STATIC_BIND_MEMBER_THIS_,                                        \
      BOOST_PP_TUPLE_EAT(1))                                                                                       \
  (id) /* fill with nobind_t (if no local-types as tparams) */                                                     \
      BOOST_PP_REPEAT(                                                                                             \
          BOOST_PP_SUB(                                                                                            \
              BOOST_LOCAL_FUNCTION_CONFIG_BIND_MAX,                                                                \
              BOOST_PP_IIF(BOOST_PP_BITOR(has_bind_this, has_const_bind_this),                                     \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MEMBER_INITS_(                                                                       \
    id, typename01, const_binds, has_const_bind_this, binds, has_bind_this)                                                        \
  BOOST_PP_EXPR_IIF(                                                                                                               \
      BOOST_PP_BITOR(                                                                                                              \
          BOOST_PP_BITOR(BOOST_PP_BITOR(BOOST_PP_LIST_IS_CONS(const_binds),                                                        \
  ...
  BOOST_PP_COMMA_IF(BOOST_PP_BITAND(BOOST_PP_LIST_IS_CONS(const_binds),                                                            \
                                    BOOST_PP_LIST_IS_CONS(binds)))                                                                 \
  BOOST_PP_LIST_FOR_EACH_I(                                                                                                        \
      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_MEMBER_INIT_ENUM_, /* offset index of # of const-binds (could be 0) */ \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_(                                                                                                                                                                                                                                                           \
    id, typename01, decl_traits, params, default_count, const_binds,                                                                                                                                                                                                                                      \
    has_const_bind_this, binds, has_bind_this)                                                                                                                                                                                                                                                            \
  typedef class BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CLASS_TYPE_(                                                                                                                                                                                                                                        \
      id) /* run-time: do not use base class to allow for compiler                                                                                                                                                                                                                                        \
             optimizations */                                                                                                                                                                                                                                                                             \
  {                                                                                                                                                                                                                                                                                                       \
    /* function type */                                                                                                                                                                                                                                                                                   \
  private:                                                                                                                                                                                                                                                                                                \
    typedef BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_F_(                                                                                                                                                                                                                                                     \
        id, typename01, decl_traits, 1 /* has type */,                                                                                                                                                                                                                                                    \
  ...
  public:                                                                                                                                                                                                                                                                                                 \
    typedef BOOST_PP_EXPR_IIF(typename01, typename) BOOST_IDENTITY_TYPE(                                                                                                                                                                                                                                  \
        (/* IDENTITY for template param comma */                                                                                                                                                                                                                                                          \
         ::boost::local_function::aux::function<                                                                                                                                                                                                                                                          \
             BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_F_TYPE_,                                                                                                                                                                                                                                               \
             default_count BOOST_PP_IIF(                                                                                                                                                                                                                                                                  \
                 BOOST_LOCAL_FUNCTION_CONFIG_LOCALS_AS_TPARAMS,                                                                                                                                                                                                                                           \
                 BOOST_PP_TUPLE_EAT(6),                                                                                                                                                                                                                                                                   \
                 BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_COMMA_BIND_TYPES_)(                                                                                                                                                                                                                                \
                 id, typename01, const_binds, has_const_bind_this, binds,                                                                                                                                                                                                                                 \
                 has_bind_this)>)) BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_TYPE;                                                                                                                                                                                                                            \
                                                                                                                                                                                                                                                                                                          \
  private:                                                                                                                                                                                                                                                                                                \
  ...
  public:                                                                                                                                                                                                                                                                                                 \
    ...
    enum {                                                                                                                                                                                                                                                                                                \
      arity = ::boost::                                                                                                                                                                                                                                                                                   \
          function_traits</* can't use static data */                                                                                                                                                                                                                                                     \
                          BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_F_TYPE_>::                                                                                                                                                                                                                                \
              arity                                                                                                                                                                                                                                                                                       \
    };                                                                                                                                                                                                                                                                                                    \
    typedef BOOST_LOCAL_FUNCTION_AUX_CODE_RESULT_TYPE(id,                                                                                                                                                                                                                                                 \
                                                      typename01) result_type;                                                                                                                                                                                                                            \
    BOOST_PP_LIST_FOR_EACH_I(                                                                                                                                                                                                                                                                             \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_ARG_TYPEDEF_, typename01,                                                                                                                                                                                                                                   \
        params)                                                                                                                                                                                                                                                                                           \
    /* constructor */                                                                                                                                                                                                                                                                                     \
    inline explicit BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CLASS_TYPE_(id)(void *                                                                                                                                                                                                                          \
                                                                              BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAMS_) /* NOTE: there is no way to wrap member initializer commas */ /* within paren so you must handle these commas manually if */ /* expanding this macro within another macro */ \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MEMBER_INITS_(                                                                                                                                                                                                                                              \
            id, typename01, const_binds, has_const_bind_this, binds,                                                                                                                                                                                                                                      \
            has_bind_this) { /* do nothing */                                                                                                                                                                                                                                                             \
    }                                                                                                                                                                                                                                                                                                     \
    ...
    BOOST_PP_REPEAT(/* PP_INC to handle no dflt (EXPAND for MVSC) */                                                                                                                                                                                                                                      \
                    BOOST_PP_EXPAND(BOOST_PP_INC(default_count)),                                                                                                                                                                                                                                         \
                    BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_FOR_DEFAULTS_,                                                                                                                                                                                                                             \
                    (BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_CALL_, id,                                                                                                                                                                                                                                     \
    ...
    inline static void BOOST_LOCAL_FUNCTION_AUX_FUNCTION_INIT_CALL_FUNC(                                                                                                                                                                                                                                  \
        void *object, BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_TYPE &functor) {                                                                                                                                                                                                                              \
          ...
          object BOOST_PP_IIF(                                                                                                                                                                                                                                                                            \
              ...
              BOOST_PP_REPEAT(/* INC to handle no dflt (EXPAND for MVSC) */                                                                                                                                                                                                                               \
                              ...
                              ~));                                                                                                                                                                                                                                                                        \
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          \
  private:                                                                                                                                                                                                                                                                                                \
    BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_MEMBER_DECLS_(                                                                                                                                                                                                                                             \
        id, typename01, const_binds, has_const_bind_this, binds,                                                                                                                                                                                                                                          \
        has_bind_this)                                                                                                                                                                                                                                                                                    \
    ...
    inline BOOST_LOCAL_FUNCTION_AUX_CODE_RESULT_TYPE(id, typename01)                                                                                                                                                                                                                                      \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BODY_FUNC_(/* const binds */                                                                                                                                                                                                                                \
                                                         BOOST_PP_LIST_FOR_EACH_I(                                                                                                                                                                                                                        \
                                                         ...
                                                         BOOST_PP_COMMA_IF(BOOST_PP_BITAND(                                                                                                                                                                                                               \
                                                             ...
                                                             BOOST_PP_LIST_IS_CONS(                                                                                                                                                                                                                       \
                                                                 binds)))                                                                                                                                                                                                                                 \
                                                             BOOST_PP_LIST_FOR_EACH_I(                                                                                                                                                                                                                    \
                                                                 BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_DECL_ENUM_, /* offset index of # of const-binds (could be 0) */                                                                                                                    \
                                                                 (id,                                                                                                                                                                                                                                     \
                                                                  typename01,                                                                                                                                                                                                                             \
                                                                  BOOST_PP_LIST_SIZE(const_binds), 0 /* not const-bind */),                                                                                                                                                                               \
                                                                 binds) /* `this`                                                                                                                                                                                                                         \
                                                                           bind                                                                                                                                                                                                                           \
                                                                         */                                                                                                                                                                                                                               \
                                                         BOOST_PP_COMMA_IF(BOOST_PP_BITAND(                                                                                                                                                                                                               \
                                                             ...
                                                             BOOST_PP_BITOR(                                                                                                                                                                                                                              \
                                                                 has_const_bind_this,                                                                                                                                                                                                                     \
                                                                 has_bind_this))) /* const pointer to const object */                                                                                                                                                                                     \
                                                         BOOST_PP_EXPR_IIF(                                                                                                                                                                                                                               \
                                                             has_const_bind_this,                                                                                                                                                                                                                         \
                                                             BOOST_PP_EXPR_IIF(                                                                                                                                                                                                                           \
                                                                 typename01,                                                                                                                                                                                                                              \
                                                                 typename)::boost::local_function::                                                                                                                                                                                                       \
                                                                 aux::add_pointed_const<                                                                                                                                                                                                                  \
                                                                     BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPE(                                                                                                                                                                                        \
                                                                         id,                                                                                                                                                                                                                              \
                                                                         typename01)>::                                                                                                                                                                                                                   \
                                                                     type const                                                                                                                                                                                                                           \
                                                         ...
                                                         BOOST_PP_COMMA_IF(BOOST_PP_BITAND(                                                                                                                                                                                                               \
                                                             ...
                                                             BOOST_PP_LIST_IS_CONS(                                                                                                                                                                                                                       \
                                                                 params)))                                                                                                                                                                                                                                \
                                                             BOOST_PP_LIST_FOR_EACH_I(BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_PARAM_DECL_ENUM_,                                                                                                                                                             \
                                                                                      1 /* with defaults */                                                                                                                                                                                               \
                                                                                      ,                                                                                                                                                                                                                   \
                                                                                      params)) /* end body function params */ /* cannot be const because recursive functor is non const member */ /* user local function definition `{ ... }` will follow here */ /* `END` macro will close function class decl `};` here */
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR(id, typename01, decl_traits)     \
  BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_(                                      \
      id, typename01, decl_traits /* params (might have defaults) */           \
      ,                                                                        \
      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_PARAMS(decl_traits),             \
      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_PARAMS_DEFAULT_COUNT(            \
          decl_traits) /* const bind vars (`this` excluded) */                 \
      ,                                                                        \
      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_CONST_BINDS(                     \
          decl_traits) /* if const bind `this` is present */                   \
      ,                                                                        \
      BOOST_PP_LIST_IS_CONS(                                                   \
          BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_CONST_BIND_THIS_TYPES(       \
              decl_traits)) /* bind (non-const) vars (`this` excluded) */      \
      ,                                                                        \
      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_BINDS(                           \
          decl_traits) /* if (non-const) bind `this` is present */             \
      ,                                                                        \
      BOOST_PP_LIST_IS_CONS(                                                   \
