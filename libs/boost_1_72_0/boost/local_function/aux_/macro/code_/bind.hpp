...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_CAPTURE_DECL_TYPED_(                                                                                                                                  \
  ...
  typedef BOOST_PP_EXPR_IIF(                                                                                                                                                                     \
      typename01,                                                                                                                                                                                \
      typename) /* remove ref because typed var can have & prefix */                                                                                                                             \
      ::boost::                                                                                                                                                                                  \
          remove_reference<                                                                                                                                                                      \
              BOOST_PP_EXPR_IIF(typename01, typename)::boost::function_traits</* instead of using Boost.Typeof, get bind type as 1st */ /* argument type of func type `void (type_ [&] var_)` */ \
                                                                              void(BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITH_TYPE(                                                        \
                                                                                  bind_traits))>::                                                                                               \
                  arg1_type>::type                                                                                                                                                               \
              BOOST_SCOPE_EXIT_DETAIL_CAPTURE_T(                                                                                                                                                 \
                  id, i,                                                                                                                                                                         \
                  BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITHOUT_TYPE(                                                                                                                      \
                      bind_traits)); /* close typedef */

#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_CAPTURE_DECL_DEDUCED_(              \
    r, id, typename01, i, bind_traits)                                         \
  BOOST_SCOPE_EXIT_DETAIL_CAPTURE_DECL(                                        \
      r,                                                                       \
      (id, /* ScopeExit expects typename or EMPTY() here */                    \
       BOOST_PP_EXPR_IIF(typename01, typename)),                               \
      i,                                                                       \
      BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITHOUT_TYPE(bind_traits))

#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_CAPTURE_DECL_(r, id_typename, i,    \
                                                         bind_traits)          \
  BOOST_PP_IIF(                                                                \
      BOOST_PP_IS_EMPTY(                                                       \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_PARAM_DECL_(r, id_typename, i,      \
                                                       bind_traits)            \
  BOOST_SCOPE_EXIT_DETAIL_PARAM_DECL(                                          \
      r,                                                                       \
      (BOOST_PP_TUPLE_ELEM(                                                    \
           2, 0,                                                               \
           id_typename), /* ScopeExit expects typename or EMPTY() here */      \
       BOOST_PP_EXPR_IIF(BOOST_PP_TUPLE_ELEM(2, 1, id_typename), typename)),   \
      i,                                                                       \
      BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITHOUT_TYPE(bind_traits))

#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_MEMBER_DECL_VAR_(r, id, typename01, \
                                                            i, var)            \
  BOOST_PP_EXPR_IIF(typename01, typename)                                      \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_MEMBER_DECL_(r, id_typename, i,     \
                                                        bind_traits)           \
  BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_MEMBER_DECL_VAR_(                         \
      r, BOOST_PP_TUPLE_ELEM(2, 0, id_typename),                               \
      BOOST_PP_TUPLE_ELEM(2, 1, id_typename), i,                               \
      BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITHOUT_TYPE(bind_traits))

#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_PARAM_INIT_(r, id, i, bind_traits)  \
  BOOST_SCOPE_EXIT_DETAIL_PARAM_INIT(                                          \
      r, id, i,                                                                \
      BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_VAR_WITHOUT_TYPE(bind_traits))
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPEDEF_DEDUCED_(              \
  ...
  BOOST_SCOPE_EXIT_DETAIL_TYPEDEF_TYPEOF_THIS(                                 \
      id, BOOST_PP_EXPR_IIF(typename01, typename), /* otherwise EMPTY() */     \
      BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_CAPTURE_TYPE_(id))

#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPEDEF_TYPED_(                \
    id, typename01, all_bind_this_types)                                       \
  typedef BOOST_LOCAL_FUNCTION_AUX_PP_BIND_TRAITS_THIS_TYPE(                   \
      BOOST_PP_LIST_FIRST(all_bind_this_types))                                \
      BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_CAPTURE_TYPE_(id);

#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPEDEF_(id, typename01,       \
                                                         all_bind_this_types)  \
  /* typedef type_ */                                                          \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_ALL_(                               \
  ...
  (id, typename01, all_bind_this_types) BOOST_PP_LIST_FOR_EACH_I(              \
      BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_TAG_DECL_, id, all_binds)             \
      BOOST_PP_LIST_FOR_EACH_I(                                                \
          BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_CAPTURE_DECL_, (id, typename01),  \
          all_binds) /* binding class */                                       \
    ...
    BOOST_PP_LIST_FOR_EACH_I(BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_MEMBER_DECL_,  \
                             (id, typename01), all_binds)                      \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPE(id, typename01)           \
  ...
  BOOST_SCOPE_EXIT_DETAIL_PARAMS_T(                                            \
      id)::BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPE_(id)
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND(id, typename01, decl_traits)                                                                                                                                                                                                                                                                                                                  \
  ...
  /*      ...Xargs); */                                                                                                                                                                                                                                                                                                                                                                  \
  /* which is a no-op */                                                                                                                                                                                                                                                                                                                                                                 \
  ::boost::scope_exit::detail::declared<boost::scope_exit::detail::resolve</* cannot prefix with `::` as in `sizeof(:: ...` because the name */ /* must refer to the local variable name to allow multiple local */ /* functions (and exits) within the same scope (however this */ /* does not allow for nesting because local variables cannot be */ /* used in nested code blocks) */ \
                                                                           sizeof(                                                                                                                                                                                                                                                                                                       \
