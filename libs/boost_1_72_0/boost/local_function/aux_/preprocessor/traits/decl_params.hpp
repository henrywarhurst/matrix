...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_PARAMS_DEFAULT_OP_(            \
    s, default_count, param_traits)                                            \
  BOOST_PP_IIF(                                                                \
      BOOST_PP_IS_EMPTY(                                                       \
          BOOST_LOCAL_FUNCTION_AUX_PP_PARAM_TRAITS_DEFAULT(param_traits)),     \
      BOOST_PP_TUPLE_REM(1), BOOST_PP_INC)                                     \
  (default_count)
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_PARAMS(decl_traits)            \
  BOOST_PP_TUPLE_ELEM(BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_INDEX_MAX,       \
                      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_INDEX_PARAMS,    \
                      decl_traits)
