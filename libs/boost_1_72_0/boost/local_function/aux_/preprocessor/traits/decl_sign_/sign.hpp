...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALID_CONST_BIND_THIS_(   \
  ...
  BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_APPEND_CONST_BIND_THIS_TYPE(         \
      decl_traits,                                                             \
      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_ANY_BIND_THIS_TYPE(sign))

#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALID_CONST_BIND_VAR_(    \
    decl_traits, sign)                                                         \
  BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_APPEND_CONST_BIND(                   \
      decl_traits,                                                             \
      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_ANY_BIND_WITHOUT_TYPE(      \
          sign),                                                               \
      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_ANY_BIND_WITH_TYPE(sign))
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALID_CONST_BIND_(                                                                 \
  ...
  BOOST_PP_IIF(                                                                                                                         \
      BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_IS_THISUNDERSCORE_BACK(/* remove                                                           \
                                                                       all                                                              \
                                                                       leading                                                          \
                                                                       symbols                                                          \
                                                                       `[const]                                                         \
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALID_BIND_THIS_(         \
    decl_traits, sign)                                                         \
  BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_APPEND_BIND_THIS_TYPE(               \
      decl_traits,                                                             \
      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_ANY_BIND_THIS_TYPE(sign))

#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALID_BIND_VAR_(          \
    decl_traits, sign)                                                         \
  BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_APPEND_BIND(                         \
      decl_traits,                                                             \
      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_ANY_BIND_WITHOUT_TYPE(      \
          sign),                                                               \
      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_ANY_BIND_WITH_TYPE(sign))

#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALID_BIND_(decl_traits,                                                           \
                                                                 sign)                                                                  \
  /* check from back because non `this` bounds might have `&` in front */                                                               \
  BOOST_PP_IIF(                                                                                                                         \
      BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_IS_THISUNDERSCORE_BACK(/* remove                                                           \
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALID_(s, decl_traits,                                                                                                                                                                                                                                           \
                                                            sign)                                                                                                                                                                                                                                                     \
  BOOST_PP_IIF(                                                                                                                                                                                                                                                                                                       \
      BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_IS_RETURN_FRONT(sign),                                                                                                                                                                                                                                                   \
      BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_APPEND_RETURN,                                                                                                                                                                                                                                                          \
      BOOST_PP_IIF(                                                                                                                                                                                                                                                                                                   \
          BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_IS_BIND_FRONT(sign),                                                                                                                                                                                                                                                 \
          ...
          BOOST_PP_IIF(                                                                                                                                                                                                                                                                                               \
              ...
              BOOST_PP_IIF(                                                                                                                                                                                                                                                                                           \
                  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_IS_DEFAULT_FRONT(sign), /* elem is `default ...` where leading default is kept because */ /* default value might not be alphanumeric (so it fails later CAT */ /* for checks), leading default will be removed later when getting */ /* the default value */ \
                  BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_APPEND_PARAM_DEFAULT, /* else, it is a function parameter */                                                                                                                                                                                                \
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALID(sign)               \
  BOOST_PP_LIST_FOLD_LEFT(BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALID_, \
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN(sign)                     \
  BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_(                               \
      sign, BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALIDATE(sign))
