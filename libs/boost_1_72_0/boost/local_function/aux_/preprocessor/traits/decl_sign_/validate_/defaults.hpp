...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALIDATE_DEFAULTS_IS_UNBIND_( \
    sign)                                                                          \
  /* PP_OR/PP_BITOR (instead of IIF) don't expand on MSVC */                       \
  BOOST_PP_IIF(                                                                    \
      BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_IS_DEFAULT_FRONT(sign), 0,            \
      BOOST_PP_IIF(                                                                \
          BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_IS_CONST_BIND_FRONT(sign), 0,     \
          BOOST_PP_IIF(                                                            \
              BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_IS_BIND_FRONT(sign), 0,       \
              1)))
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALIDATE_DEFAULTS_PREV_(    \
  ...
  BOOST_PP_IIF(                                                                  \
      ...
      ,                                                                          \
      BOOST_PP_CAT(                                                              \
          BOOST_PP_CAT(ERROR_default_value_at_element_, BOOST_PP_INC(index)),    \
          _must_follow_an_unbound_parameter)                                     \
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALIDATE_DEFAULTS_INDEX_( \
    sign, index, error)                                                        \
  BOOST_PP_IF(                                                                 \
      index, /* can't use IIF because index can be any number */               \
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALIDATE_DEFAULTS_OP_DATA_( \
    sign, index, error)                                                          \
  (sign, BOOST_PP_INC(index),                                                    \
   BOOST_PP_IIF(                                                                 \
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALIDATE_DEFAULTS_OP_(    \
    d, sign_index_error)                                                       \
...
#define BOOST_LOCAL_FUNCTION_AUX_PP_DECL_TRAITS_SIGN_VALIDATE_DEFAULTS_PRED_DATA_( \
    sign, index, error)                                                            \
  BOOST_PP_BITAND(BOOST_PP_IS_EMPTY(error(/* expand empty */)),                    \
