...
#define BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_REMOVE_EXPAND_OO_(par) \
...
#define BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_REMOVE_FRONT(          \
  ...
  BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_REMOVE_EXPAND_(              \
      BOOST_PP_IIF(is_front_macro(tokens), BOOST_PP_CAT,                       \
                   tokens BOOST_PP_TUPLE_EAT(2))(removing_prefix, tokens))
...
#define BOOST_LOCAL_FUNCTION_DETAIL_PP_KEYWORD_FACILITY_REMOVE_BACK(           \
  ...
  BOOST_PP_IIF(is_back_macro(tokens), BOOST_PP_CAT,                            \
