...
public:
  ...
  static CharType get_manipulator(std::basic_ios<CharType, CharTrait> &i,
    ...
    if (!c) {
      switch (m) {
      case detail::format_info::open:
        c = i.widen('(');
        break;
      case detail::format_info::close:
        c = i.widen(')');
        break;
      case detail::format_info::delimiter:
        c = i.widen(' ');
        break;
      }
    }
...
template <class CharType> class tuple_manipulator {
...
inline std::basic_ostream<CharType, CharTrait> &
print(std::basic_ostream<CharType, CharTrait> &o,
...
template <class CharType, class CharTrait>
inline std::basic_istream<CharType, CharTrait> &
extract_and_check_delimiter(std::basic_istream<CharType, CharTrait> &is,
