...
#define BOOST_CONTRACT_CHECK_AUDIT(cond) BOOST_CONTRACT_CHECK(cond)
#else
#define BOOST_CONTRACT_CHECK_AUDIT(cond) BOOST_CONTRACT_DETAIL_NOEVAL(cond)
#endif
...
*/
#define BOOST_CONTRACT_CHECK_AXIOM(cond) BOOST_CONTRACT_DETAIL_NOEVAL(cond)
