...
#define BOOST_CONTRACT_CALL_IF_RESULT_OF_(F) decltype(boost::declval<F>()())
#else
...
}; // Empty so cannot be used (but copyable).
...
struct call_if_statement<true, Then,
  ...
  */
  explicit call_if_statement(Then f)
      : call_if_statement<true, Then, BOOST_CONTRACT_CALL_IF_RESULT_OF_(Then)>(
            f) {}
};
...
struct call_if_statement<true, Then, ThenResult> { // Copyable (as *).
  ...
  */
  ...
  call_if_statement<true, Then, ThenResult> else_if_c(ElseIfThen const &
  ...
  */
  ...
  call_if_statement<true, Then, ThenResult> else_if(ElseIfThen const &
#ifdef BOOST_CONTRACT_DETAIL_DOXYGEN // Avoid unused param warning.
                                                        f
#endif
  ) const {
...
struct call_if_statement<false, Then,
  ...
  */
  template <class ElseIfPred, typename ElseIfThen>
  call_if_statement<ElseIfPred::value, ElseIfThen> else_if(ElseIfThen f) const {
...
condition_if_c(Then f, bool /* else_ */ = true) {
  return f();
}
