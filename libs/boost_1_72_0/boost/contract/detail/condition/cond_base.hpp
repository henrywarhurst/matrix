...
#include <boost/contract/core/exception.hpp>
    ...
    !defined(BOOST_CONTRACT_NO_OLDS) || !defined(BOOST_CONTRACT_NO_EXEPTS)
...
class cond_base
    :                            // Base to hold all contract objects for RAII.
...
public:
  ...
  template <typename F> void set_pre(F const &f) { pre_ = f; }
#endif

#ifndef BOOST_CONTRACT_NO_OLDS
  template <typename F> void set_old(F const &f) { old_ = f; }
#endif

#ifndef BOOST_CONTRACT_NO_EXCEPTS
  template <typename F> void set_except(F const &f) { except_ = f; }
#endif
...
// Return true if actually checked calling user ftor.
  ...
  void copy_old() {
    ...
    try {
      ...
      fail(&boost::contract::old_failure);
    }
  }
#endif
  ...
  void check_except() {
    ...
    try {
      ...
      fail(&boost::contract::except_failure);
    }
  }
#endif
