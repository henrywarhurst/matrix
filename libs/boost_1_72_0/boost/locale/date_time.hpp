...
///
template <typename T> date_time_period operator*(period::period_type f, T v) {
...
/// Create date_time_period of type \a f with value \a v.
///
template <typename T> date_time_period operator*(T v, period::period_type f) {
  return date_time_period(f, v);
}
///
/// Create date_time_period of type \a f with value \a v.
///
template <typename T> date_time_period operator*(T v, date_time_period f) {
...
/// Create date_time_period of type \a f with value \a v.
///
template <typename T> date_time_period operator*(date_time_period f, T v) {
  return date_time_period(f.type, f.value * v);
}
...
public:
  ...
  ///
  /// \note throws std::bad_cast if loc does not have \ref calendar_facet facet
  /// installed
  ///
  ...
  ///
  /// Get least maximum value for period f, For example for Gregorian calendar's
  /// maximum period::day it is 28.
  ///
...
public:
  ///
  /// Dafault constructor, uses default calendar initialized date_time object to
  /// current time.
  ///
  ...
  ///
  /// Create a date_time object using calendar \a cal and define values given in
  /// \a set
  ///
  ...
  ///
  /// calculate the distance from this date_time to \a other in terms of perios
  /// \a f
  ///
