...
template <typename CharType> class boundary_indexing;
...
template <>
class BOOST_LOCALE_DECL boundary_indexing<char16_t>
...
template <>
class BOOST_LOCALE_DECL boundary_indexing<char32_t>
    : public std::locale::facet {
public:
  boundary_indexing(size_t refs = 0) : std::locale::facet(refs) {}
