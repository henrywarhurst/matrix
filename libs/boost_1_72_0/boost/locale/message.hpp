...
public:
  ...
  ///
  /// This function returns a pointer to the string for a plural message defined
  /// by a \a context and identification string \a single_id.
  ///
  /// If \a context is NULL it is not considered to be a part of the key
  ///
...
public:
  ...
  ///
  /// Create a simple plural form message from 0 terminated strings. The strings
  /// should exist until the message is destroyed. Generally useful with static
  /// constant strings.
  ///
  /// \a n is the number, \a single and \a plural are singular and plural forms
  /// of the message
  ///
  ...
  ///
  /// \a n is the number, \a single and \a plural are single and plural forms of
  /// the message
  ///
  explicit basic_message(string_type const &single, string_type const &plural,
                         int number)
      : n_(number), c_id_(0), c_context_(0), c_plural_(0), id_(single),
        plural_(plural) {}
  ...
  /// the message
  ///
  explicit basic_message(string_type const &context, string_type const &single,
                         string_type const &plural, int number)
      : n_(number), c_id_(0), c_context_(0), c_plural_(0), id_(single),
        context_(context), plural_(plural) {}
  ...
  ///
  /// Translate message to a string in the default global locale, using default
  /// domain
  ///
  ...
  ///
  /// Translate message to a string using locale \a locale and message domain \a
  /// domain_id
  ///
  ...
  ///
  /// Translate message to a string using the default locale and message domain
  /// \a domain_id
  ///
  ...
  ///
  /// Translate message to a string using locale \a loc and message domain index
  /// \a id
  ///
...
translate(std::basic_string<CharType> const &msg) {
  return basic_message<CharType>(msg);
}
...
npgettext(CharType const *context, CharType const *s, CharType const *p, int n,
          std::locale const &loc = std::locale()) {
