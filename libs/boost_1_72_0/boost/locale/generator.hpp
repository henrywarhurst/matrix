...
public:
  ...
  ///
  /// Set the characters type for which the facets should be generated, default
  /// all supported
  ///
  void characters(character_facet_type chars);
  ///
  /// Get the characters type for which the facets should be generated, default
  /// all supported
  ///
  character_facet_type characters() const;

  ///
  /// Add a new domain of messages that would be generated. It should be set in
  /// order to enable messages support.
  ///
  ...
  /// API, you do not specify the encoding part. So for example if the provided
  ...
  ///
  /// Set default message domain. If this member was not called, the first added
  /// messages domain is used. If the domain \a domain is not added yet it is
  /// added.
  ///
  ...
  /// \note
  ///
  /// - Under the Windows platform the path is treated as a path in the locale's
  /// encoding so
  ///   if you create locale "en_US.windows-1251" then path would be treated as
  ///   cp1255, and if it is en_US.UTF-8 it is treated as UTF-8. File name is
  ///   always opened with a wide file name as wide file names are the native
  ...
  ///
  /// Check if by default ANSI encoding is selected or UTF-8 onces. The default
  /// is false.
  ///
