...
namespace detail {
template <typename SeqRef, typename M> struct get_endpoint {
  ...
  template <typename Sequence> struct apply {
    typedef zip_view_iterator<
        typename result_of::transform<
            ...
            detail::endpoints<typename Sequence::size>>::type,
    ...
    call(Sequence &sequence) {
      return type(fusion::transform(
          sequence.sequences_, detail::endpoints<typename Sequence::size>()));
    }
  };
};
} // namespace extension
