...
class unfused_typed
    : public detail::unfused_typed_impl<unfused_typed<Function, Sequence>,
                                        Function, Sequence,
...
public:
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED inline explicit unfused_typed(
...
#define M(z, i, s)                                                             \
  ...
  BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED inline
      typename boost::result_of<function_c(arg_vector_t &)>::type
  ...
  BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED inline
      typename boost::result_of<function(arg_vector_t &)>::type
