...
template <class Sequence, int N> struct invoke_function_object_param_types;
...
struct invoke_function_object<
    Function, Sequence,
    typename enable_if_has_type<typename detail::invoke_function_object_impl<
...
template <class Function, class Sequence>
struct invoke_function_object_impl<
    Function, Sequence, N, true,
    typename enable_if_has_type<typename boost::result_of<Function(
        BOOST_PP_ENUM(N, M, ~))>::type>::type> {
public:
