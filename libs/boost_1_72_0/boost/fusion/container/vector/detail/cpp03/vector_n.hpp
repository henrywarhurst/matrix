...
#define FUSION_VECTOR_CTOR_DEFAULT_INIT(z, n, _) m##n()

#define FUSION_VECTOR_CTOR_INIT(z, n, _) m##n(_##n)

#define FUSION_VECTOR_MEMBER_CTOR_INIT(z, n, _) m##n(other.m##n)
...
#define FUSION_VECTOR_MEMBER_DECL(z, n, _) T##n m##n;

#define FUSION_VECTOR_MEMBER_FORWARD(z, n, _) BOOST_FUSION_FWD_ELEM(U##n, _##n)
...
#define FUSION_VECTOR_MEMBER_MOVE(z, n, _)                                     \
  this->BOOST_PP_CAT(m, n) =                                                   \
      std::forward<BOOST_PP_CAT(T, n)>(vec.BOOST_PP_CAT(m, n));
...
#define FUSION_VECTOR_MEMBER_ITER_DECL_VAR(z, n, _)                            \
  typedef typename result_of::next<BOOST_PP_CAT(I, BOOST_PP_DEC(n))>::type     \
      BOOST_PP_CAT(I, n);                                                      \
  BOOST_PP_CAT(I, n)                                                           \
  BOOST_PP_CAT(i, n) = fusion::next(BOOST_PP_CAT(i, BOOST_PP_DEC(n)));
...
struct BOOST_PP_CAT(vector_data, N) {
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED BOOST_PP_CAT(vector_data, N)()
  ...
  FUSION_HASH if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
    ...
    (defined(__WAVE__) && defined(BOOST_FUSION_CREATE_PREPROCESSED_FILES))
      ...
      FUSION_HASH if !defined(BOOST_CLANG)
          BOOST_CXX14_CONSTEXPR FUSION_HASH endif
#else
      ...
      BOOST_CXX14_CONSTEXPR
              ...
              BOOST_PP_CAT(vector_data, N)(
                  ...
                  typename boost::enable_if<is_convertible<U0, T0>>::type
                      * /*dummy*/
                  = 0)
...
#if defined(__WAVE__) && defined(BOOST_FUSION_CREATE_PREPROCESSED_FILES)
      FUSION_HASH if !defined(BOOST_CLANG) BOOST_CONSTEXPR FUSION_HASH endif
#else
#if !defined(BOOST_CLANG)
  BOOST_CONSTEXPR
#endif
#endif
          BOOST_FUSION_GPU_ENABLED
          BOOST_PP_CAT(vector_data, N)(BOOST_PP_ENUM_BINARY_PARAMS(
              N, typename detail::call_param<T, >::type arg))
      : BOOST_PP_ENUM(N, FUSION_VECTOR_CTOR_INIT, arg) {
  }

  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
  BOOST_PP_CAT(vector_data, N)(BOOST_PP_CAT(vector_data, N) const &other)
      : BOOST_PP_ENUM(N, FUSION_VECTOR_MEMBER_CTOR_INIT, _) {}

  BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED BOOST_PP_CAT(vector_data, N) &
...
#if defined(__WAVE__) && defined(BOOST_FUSION_CREATE_PREPROCESSED_FILES)
  FUSION_HASH if !defined(BOOST_CLANG) BOOST_CXX14_CONSTEXPR FUSION_HASH endif
#else
#if !defined(BOOST_CLANG)
  BOOST_CXX14_CONSTEXPR
#endif
#endif
      BOOST_FUSION_GPU_ENABLED static BOOST_PP_CAT(vector_data, N)
...
struct BOOST_PP_CAT(vector, N)
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED BOOST_PP_CAT(vector, N)() {}
  ...
  FUSION_HASH if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
    ...
    (defined(__WAVE__) && defined(BOOST_FUSION_CREATE_PREPROCESSED_FILES))
      ...
      explicit BOOST_PP_CAT(vector, N)(
          U0 && _0,
          typename boost::enable_if<is_convertible<U0, T0>>::type * /*dummy*/ =
              0)
  ...
  BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED BOOST_PP_CAT(vector, N) &
  ...
  BOOST_CXX14_CONSTEXPR
              ...
              BOOST_PP_CAT(vector, N)(BOOST_PP_CAT(vector, N) <
                                      BOOST_PP_ENUM_PARAMS(N, U) > const &vec)
