...
template <typename Dummy> struct vector0 : sequence_base<vector0<Dummy>> {
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED vector0() BOOST_NOEXCEPT {}

  template <typename Sequence>
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED vector0(Sequence const & /*seq*/)
      BOOST_NOEXCEPT {}
};
} // namespace fusion
} // namespace boost
