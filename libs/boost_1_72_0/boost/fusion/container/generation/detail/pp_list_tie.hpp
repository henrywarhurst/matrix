...
#pragma wave option(preserve : 2, line : 0, output                             \
                    : "preprocessed/list_tie" FUSION_MAX_LIST_SIZE_STR ".hpp")
#endif
...
struct list_tie<BOOST_PP_ENUM_PARAMS(N, T) BOOST_PP_REPEAT_FROM_TO(
...
template <BOOST_PP_ENUM_PARAMS(N, typename T)>
BOOST_CONSTEXPR
    BOOST_FUSION_GPU_ENABLED inline list<BOOST_PP_ENUM(N, BOOST_FUSION_REF, _)>
