...
#pragma wave option(preserve : 2, line : 0, output                             \
                    : "preprocessed/make_list" FUSION_MAX_LIST_SIZE_STR        \
                      ".hpp")
#endif
...
namespace result_of {
template <BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(FUSION_MAX_LIST_SIZE, typename T,
                                              void_),
...
struct make_list<BOOST_PP_ENUM_PARAMS(N, T) BOOST_PP_REPEAT_FROM_TO(
    BOOST_PP_DEC(N), FUSION_MAX_LIST_SIZE, TEXT, void_)>
#undef TEXT
{
