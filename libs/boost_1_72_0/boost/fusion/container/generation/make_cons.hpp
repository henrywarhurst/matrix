...
namespace result_of {
template <typename Car, typename Cdr = nil_> struct make_cons {
  typedef cons<typename detail::as_fusion_element<Car>::type, Cdr> type;
};
} // namespace result_of

template <typename Car>
BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED inline cons<
...
BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED inline cons<
    typename detail::as_fusion_element<Car>::type, Cdr>
