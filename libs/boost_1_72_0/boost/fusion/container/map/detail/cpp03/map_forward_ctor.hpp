...
BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
    ...
    explicit
#endif
    map(BOOST_PP_ENUM_BINARY_PARAMS(N,
                                    typename detail::call_param<T, >::type arg))
...
FUSION_HASH if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
    ...
    N == 1
            ...
            FUSION_HASH if defined(BOOST_MSVC) &&
            (BOOST_MSVC == 1700),
        typename enable_if<is_same<U0, T0>>::type * = 0 FUSION_HASH endif
#endif
        )
