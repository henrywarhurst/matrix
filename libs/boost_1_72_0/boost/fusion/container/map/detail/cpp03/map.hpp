...
#pragma wave option(preserve : 2, line : 0, output                             \
                    : "preprocessed/map" FUSION_MAX_MAP_SIZE_STR ".hpp")
#endif
...
struct map : sequence_base<map<BOOST_PP_ENUM_PARAMS(FUSION_MAX_MAP_SIZE, T)>> {
  ...
  typedef vector<BOOST_PP_ENUM_PARAMS(FUSION_MAX_MAP_SIZE, T)> storage_type;
...
#include <boost/fusion/container/map/detail/cpp03/map_forward_ctor.hpp>
  ...
  FUSION_HASH endif
      ...
      BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED storage_type &
      get_data() {
    return data;
  }
