...
namespace detail {
template <typename T> struct boost_tuple_is_empty : mpl::false_ {};

template <> struct boost_tuple_is_empty<tuples::null_type> : mpl::true_ {};

template <>
struct boost_tuple_is_empty<tuples::null_type const> : mpl::true_ {};

template <> struct boost_tuple_is_empty<tuples::tuple<>> : mpl::true_ {};

template <> struct boost_tuple_is_empty<tuples::tuple<> const> : mpl::true_ {};
} // namespace detail

template <typename Cons> struct boost_tuple_iterator_identity;
...
struct boost_tuple_iterator
  ...
  typedef boost_tuple_iterator_identity<typename add_const<Cons>::type>
      identity;

  BOOST_FUSION_GPU_ENABLED
  explicit boost_tuple_iterator(Cons &in_cons) : cons(in_cons) {}
  Cons &cons;
  ...
  template <typename Iterator> struct deref {
    ...
    typedef typename mpl::if_<
        ...
        typename tuples::access_traits<element>::non_const_type>::type type;

    BOOST_FUSION_GPU_ENABLED
    static type call(Iterator const &iter) { return iter.cons.get_head(); }
  };
  ...
  template <typename Iterator> struct next {
    ...
    typedef boost_tuple_iterator<
        typename mpl::eval_if<is_const<cons_type>, add_const<tail_type>,
                              mpl::identity<tail_type>>::type>
        type;
  ...
  template <typename I1, typename I2> struct distance;

  // detail
  template <typename I1, typename I2> struct lazy_next_distance {
    typedef typename mpl::plus<
        mpl::int_<1>,
        typename distance<typename next<I1>::type, I2>::type>::type type;
  };

  template <typename I1, typename I2> struct distance {
    typedef typename mpl::eval_if<boost::is_same<I1, I2>, mpl::int_<0>,
                                  lazy_next_distance<I1, I2>>::type type;

    BOOST_FUSION_GPU_ENABLED
    static type call(I1 const &, I2 const &) { return type(); }
  };

  template <typename I1, typename I2>
  struct equal_to : is_same<typename I1::identity, typename I2::identity> {};
...
struct boost_tuple_null_iterator
  ...
  typedef boost_tuple_iterator_identity<typename add_const<Null>::type>
      identity;
  ...
  struct equal_to
      : mpl::or_<
            is_same<I1, I2>,
            mpl::and_<detail::boost_tuple_is_empty<typename I1::cons_type>,
...
struct boost_tuple_iterator<tuples::null_type>
  ...
  BOOST_FUSION_GPU_ENABLED explicit boost_tuple_iterator(Cons const &) {}
};
