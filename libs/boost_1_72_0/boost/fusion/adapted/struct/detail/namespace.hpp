...
#define BOOST_FUSION_ADAPT_STRUCT_NAMESPACE_DEFINITION_BEGIN(NAMESPACE_SEQ)    \
  BOOST_PP_IF(BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(NAMESPACE_SEQ)),                  \
              BOOST_PP_SEQ_FOR_EACH_R, BOOST_PP_TUPLE_EAT(4))                  \
  (1, BOOST_FUSION_ADAPT_STRUCT_NAMESPACE_BEGIN_I, _,                          \
   BOOST_PP_SEQ_TAIL(NAMESPACE_SEQ))

#define BOOST_FUSION_ADAPT_STRUCT_NAMESPACE_DEFINITION_END(NAMESPACE_SEQ)      \
  BOOST_PP_REPEAT_1(BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(NAMESPACE_SEQ)),            \
                    BOOST_FUSION_ADAPT_STRUCT_NAMESPACE_END_I, _)

#define BOOST_FUSION_ADAPT_STRUCT_NAMESPACE_DECLARATION(NAMESPACE_SEQ)         \
  BOOST_PP_IF(BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(NAMESPACE_SEQ)),                  \
              BOOST_PP_SEQ_FOR_EACH_R, BOOST_PP_TUPLE_EAT(4))                  \
  (1, BOOST_FUSION_ADAPT_STRUCT_NAMESPACE_DECLARATION_I, _,                    \
   BOOST_PP_SEQ_TAIL(NAMESPACE_SEQ))
