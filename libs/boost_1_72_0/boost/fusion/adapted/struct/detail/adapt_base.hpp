...
#define BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(SEQ)                             \
  BOOST_PP_IF(BOOST_PP_SEQ_HEAD(SEQ),                                          \
...
#define BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS_IMPL(SEQ)             \
  BOOST_PP_SEQ_ENUM(BOOST_PP_SEQ_FOR_EACH(                                     \
      BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS_IMPL_C, _,              \
      BOOST_PP_SEQ_TAIL(SEQ)))
...
#define BOOST_FUSION_ATTRIBUTE_TYPEOF(                                         \
  ...
  struct deduced_attr_type {                                                   \
    ...
    typedef BOOST_PP_IF(BOOST_FUSION_ADAPT_IS_TPL(TEMPLATE_PARAMS_SEQ),        \
                        typename, )                                            \
        BOOST_TYPEOF(PREFIX() obj.BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPLE_SIZE, 0, \
                                                      ATTRIBUTE)) type;        \
  };                                                                           \
                                                                               \
  typedef BOOST_PP_IF(BOOST_FUSION_ADAPT_IS_TPL(TEMPLATE_PARAMS_SEQ),          \
                      typename, ) deduced_attr_type::type attribute_type;
...
#define BOOST_FUSION_ATTRIBUTE_TYPEOF(                                         \
  ...
  struct deduced_attr_type {                                                   \
    static const BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ) & obj;        \
    typedef BOOST_TYPEOF(PREFIX()                                              \
                             obj.BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPLE_SIZE, 0,  \
                                                     ATTRIBUTE)) type;         \
  };                                                                           \
                                                                               \
  typedef BOOST_PP_IF(BOOST_FUSION_ADAPT_IS_TPL(TEMPLATE_PARAMS_SEQ),          \
...
#define BOOST_FUSION_ATTRIBUTE_GIVENTYPE(                                      \
    NAME_SEQ, ATTRIBUTE, ATTRIBUTE_TUPLE_SIZE, PREFIX, TEMPLATE_PARAMS_SEQ)    \
  typedef BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPLE_SIZE, 0, ATTRIBUTE)              \
      attribute_type;
...
#define BOOST_FUSION_ADAPT_STRUCT_BASE_UNPACK_AND_CALL(R, DATA, I, ATTRIBUTE)  \
  ...
  (BOOST_PP_TUPLE_ELEM(4, 1, DATA), BOOST_PP_TUPLE_ELEM(4, 2, DATA),           \
   BOOST_PP_TUPLE_ELEM(4, 3, DATA), I, ATTRIBUTE)
...
#define BOOST_FUSION_ADAPT_STRUCT_MSVC_REDEFINE_TEMPLATE_PARAMS_IMPL(SEQ)      \
  BOOST_PP_SEQ_FOR_EACH(                                                       \
      BOOST_FUSION_ADAPT_STRUCT_MSVC_REDEFINE_TEMPLATE_PARAM, _,               \
      BOOST_PP_SEQ_TAIL(SEQ))
...
#define BOOST_FUSION_ADAPT_STRUCT_C_BASE(TEMPLATE_PARAMS_SEQ, NAME_SEQ,        \
                                         IS_VIEW, I, PREFIX, ATTRIBUTE,        \
  ...
  struct access::struct_member<                                                \
    ...
    BOOST_PP_IF(DEDUCE_TYPE, BOOST_FUSION_ATTRIBUTE_TYPEOF,                    \
    ...
    template <typename Seq> struct apply {                                     \
      ...
      BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static type call(Seq &seq) {    \
        return seq.PREFIX() BOOST_PP_TUPLE_ELEM(                               \
            ATTRIBUTE_TUPLE_SIZE, BOOST_PP_NOT(DEDUCE_TYPE), ATTRIBUTE);       \
      }                                                                        \
    };                                                                         \
  };                                                                           \
                                                                               \
  template <BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS(                  \
      TEMPLATE_PARAMS_SEQ)>                                                    \
  struct struct_member_name<BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ),   \
                            I> {                                               \
    typedef char const *type;                                                  \
                                                                               \
    BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static type call() {              \
      return BOOST_PP_STRINGIZE(BOOST_PP_TUPLE_ELEM(                           \
          ATTRIBUTE_TUPLE_SIZE, BOOST_PP_NOT(DEDUCE_TYPE), ATTRIBUTE));        \
    }                                                                          \
  };

#define BOOST_FUSION_ADAPT_STRUCT_BASE(TEMPLATE_PARAMS_SEQ, NAME_SEQ, TAG,     \
                                       IS_VIEW, ATTRIBUTES_SEQ,                \
                                       ATTRIBUTES_CALLBACK)                    \
                                                                               \
  namespace boost {                                                            \
  namespace fusion {                                                           \
  namespace traits {                                                           \
  BOOST_FUSION_ADAPT_STRUCT_TAG_OF_SPECIALIZATION(BOOST_PP_EMPTY(),            \
                                                  TEMPLATE_PARAMS_SEQ,         \
                                                  NAME_SEQ, TAG)               \
  BOOST_FUSION_ADAPT_STRUCT_TAG_OF_SPECIALIZATION(const, TEMPLATE_PARAMS_SEQ,  \
                                                  NAME_SEQ, TAG)               \
  }                                                                            \
                                                                               \
  namespace extension {                                                        \
  BOOST_PP_IF(BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(ATTRIBUTES_SEQ)),                 \
              BOOST_PP_SEQ_FOR_EACH_I_R, BOOST_PP_TUPLE_EAT(4))                \
  (1, BOOST_FUSION_ADAPT_STRUCT_BASE_UNPACK_AND_CALL,                          \
  ...
  struct struct_is_view<BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ)>       \
  ...
  template <BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS(                  \
      TEMPLATE_PARAMS_SEQ)>                                                    \
  struct sequence_tag<BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ) const> { \
    typedef fusion::fusion_sequence_tag type;                                  \
  };                                                                           \
  }                                                                            \
  }
