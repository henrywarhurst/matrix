...
#define BOOST_FUSION_ADAPT_ASSOC_STRUCT_C_BASE(TEMPLATE_PARAMS_SEQ, NAME_SEQ,  \
                                               IS_VIEW, I, PREFIX, ATTRIBUTE)  \
                                                                               \
  BOOST_FUSION_ADAPT_STRUCT_C_BASE(                                            \
      TEMPLATE_PARAMS_SEQ, NAME_SEQ, IS_VIEW, I,                               \
      BOOST_PP_IIF(IS_VIEW, BOOST_FUSION_PROXY_PREFIX, BOOST_PP_EMPTY),        \
      BOOST_FUSION_ADAPT_STRUCT_WRAPPEDATTR(ATTRIBUTE),                        \
      BOOST_FUSION_ADAPT_STRUCT_WRAPPEDATTR_SIZE(ATTRIBUTE),                   \
      BOOST_PP_LESS(BOOST_FUSION_ADAPT_STRUCT_WRAPPEDATTR_SIZE(ATTRIBUTE), 3)) \
                                                                               \
  template <BOOST_FUSION_ADAPT_STRUCT_UNPACK_TEMPLATE_PARAMS(                  \
      TEMPLATE_PARAMS_SEQ)>                                                    \
  struct struct_assoc_key<BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ),     \
                          I> {                                                 \
    typedef BOOST_FUSION_ADAPT_ASSOC_STRUCT_WRAPPEDATTR_GET_KEY(               \
        ATTRIBUTE) type;                                                       \
  };

#define BOOST_FUSION_ADAPT_ASSOC_STRUCT_C(TEMPLATE_PARAMS_SEQ, NAME_SEQ,       \
                                          IS_VIEW, I, ATTRIBUTE)               \
                                                                               \
  BOOST_FUSION_ADAPT_ASSOC_STRUCT_C_BASE(                                      \
      TEMPLATE_PARAMS_SEQ, NAME_SEQ, IS_VIEW, I, BOOST_PP_EMPTY, ATTRIBUTE)

#define BOOST_FUSION_ADAPT_ASSOC_TPL_STRUCT(TEMPLATE_PARAMS_SEQ, NAME_SEQ,     \
                                            ATTRIBUTES)                        \
                                                                               \
  BOOST_FUSION_ADAPT_STRUCT_BASE(                                              \
      (1)TEMPLATE_PARAMS_SEQ, (1)NAME_SEQ, assoc_struct_tag, 0,                \
      BOOST_PP_CAT(                                                            \
