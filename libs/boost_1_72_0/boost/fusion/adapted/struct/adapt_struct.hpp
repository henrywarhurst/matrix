...
#define BOOST_FUSION_ADAPT_STRUCT_C(TEMPLATE_PARAMS_SEQ, NAME_SEQ, IS_VIEW, I, \
                                    ATTRIBUTE)                                 \
  BOOST_FUSION_ADAPT_STRUCT_C_BASE(                                            \
      ...
      BOOST_PP_LESS(BOOST_FUSION_ADAPT_STRUCT_WRAPPEDATTR_SIZE(ATTRIBUTE), 2))

#if BOOST_PP_VARIADICS

#define BOOST_FUSION_ADAPT_TPL_STRUCT(TEMPLATE_PARAMS_SEQ, NAME_SEQ, ...)      \
  BOOST_FUSION_ADAPT_STRUCT_BASE((1)TEMPLATE_PARAMS_SEQ, (1)NAME_SEQ,          \
                                 struct_tag, 0,                                \
...
#define BOOST_FUSION_ADAPT_STRUCT(...)                                         \
  BOOST_FUSION_ADAPT_STRUCT_BASE(                                              \
      (0), (0)(BOOST_PP_SEQ_HEAD(BOOST_PP_VARIADIC_TO_SEQ(__VA_ARGS__))),      \
      struct_tag, 0,                                                           \
      BOOST_FUSION_ADAPT_STRUCT_ATTRIBUTES_FILLER(                             \
