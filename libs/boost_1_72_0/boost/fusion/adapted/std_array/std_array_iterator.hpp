...
struct std_array_iterator : iterator_facade<std_array_iterator<Array, Pos>,
  ...
  std_array_iterator(Array &a) : array(a) {}
  ...
  template <typename Iterator> struct deref {
    typedef typename Iterator::array_type array_type;
    typedef typename mpl::if_<is_const<array_type>,
  ...
  template <typename Iterator, typename N> struct advance {
    ...
    static type call(Iterator const &i) { return type(i.array); }
  };
...
private:
  std_array_iterator<Array, Pos> &
  operator=(std_array_iterator<Array, Pos> const &);
};
} // namespace fusion
} // namespace boost
