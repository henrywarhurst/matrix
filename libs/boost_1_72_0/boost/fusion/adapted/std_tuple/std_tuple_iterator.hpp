...
template <typename Tuple, int Index> struct std_tuple_iterator_identity;

template <typename Tuple, int Index>
struct std_tuple_iterator : iterator_facade<std_tuple_iterator<Tuple, Index>,
                                            random_access_traversal_tag> {
  typedef Tuple tuple_type;
  static int const index = Index;
  typedef std_tuple_iterator_identity<typename add_const<Tuple>::type, Index>
      identity;
  ...
  template <typename Iterator> struct deref {
    ...
    typedef typename mpl::if_<
        ...
        typename fusion::detail::ref_result<element>::type>::type type;
