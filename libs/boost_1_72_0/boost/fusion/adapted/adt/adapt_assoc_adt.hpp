...
#define BOOST_FUSION_ADAPT_ASSOC_ADT_C(TEMPLATE_PARAMS_SEQ, NAME_SEQ, IS_VIEW, \
                                       I, ATTRIBUTE)                           \
                                                                               \
  BOOST_FUSION_ADAPT_ADT_C_BASE(                                               \
      TEMPLATE_PARAMS_SEQ, NAME_SEQ, I,                                        \
      ...
      BOOST_PP_LESS(BOOST_FUSION_ADAPT_ADT_WRAPPEDATTR_SIZE(ATTRIBUTE), 5))    \
                                                                               \
...
#define BOOST_FUSION_ADAPT_ASSOC_TPL_ADT(TEMPLATE_PARAMS_SEQ, NAME_SEQ,        \
                                         ATTRIBUTES)                           \
                                                                               \
  BOOST_FUSION_ADAPT_STRUCT_BASE(                                              \
      (1)TEMPLATE_PARAMS_SEQ, (1)NAME_SEQ, assoc_struct_tag, 0,                \
      BOOST_PP_CAT(BOOST_FUSION_ADAPT_ASSOC_ADT_FILLER_0(0, 0, 0, 0, 0)        \
                       ATTRIBUTES,                                             \
                   _END),                                                      \
