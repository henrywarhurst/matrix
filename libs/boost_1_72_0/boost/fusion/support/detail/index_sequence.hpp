...
// GCC5 has O(logN) implementation, see https://gcc.gnu.org/PR66059 .
    ...
    (defined(BOOST_LIBSTDCXX_VERSION) && BOOST_LIBSTDCXX_VERSION >= 500000 &&  \
     __cplusplus >= 201402)
#include <utility>
...
// Use aliasing templates without checking availability, the compiler should
// work.
...
template <std::size_t... Ints> struct index_sequence {
  ...
  BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED static std::size_t
  size() BOOST_NOEXCEPT {
    return sizeof...(Ints);
  }
