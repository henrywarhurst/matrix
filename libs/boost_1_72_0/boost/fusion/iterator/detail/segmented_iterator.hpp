...
namespace detail {
template <typename Stack> struct segmented_next_impl;
}
...
struct segmented_iterator
  ...
  template <typename It> struct deref {
    typedef typename result_of::deref<
        typename It::context_type::car_type::begin_type>::type type;
  ...
  //}
  template <typename It> struct deref_data {
  ...
  //}
  template <typename It>
  struct value_of_data : result_of::value_of_data<
  ...
  struct equal_to<It1, It2, Size, Size>
      : detail::segmented_equal_to<typename It1::context_type,
