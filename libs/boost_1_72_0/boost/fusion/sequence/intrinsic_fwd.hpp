...
template <typename Tag> struct at_key_impl;
...
template <typename Sequence, int N> struct at_c;
...
template <typename Sequence, typename N> struct value_at;

template <typename Sequence, int N> struct value_at_c;

template <typename Sequence, typename Key> struct at_key;

template <typename Sequence, typename N> struct value_at_key;
} // namespace result_of
