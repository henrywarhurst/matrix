...
ForwardIterator scan_keyword(InputIterator &b, InputIterator e,
  ...
  // Error: Could not find a match for boost::interprocess::unique_ptr<unsigned
  // char, void(*)(void*)>::unique_ptr(int, extern "C" void(void*))
