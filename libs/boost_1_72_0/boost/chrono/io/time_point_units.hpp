 ...
 * The default calls @c f.do_get_epoch(Clock()). The user can overload this
 * function.
...
/**
 * @c time_point_units facet gives useful information about the time_point
 * pattern, the text associated to a time_point's epoch,
 */
...
public:
   ...
   */
  explicit time_point_units(size_t refs = 0) : std::locale::facet(refs) {}
  ...
  /**
   * @return the epoch associated to the clock @c Clock calling @c
   * do_get_epoch(Clock())
   */
...
template <typename CharT> std::locale::id time_point_units<CharT>::id;
...
public:
  ...
  /**
   * @param c a dummy instance of @c system_clock.
   * @return The epoch string returned by @c
   ...
   * @param c a dummy instance of @c process_real_cpu_clock.
   * @return The epoch string returned by @c
   * clock_string<process_real_cpu_clock,CharT>::since().
   */
   ...
   * @param c a dummy instance of @c process_user_cpu_clock.
   * @return The epoch string returned by @c
   * clock_string<process_user_cpu_clock,CharT>::since().
   */
   ...
   * @param c a dummy instance of @c process_system_cpu_clock.
   * @return The epoch string returned by @c
   * clock_string<process_system_cpu_clock,CharT>::since().
   */
   ...
   * @param c a dummy instance of @c process_cpu_clock.
   * @return The epoch string returned by @c
   * clock_string<process_cpu_clock,CharT>::since().
   */
   ...
   * @param c a dummy instance of @c thread_clock.
   * @return The epoch string returned by @c
   * clock_string<thread_clock,CharT>::since().
   */
