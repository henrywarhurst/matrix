...
extern "C" {
void *__splitstack_makecontext(std::size_t, void *[BOOST_CONTEXT_SEGMENTS],
                               std::size_t *);
...
template <typename traitsT> class basic_segmented_stack {
private:
  std::size_t size_;
...
public:
  ...
  basic_segmented_stack(std::size_t size = traits_type::default_size())
      BOOST_NOEXCEPT_OR_NOTHROW : size_(size) {}
