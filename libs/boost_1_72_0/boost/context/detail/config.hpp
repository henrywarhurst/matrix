...
#undef BOOST_CONTEXT_DECL
    ...
    !defined(BOOST_CONTEXT_STATIC_LINK)
...
#if !defined(BOOST_CONTEXT_SOURCE) && !defined(BOOST_ALL_NO_LIB) &&            \
    !defined(BOOST_CONTEXT_NO_LIB)
...
#define BOOST_CONTEXT_CALLDECL
      ...
      (defined(__clang__) && (__clang_major__ > 2 ||                           \
                              (__clang_major__ == 2 && __clang_minor__ > 3))))
...
#endif
// workaroud: MSVC 14 does not provide macros to test for compile-time integer
// sequence
...
#undef BOOST_CONTEXT_NO_CXX11
    ...
    defined(BOOST_NO_CXX11_FINAL) || defined(BOOST_NO_CXX11_HDR_TUPLE) ||      \
    defined(BOOST_NO_CXX11_NOEXCEPT) || defined(BOOST_NO_CXX11_NULLPTR) ||     \
    defined(BOOST_NO_CXX11_RVALUE_REFERENCES) ||                               \
    defined(BOOST_NO_CXX11_TEMPLATE_ALIASES) ||                                \
    defined(BOOST_NO_CXX11_UNIFIED_INITIALISATION_SYNTAX) ||                   \
    defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) ||                              \
    defined(BOOST_NO_HDR_ATOMIC) || defined(BOOST_NO_HDR_TUPLE)
