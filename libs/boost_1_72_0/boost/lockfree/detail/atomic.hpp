...
#define BOOST_ATOMIC_CLANG_VERSION                                             \
  (__clang_major__ * 10000 + __clang_minor__ * 100 + __clang_patchlevel__)

#if defined(__apple_build_version__) &&                                        \
    (BOOST_ATOMIC_CLANG_VERSION >= 60100) && (__cplusplus >= 201103L)
#undef BOOST_LOCKFREE_NO_HDR_ATOMIC
#endif

#if !defined(__apple_build_version__) &&                                       \
    (BOOST_ATOMIC_CLANG_VERSION >= 30600) && (__cplusplus >= 201103L)
#undef BOOST_LOCKFREE_NO_HDR_ATOMIC
#endif
...
#define BOOST_LOCKFREE_NO_HDR_ATOMIC
    ...
    defined(BOOST_LOCKFREE_FORCE_BOOST_ATOMIC)
