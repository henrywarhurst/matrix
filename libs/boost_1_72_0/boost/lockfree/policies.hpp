 ...
 *
 *  The internal nodes are stored inside an array and they are addressed by
 * array indexing. This limits the possible size of the queue to the number of
 ...
 * the best way to achieve lock-freedom. This implies that a data structure is
 * bounded.
 * */
...
struct capacity : boost::parameter::template_keyword<tag::capacity,
