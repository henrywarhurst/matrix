...
struct pickle_suite_registration {
  ...
  template <class Class_, class Tgetinitargs, class Rgetstate, class Tgetstate,
  ...
  template <class Class_> static void register_(Class_ &, ...) {
    typedef typename error_messages::
        missing_pickle_suite_function_or_incorrect_signature<Class_>::error_type
            error_type BOOST_ATTRIBUTE_UNUSED;
  }
};
