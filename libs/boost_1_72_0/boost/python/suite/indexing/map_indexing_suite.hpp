...
class final_map_derived_policies
    : public map_indexing_suite<
          Container, NoProxy, final_map_derived_policies<Container, NoProxy>> {
};
} // namespace detail
...
public:
  ...
  template <class Class> static void extension_def(Class &cl) {
    ...
    typedef
        typename mpl::if_<mpl::and_<is_class<data_type>, mpl::bool_<!NoProxy>>,
  ...
  static typename mpl::if_<mpl::and_<is_class<data_type>, mpl::bool_<!NoProxy>>,
