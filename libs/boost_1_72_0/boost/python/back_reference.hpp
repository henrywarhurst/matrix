...
template <typename T> class is_back_reference {
public:
  BOOST_STATIC_CONSTANT(bool, value = false);
};

template <typename T> class is_back_reference<back_reference<T>> {
public:
...
template <class T> T back_reference<T>::get() const { return m_value; }
