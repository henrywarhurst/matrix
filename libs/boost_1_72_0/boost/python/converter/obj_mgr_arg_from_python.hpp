...
template <class T> struct object_manager_value_arg_from_python {
...
// "forced" object.
template <class Ref> struct object_manager_ref_arg_from_python {
...
namespace detail {
template <class T> inline bool object_manager_ref_check(T const &x) {
