...
#define BOOST_PP_ITERATION_PARAMS_1                                            \
  (4, (0, BOOST_PYTHON_MAX_ARITY, <boost / python / detail / target.hpp>,      \
       BOOST_PYTHON_FUNCTION_POINTER))
#include BOOST_PP_ITERATE()

#define BOOST_PP_ITERATION_PARAMS_1                                            \
  (4, (0, BOOST_PYTHON_CV_COUNT - 1, <boost / python / detail / target.hpp>,   \
       BOOST_PYTHON_POINTER_TO_MEMBER))
#include BOOST_PP_ITERATE()

template <class R, class T> T &(*target(R(T::*)))() { return 0; }
...
// BOOST_PP_ITERATION_DEPTH test inside an #else clause.
    ...
    BOOST_PP_ITERATION_FLAGS() == BOOST_PYTHON_FUNCTION_POINTER
...
BOOST_PP_IF(N, A0, void)
(*target(R (*)(BOOST_PP_ENUM_PARAMS_Z(1, N, A))))() {
  return 0;
}
...
/* --------------- pointers-to-members --------------- */
    ...
    BOOST_PP_ITERATION_FLAGS() == BOOST_PYTHON_POINTER_TO_MEMBER
// Outer over cv-qualifiers

#define BOOST_PP_ITERATION_PARAMS_2                                            \
  (3, (0, BOOST_PYTHON_MAX_ARITY, <boost / python / detail / target.hpp>))
#include BOOST_PP_ITERATE()
