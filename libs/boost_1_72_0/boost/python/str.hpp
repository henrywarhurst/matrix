...
public:
  ...
  template <class T> explicit str(T const &other) : base(object(other)) {}

  template <class T> str center(T const &width) const {
    return base::center(object(width));
  }

  template <class T> long count(T const &sub) const {
  ...
  template <class T> object decode(T const &encoding) const {
  ...
  template <class T> object encode(T const &encoding) const {
  ...
  template <class T> bool endswith(T const &suffix) const {
  ...
  template <class T> str expandtabs(T const &tabsize) const {
    return base::expandtabs(object(tabsize));
  }

  template <class T> long find(T const &sub) const {
  ...
  template <class T> long index(T const &sub) const {
  ...
  template <class T> str join(T const &sequence) const {
    return base::join(object(sequence));
  }

  template <class T> str ljust(T const &width) const {
  ...
  template <class T> long rfind(T const &sub) const {
  ...
  template <class T> long rindex(T const &sub) const {
  ...
  template <class T> str rjust(T const &width) const {
    return base::rjust(object(width));
  }

  list split() const { return base::split(); }

  template <class T> list split(T const &sep) const {
  ...
  template <class T> list splitlines(T const &keepends) const {
    return base::splitlines(object(keepends));
  }

  template <class T> bool startswith(T const &prefix) const {
  ...
  template <class T> str translate(T const &table) const {
