...
template <class S, class T1, class T2> struct replace_front2 {
  // Metafunction forwarding seemed to confound vc6
  typedef typename mpl::push_front<
      typename mpl::push_front<
          typename mpl::pop_front<typename mpl::pop_front<S>::type>::type,
          T2>::type,
      T1>::type type;
};
...
struct pure_virtual_visitor
  ...
  pure_virtual_visitor(PointerToMemberFunction pmf) : m_pmf(pmf) {}
