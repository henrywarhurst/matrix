...
template <class T> inline void del(proxy<T> const &x) { x.del(); }
...
template <class Policies> inline proxy<Policies>::operator object() const {
...
template <class Policies> inline void proxy<Policies>::del() const {
