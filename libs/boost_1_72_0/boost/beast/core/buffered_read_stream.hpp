...
public:
  ...
  */
  template <class... Args> explicit buffered_read_stream(Args &&... args);

  /// Get a reference to the next layer.
  next_layer_type &next_layer() noexcept { return next_layer_; }

  /// Get a const reference to the next layer.
  next_layer_type const &next_layer() const noexcept { return next_layer_; }
  ...
  */
  DynamicBuffer &buffer() noexcept { return buffer_; }

  /// Access the internal buffer
  DynamicBuffer const &buffer() const noexcept { return buffer_; }
  ...
  */
  void capacity(std::size_t size) noexcept { capacity_ = size; }
