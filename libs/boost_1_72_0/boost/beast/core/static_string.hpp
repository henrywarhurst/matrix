...
class static_string {
  template <std::size_t, class, class> friend class static_string;

  void term() { Traits::assign(s_[n_], 0); }
...
public:
  ...
  */
  ...
  template <class InputIt> static_string(InputIt first, InputIt last);
  ...
  explicit static_string(string_view_type sv);
  ...
  */
  ...
  /// Copy assignment.
  static_string &operator=(static_string const &str) { return assign(str); }
  ...
  static_string &operator=(string_view_type sv) { return assign(sv); }
  ...
  static_string &assign(CharT const *s) { return assign(s, Traits::length(s)); }
  ...
  */
  ...
  reference operator[](size_type pos) { return s_[pos]; }

  /// Access specified character.
  const_reference operator[](size_type pos) const { return s_[pos]; }

  /// Accesses the first character.
  CharT &front() { return s_[0]; }

  /// Accesses the first character.
  CharT const &front() const { return s_[0]; }

  /// Accesses the last character.
  CharT &back() { return s_[n_ - 1]; }

  /// Accesses the last character.
  CharT const &back() const { return s_[n_ - 1]; }

  /// Returns a pointer to the first character of a string.
  CharT *data() { return &s_[0]; }

  /// Returns a pointer to the first character of a string.
  CharT const *data() const { return &s_[0]; }

  /// Returns a non-modifiable standard C character array version of the string.
  CharT const *c_str() const { return data(); }
  ...
  iterator end() { return &s_[n_]; }

  /// Returns an iterator to the end.
  const_iterator end() const { return &s_[n_]; }

  /// Returns an iterator to the end.
  const_iterator cend() const { return &s_[n_]; }
  ...
  /// Returns the maximum number of characters that can be stored, excluding the
  /// null terminator.
  size_type constexpr max_size() const { return N; }
  ...
  */
  ...
  /// storage.
  size_type constexpr capacity() const { return max_size(); }
  ...
  */
  ...
  template <std::size_t M>
  static_string &insert(size_type index,
  ...
  typename std::enable_if<
      ...
      static_string &>::type
#endif
  insert(size_type index, T const &t, size_type index_str,
  ...
  void pop_back() { Traits::assign(s_[--n_], 0); }
  ...
  static_string &operator+=(CharT const *s) { return append(s); }

  static_string &operator+=(std::initializer_list<CharT> init) {
    return append(init);
  }

  static_string &operator+=(string_view_type const &str) { return append(str); }

  template <std::size_t M>
  int compare(static_string<M, CharT, Traits> const &str) const {
    return detail::lexicographical_compare<CharT, Traits>(&s_[0], n_,
                                                          &str.s_[0], str.n_);
  }
  ...
  template <std::size_t M>
  int compare(size_type pos1, size_type count1,
              static_string<M, CharT, Traits> const &str, size_type pos2,
              size_type count2 = npos) const {
    return detail::lexicographical_compare(substr(pos1, count1),
                                           str.substr(pos2, count2));
  }

  int compare(CharT const *s) const {
    return detail::lexicographical_compare<CharT, Traits>(&s_[0], n_, s,
                                                          Traits::length(s));
  }

  int compare(size_type pos1, size_type count1, CharT const *s) const {
    return detail::lexicographical_compare<CharT, Traits>(substr(pos1, count1),
                                                          s, Traits::length(s));
  }

  int compare(size_type pos1, size_type count1, CharT const *s,
  ...
  typename std::enable_if<
    ...
    compare(size_type pos1, size_type count1,
        T const& t, size_type pos2,
            size_type count2 = npos) const
    {
    return compare(pos1, count1, string_view_type(t).substr(pos2, count2));
  }

  string_view_type substr(size_type pos = 0, size_type count = npos) const;

  /// Copy a substring (pos, pos+count) to character string pointed to by
  /// `dest`.
  ...
  */
  ...
  /// Exchange the contents of this string with another.
  template <std::size_t M> void swap(static_string<M, CharT, Traits> &str);
...
private:
  static_string &assign_char(CharT ch, std::true_type);

  static_string &assign_char(CharT ch, std::false_type);
};
...
void operator+(static_string<N, CharT, Traits> const &,
               static_string<M, CharT, Traits> const &) = delete;

template <std::size_t N, class CharT, class Traits>
void operator+(CharT const *, static_string<N, CharT, Traits> const &) = delete;

template <std::size_t N, class CharT, class Traits>
void operator+(CharT, static_string<N, CharT, Traits> const &) = delete;

template <std::size_t N, class CharT, class Traits>
void operator+(static_string<N, CharT, Traits> const &, CharT const *) = delete;

template <std::size_t N, class CharT, class Traits>
void operator+(static_string<N, CharT, Traits> const &, CharT) = delete;
...
template <std::size_t N, std::size_t M, class CharT, class Traits>
bool operator==(static_string<N, CharT, Traits> const &lhs,
...
template <std::size_t N, class CharT, class Traits>
void swap(static_string<N, CharT, Traits> &lhs,
...
operator<<(std::basic_ostream<CharT, Traits> &os,
  ...
  return os << static_cast<beast::basic_string_view<CharT, Traits>>(str);
}
