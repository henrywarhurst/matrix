...
public:
  /// Constructor
  static_buffer() noexcept : static_buffer_base(buf_, N) {}
  ...
  static_buffer_base &base() noexcept { return *this; }

  /// Returns the @ref static_buffer_base portion of this object
  static_buffer_base const &base() const noexcept { return *this; }

  /// Return the maximum sum of the input and output sequence sizes.
  std::size_t constexpr max_size() const noexcept { return N; }

  /// Return the maximum sum of input and output sizes that can be held without
  /// an allocation.
  std::size_t constexpr capacity() const noexcept { return N; }
};
