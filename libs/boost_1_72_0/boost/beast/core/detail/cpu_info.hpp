...
#include <boost/config.hpp>
    ...
    ((defined(BOOST_GCC) || defined(BOOST_CLANG)) && defined(__SSE4_2__))
...
*/
template <class = void>
void cpuid(std::uint32_t id, std::uint32_t &eax, std::uint32_t &ebx,
...
template <class = void> cpu_info const &get_cpu_info() {
