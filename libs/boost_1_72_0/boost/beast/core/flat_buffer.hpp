...
#endif
{
  template <class OtherAlloc> friend class basic_flat_buffer;

  using base_alloc_type =
      typename detail::allocator_traits<Allocator>::template rebind_alloc<char>;

  static bool constexpr default_nothrow =
      std::is_nothrow_default_constructible<Allocator>::value;

  using alloc_traits = beast::detail::allocator_traits<base_alloc_type>;
  ...
  static std::size_t dist(char const *first, char const *last) noexcept {
...
public:
  ...
  */
  explicit basic_flat_buffer(std::size_t limit) noexcept(default_nothrow);
  ...
  /** Constructor
      ...
      No-throw guarantee.
  */
  explicit basic_flat_buffer(Allocator const &alloc) noexcept;
  ...
  /** Constructor
      ...
      No-throw guarantee.
  */
  basic_flat_buffer(std::size_t limit, Allocator const &alloc) noexcept;
  ...
  */
  ...
  basic_flat_buffer(basic_flat_buffer<OtherAlloc> const &other) noexcept(
      default_nothrow);
  ...
  */
  ...
  /** Move Assignment
      ...
      No-throw guarantee.
  */
  basic_flat_buffer &operator=(basic_flat_buffer &&other) noexcept;
  ...
  */
  ...
  /** Set the maximum allowed capacity
      ...
      No-throw guarantee.
  */
  void max_size(std::size_t n) noexcept { max_ = n; }
  ...
  */
  ...
  friend void swap(basic_flat_buffer<Alloc> &, basic_flat_buffer<Alloc> &);
  ...
  std::size_t size() const noexcept { return dist(in_, out_); }
  ...
  /// Return the maximum number of bytes, both readable and writable, that can
  /// be held without requiring an allocation.
  std::size_t capacity() const noexcept { return dist(begin_, end_); }

  /// Returns a constant buffer sequence representing the readable bytes
  const_buffers_type data() const noexcept { return {in_, dist(in_, out_)}; }

  /// Returns a constant buffer sequence representing the readable bytes
  const_buffers_type cdata() const noexcept { return data(); }

  /// Returns a mutable buffer sequence representing the readable bytes
  mutable_data_type data() noexcept { return {in_, dist(in_, out_)}; }
