...
BOOST_PRAGMA_MESSAGE("<boost/beast/core/handler_ptr.hpp> is DEPRECATED and "
...
template <class T, class Handler> class handler_ptr {
  ...
  static_assert(sizeof(T) == 0, BOOST_BEAST_DEPRECATION_STRING);
#endif
...
public:
  ...
  */
  ...
  handler_type const &handler() const noexcept { return h_; }

  /// Return a reference to the handler
  handler_type &handler() noexcept { return h_; }
