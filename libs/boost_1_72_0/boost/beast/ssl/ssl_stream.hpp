...
public:
  ...
  */
  ...
  ssl_stream(Arg &&arg, net::ssl::context &ctx)
      : p_(new stream_type{std::forward<Arg>(arg), ctx}) {}
  ...
  */
  ...
  /** Set the peer verification mode.
      ...
      the stream. The new mode will override the mode inherited from the
     context.
  ...
  */
  void set_verify_depth(int depth) { p_->next_layer().set_verify_depth(depth); }
  ...
  */
  ...
  /** Perform SSL handshaking.
     ...
     as a server.
      ...
      @throws boost::system::system_error Thrown on failure.
  */
  void handshake(handshake_type type) { p_->next_layer().handshake(type); }
  ...
  */
  ...
  async_handshake(handshake_type type,
    ...
    return p_->next_layer().async_handshake(
        type, BOOST_ASIO_MOVE_CAST(HandshakeHandler)(handler));
  }
  ...
  */
  ...
  /** Shut down SSL on the stream.
      ...
      @throws boost::system::system_error Thrown on failure.
  */
  void shutdown() { p_->next_layer().shutdown(); }
  ...
  */
  ...
  /** Read some data from the stream.
     ...
     of bytes. Consider using the `net::read` function if you need to ensure
