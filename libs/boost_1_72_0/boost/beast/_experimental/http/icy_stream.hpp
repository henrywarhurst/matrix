...
template <class NextLayer> class icy_stream {
  ...
  static net::const_buffer version() { return {"HTTP/1.1", 8}; }
...
public:
  ...
  */
  template <class... Args> explicit icy_stream(Args &&... args);
  ...
  */
  ...
  /** Get a reference to the next layer
      ...
      stream layers.
  */
  next_layer_type const &next_layer() const { return stream_; }
