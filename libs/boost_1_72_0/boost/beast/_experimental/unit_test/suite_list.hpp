...
public:
  ...
  */
  ...
  void insert(char const *name, char const *module, char const *library,
              bool manual);
};
...
template <class Suite>
void suite_list::insert(char const *name, char const *module,
...
#endif
  cont().emplace(make_suite_info<Suite>(name, module, library, manual));
}
