...
template <class File> void basic_file_body<File>::value_type::close() {
  error_code ignored;
  file_.close(ignored);
}

template <class File>
void basic_file_body<File>::value_type::open(char const *path, file_mode mode,
                                             error_code &ec) {
  // Open the file
...
*/
template <class File> class basic_file_body<File>::writer {
...
// Initializer
template <class File> void basic_file_body<File>::writer::init(error_code &ec) {
...
*/
template <class File> class basic_file_body<File>::reader {
...
void basic_file_body<File>::reader::init(
    boost::optional<std::uint64_t> const &content_length, error_code &ec) {
...
template <class ConstBufferSequence>
std::size_t
basic_file_body<File>::reader::put(ConstBufferSequence const &buffers,
                                   error_code &ec) {
