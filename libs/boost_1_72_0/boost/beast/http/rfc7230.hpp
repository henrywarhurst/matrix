...
public:
  ...
  */
  explicit param_list(string_view s) : s_(s) {}
...
/** A list of extensions in a comma separated HTTP field value.
    ...
    @par Example
    @code
    for(auto const& ext : ext_list{"none, 7z;level=9,
   zip;no_context_takeover;bits=15"})
    {
        std::cout << ext.first << "\n";
...
public:
  ...
  */
  ...
  /** Construct a list.
      ...
      must remain valid for the lifetime of the container.
  */
  explicit ext_list(string_view s) : s_(s) {}
  ...
  */
  BOOST_BEAST_DECL
  const_iterator find(string_view const &s);
  ...
  */
  BOOST_BEAST_DECL
  bool exists(string_view const &s);
};
...
public:
  ...
  /** Construct a list.
      ...
      must remain valid for the lifetime of the container.
  */
  explicit token_list(string_view s) : s_(s) {}
