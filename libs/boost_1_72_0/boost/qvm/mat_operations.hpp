...
namespace qvm_detail {
template <int R, int C> struct to_string_m_defined {
  static bool const value = false;
};

template <int I, int SizeMinusOne> struct to_string_matrix_elements {
  template <class A> static std::string f(A const &a) {
    using namespace qvm_to_string_detail;
    return ((I % mat_traits<A>::cols) == 0 ? '(' : ',') +
           to_string(mat_traits<A>::template read_element<
                     I / mat_traits<A>::cols, I % mat_traits<A>::cols>(a)) +
...
inline typename boost::enable_if_c<
    is_mat<A>::value && !qvm_detail::to_string_m_defined<
                            mat_traits<A>::rows, mat_traits<A>::cols>::value,
    std::string>::type
to_string(A const &a) {
  return "(" +
         qvm_detail::to_string_matrix_elements<
             0, mat_traits<A>::rows * mat_traits<A>::cols - 1>::f(a) +
         ')';
}
...
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<is_mat<A>::value && is_mat<B>::value &&
                             mat_traits<A>::rows == mat_traits<B>::rows &&
                             mat_traits<A>::cols == mat_traits<B>::cols,
                         bool>::type
    cmp(A const &a, B const &b, Cmp f) {
  typedef typename deduce_scalar<typename mat_traits<A>::scalar_type,
...
namespace qvm_detail {
template <int M, int N> struct convert_to_m_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_TRIVIAL typename enable_if_c<
    is_mat<R>::value && is_mat<A>::value &&
        ...
        !qvm_detail::convert_to_m_defined<mat_traits<A>::rows,
...
namespace qvm_detail {
template <class T, int Dim> class identity_mat_ {
...
template <class T, int Dim>
BOOST_QVM_INLINE_TRIVIAL qvm_detail::identity_mat_<T, Dim> const &
identity_mat() {
  return *(qvm_detail::identity_mat_<T, Dim> const *)
      qvm_detail::get_valid_ptr_mat_operations();
}

template <class A>
BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
    is_mat<A>::value && mat_traits<A>::rows == mat_traits<A>::cols, void>::type
set_identity(A &a) {
  assign(
      a,
      identity_mat<typename mat_traits<A>::scalar_type, mat_traits<A>::rows>());
}

////////////////////////////////////////////////

namespace qvm_detail {
template <class T> struct projection_ {
  T const _00;
  T const _11;
  T const _22;
  T const _23;
  ...
  projection_(T _00, T _11, T _22, T _23, T _32)
      : _00(_00), _11(_11), _22(_22), _23(_23), _32(_32) {}
...
template <int Row, int Col> struct projection_get {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(projection_<T> const &) {
    return scalar_traits<T>::value(0);
  }
};

template <> struct projection_get<0, 0> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(projection_<T> const &m) {
    return m._00;
  }
};
template <> struct projection_get<1, 1> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(projection_<T> const &m) {
    return m._11;
  }
};
template <> struct projection_get<2, 2> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(projection_<T> const &m) {
    return m._22;
  }
};
template <> struct projection_get<2, 3> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(projection_<T> const &m) {
    return m._23;
  }
};
template <> struct projection_get<3, 2> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(projection_<T> const &m) {
    return m._32;
  }
...
template <class T> struct mat_traits<qvm_detail::projection_<T>> {
...
template <class T>
qvm_detail::projection_<T> BOOST_QVM_INLINE_OPERATIONS
...
namespace qvm_detail {
template <class OriginalType, class Scalar> class matrix_scalar_cast_ {
...
public:
  template <class T>
  BOOST_QVM_INLINE_TRIVIAL matrix_scalar_cast_ &operator=(T const &x) {
    assign(*this, x);
    return *this;
  }
...
struct mat_traits<qvm_detail::matrix_scalar_cast_<OriginalType, Scalar>> {
  ...
  read_element_idx(int row, int col, this_matrix const &x) {
    ...
    return scalar_type(mat_traits<OriginalType>::read_element_idx(
        col, row, reinterpret_cast<OriginalType const &>(x)));
  }
};
...
BOOST_QVM_INLINE_TRIVIAL qvm_detail::matrix_scalar_cast_<T, Scalar> const &
scalar_cast(
    T const &x,
    typename qvm_detail::scalar_cast_matrix_filter<is_mat<T>::value>::type =
        0) {
  return reinterpret_cast<qvm_detail::matrix_scalar_cast_<T, Scalar> const &>(
      x);
}
...
namespace qvm_detail {
template <int M, int N> struct div_eq_ms_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
    is_mat<A>::value && is_scalar<B>::value &&
        !qvm_detail::div_eq_ms_defined<mat_traits<A>::rows,
                                       mat_traits<A>::cols>::value,
    A &>::type
operator/=(A &a, B b) {
...
namespace qvm_detail {
template <int M, int N> struct div_ms_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    is_mat<A>::value && is_scalar<B>::value &&
        !qvm_detail::div_ms_defined<mat_traits<A>::rows,
                                    mat_traits<A>::cols>::value,
    deduce_mat<A>>::type
operator/(A const &a, B b) {
  ...
  for (int i = 0; i != mat_traits<A>::rows; ++i)
    for (int j = 0; j != mat_traits<A>::cols; ++j)
      mat_traits<R>::write_element_idx(i, j, r) =
          mat_traits<A>::read_element_idx(i, j, a) / b;
  return r;
}
...
namespace qvm_detail {
template <int M, int N> struct eq_mm_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
    is_mat<A>::value && is_mat<B>::value &&
        mat_traits<A>::rows == mat_traits<B>::rows &&
        mat_traits<A>::cols == mat_traits<B>::cols &&
        !qvm_detail::eq_mm_defined<mat_traits<A>::rows,
                                   mat_traits<A>::cols>::value,
    bool>::type
operator==(A const &a, B const &b) {
  for (int i = 0; i != mat_traits<A>::rows; ++i)
    for (int j = 0; j != mat_traits<A>::cols; ++j)
      if (mat_traits<A>::read_element_idx(i, j, a) !=
...
namespace qvm_detail {
template <int M, int N> struct minus_eq_mm_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
    is_mat<A>::value && is_mat<B>::value &&
        mat_traits<A>::rows == mat_traits<B>::rows &&
        mat_traits<A>::cols == mat_traits<B>::cols &&
        !qvm_detail::minus_eq_mm_defined<mat_traits<A>::rows,
                                         mat_traits<A>::cols>::value,
    A &>::type
operator-=(A &a, B const &b) {
  for (int i = 0; i != mat_traits<A>::rows; ++i)
    for (int j = 0; j != mat_traits<A>::cols; ++j)
      mat_traits<A>::write_element_idx(i, j, a) -=
          mat_traits<B>::read_element_idx(i, j, b);
  return a;
}
...
namespace qvm_detail {
template <int M, int N> struct minus_m_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
template <class A>
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    is_mat<A>::value && !qvm_detail::minus_m_defined<
                            mat_traits<A>::rows, mat_traits<A>::cols>::value,
    deduce_mat<A>>::type
operator-(A const &a) {
  typedef typename deduce_mat<A>::type R;
...
namespace qvm_detail {
template <int M, int N> struct minus_mm_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    is_mat<A>::value && is_mat<B>::value &&
        mat_traits<A>::rows == mat_traits<B>::rows &&
        mat_traits<A>::cols == mat_traits<B>::cols &&
        !qvm_detail::minus_mm_defined<mat_traits<A>::rows,
                                      mat_traits<A>::cols>::value,
...
namespace qvm_detail {
template <int D> struct mul_eq_mm_defined { static bool const value = false; };
} // namespace qvm_detail
...
namespace qvm_detail {
template <int M, int N> struct mul_eq_ms_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
    is_mat<A>::value && is_scalar<B>::value &&
        !qvm_detail::mul_eq_ms_defined<mat_traits<A>::rows,
                                       mat_traits<A>::cols>::value,
    A &>::type
operator*=(A &a, B b) {
  for (int i = 0; i != mat_traits<A>::rows; ++i)
...
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    is_mat<A>::value && is_mat<B>::value &&
        ...
        !qvm_detail::mul_mm_defined<mat_traits<A>::rows, mat_traits<A>::cols,
...
operator*(A const &a, B const &b) {
  ...
  for (int i = 0; i < mat_traits<A>::rows; ++i)
    for (int j = 0; j < mat_traits<B>::cols; ++j) {
      ...
      Ta x(scalar_traits<Ta>::value(0));
      for (int k = 0; k < mat_traits<A>::cols; ++k)
        x += mat_traits<A>::read_element_idx(i, k, a) *
             mat_traits<B>::read_element_idx(k, j, b);
...
namespace qvm_detail {
template <int M, int N> struct mul_ms_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    is_mat<A>::value && is_scalar<B>::value &&
        !qvm_detail::mul_ms_defined<mat_traits<A>::rows,
                                    mat_traits<A>::cols>::value,
    deduce_mat<A>>::type
operator*(A const &a, B b) {
  typedef typename deduce_mat<A>::type R;
...
namespace qvm_detail {
template <int M, int N> struct mul_sm_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    is_scalar<A>::value && is_mat<B>::value &&
        !qvm_detail::mul_sm_defined<mat_traits<B>::rows,
                                    mat_traits<B>::cols>::value,
    deduce_mat<B>>::type
operator*(A a, B const &b) {
  ...
  for (int i = 0; i != mat_traits<B>::rows; ++i)
    for (int j = 0; j != mat_traits<B>::cols; ++j)
      mat_traits<R>::write_element_idx(i, j, r) =
          a * mat_traits<B>::read_element_idx(i, j, b);
  return r;
}
...
namespace qvm_detail {
template <int M, int N> struct neq_mm_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
    is_mat<A>::value && is_mat<B>::value &&
        mat_traits<A>::rows == mat_traits<B>::rows &&
        mat_traits<A>::cols == mat_traits<B>::cols &&
        !qvm_detail::neq_mm_defined<mat_traits<A>::rows,
                                    mat_traits<A>::cols>::value,
    bool>::type
operator!=(A const &a, B const &b) {
  for (int i = 0; i != mat_traits<A>::rows; ++i)
...
namespace qvm_detail {
template <int M, int N> struct plus_eq_mm_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
    is_mat<A>::value && is_mat<B>::value &&
        mat_traits<A>::rows == mat_traits<B>::rows &&
        mat_traits<A>::cols == mat_traits<B>::cols &&
        !qvm_detail::plus_eq_mm_defined<mat_traits<A>::rows,
                                        mat_traits<A>::cols>::value,
    A &>::type
operator+=(A &a, B const &b) {
  for (int i = 0; i != mat_traits<A>::rows; ++i)
...
namespace qvm_detail {
template <int M, int N> struct plus_mm_defined {
  static bool const value = false;
};
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    is_mat<A>::value && is_mat<B>::value &&
        mat_traits<A>::rows == mat_traits<B>::rows &&
        mat_traits<A>::cols == mat_traits<B>::cols &&
        !qvm_detail::plus_mm_defined<mat_traits<A>::rows,
                                     mat_traits<A>::cols>::value,
    deduce_mat2<A, B, mat_traits<A>::rows, mat_traits<A>::cols>>::type
operator+(A const &a, B const &b) {
  typedef
...
namespace qvm_detail {
template <class T> class mref_ {
  mref_(mref_ const &);
  mref_ &operator=(mref_ const &);
  ~mref_();

public:
  template <class R> BOOST_QVM_INLINE_TRIVIAL mref_ &operator=(R const &x) {
    assign(*this, x);
    return *this;
  }
...
template <class M> struct mat_traits<qvm_detail::mref_<M>> {
  ...
  read_element(this_matrix const &x) {
    ...
    BOOST_QVM_STATIC_ASSERT(Col >= 0);
    BOOST_QVM_STATIC_ASSERT(Col < cols);
    return mat_traits<M>::template read_element<Row, Col>(
        reinterpret_cast<M const &>(x));
  }
  ...
  static BOOST_QVM_INLINE_CRITICAL scalar_type &write_element(this_matrix &x) {
    ...
    BOOST_QVM_STATIC_ASSERT(Col >= 0);
    BOOST_QVM_STATIC_ASSERT(Col < cols);
    return mat_traits<M>::template write_element<Row, Col>(
        reinterpret_cast<M &>(x));
  }
  ...
  read_element_idx(int row, int col, this_matrix const &x) {
    ...
    BOOST_QVM_ASSERT(col >= 0);
    BOOST_QVM_ASSERT(col < cols);
    return mat_traits<M>::read_element_idx(row, col,
                                           reinterpret_cast<M const &>(x));
  }
...
template <class M, int R, int C> struct deduce_mat<qvm_detail::mref_<M>, R, C> {
...
template <class M>
BOOST_QVM_INLINE_TRIVIAL
    typename enable_if_c<is_mat<M>::value, qvm_detail::mref_<M> &>::type
    mref(M &a) {
...
namespace qvm_detail {
template <class T, int Rows, int Cols> class zero_mat_ {
...
template <class T, int Rows, int Cols>
BOOST_QVM_INLINE_TRIVIAL qvm_detail::zero_mat_<T, Rows, Cols> const &
zero_mat() {
  return *(qvm_detail::zero_mat_<T, Rows, Cols> const *)
      qvm_detail::get_valid_ptr_mat_operations();
}

template <class T, int Dim>
BOOST_QVM_INLINE_TRIVIAL qvm_detail::zero_mat_<T, Dim, Dim> const &zero_mat() {
  return *(qvm_detail::zero_mat_<T, Dim, Dim> const *)
      qvm_detail::get_valid_ptr_mat_operations();
}

template <class A>
BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<is_mat<A>::value, void>::type
set_zero(A &a) {
  assign(a, zero_mat<typename mat_traits<A>::scalar_type, mat_traits<A>::rows,
                     mat_traits<A>::cols>());
}
...
namespace qvm_detail {
template <int D, class S> struct rot_mat_ {
  typedef S scalar_type;
  scalar_type a[3][3];

  BOOST_QVM_INLINE
  rot_mat_(scalar_type a00, scalar_type a01, scalar_type a02, scalar_type a10,
           scalar_type a11, scalar_type a12, scalar_type a20, scalar_type a21,
           scalar_type a22) {
    a[0][0] = a00;
    a[0][1] = a01;
    a[0][2] = a02;
...
template <int Row, int Col> struct rot_m_get {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const (&)[3][3]) {
    return scalar_traits<T>::value(Row == Col);
  }
};

template <> struct rot_m_get<0, 0> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(T const (&a)[3][3]) {
    return a[0][0];
  }
};
template <> struct rot_m_get<0, 1> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(T const (&a)[3][3]) {
    return a[0][1];
  }
};
template <> struct rot_m_get<0, 2> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(T const (&a)[3][3]) {
    return a[0][2];
  }
};
template <> struct rot_m_get<1, 0> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(T const (&a)[3][3]) {
    return a[1][0];
  }
};
template <> struct rot_m_get<1, 1> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(T const (&a)[3][3]) {
    return a[1][1];
  }
};
template <> struct rot_m_get<1, 2> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(T const (&a)[3][3]) {
    return a[1][2];
  }
};
template <> struct rot_m_get<2, 0> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(T const (&a)[3][3]) {
    return a[2][0];
  }
};
template <> struct rot_m_get<2, 1> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(T const (&a)[3][3]) {
    return a[2][1];
  }
};
template <> struct rot_m_get<2, 2> {
  template <class T>
  static BOOST_QVM_INLINE_CRITICAL T get(T const (&a)[3][3]) {
    return a[2][2];
  }
...
template <int D, class S> struct mat_traits<qvm_detail::rot_mat_<D, S>> {
  ...
  read_element_idx(int row, int col, this_matrix const &x) {
    ...
    return row < 3 && col < 3 ? x.a[row][col]
...
BOOST_QVM_INLINE
    typename enable_if_c<is_vec<V>::value && vec_traits<V>::dim == 3,
  ...
  return qvm_detail::rot_mat_<Dim, Angle>(
      x2 + (one - x2) * c, xy * c1 - zs, xz * (one - c) + ys, xy * c1 + zs,
      y2 + (one - y2) * c, yz * c1 - xs, xz * c1 - ys, yz * c1 + xs,
      z2 + (one - z2) * c);
}
...
BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
    is_mat<A>::value && mat_traits<A>::rows == mat_traits<A>::cols &&
        mat_traits<A>::rows >= 3 && is_vec<B>::value && vec_traits<B>::dim == 3,
    void>::type
...
BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle>
rot_mat_xzy(Angle x1, Angle z2, Angle y3) {
  ...
  return qvm_detail::rot_mat_<Dim, Angle>(
      c2 * c3, -s2, c2 * s3, s1 * s3 + c1 * c3 * s2, c1 * c2,
      c1 * s2 * s3 - c3 * s1, c3 * s1 * s2 - c1 * s3, c2 * s1,
      c1 * c3 + s1 * s2 * s3);
}

template <class A, class Angle>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<is_mat<A>::value &&
                             mat_traits<A>::rows == mat_traits<A>::cols &&
                             mat_traits<A>::rows >= 3,
                         void>::type
...
rot_mat_xyz(Angle x1, Angle y2, Angle z3) {
  ...
  return qvm_detail::rot_mat_<Dim, Angle>(
      c2 * c3, -c2 * s3, s2, c1 * s3 + c3 * s1 * s2, c1 * c3 - s1 * s2 * s3,
      -c2 * s1, s1 * s3 - c1 * c3 * s2, c3 * s1 + c1 * s2 * s3, c1 * c2);
}
...
rot_mat_yxz(Angle y1, Angle x2, Angle z3) {
  ...
  scalar_type const s3 = sin<scalar_type>(z3);
  return qvm_detail::rot_mat_<Dim, Angle>(
      c1 * c3 + s1 * s2 * s3, c3 * s1 * s2 - c1 * s3, c2 * s1, c2 * s3, c2 * c3,
      -s2, c1 * s2 * s3 - c3 * s1, c1 * c3 * s2 + s1 * s3, c1 * c2);
}
...
rot_mat_yzx(Angle y1, Angle z2, Angle x3) {
  ...
  return qvm_detail::rot_mat_<Dim, Angle>(
      c1 * c2, s1 * s3 - c1 * c3 * s2, c3 * s1 + c1 * s2 * s3, s2, c2 * c3,
      -c2 * s3, -c2 * s1, c1 * s3 + c3 * s1 * s2, c1 * c3 - s1 * s2 * s3);
}
...
rot_mat_zyx(Angle z1, Angle y2, Angle x3) {
  ...
  scalar_type const s3 = sin<scalar_type>(x3);
  return qvm_detail::rot_mat_<Dim, Angle>(
      c1 * c2, c1 * s2 * s3 - c3 * s1, s1 * s3 + c1 * c3 * s2, c2 * s1,
...
rot_mat_zxy(Angle z1, Angle x2, Angle y3) {
  ...
  return qvm_detail::rot_mat_<Dim, Angle>(
      ...
      c3 * s1 + c1 * s2 * s3, c1 * c2, s1 * s3 - c1 * c3 * s2, -c2 * s3, s2,
      c2 * c3);
}
...
rot_mat_xzx(Angle x1, Angle z2, Angle x3) {
  ...
  scalar_type const s3 = sin<scalar_type>(x3);
  return qvm_detail::rot_mat_<Dim, Angle>(
      c2, -c3 * s2, s2 * s3, c1 * s2, c1 * c2 * c3 - s1 * s3,
      -c3 * s1 - c1 * c2 * s3, s1 * s2, c1 * s3 + c2 * c3 * s1,
      c1 * c3 - c2 * s1 * s3);
}
...
rot_mat_xyx(Angle x1, Angle y2, Angle x3) {
  ...
  scalar_type const s3 = sin<scalar_type>(x3);
  return qvm_detail::rot_mat_<Dim, Angle>(
      c2, s2 * s3, c3 * s2, s1 * s2, c1 * c3 - c2 * s1 * s3,
      -c1 * s3 - c2 * c3 * s1, -c1 * s2, c3 * s1 + c1 * c2 * s3,
      c1 * c2 * c3 - s1 * s3);
}
...
rot_mat_yxy(Angle y1, Angle x2, Angle y3) {
  ...
  scalar_type const s3 = sin<scalar_type>(y3);
  return qvm_detail::rot_mat_<Dim, Angle>(
      c1 * c3 - c2 * s1 * s3, s1 * s2, c1 * s3 + c2 * c3 * s1, s2 * s3, c2,
      -c3 * s2, -c3 * s1 - c1 * c2 * s3, c1 * s2, c1 * c2 * c3 - s1 * s3);
}
...
rot_mat_yzy(Angle y1, Angle z2, Angle y3) {
  ...
  scalar_type const s3 = sin<scalar_type>(y3);
  return qvm_detail::rot_mat_<Dim, Angle>(
      c1 * c2 * c3 - s1 * s3, -c1 * s2, c3 * s1 + c1 * c2 * s3, c3 * s2, c2,
      s2 * s3, -c1 * s3 - c2 * c3 * s1, s1 * s2, c1 * c3 - c2 * s1 * s3);
}
...
rot_mat_zyz(Angle z1, Angle y2, Angle z3) {
  ...
  return qvm_detail::rot_mat_<Dim, Angle>(
      ...
      c1 * s3 + c2 * c3 * s1, c1 * c3 - c2 * s1 * s3, s1 * s2, -c3 * s2,
      s2 * s3, c2);
}
...
rot_mat_zxz(Angle z1, Angle x2, Angle z3) {
  ...
  return qvm_detail::rot_mat_<Dim, Angle>(
      ...
      c3 * s1 + c1 * c2 * s3, c1 * c2 * c3 - s1 * s3, -c1 * s2, s2 * s3,
      c3 * s2, c2);
}
...
namespace qvm_detail {
template <int Dim, class Angle> struct rotx_mat_ {
  BOOST_QVM_INLINE_TRIVIAL
  rotx_mat_() {}
...
template <int Row, int Col> struct rotx_m_get {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &) {
    return scalar_traits<T>::value(Row == Col);
  }
};

template <> struct rotx_m_get<1, 1> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return cos<T>(angle);
  }
};

template <> struct rotx_m_get<1, 2> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return -sin<T>(angle);
  }
};

template <> struct rotx_m_get<2, 1> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return sin<T>(angle);
  }
};

template <> struct rotx_m_get<2, 2> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return cos<T>(angle);
  }
};
...
struct mat_traits<qvm_detail::rotx_mat_<Dim, Angle>> {
  ...
  read_element(this_matrix const &x) {
    ...
    BOOST_QVM_STATIC_ASSERT(Row < Dim);
    BOOST_QVM_STATIC_ASSERT(Col < Dim);
    return qvm_detail::rotx_m_get<Row, Col>::get(
        reinterpret_cast<Angle const &>(x));
  }
...
template <int Dim, class Angle>
struct deduce_mat2<qvm_detail::rotx_mat_<Dim, Angle>,
                   qvm_detail::rotx_mat_<Dim, Angle>, Dim, Dim> {
  typedef mat<Angle, Dim, Dim> type;
};

template <int Dim, class Angle>
BOOST_QVM_INLINE_TRIVIAL qvm_detail::rotx_mat_<Dim, Angle> const &
...
template <class A, class Angle>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<is_mat<A>::value && mat_traits<A>::rows >= 3 &&
                             mat_traits<A>::rows == mat_traits<A>::cols,
                         void>::type
...
namespace qvm_detail {
template <int Dim, class Angle> struct roty_mat_ {
  BOOST_QVM_INLINE_TRIVIAL
  roty_mat_() {}
...
template <int Row, int Col> struct roty_m_get {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &) {
    return scalar_traits<T>::value(Row == Col);
  }
};

template <> struct roty_m_get<0, 0> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return cos<T>(angle);
  }
};

template <> struct roty_m_get<0, 2> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return sin<T>(angle);
  }
};

template <> struct roty_m_get<2, 0> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return -sin<T>(angle);
  }
};

template <> struct roty_m_get<2, 2> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return cos<T>(angle);
  }
};
...
struct mat_traits<qvm_detail::roty_mat_<Dim, Angle>> {
  ...
  read_element(this_matrix const &x) {
    ...
    BOOST_QVM_STATIC_ASSERT(Row < Dim);
    BOOST_QVM_STATIC_ASSERT(Col < Dim);
    return qvm_detail::roty_m_get<Row, Col>::get(
        reinterpret_cast<Angle const &>(x));
  }
...
template <int Dim, class Angle>
struct deduce_mat2<qvm_detail::roty_mat_<Dim, Angle>,
                   qvm_detail::roty_mat_<Dim, Angle>, Dim, Dim> {
  typedef mat<Angle, Dim, Dim> type;
};

template <int Dim, class Angle>
BOOST_QVM_INLINE_TRIVIAL qvm_detail::roty_mat_<Dim, Angle> const &
...
template <class A, class Angle>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<is_mat<A>::value && mat_traits<A>::rows >= 2 &&
                             mat_traits<A>::rows == mat_traits<A>::cols,
                         void>::type
...
namespace qvm_detail {
template <int Dim, class Angle> struct rotz_mat_ {
  BOOST_QVM_INLINE_TRIVIAL
  rotz_mat_() {}
...
template <int Row, int Col> struct rotz_m_get {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &) {
    return scalar_traits<T>::value(Row == Col);
  }
};

template <> struct rotz_m_get<0, 0> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return cos<T>(angle);
  }
};

template <> struct rotz_m_get<0, 1> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return -sin<T>(angle);
  }
};

template <> struct rotz_m_get<1, 0> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return sin<T>(angle);
  }
};

template <> struct rotz_m_get<1, 1> {
  template <class T> static BOOST_QVM_INLINE_CRITICAL T get(T const &angle) {
    return cos<T>(angle);
  }
};
...
struct mat_traits<qvm_detail::rotz_mat_<Dim, Angle>> {
  ...
  read_element(this_matrix const &x) {
    ...
    BOOST_QVM_STATIC_ASSERT(Row < Dim);
    BOOST_QVM_STATIC_ASSERT(Col < Dim);
    return qvm_detail::rotz_m_get<Row, Col>::get(
        reinterpret_cast<Angle const &>(x));
  }
...
struct deduce_mat2<qvm_detail::rotz_mat_<Dim, Angle>,
                   qvm_detail::rotz_mat_<Dim, Angle>, R, C> {
  typedef mat<Angle, R, C> type;
};

template <int Dim, class Angle>
BOOST_QVM_INLINE_TRIVIAL qvm_detail::rotz_mat_<Dim, Angle> const &
...
namespace qvm_detail {
template <int D> struct inverse_m_defined { static bool const value = false; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_TRIVIAL typename lazy_enable_if_c<
    is_mat<A>::value && is_scalar<B>::value &&
        mat_traits<A>::rows == mat_traits<A>::cols &&
...
inverse(A const &a, B det) {
  ...
  return reinterpret_cast<
             qvm_detail::transposed_<cofactor_return_type> const &>(c) *
         f;
}
