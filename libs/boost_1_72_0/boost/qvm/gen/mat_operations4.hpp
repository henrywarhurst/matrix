...
operator+(A const &a, B const &b) {
  ...
  mat_traits<R>::template write_element<0, 2>(r) =
      mat_traits<A>::template read_element<0, 2>(a) +
      mat_traits<B>::template read_element<0, 2>(b);
  mat_traits<R>::template write_element<0, 3>(r) =
  ...
  mat_traits<R>::template write_element<1, 2>(r) =
      mat_traits<A>::template read_element<1, 2>(a) +
      mat_traits<B>::template read_element<1, 2>(b);
  mat_traits<R>::template write_element<1, 3>(r) =
      mat_traits<A>::template read_element<1, 3>(a) +
      mat_traits<B>::template read_element<1, 3>(b);
  mat_traits<R>::template write_element<2, 0>(r) =
      mat_traits<A>::template read_element<2, 0>(a) +
      mat_traits<B>::template read_element<2, 0>(b);
  mat_traits<R>::template write_element<2, 1>(r) =
      mat_traits<A>::template read_element<2, 1>(a) +
      mat_traits<B>::template read_element<2, 1>(b);
  mat_traits<R>::template write_element<2, 2>(r) =
      mat_traits<A>::template read_element<2, 2>(a) +
      mat_traits<B>::template read_element<2, 2>(b);
  mat_traits<R>::template write_element<2, 3>(r) =
      mat_traits<A>::template read_element<2, 3>(a) +
      mat_traits<B>::template read_element<2, 3>(b);
  mat_traits<R>::template write_element<3, 0>(r) =
      mat_traits<A>::template read_element<3, 0>(a) +
      mat_traits<B>::template read_element<3, 0>(b);
  mat_traits<R>::template write_element<3, 1>(r) =
      mat_traits<A>::template read_element<3, 1>(a) +
      mat_traits<B>::template read_element<3, 1>(b);
  mat_traits<R>::template write_element<3, 2>(r) =
      mat_traits<A>::template read_element<3, 2>(a) +
      mat_traits<B>::template read_element<3, 2>(b);
  mat_traits<R>::template write_element<3, 3>(r) =
      mat_traits<A>::template read_element<3, 3>(a) +
...
template <> struct plus_mm_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct plus_mm_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct plus_mm_defined<1, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct minus_mm_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct minus_mm_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct minus_mm_defined<1, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct plus_eq_mm_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct plus_eq_mm_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct plus_eq_mm_defined<1, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct minus_eq_mm_defined<4, 4> {
...
template <> struct minus_eq_mm_defined<4, 1> {
  static bool const value = true;
};
} // namespace qvm_detail
...
template <> struct minus_eq_mm_defined<1, 4> {
  static bool const value = true;
};
} // namespace qvm_detail
...
operator*(A const &a, B b) {
  ...
  mat_traits<R>::template write_element<0, 2>(r) =
      mat_traits<A>::template read_element<0, 2>(a) * b;
  mat_traits<R>::template write_element<0, 3>(r) =
      mat_traits<A>::template read_element<0, 3>(a) * b;
  mat_traits<R>::template write_element<1, 0>(r) =
      mat_traits<A>::template read_element<1, 0>(a) * b;
  mat_traits<R>::template write_element<1, 1>(r) =
      mat_traits<A>::template read_element<1, 1>(a) * b;
  mat_traits<R>::template write_element<1, 2>(r) =
      mat_traits<A>::template read_element<1, 2>(a) * b;
  mat_traits<R>::template write_element<1, 3>(r) =
      mat_traits<A>::template read_element<1, 3>(a) * b;
  mat_traits<R>::template write_element<2, 0>(r) =
      mat_traits<A>::template read_element<2, 0>(a) * b;
  mat_traits<R>::template write_element<2, 1>(r) =
      mat_traits<A>::template read_element<2, 1>(a) * b;
  mat_traits<R>::template write_element<2, 2>(r) =
      mat_traits<A>::template read_element<2, 2>(a) * b;
  mat_traits<R>::template write_element<2, 3>(r) =
      mat_traits<A>::template read_element<2, 3>(a) * b;
  mat_traits<R>::template write_element<3, 0>(r) =
      mat_traits<A>::template read_element<3, 0>(a) * b;
  mat_traits<R>::template write_element<3, 1>(r) =
      mat_traits<A>::template read_element<3, 1>(a) * b;
  mat_traits<R>::template write_element<3, 2>(r) =
      mat_traits<A>::template read_element<3, 2>(a) * b;
  mat_traits<R>::template write_element<3, 3>(r) =
      mat_traits<A>::template read_element<3, 3>(a) * b;
  return r;
}
...
template <> struct mul_ms_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename lazy_enable_if_c<is_scalar<A>::value && mat_traits<B>::rows == 4 &&
                                  mat_traits<B>::cols == 4,
                              deduce_mat<B>>::type
    operator*(A a, B const &b) {
  ...
  mat_traits<R>::template write_element<0, 2>(r) =
      a * mat_traits<B>::template read_element<0, 2>(b);
  mat_traits<R>::template write_element<0, 3>(r) =
      a * mat_traits<B>::template read_element<0, 3>(b);
  mat_traits<R>::template write_element<1, 0>(r) =
      a * mat_traits<B>::template read_element<1, 0>(b);
  mat_traits<R>::template write_element<1, 1>(r) =
      a * mat_traits<B>::template read_element<1, 1>(b);
  mat_traits<R>::template write_element<1, 2>(r) =
      a * mat_traits<B>::template read_element<1, 2>(b);
  mat_traits<R>::template write_element<1, 3>(r) =
      a * mat_traits<B>::template read_element<1, 3>(b);
  mat_traits<R>::template write_element<2, 0>(r) =
      a * mat_traits<B>::template read_element<2, 0>(b);
  mat_traits<R>::template write_element<2, 1>(r) =
      a * mat_traits<B>::template read_element<2, 1>(b);
  mat_traits<R>::template write_element<2, 2>(r) =
      a * mat_traits<B>::template read_element<2, 2>(b);
  mat_traits<R>::template write_element<2, 3>(r) =
      a * mat_traits<B>::template read_element<2, 3>(b);
  mat_traits<R>::template write_element<3, 0>(r) =
      a * mat_traits<B>::template read_element<3, 0>(b);
  mat_traits<R>::template write_element<3, 1>(r) =
      a * mat_traits<B>::template read_element<3, 1>(b);
  mat_traits<R>::template write_element<3, 2>(r) =
      a * mat_traits<B>::template read_element<3, 2>(b);
  mat_traits<R>::template write_element<3, 3>(r) =
      a * mat_traits<B>::template read_element<3, 3>(b);
  return r;
}
...
template <> struct mul_sm_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_ms_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_sm_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_ms_defined<1, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_sm_defined<1, 4> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<mat_traits<A>::rows == 4 && mat_traits<A>::cols == 4 &&
                             is_scalar<B>::value,
                         A &>::type
    operator*=(A &a, B b) {
...
template <> struct mul_eq_ms_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<mat_traits<A>::rows == 4 && mat_traits<A>::cols == 1 &&
                             is_scalar<B>::value,
                         A &>::type
    operator*=(A &a, B b) {
  mat_traits<A>::template write_element<0, 0>(a) *= b;
...
template <> struct mul_eq_ms_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<mat_traits<A>::rows == 1 && mat_traits<A>::cols == 4 &&
                             is_scalar<B>::value,
                         A &>::type
    operator*=(A &a, B b) {
  mat_traits<A>::template write_element<0, 0>(a) *= b;
...
template <> struct mul_eq_ms_defined<1, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_ms_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_sm_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_ms_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_sm_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_ms_defined<1, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_eq_ms_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_eq_ms_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_eq_ms_defined<1, 4> { static bool const value = true; };
} // namespace qvm_detail

template <class R, class A>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<mat_traits<R>::rows == 4 && mat_traits<A>::rows == 4 &&
                             mat_traits<R>::cols == 4 &&
                             mat_traits<A>::cols == 4,
                         R>::type
...
template <class R, class A>
BOOST_QVM_INLINE typename enable_if_c<is_mat<R>::value && is_quat<A>::value &&
                                          mat_traits<R>::rows == 4 &&
                                          mat_traits<R>::cols == 4,
                                      R>::type
...
template <> struct convert_to_m_defined<4, 4> {
  static bool const value = true;
};
} // namespace qvm_detail
...
template <> struct convert_to_m_defined<4, 1> {
  static bool const value = true;
};
} // namespace qvm_detail
...
template <> struct convert_to_m_defined<1, 4> {
  static bool const value = true;
};
} // namespace qvm_detail
...
template <> struct eq_mm_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct eq_mm_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct eq_mm_defined<1, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct neq_mm_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct neq_mm_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct neq_mm_defined<1, 4> { static bool const value = true; };
} // namespace qvm_detail

template <class A>
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    mat_traits<A>::rows == 4 && mat_traits<A>::cols == 4, deduce_mat<A>>::type
operator-(A const &a) {
  typedef typename deduce_mat<A>::type R;
  R r;
  mat_traits<R>::template write_element<0, 0>(r) =
...
template <> struct minus_m_defined<4, 4> { static bool const value = true; };
} // namespace qvm_detail

template <class A>
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    mat_traits<A>::rows == 4 && mat_traits<A>::cols == 1, deduce_mat<A>>::type
operator-(A const &a) {
  typedef typename deduce_mat<A>::type R;
  R r;
  mat_traits<R>::template write_element<0, 0>(r) =
...
template <> struct minus_m_defined<4, 1> { static bool const value = true; };
} // namespace qvm_detail

template <class A>
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    mat_traits<A>::rows == 1 && mat_traits<A>::cols == 4, deduce_mat<A>>::type
operator-(A const &a) {
  typedef typename deduce_mat<A>::type R;
  R r;
  mat_traits<R>::template write_element<0, 0>(r) =
...
template <> struct minus_m_defined<1, 4> { static bool const value = true; };
} // namespace qvm_detail
...
BOOST_QVM_INLINE_OPERATIONS
  ...
  T det =
      (a00 * (a11 * (a22 * a33 - a23 * a32) - a12 * (a21 * a33 - a23 * a31) +
              a13 * (a21 * a32 - a22 * a31)) -
       a01 * (a10 * (a22 * a33 - a23 * a32) - a12 * (a20 * a33 - a23 * a30) +
              a13 * (a20 * a32 - a22 * a30)) +
       a02 * (a10 * (a21 * a33 - a23 * a31) - a11 * (a20 * a33 - a23 * a30) +
              a13 * (a20 * a31 - a21 * a30)) -
       a03 * (a10 * (a21 * a32 - a22 * a31) - a11 * (a20 * a32 - a22 * a30) +
              a12 * (a20 * a31 - a21 * a30)));
  return det;
}
...
template <> struct determinant_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
inverse(A const &a, B det) {
  ...
  R r;
  mat_traits<R>::template write_element<0, 0>(r) =
      f * (a11 * (a22 * a33 - a23 * a32) - a12 * (a21 * a33 - a23 * a31) +
           a13 * (a21 * a32 - a22 * a31));
  mat_traits<R>::template write_element<0, 1>(r) =
      -f * (a01 * (a22 * a33 - a23 * a32) - a02 * (a21 * a33 - a23 * a31) +
            a03 * (a21 * a32 - a22 * a31));
  mat_traits<R>::template write_element<0, 2>(r) =
      f * (a01 * (a12 * a33 - a13 * a32) - a02 * (a11 * a33 - a13 * a31) +
           a03 * (a11 * a32 - a12 * a31));
  mat_traits<R>::template write_element<0, 3>(r) =
      -f * (a01 * (a12 * a23 - a13 * a22) - a02 * (a11 * a23 - a13 * a21) +
            a03 * (a11 * a22 - a12 * a21));
  mat_traits<R>::template write_element<1, 0>(r) =
      -f * (a10 * (a22 * a33 - a23 * a32) - a12 * (a20 * a33 - a23 * a30) +
            a13 * (a20 * a32 - a22 * a30));
  mat_traits<R>::template write_element<1, 1>(r) =
      f * (a00 * (a22 * a33 - a23 * a32) - a02 * (a20 * a33 - a23 * a30) +
           a03 * (a20 * a32 - a22 * a30));
  mat_traits<R>::template write_element<1, 2>(r) =
      -f * (a00 * (a12 * a33 - a13 * a32) - a02 * (a10 * a33 - a13 * a30) +
            a03 * (a10 * a32 - a12 * a30));
  mat_traits<R>::template write_element<1, 3>(r) =
      f * (a00 * (a12 * a23 - a13 * a22) - a02 * (a10 * a23 - a13 * a20) +
           a03 * (a10 * a22 - a12 * a20));
  mat_traits<R>::template write_element<2, 0>(r) =
      f * (a10 * (a21 * a33 - a23 * a31) - a11 * (a20 * a33 - a23 * a30) +
           a13 * (a20 * a31 - a21 * a30));
  mat_traits<R>::template write_element<2, 1>(r) =
      -f * (a00 * (a21 * a33 - a23 * a31) - a01 * (a20 * a33 - a23 * a30) +
            a03 * (a20 * a31 - a21 * a30));
  mat_traits<R>::template write_element<2, 2>(r) =
      f * (a00 * (a11 * a33 - a13 * a31) - a01 * (a10 * a33 - a13 * a30) +
           a03 * (a10 * a31 - a11 * a30));
  mat_traits<R>::template write_element<2, 3>(r) =
      -f * (a00 * (a11 * a23 - a13 * a21) - a01 * (a10 * a23 - a13 * a20) +
            a03 * (a10 * a21 - a11 * a20));
  mat_traits<R>::template write_element<3, 0>(r) =
      -f * (a10 * (a21 * a32 - a22 * a31) - a11 * (a20 * a32 - a22 * a30) +
            a12 * (a20 * a31 - a21 * a30));
  mat_traits<R>::template write_element<3, 1>(r) =
      f * (a00 * (a21 * a32 - a22 * a31) - a01 * (a20 * a32 - a22 * a30) +
           a02 * (a20 * a31 - a21 * a30));
  mat_traits<R>::template write_element<3, 2>(r) =
      -f * (a00 * (a11 * a32 - a12 * a31) - a01 * (a10 * a32 - a12 * a30) +
            a02 * (a10 * a31 - a11 * a30));
  mat_traits<R>::template write_element<3, 3>(r) =
      f * (a00 * (a11 * a22 - a12 * a21) - a01 * (a10 * a22 - a12 * a20) +
           a02 * (a10 * a21 - a11 * a20));
  return r;
}
...
template <> struct inverse_m_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_mm_defined<4, 4, 4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_eq_mm_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_mm_defined<4, 4, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_mm_defined<1, 4, 4> { static bool const value = true; };
} // namespace qvm_detail
