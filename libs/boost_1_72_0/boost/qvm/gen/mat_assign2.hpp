...
template <> struct assign_mm_defined<2, 2> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct assign_mm_defined<2, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct assign_mm_defined<1, 2> { static bool const value = true; };
} // namespace qvm_detail
