...
template <> struct assign_mm_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct assign_mm_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct assign_mm_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail
