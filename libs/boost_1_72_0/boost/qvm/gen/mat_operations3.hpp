...
template <> struct plus_mm_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct plus_mm_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct plus_mm_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct minus_mm_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct minus_mm_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct minus_mm_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<mat_traits<A>::rows == 3 && mat_traits<B>::rows == 3 &&
                             mat_traits<A>::cols == 3 &&
                             mat_traits<B>::cols == 3,
                         A &>::type
...
template <> struct plus_eq_mm_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct plus_eq_mm_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct plus_eq_mm_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct minus_eq_mm_defined<3, 3> {
...
template <> struct minus_eq_mm_defined<3, 1> {
  static bool const value = true;
};
} // namespace qvm_detail
...
template <> struct minus_eq_mm_defined<1, 3> {
  static bool const value = true;
};
} // namespace qvm_detail
...
template <> struct mul_ms_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename lazy_enable_if_c<is_scalar<A>::value && mat_traits<B>::rows == 3 &&
                                  mat_traits<B>::cols == 3,
                              deduce_mat<B>>::type
    operator*(A a, B const &b) {
...
template <> struct mul_sm_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_ms_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_sm_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_ms_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_sm_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<mat_traits<A>::rows == 3 && mat_traits<A>::cols == 3 &&
                             is_scalar<B>::value,
                         A &>::type
    operator*=(A &a, B b) {
...
template <> struct mul_eq_ms_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<mat_traits<A>::rows == 3 && mat_traits<A>::cols == 1 &&
                             is_scalar<B>::value,
                         A &>::type
    operator*=(A &a, B b) {
  mat_traits<A>::template write_element<0, 0>(a) *= b;
...
template <> struct mul_eq_ms_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<mat_traits<A>::rows == 1 && mat_traits<A>::cols == 3 &&
                             is_scalar<B>::value,
                         A &>::type
    operator*=(A &a, B b) {
  mat_traits<A>::template write_element<0, 0>(a) *= b;
...
template <> struct mul_eq_ms_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_ms_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_sm_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_ms_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_sm_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_ms_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_eq_ms_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_eq_ms_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_eq_ms_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail

template <class R, class A>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<mat_traits<R>::rows == 3 && mat_traits<A>::rows == 3 &&
                             mat_traits<R>::cols == 3 &&
                             mat_traits<A>::cols == 3,
                         R>::type
...
template <> struct convert_to_m_defined<3, 3> {
  static bool const value = true;
};
} // namespace qvm_detail
...
template <> struct convert_to_m_defined<3, 1> {
  static bool const value = true;
};
} // namespace qvm_detail
...
template <> struct convert_to_m_defined<1, 3> {
  static bool const value = true;
};
} // namespace qvm_detail
...
template <> struct eq_mm_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct eq_mm_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct eq_mm_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct neq_mm_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct neq_mm_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct neq_mm_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail

template <class A>
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    mat_traits<A>::rows == 3 && mat_traits<A>::cols == 3, deduce_mat<A>>::type
operator-(A const &a) {
  typedef typename deduce_mat<A>::type R;
  R r;
  mat_traits<R>::template write_element<0, 0>(r) =
...
template <> struct minus_m_defined<3, 3> { static bool const value = true; };
} // namespace qvm_detail

template <class A>
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    mat_traits<A>::rows == 3 && mat_traits<A>::cols == 1, deduce_mat<A>>::type
operator-(A const &a) {
  typedef typename deduce_mat<A>::type R;
  R r;
  mat_traits<R>::template write_element<0, 0>(r) =
...
template <> struct minus_m_defined<3, 1> { static bool const value = true; };
} // namespace qvm_detail

template <class A>
BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
    mat_traits<A>::rows == 1 && mat_traits<A>::cols == 3, deduce_mat<A>>::type
operator-(A const &a) {
  typedef typename deduce_mat<A>::type R;
  R r;
  mat_traits<R>::template write_element<0, 0>(r) =
...
template <> struct minus_m_defined<1, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct determinant_defined<3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct inverse_m_defined<3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_mm_defined<3, 3, 3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_eq_mm_defined<3> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_mm_defined<3, 3, 1> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mul_mm_defined<1, 3, 3> { static bool const value = true; };
} // namespace qvm_detail
