...
BOOST_QVM_INLINE_OPERATIONS
    typename lazy_enable_if_c<vec_traits<A>::dim == 4 &&
                                  vec_traits<B>::dim == 4,
  ...
  vec_traits<R>::template write_element<3>(r) =
      vec_traits<A>::template read_element<3>(a) +
      vec_traits<B>::template read_element<3>(b);
  return r;
}
...
template <> struct plus_vv_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct minus_vv_defined<4> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<vec_traits<A>::dim == 4 && vec_traits<B>::dim == 4,
                         A &>::type
  ...
  vec_traits<A>::template write_element<2>(a) +=
      vec_traits<B>::template read_element<2>(b);
  vec_traits<A>::template write_element<3>(a) +=
      vec_traits<B>::template read_element<3>(b);
  return a;
}
...
template <> struct plus_eq_vv_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct minus_eq_vv_defined<4> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename lazy_enable_if_c<vec_traits<A>::dim == 4 && is_scalar<B>::value,
                              deduce_vec<A>>::type
  ...
  vec_traits<R>::template write_element<3>(r) =
      vec_traits<A>::template read_element<3>(a) * b;
  return r;
}
...
template <> struct mul_vs_defined<4> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename lazy_enable_if_c<is_scalar<A>::value && vec_traits<B>::dim == 4,
                              deduce_vec<B>>::type
    operator*(A a, B const &b) {
  ...
  vec_traits<R>::template write_element<3>(r) =
      a * vec_traits<B>::template read_element<3>(b);
  return r;
}
...
template <> struct mul_sv_defined<4> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<vec_traits<A>::dim == 4 && is_scalar<B>::value,
                         A &>::type
    operator*=(A &a, B b) {
...
template <> struct mul_eq_vs_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_vs_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct div_eq_vs_defined<4> { static bool const value = true; };
} // namespace qvm_detail

template <class R, class A>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<is_vec<A>::value && vec_traits<R>::dim == 4 &&
                             vec_traits<A>::dim == 4,
                         R>::type
...
template <> struct convert_to_v_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct eq_vv_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct neq_vv_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct minus_v_defined<4> { static bool const value = true; };
} // namespace qvm_detail

template <class A>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<is_vec<A>::value && vec_traits<A>::dim == 4,
...
template <> struct mag_v_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct mag_sqr_v_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <class A>
BOOST_QVM_INLINE_OPERATIONS
    typename enable_if_c<vec_traits<A>::dim == 4, void>::type
    normalize(A &a) {
  typedef typename vec_traits<A>::scalar_type T;
  T const a0 = vec_traits<A>::template read_element<0>(a);
  T const a1 = vec_traits<A>::template read_element<1>(a);
...
template <> struct normalize_v_defined<4> { static bool const value = true; };
} // namespace qvm_detail
...
template <> struct dot_vv_defined<4> { static bool const value = true; };
} // namespace qvm_detail
