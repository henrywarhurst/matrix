...
BOOST_QVM_INLINE_OPERATIONS
    typename lazy_enable_if_c<mat_traits<A>::rows == 2 &&
                                  mat_traits<A>::cols == 2 &&
                                  vec_traits<B>::dim == 2,
...
template <> struct mul_mv_defined<2, 2> { static bool const value = true; };
} // namespace qvm_detail

template <class A, class B>
BOOST_QVM_INLINE_OPERATIONS
    typename lazy_enable_if_c<mat_traits<B>::rows == 2 &&
                                  mat_traits<B>::cols == 2 &&
                                  vec_traits<A>::dim == 2,
                              deduce_vec2<A, B, 2>>::type
    operator*(A const &a, B const &b) {
...
template <> struct mul_vm_defined<2, 2> { static bool const value = true; };
} // namespace qvm_detail
