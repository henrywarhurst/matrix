...
struct make_pair {
  ...
  std::pair<First, Second> operator()(First const &first,
...
struct first {
  ...
  template <typename This, typename Pair> struct result<This(Pair)> {
  ...
  template <typename This, typename Pair> struct result<This(Pair const &)> {
