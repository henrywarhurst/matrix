...
struct enable_binary<Domain, proto::_, Trait, Tag, Left &, Right &>
    : boost::lazy_enable_if_c<
          Trait::value, result_of::make_expr<Tag, Domain, Left &, Right &>> {};
...
#define BOOST_PROTO_DEFINE_UNARY_OPERATOR(OP, TAG, TRAIT, DOMAIN, POST)        \
  ...
  BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                             \
      typename boost::proto::detail::enable_unary<                             \
          DOMAIN, DOMAIN::proto_grammar, BOOST_PROTO_APPLY_UNARY_(TRAIT, Arg), \
          TAG, Arg &>::type const                                              \
...
#define BOOST_PROTO_DEFINE_OPERATORS(TRAIT, DOMAIN)                            \
  ...
  BOOST_PROTO_DEFINE_UNARY_OPERATOR(-, boost::proto::tag::negate, TRAIT,       \
                                    DOMAIN, 0)                                 \
  BOOST_PROTO_DEFINE_UNARY_OPERATOR(*, boost::proto::tag::dereference, TRAIT,  \
                                    DOMAIN, 0)                                 \
  ...
  BOOST_PROTO_DEFINE_UNARY_OPERATOR(&, boost::proto::tag::address_of, TRAIT,   \
                                    DOMAIN, 0)                                 \
  BOOST_PROTO_DEFINE_UNARY_OPERATOR(!, boost::proto::tag::logical_not, TRAIT,  \
                                    DOMAIN, 0)                                 \
  ...
  BOOST_PROTO_DEFINE_UNARY_OPERATOR(--, boost::proto::tag::post_dec, TRAIT,    \
                                    DOMAIN, 1)                                 \
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(<<, boost::proto::tag::shift_left, TRAIT, \
                                     DOMAIN)                                   \
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(>>, boost::proto::tag::shift_right,       \
                                     TRAIT, DOMAIN)                            \
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(*, boost::proto::tag::multiplies, TRAIT,  \
                                     DOMAIN)                                   \
  ...
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(>, boost::proto::tag::greater, TRAIT,     \
                                     DOMAIN)                                   \
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(<=, boost::proto::tag::less_equal, TRAIT, \
                                     DOMAIN)                                   \
  ...
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(!=, boost::proto::tag::not_equal_to,      \
                                     TRAIT, DOMAIN)                            \
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(||, boost::proto::tag::logical_or, TRAIT, \
                                     DOMAIN)                                   \
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(&&, boost::proto::tag::logical_and,       \
                                     TRAIT, DOMAIN)                            \
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(&, boost::proto::tag::bitwise_and, TRAIT, \
                                     DOMAIN)                                   \
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(|, boost::proto::tag::bitwise_or, TRAIT,  \
                                     DOMAIN)                                   \
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(^, boost::proto::tag::bitwise_xor, TRAIT, \
                                     DOMAIN)                                   \
  ...
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(*=, boost::proto::tag::multiplies_assign, \
                                     TRAIT, DOMAIN)                            \
  ...
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(|=, boost::proto::tag::bitwise_or_assign, \
                                     TRAIT, DOMAIN)                            \
  BOOST_PROTO_DEFINE_BINARY_OPERATOR(                                          \
...
template <typename T> struct is_extension<T &> : is_expr<T> {};
