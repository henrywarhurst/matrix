...
#pragma wave option(preserve : 2, line : 0, output                             \
                    : "preprocessed/expr_variadic.hpp")
#endif
...
struct expr<Tag, BOOST_PP_CAT(list, BOOST_PP_ITERATION()) <
...
#endif
{
  ...
  typedef BOOST_PP_CAT(
      list,
      BOOST_PP_ITERATION())<BOOST_PP_ENUM_PARAMS(ARG_COUNT, Arg)> proto_args;
#endif
  ...
  make(BOOST_PP_ENUM_BINARY_PARAMS(ARG_COUNT, A, const &a)) {
  ...
  ///
  /// \param a The rhs.
  /// \return A new \c expr\<\> node representing an assignment of \c that to \c
  /// *this.
  BOOST_FORCEINLINE
  ...
  ///
  /// \param a The rhs.
  /// \return A new \c expr\<\> node representing an assignment of \c a to \c
  /// *this.
  template <typename A>
  BOOST_FORCEINLINE
  ...
  ///
  /// \param a The rhs.
  /// \return A new \c expr\<\> node representing \c *this subscripted with \c
  /// a.
  template <typename A>
  BOOST_FORCEINLINE
  ...
  /// Encodes the return type of \c expr\<\>::operator(), for use with \c
  /// boost::result_of\<\>
  ///
  ...
  /// Function call
  ///
  /// \return A new \c expr\<\> node representing the function invocation of \c
  /// (*this)().
  BOOST_FORCEINLINE
