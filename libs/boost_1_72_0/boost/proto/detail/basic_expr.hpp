...
#define BOOST_PP_ITERATION_PARAMS_1                                            \
  (3, (0, 0, <boost / proto / detail / basic_expr.hpp>))
#include BOOST_PP_ITERATE()

#undef BOOST_PROTO_DEFINE_TERMINAL
#define BOOST_PP_ITERATION_PARAMS_1                                            \
  (3, (1, BOOST_PROTO_MAX_ARITY, <boost / proto / detail / basic_expr.hpp>))
#include BOOST_PP_ITERATE()
...
struct basic_expr<Tag, BOOST_PP_CAT(list, BOOST_PP_ITERATION()) <
