...
template <typename Tag, typename Arg0> struct basic_expr<Tag, term<Arg0>, 0> {
...
template <typename Tag, typename Arg0> struct basic_expr<Tag, list1<Arg0>, 1> {
  typedef Tag proto_tag;
...
template <typename Tag, typename Arg0, typename Arg1, typename Arg2,
          typename Arg3, typename Arg4, typename Arg5, typename Arg6,
          typename Arg7>
struct basic_expr<Tag, list8<Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7>,
                  8> {
  typedef Tag proto_tag;
