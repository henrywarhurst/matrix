...
namespace detail {
/// INTERNAL ONLY
template <typename Expr> struct expr_traits {
...
/// INTERNAL ONLY
template <typename Expr> struct expr_traits<Expr &> {
  typedef Expr value_type;
  typedef Expr &reference;
...
/// INTERNAL ONLY
template <typename Expr> struct expr_traits<Expr const &> {
  typedef Expr value_type;
...
/// INTERNAL ONLY
template <typename T> struct term_traits {
...
/// INTERNAL ONLY
template <typename T> struct term_traits<T &> {
...
/// INTERNAL ONLY
template <typename T> struct term_traits<T const &> {
  typedef T value_type;
...
/// INTERNAL ONLY
template <typename T, std::size_t N> struct term_traits<T (&)[N]> {
...
/// INTERNAL ONLY
template <typename T, std::size_t N> struct term_traits<T const (&)[N]> {
  typedef T value_type[N];
