...
#define BOOST_PROTO_DEFINE_FUN_OP_IMPL_(Z, N, DATA, Const)                     \
  ...
  (Z, N) BOOST_PROTO_DISABLE_MSVC_C4180 BOOST_PROTO_DISABLE_MSVC_C4714         \
    ...
    typedef boost::proto::result_of::BOOST_PP_CAT(                             \
        funop, N)<proto_derived_expr Const(),                                  \
                  proto_domain BOOST_PP_ENUM_TRAILING_PARAMS_Z(Z, N, const A)> \
        funop;                                                                 \
...
#define BOOST_PROTO_DEFINE_FUN_OP_VARIADIC_IMPL_(Const)                        \
  template <typename... A>                                                     \
  BOOST_PROTO_DISABLE_MSVC_C4180 BOOST_PROTO_DISABLE_MSVC_C4714                \
      BOOST_FORCEINLINE typename BOOST_PROTO_RESULT_OF<proto_generator(        \
          typename boost::proto::result_of::funop<                             \
              proto_derived_expr Const()(A const &...), proto_derived_expr,    \
              proto_domain>::type)>::type const                                \
      operator()(A const &... a) Const() {                                     \
    typedef boost::proto::result_of::funop<proto_derived_expr Const()(         \
                                               A const &...),                  \
                                           proto_derived_expr, proto_domain>   \
        funop;                                                                 \
    return proto_generator()(                                                  \
        funop::call(*static_cast<proto_derived_expr Const() *>(this), a...));  \
  }                                                                            \
  /**/
