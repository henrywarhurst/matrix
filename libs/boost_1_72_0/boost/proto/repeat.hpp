...
/// \brief Generates a sequence like <tt>boost::ref(a0), boost::ref(a1),
/// ...</tt>
///
...
#define BOOST_PROTO_invoke(Z, N, DATA)                                         \
  ...
  (N, BOOST_PP_TUPLE_ELEM(5, 1, DATA), BOOST_PP_TUPLE_ELEM(5, 2, DATA),        \
   BOOST_PP_TUPLE_ELEM(5, 3, DATA), BOOST_PP_TUPLE_ELEM(5, 4, DATA))

/// \brief Repeatedly invoke the specified macro.
///
/// BOOST_PROTO_REPEAT_FROM_TO_EX() is used generate the kind of repetitive code
/// that is typical of EDSLs built with Proto.
/// BOOST_PROTO_REPEAT_FROM_TO_EX(FROM, TO, MACRO, typename_A, A, A_a, a)  is
/// equivalent to:
///
/// \code
...
#define BOOST_PROTO_REPEAT_FROM_TO_EX(FROM, TO, MACRO, typename_A, A, A_a, a)  \
  BOOST_PP_REPEAT_FROM_TO(FROM, TO, BOOST_PROTO_invoke,                        \
                          (MACRO, typename_A, A, A_a, a))

/// \brief Repeatedly invoke the specified macro.
///
/// BOOST_PROTO_REPEAT_FROM_TO() is used generate the kind of repetitive code
/// that is typical of EDSLs built with Proto. BOOST_PROTO_REPEAT_FROM_TO(FROM,
/// TO, MACRO)  is equivalent to:
///
/// \code
/// MACRO(FROM, BOOST_PROTO_typename_A, BOOST_PROTO_A_const_ref,
/// BOOST_PROTO_A_const_ref_a, BOOST_PROTO_ref_a) MACRO(FROM+1,
/// BOOST_PROTO_typename_A, BOOST_PROTO_A_const_ref, BOOST_PROTO_A_const_ref_a,
/// BOOST_PROTO_ref_a)
/// ...
/// MACRO(TO-1, BOOST_PROTO_typename_A, BOOST_PROTO_A_const_ref,
/// BOOST_PROTO_A_const_ref_a, BOOST_PROTO_ref_a) \endcode
///
/// Example:
///
/** \code
...
#define BOOST_PROTO_REPEAT_FROM_TO(FROM, TO, MACRO)                            \
  BOOST_PROTO_REPEAT_FROM_TO_EX(FROM, TO, MACRO, BOOST_PROTO_typename_A,       \
                                BOOST_PROTO_A_const_ref,                       \
                                BOOST_PROTO_A_const_ref_a, BOOST_PROTO_ref_a)

/// \brief Repeatedly invoke the specified macro.
///
/// BOOST_PROTO_REPEAT_EX() is used generate the kind of repetitive code that is
/// typical of EDSLs built with Proto. BOOST_PROTO_REPEAT_EX(MACRO, typename_A,
/// A, A_a, a)  is equivalent to:
///
/// \code
...
#define BOOST_PROTO_REPEAT_EX(MACRO, typename_A, A, A_a, a)                    \
  BOOST_PROTO_REPEAT_FROM_TO_EX(                                               \
      1, BOOST_PP_INC(BOOST_PROTO_MAX_ARITY), MACRO, BOOST_PROTO_typename_A,   \
      BOOST_PROTO_A_const_ref, BOOST_PROTO_A_const_ref_a, BOOST_PROTO_ref_a)

/// \brief Repeatedly invoke the specified macro.
///
/// BOOST_PROTO_REPEAT() is used generate the kind of repetitive code that is
/// typical of EDSLs built with Proto. BOOST_PROTO_REPEAT(MACRO)  is equivalent
/// to:
///
/// \code
/// MACRO(1, BOOST_PROTO_typename_A, BOOST_PROTO_A_const_ref,
/// BOOST_PROTO_A_const_ref_a, BOOST_PROTO_ref_a) MACRO(2,
/// BOOST_PROTO_typename_A, BOOST_PROTO_A_const_ref, BOOST_PROTO_A_const_ref_a,
/// BOOST_PROTO_ref_a)
/// ...
/// MACRO(BOOST_PROTO_MAX_ARITY, BOOST_PROTO_typename_A,
/// BOOST_PROTO_A_const_ref, BOOST_PROTO_A_const_ref_a, BOOST_PROTO_ref_a)
/// \endcode
...
/// \brief Repeatedly invoke the specified macro.
///
/// BOOST_PROTO_LOCAL_ITERATE() is used generate the kind of repetitive code
/// that is typical of EDSLs built with Proto. This macro causes the
/// user-defined macro BOOST_PROTO_LOCAL_MACRO to be expanded with values in the
/// range specified by BOOST_PROTO_LOCAL_LIMITS.
///
/// Usage:
///
/// \code
