...
template <class T> inline void check_object_level() {
...
template <class T> inline void check_object_versioning() {
...
template <class T> inline void check_object_tracking() {
  // presume it has already been determined that
  // T is not a const
  BOOST_STATIC_ASSERT(!boost::is_const<T>::value);
  typedef
      typename mpl::equal_to<serialization::tracking_level<T>,
                             mpl::int_<serialization::track_never>>::type typex;
...
template <class T> inline void check_pointer_level() {
...
template <class T> void inline check_pointer_tracking() {
  typedef
      typename mpl::greater<serialization::tracking_level<T>,
                            mpl::int_<serialization::track_never>>::type typex;
...
template <class T> inline void check_const_loading() {
  typedef
