...
template <class Archive, class T> class iserializer : public basic_iserializer {
private:
...
template <class Archive> struct load_non_pointer_type {
  ...
  struct load_standard {
    template <class T> static void invoke(Archive &ar, const T &t) {
      ...
      ar.load_object(x, boost::serialization::singleton<
                            iserializer<Archive, T>>::get_const_instance());
    }
  };
...
template <class Archive> struct load_pointer_type {
  struct abstract {
    template <class T>
  ...
  static const basic_pointer_iserializer *register_type(Archive &ar,
    ...
    typedef
        typename mpl::eval_if<boost::serialization::is_abstract<const T>,
                              ...
                              boost::mpl::identity<non_abstract>>::type typex;
  ...
  template <class T> static void check_load(T *const /* t */) {
  ...
  template <class Tptr> static void invoke(Archive &ar, Tptr &t) {
    check_load(t);
...
template <class Archive> struct load_enum_type {
  template <class T> static void invoke(Archive &ar, T &t) {
...
template <class Archive> struct load_array_type {
  template <class T> static void invoke(Archive &ar, T &t) {
    ...
    ar >> serialization::make_array<value_type,
...
template <class Archive, class T> inline void load(Archive &ar, T &t) {
