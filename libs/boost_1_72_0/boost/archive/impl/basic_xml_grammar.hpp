...
template <class CharType> class BOOST_SYMBOL_VISIBLE basic_xml_grammar {
public:
...
private:
  ...
  rule_t Reference, Eq, STag, ETag, LetterOrUnderscoreOrColon, AttValue,
      ...
      CharData, CharDataChars, content, AmpName, LTName, GTName, ClassNameChar,
      ClassName, Name, XMLDecl, XMLDeclChars, DocTypeDecl, DocTypeDeclChars,
