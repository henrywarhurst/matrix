...
inline void lsp_pointer_construct(boost::local_shared_ptr<E> * /*ppx*/, Y *p,
...
inline void lsp_pointer_construct(boost::local_shared_ptr<E[N]> * /*ppx*/, Y *p,
                                  boost::detail::local_counted_base *&pn) {
...
inline void lsp_deleter_construct(boost::local_shared_ptr<E> * /*ppx*/, P p,
                                  D const &d,
                                  boost::detail::local_counted_base *&pn) {
...
inline void lsp_allocator_construct(boost::local_shared_ptr<E> * /*ppx*/, P p,
                                    D const &d, A const &a,
                                    boost::detail::local_counted_base *&pn) {
  typedef boost::detail::local_sp_deleter<D> D2;
...
public:
  ...
  BOOST_CONSTEXPR
  local_shared_ptr(boost::detail::sp_nullptr_t) BOOST_SP_NOEXCEPT : px(0),
                                                                    pn(0) {}
  ...
  BOOST_CONSTEXPR
  local_shared_ptr(boost::detail::lsp_internal_constructor_tag,
                   element_type *px_,
                   boost::detail::local_counted_base *pn_) BOOST_SP_NOEXCEPT
      : px(px_),
        pn(pn_) {}
  ...
  template <class D>
  local_shared_ptr(boost::detail::sp_nullptr_t p, D d) : px(p), pn(0) {
    boost::detail::lsp_deleter_construct(this, p, d, pn);
  }
  ...
  local_shared_ptr(Y *p, D d, A a) : px(p), pn(0) {
  ...
  local_shared_ptr(boost::detail::sp_nullptr_t p, D d, A a) : px(p), pn(0) {
    boost::detail::lsp_allocator_construct(this, p, d, a, pn);
  }
  ...
  local_shared_ptr(
    ...
    if (px) {
      pn = new boost::detail::local_counted_impl(
          shared_ptr<T>(std::move(r))._internal_count());
    }
  }
  ...
  local_shared_ptr(local_shared_ptr const &r) BOOST_SP_NOEXCEPT : px(r.px),
                                                                  pn(r.pn) {
    if (pn) {
      pn->add_ref();
    }
  ...
  local_shared_ptr(local_shared_ptr &&r) BOOST_SP_NOEXCEPT : px(r.px),
                                                             pn(r.pn) {
    r.px = 0;
    r.pn = 0;
  }
  ...
  local_shared_ptr(
      ...
      typename boost::detail::sp_enable_if_convertible<Y, T>::type =
          boost::detail::sp_empty()) BOOST_SP_NOEXCEPT : px(r.px),
                                                         pn(r.pn) {
    boost::detail::sp_assert_convertible<Y, T>();
  ...
  local_shared_ptr(local_shared_ptr<Y> const &r,
                   element_type *p) BOOST_SP_NOEXCEPT : px(p),
                                                        pn(r.pn) {
    if (pn) {
      pn->add_ref();
    }
  ...
  template <class Y>
  local_shared_ptr(local_shared_ptr<Y> &&r, element_type *p) BOOST_SP_NOEXCEPT
      : px(p),
        pn(r.pn) {
    r.px = 0;
    r.pn = 0;
  ...
  template <class Y>
  local_shared_ptr &operator=(local_shared_ptr<Y> const &r) BOOST_SP_NOEXCEPT {
    local_shared_ptr(r).swap(*this);
    return *this;
  }
  ...
  void reset() BOOST_SP_NOEXCEPT { local_shared_ptr().swap(*this); }
  ...
  template <class Y>
  void reset(local_shared_ptr<Y> const &r, element_type *p) BOOST_SP_NOEXCEPT {
  ...
  template <class Y>
  void reset(local_shared_ptr<Y> &&r, element_type *p) BOOST_SP_NOEXCEPT {
  ...
  operator*() const BOOST_SP_NOEXCEPT {
    return *px;
  }
...
#include <boost/smart_ptr/detail/operator_bool.hpp>
  ...
  template <class Y, class E = typename boost::detail::sp_enable_if_convertible<
                         T, Y>::type>
  operator shared_ptr<Y>() const BOOST_SP_NOEXCEPT
#else
  template <class Y>
  operator shared_ptr<Y>() const BOOST_SP_NOEXCEPT
#endif
  {
    ...
    if (pn) {
      return shared_ptr<Y>(boost::detail::sp_internal_constructor_tag(), px,
                           pn->local_cb_get_shared_count());
    } else {
      return shared_ptr<Y>();
    }
  }
  ...
  template <class Y, class E = typename boost::detail::sp_enable_if_convertible<
                         T, Y>::type>
  operator weak_ptr<Y>() const BOOST_SP_NOEXCEPT
#else
  template <class Y>
  operator weak_ptr<Y>() const BOOST_SP_NOEXCEPT
#endif
  ...
  template <class Y>
  bool owner_before(local_shared_ptr<Y> const &r) const BOOST_SP_NOEXCEPT {
    return std::less<boost::detail::local_counted_base *>()(pn, r.pn);
  }
};

template <class T, class U>
inline bool operator==(local_shared_ptr<T> const &a,
                       local_shared_ptr<U> const &b) BOOST_SP_NOEXCEPT {
  return a.get() == b.get();
}
...
template <class T>
inline bool operator==(local_shared_ptr<T> const &p,
...
inline bool operator==(boost::detail::sp_nullptr_t,
                       local_shared_ptr<T> const &p) BOOST_SP_NOEXCEPT {
  return p.get() == 0;
}
...
template <class T>
inline void swap(local_shared_ptr<T> &a,
                 local_shared_ptr<T> &b) BOOST_SP_NOEXCEPT {
  a.swap(b);
}

template <class T, class U>
local_shared_ptr<T>
static_pointer_cast(local_shared_ptr<U> const &r) BOOST_SP_NOEXCEPT {
...
template <class T, class U>
local_shared_ptr<T>
const_pointer_cast(local_shared_ptr<U> const &r) BOOST_SP_NOEXCEPT {
...
template <class T, class U>
local_shared_ptr<T>
dynamic_pointer_cast(local_shared_ptr<U> const &r) BOOST_SP_NOEXCEPT {
...
template <class T, class U>
local_shared_ptr<T>
reinterpret_pointer_cast(local_shared_ptr<U> const &r) BOOST_SP_NOEXCEPT {
...
template <class T, class U>
local_shared_ptr<T>
static_pointer_cast(local_shared_ptr<U> &&r) BOOST_SP_NOEXCEPT {
  (void)static_cast<T *>(static_cast<U *>(0));
...
template <class T, class U>
local_shared_ptr<T>
const_pointer_cast(local_shared_ptr<U> &&r) BOOST_SP_NOEXCEPT {
  (void)const_cast<T *>(static_cast<U *>(0));
...
template <class T, class U>
local_shared_ptr<T>
dynamic_pointer_cast(local_shared_ptr<U> &&r) BOOST_SP_NOEXCEPT {
  (void)dynamic_cast<T *>(static_cast<U *>(0));
...
template <class T, class U>
local_shared_ptr<T>
reinterpret_pointer_cast(local_shared_ptr<U> &&r) BOOST_SP_NOEXCEPT {
  (void)reinterpret_cast<T *>(static_cast<U *>(0));
...
get_pointer(local_shared_ptr<T> const &p) BOOST_SP_NOEXCEPT {
  return p.get();
}
...
D *get_deleter(local_shared_ptr<T> const &p) BOOST_SP_NOEXCEPT {
...
template <class T>
std::size_t hash_value(local_shared_ptr<T> const &p) BOOST_SP_NOEXCEPT {
