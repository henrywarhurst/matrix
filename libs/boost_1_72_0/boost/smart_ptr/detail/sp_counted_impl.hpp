...
public:
  ...
  virtual void dispose() BOOST_SP_NOEXCEPT { del(ptr); }
...
public:
  ...
  virtual void dispose() BOOST_SP_NOEXCEPT { d_(p_); }

  virtual void destroy() BOOST_SP_NOEXCEPT {
#if !defined(BOOST_NO_CXX11_ALLOCATOR)

    typedef typename std::allocator_traits<A>::template rebind_alloc<this_type>
        A2;
