...
atomic_decrement(std::atomic_int_least32_t *pw) BOOST_SP_NOEXCEPT {
  return pw->fetch_sub(1, std::memory_order_acq_rel);
}

inline std::int_least32_t
atomic_conditional_increment(std::atomic_int_least32_t *pw) BOOST_SP_NOEXCEPT {
  // long r = *pw;
  // if( r != 0 ) ++*pw;
  // return r;
...
public:
  ...
  virtual void destroy() BOOST_SP_NOEXCEPT { delete this; }
