...
// Unlike __MINGW64__, __MINGW64_VERSION_MAJOR is defined by MinGW-w64 for both
...
#elif defined(__clang__) && defined(_MSC_VER) && defined(_CPPLIB_VER) &&       \
    _CPPLIB_VER >= 520
...
extern "C" long __CLRCALL_PURE_OR_CDECL
_InterlockedCompareExchange(long volatile *, long, long);
extern "C" long __CLRCALL_PURE_OR_CDECL _InterlockedExchange(long volatile *,
                                                             long);
extern "C" long __CLRCALL_PURE_OR_CDECL _InterlockedExchangeAdd(long volatile *,
                                                                long);
...
// From MSDN, Visual Studio .NET 2003 spedific: To declare one of the
// interlocked functions for use as an intrinsic, the function must be declared
// with the leading underscore and the new function must appear in a #pragma
// intrinsic statement.
...
extern "C" __declspec(dllimport) long __stdcall InterlockedDecrement(
    long volatile *);
extern "C" __declspec(dllimport) long __stdcall InterlockedCompareExchange(
    long volatile *, long, long);
extern "C" __declspec(dllimport) long __stdcall InterlockedExchange(
    long volatile *, long);
extern "C" __declspec(dllimport) long __stdcall InterlockedExchangeAdd(
    long volatile *, long);
...
#define BOOST_SP_INTERLOCKED_COMPARE_EXCHANGE                                  \
  ::boost::detail::InterlockedCompareExchange
#define BOOST_SP_INTERLOCKED_EXCHANGE ::boost::detail::InterlockedExchange
#define BOOST_SP_INTERLOCKED_EXCHANGE_ADD                                      \
  ::boost::detail::InterlockedExchangeAdd
