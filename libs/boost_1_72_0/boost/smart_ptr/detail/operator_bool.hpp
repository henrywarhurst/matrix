...
explicit operator bool() const BOOST_SP_NOEXCEPT { return px != 0; }

#elif (defined(__SUNPRO_CC) && BOOST_WORKAROUND(__SUNPRO_CC, < 0x570)) ||      \
    defined(__CINT__)

operator bool() const BOOST_SP_NOEXCEPT { return px != 0; }
...
bool operator!() const BOOST_SP_NOEXCEPT { return px == 0; }
