...
struct thread_unsafe_counter {
  ...
  static void increment(unsigned int &counter) BOOST_SP_NOEXCEPT { ++counter; }
...
template <typename DerivedT, typename CounterPolicyT>
inline void
intrusive_ptr_add_ref(const intrusive_ref_counter<DerivedT, CounterPolicyT> *p)
    BOOST_SP_NOEXCEPT {
...
template <typename DerivedT, typename CounterPolicyT>
inline void
intrusive_ptr_release(const intrusive_ref_counter<DerivedT, CounterPolicyT> *p)
    BOOST_SP_NOEXCEPT {
