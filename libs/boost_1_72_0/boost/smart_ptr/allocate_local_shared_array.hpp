...
public:
  ...
  lsp_array_base &base() BOOST_SP_NOEXCEPT { return base_; }
...
inline
    typename enable_if_<is_unbounded_array<T>::value, local_shared_ptr<T>>::type
...
template <class T, class A>
inline
    typename enable_if_<is_bounded_array<T>::value, local_shared_ptr<T>>::type
