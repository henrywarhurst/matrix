...
// Note: do not rely on this header being included since users can short-circuit
// this #include if they know whose std lib they are using.
#if !defined(__LIBCOMO__) && !defined(__STD_RWCOMPILER_H__) &&                 \
    !defined(_RWSTD_VER) && !defined(_LIBCPP_VERSION) &&                       \
    !defined(__GLIBCPP__) && !defined(__GLIBCXX__) &&                          \
    !defined(__STL_CONFIG_H) && !defined(__MSL_CPP__) &&                       \
    !defined(__IBMCPP__) && !defined(MSIPL_COMPILE_H) && !defined(_YVALS) &&   \
    !defined(_CPPLIB_VER)
#include <utility>
#endif
