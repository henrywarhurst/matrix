...
// Flags determined by comparing output of 'icpc -dM -E' with and without
// '-std=c++0x'
...
#ifdef __GNUC__
#define BOOST_INTEL_GCC_VERSION                                                \
...
#else // defined(__INTEL_COMPILER) && (__INTEL_COMPILER >= 1500) &&
      // (defined(_MSC_VER) || defined(__GNUC__))
...
#define BOOST_FUNCTION_SCOPE_USING_DECLARATION_BREAKS_ADL
    ...
    (defined(_WIN32) && (BOOST_INTEL_CXX_VERSION <= 1200)) ||                  \
...
// Apparently Intel 12.1 (compiler version number 9999 !!) has the same issue
// (compiler regression).
#if defined(__INTEL_COMPILER)
#if (__INTEL_COMPILER <= 1110) || (__INTEL_COMPILER == 9999) ||                \
    (defined(_WIN32) && (__INTEL_COMPILER < 1600))
...
#if (BOOST_INTEL_CXX_VERSION >= 1210) &&                                       \
    (!defined(BOOST_INTEL_GCC_VERSION) ||                                      \
     (BOOST_INTEL_GCC_VERSION >= 40700)) &&                                    \
    (!defined(_MSC_VER) || (_MSC_FULL_VER >= 180020827))
...
#if (BOOST_INTEL_CXX_VERSION >= 1300) &&                                       \
    (!defined(BOOST_INTEL_GCC_VERSION) ||                                      \
     (BOOST_INTEL_GCC_VERSION >= 40300)) &&                                    \
    (!defined(_MSC_VER) || (_MSC_VER >= 1600))
// This is available from earlier Intel versions, but breaks Filesystem and
// other libraries:
...
// BOOST_NO_CXX11_CHAR16_T
    ...
    (!defined(BOOST_INTEL_GCC_VERSION) ||                                      \
     (BOOST_INTEL_GCC_VERSION >= 40400)) &&                                    \
    (!defined(_MSC_VER) || (_MSC_VER >= 9999))
...
#if (BOOST_INTEL_CXX_VERSION >= 1200) &&                                       \
    (!defined(BOOST_INTEL_GCC_VERSION) || (BOOST_INTEL_GCC_VERSION >= 40500))
...
// BOOST_NO_CXX11_USER_DEFINED_LITERALS
    ...
    (!defined(BOOST_INTEL_GCC_VERSION) ||                                      \
     (BOOST_INTEL_GCC_VERSION >= 40700)) &&                                    \
    (!defined(_MSC_VER) || (_MSC_FULL_VER >= 190021730))
...
// A regression in Intel's compiler means that <tuple> seems to be broken in
// this release as well as <future> :
#define BOOST_NO_CXX11_HDR_FUTURE
...
// Intel 13.10 fails to access defaulted functions of a base class declared in
// private or protected sections, producing the following errors: error #453:
// protected function "..." (declared at ...") is not accessible through a "..."
// pointer or object
...
#define BOOST_NVCC_CXX03
    ...
    (BOOST_INTEL_CXX_VERSION >= 1310) && !defined(BOOST_NVCC_CXX03)
...
#error                                                                         \
    "Boost.Config is older than your compiler - please check for an updated Boost release."
#elif defined(_MSC_VER)
//
//      We don't emit this warning any more, since we have so few
//      defect macros set anyway (just the one).
//
//#     pragma message("boost: Unknown compiler version - please run the
