...
// b2 -j 8 toolset=cray cxxstd=03 cxxstd=11 cxxstd=14 cxxstd-dialect=gnu
// linkflags=-lrt
// ```
...
#define BOOST_CRAY_VERSION                                                     \
  (_RELEASE_MAJOR * 10000 + _RELEASE_MINOR * 100 + _RELEASE_PATCHLEVEL)
...
#define BOOST_COMPILER                                                         \
  "Cray C++ version " BOOST_STRINGIZE(_RELEASE_MAJOR) "." BOOST_STRINGIZE(     \
      _RELEASE_MINOR) "." BOOST_STRINGIZE(_RELEASE_PATCHLEVEL)
#endif
...
#error                                                                         \
    "Boost is not configured for Cray compilers prior to version 8, please try the configure script."
#endif
...
//#define BOOST_BUGGY_INTEGRAL_CONSTANT_EXPRESSIONS //(this may be implied by
//the previous #define
...
#define BOOST_HAS_FLOAT128
#define BOOST_HAS_PTHREAD_YIELD // This is a platform macro, but it improves
                                // test results.
#define BOOST_NO_COMPLETE_VALUE_INITIALIZATION // This is correct. Test
...
#undef BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS
#define BOOST_NO_CXX11_SFINAE_EXPR // This is correct, even though '*_fail.cpp'
                                   // test fails.
#undef BOOST_NO_CXX11_UNIFIED_INITIALIZATION_SYNTAX
#undef BOOST_NO_CXX11_VARIADIC_MACROS
#undef BOOST_NO_CXX11_VARIADIC_TEMPLATES
...
#define BOOST_NO_CXX11_HDR_REGEX // This is correct. Test compiles, but fails to
                                 // run.
#undef BOOST_NO_CXX11_SFINAE_EXPR
