...
#if !_HAS_EXCEPTIONS && ((defined(BOOST_MSVC) && BOOST_MSVC >= 1400) ||        \
...
#if ((!defined(_HAS_TR1_IMPORTS) || (_HAS_TR1_IMPORTS + 0 == 0)) &&            \
...
// C++17 features
#if !defined(_CPPLIB_VER) || (_CPPLIB_VER < 650) || !defined(BOOST_MSVC) ||    \
    (BOOST_MSVC < 1910) || !defined(_HAS_CXX17) || (_HAS_CXX17 == 0)
...
#endif
#if !defined(_CPPLIB_VER) || (_CPPLIB_VER < 650) || !defined(_HAS_CXX17) ||    \
    (_HAS_CXX17 == 0) || !defined(_MSVC_STL_UPDATE) ||                         \
    (_MSVC_STL_UPDATE < 201709)
#define BOOST_NO_CXX17_STD_INVOKE
#endif

#if !(!defined(_CPPLIB_VER) || (_CPPLIB_VER < 650) || !defined(BOOST_MSVC) ||  \
      (BOOST_MSVC < 1912) || !defined(_HAS_CXX17) || (_HAS_CXX17 == 0))
...
#if defined(_CPPLIB_VER) && (_CPPLIB_VER >= 650)
// If _HAS_AUTO_PTR_ETC is defined to 0, std::auto_ptr and std::random_shuffle
// are not available. See
// https://www.visualstudio.com/en-us/news/vs2015-vs.aspx#C++ and
