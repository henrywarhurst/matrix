...
#endif
#if (_LIBCPP_VERSION > 4000) && (__cplusplus > 201402L) &&                     \
    !defined(_LIBCPP_ENABLE_CXX17_REMOVED_BINDERS)
#define BOOST_NO_CXX98_BINDERS
#endif

#define BOOST_NO_CXX17_ITERATOR_TRAITS
#define BOOST_NO_CXX17_STD_INVOKE // Invoke support is incomplete (no
                                  // invoke_result)

#if (_LIBCPP_VERSION <= 1101) && !defined(BOOST_NO_CXX11_THREAD_LOCAL)
// This is a bit of a sledgehammer, because really it's just libc++abi that has
// no support for thread_local, leading to linker errors such as "undefined
// reference to `__cxa_thread_atexit'".  It is fixed in the most recent releases
// of libc++abi though...
#define BOOST_NO_CXX11_THREAD_LOCAL
#endif

#if defined(__linux__) && (_LIBCPP_VERSION < 6000) &&                          \
